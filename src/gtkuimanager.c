...
gtk_ui_manager_init (GtkUIManager *self)
{
  ...
  merge_id = __gtk_ui_manager_new_merge_id (self);
				    ...
				    const gchar   *type)
{
  ...
  g_object_ref (child);
  __gtk_ui_manager_insert_action_group (self,
			    ...
			    GtkUIManager *uimgr)
{
  ...
  group = __gtk_ui_manager_get_accel_group (uimgr);
  groups = __gtk_accel_groups_from_object (G_OBJECT (toplevel));
  if (g_slist_find (groups, group) == NULL)
    __gtk_window_add_accel_group (GTK_WINDOW (toplevel), group);
					  ...
					  const gchar  *id)
{
  ...
  widget = __gtk_ui_manager_get_widget (GTK_UI_MANAGER (buildable), name);
  if (!widget)
    {
			     ...
			     GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_ADD_TEAROFFS:
      __gtk_ui_manager_set_add_tearoffs (self, g_value_get_boolean (value));
      break;
    default:
			     ...
			     GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_ADD_TEAROFFS:
      ...
      break;
    case PROP_UI:
      g_value_take_string (value, __gtk_ui_manager_get_ui (self));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
                                ...
                                const gchar  *path)
{
   ...
   * widget */
  __gtk_ui_manager_ensure_update (self);
...
/**
 * __gtk_ui_manager_get_add_tearoffs:
 * @self: a #GtkUIManager
 * 
 ...
 **/
gboolean 
__gtk_ui_manager_get_add_tearoffs (GtkUIManager *self)
{
...
/**
 * __gtk_ui_manager_set_add_tearoffs:
 * @self: a #GtkUIManager
 ...
 **/
void 
__gtk_ui_manager_set_add_tearoffs (GtkUIManager *self,
				 gboolean      add_tearoffs)
{
...
/**
 * __gtk_ui_manager_insert_action_group:
 ...
 **/
void
__gtk_ui_manager_insert_action_group (GtkUIManager   *self,
...
#ifdef G_ENABLE_DEBUG
  group_name  = __gtk_action_group_get_name (action_group);

  for (l = self->private_data->action_groups; l; l = l->next) 
    {
      GtkActionGroup *group = l->data;

      if (strcmp (__gtk_action_group_get_name (group), group_name) == 0)
        {
...
/**
 * __gtk_ui_manager_remove_action_group:
 * @self: a #GtkUIManager object
 ...
 **/
void
__gtk_ui_manager_remove_action_group (GtkUIManager   *self,
				    GtkActionGroup *action_group)
{
  g_return_if_fail (GTK_IS_UI_MANAGER (self));
  g_return_if_fail (GTK_IS_ACTION_GROUP (action_group));
...
/**
 * __gtk_ui_manager_get_action_groups:
 * @self: a #GtkUIManager object
 * 
 ...
 **/
GList *
__gtk_ui_manager_get_action_groups (GtkUIManager *self)
{
...
/**
 * __gtk_ui_manager_get_accel_group:
 * @self: a #GtkUIManager object
 * 
 ...
 **/
GtkAccelGroup *
__gtk_ui_manager_get_accel_group (GtkUIManager *self)
{
  g_return_val_if_fail (GTK_IS_UI_MANAGER (self), NULL);
 ...
 **/
GtkWidget *
__gtk_ui_manager_get_widget (GtkUIManager *self,
			   const gchar  *path)
{
  g_return_val_if_fail (GTK_IS_UI_MANAGER (self), NULL);
...
/**
 * __gtk_ui_manager_get_toplevels:
 * @self: a #GtkUIManager
 ...
 **/
GSList *
__gtk_ui_manager_get_toplevels (GtkUIManager         *self,
			      GtkUIManagerItemType  types)
{
  ToplevelData data;
...
/**
 * __gtk_ui_manager_get_action:
 * @self: a #GtkUIManager
 * @path: a path
 * 
 * Looks up an action by following a path. See __gtk_ui_manager_get_widget()
 ...
 **/
GtkAction *
__gtk_ui_manager_get_action (GtkUIManager *self,
			   const gchar  *path)
{
  g_return_val_if_fail (GTK_IS_UI_MANAGER (self), NULL);
  g_return_val_if_fail (path != NULL, NULL);
...
/**
 * __gtk_ui_manager_new_merge_id:
 * @self: a #GtkUIManager
 * 
 * Returns an unused merge id, suitable for use with 
 * __gtk_ui_manager_add_ui().
 * 
 ...
 **/
guint
__gtk_ui_manager_new_merge_id (GtkUIManager *self)
{
	 ...
	 gpointer             user_data)
{
  ...
  __gtk_ui_manager_remove_ui (ctx->self, ctx->merge_id);
}
		    ...
		    GError      **error)
{
  ...
  ctx.self = self;
  ctx.current = NULL;
  ctx.merge_id = __gtk_ui_manager_new_merge_id (self);
...
/**
 * __gtk_ui_manager_add_ui_from_string:
 * @self: a #GtkUIManager object
 ...
 *   to unmerge the UI with __gtk_ui_manager_remove_ui(). If an error occurred,
 *   the return value is 0.
 *
 * Since: 2.4
 **/
guint
__gtk_ui_manager_add_ui_from_string (GtkUIManager *self,
				   const gchar  *buffer, 
				   gssize        length,
				   GError      **error)
{
...
/**
 * __gtk_ui_manager_add_ui_from_file:
 * @self: a #GtkUIManager object
 ...
 **/
guint
__gtk_ui_manager_add_ui_from_file (GtkUIManager *self,
 ...
 * __gtk_ui_manager_add_ui:
 * @self: a #GtkUIManager
 * @merge_id: the merge id for the merged UI, see __gtk_ui_manager_new_merge_id()
 * @path: a path
 ...
 **/
void
__gtk_ui_manager_add_ui (GtkUIManager        *self,
		       guint                merge_id,
		       const gchar         *path,
		       const gchar         *name,
		       const gchar         *action,
...
/**
 * __gtk_ui_manager_remove_ui:
 * @self: a #GtkUIManager object
 * @merge_id: a merge id as returned by __gtk_ui_manager_add_ui_from_string()
 * 
 ...
 **/
void
__gtk_ui_manager_remove_ui (GtkUIManager *self, 
			  guint         merge_id)
{
  g_return_if_fail (GTK_IS_UI_MANAGER (self));
  ...
  for (tmp = merge->private_data->action_groups; tmp != NULL; tmp = tmp->next)
    {
      ...
      action = __gtk_action_group_get_action (action_group, action_name);
  ...
  if (node->prev == NULL)
	...
	case NODE_TYPE_MENU:
	  ...
	  if (GTK_IS_MENU_ITEM (menushell))
	    menushell = __gtk_menu_item_get_submenu (GTK_MENU_ITEM (menushell));
	  siblings = __gtk_container_get_children (GTK_CONTAINER (menushell));
	...
	prev_child = NODE_INFO (sibling)->proxy;
      ...
      menushell = __gtk_widget_get_parent (prev_child);
		       ...
		       gint       *pos_p)
{
  ...
  if (node->prev == NULL)
	...
	case NODE_TYPE_TOOLBAR:
	  ...
	  break;
	case NODE_TYPE_TOOLBAR_PLACEHOLDER:
	  toolbar = __gtk_widget_get_parent (NODE_INFO (parent)->proxy);
	  g_return_val_if_fail (GTK_IS_TOOLBAR (toolbar), FALSE);
	  pos = __gtk_toolbar_get_item_index (GTK_TOOLBAR (toolbar),
	...
	prev_child = NODE_INFO (sibling)->proxy;
      ...
      toolbar = __gtk_widget_get_parent (prev_child);
...
_gtk_menu_is_empty (GtkWidget *menu)
{
  ...
  while (cur) 
    {
      if (__gtk_widget_get_visible (cur->data))
	{
...
update_smart_separators (GtkWidget *proxy)
{
  ...
  if (GTK_IS_MENU (proxy) || GTK_IS_TOOLBAR (proxy))
    ...
    parent = __gtk_widget_get_parent (proxy);
  ...
  if (parent) 
    {
      ...
      children = __gtk_container_get_children (GTK_CONTAINER (parent));
      ...
      while (cur) 
	{
	  if (g_object_get_data (cur->data, "gtk-empty-menu-item"))
		...
		case SEPARATOR_MODE_VISIBLE:
		  __gtk_widget_show (GTK_WIDGET (cur->data));
		  last = NULL;
		  visible = FALSE;
		  break;
		case SEPARATOR_MODE_HIDDEN:
		  __gtk_widget_hide (GTK_WIDGET (cur->data));
		  break;
	  ...
	  else if (__gtk_widget_get_visible (cur->data))
	    {
	      last = NULL;
      ...
      if (last)
	__gtk_widget_hide (GTK_WIDGET (last->data));

      if (GTK_IS_MENU (parent)) 
	{
	  GtkWidget *item;

	  item = __gtk_menu_get_attach_widget (GTK_MENU (parent));
	  if (GTK_IS_MENU_ITEM (item))
	    ___gtk_action_sync_menu_visible (NULL, item, empty);
	  if (GTK_IS_WIDGET (filler))
	    {
	      if (empty)
		__gtk_widget_show (filler);
	      else
		__gtk_widget_hide (filler);
	    }
	}
             ...
             gboolean      popup_accels)
{
  ...
  if (action)
    __gtk_action_set_accel_group (action, self->private_data->accel_group);
  ...
  if (info->proxy != NULL && action == info->action)
      ...
      if (info->type == NODE_TYPE_MENU) 
	{
	  ...
	  if (GTK_IS_MENU (info->proxy))
	    ...
	    menu = __gtk_menu_item_get_submenu (GTK_MENU_ITEM (info->proxy));
	  siblings = __gtk_container_get_children (GTK_CONTAINER (menu));
	  if (siblings != NULL && GTK_IS_TEAROFF_MENU_ITEM (siblings->data))
	    {
	      if (self->private_data->add_tearoffs && !in_popup)
		__gtk_widget_show (GTK_WIDGET (siblings->data));
	      else
		__gtk_widget_hide (GTK_WIDGET (siblings->data));
	    }
	  g_list_free (siblings);
	}
  ...
  switch (info->type)
    ...
    case NODE_TYPE_MENUBAR:
      if (info->proxy == NULL)
	{
	  info->proxy = __gtk_menu_bar_new ();
	  g_object_ref_sink (info->proxy);
	  __gtk_widget_set_name (info->proxy, info->name);
	  __gtk_widget_show (info->proxy);
	...
	if (info->proxy &&  
	    G_OBJECT_TYPE (info->proxy) != GTK_ACTION_GET_CLASS (action)->menu_item_type)
	  {
	    if (GTK_IS_MENU_ITEM (info->proxy))
	      {
		prev_submenu = __gtk_menu_item_get_submenu (GTK_MENU_ITEM (info->proxy));
		if (prev_submenu)
		  {
		    g_object_ref (prev_submenu);
		    __gtk_menu_item_set_submenu (GTK_MENU_ITEM (info->proxy), NULL);
		}
	      }

            __gtk_activatable_set_related_action (GTK_ACTIVATABLE (info->proxy), NULL);
	    __gtk_container_remove (GTK_CONTAINER (gtk_widget_get_props (info->proxy)->parent),
				  info->proxy);
	    g_object_unref (info->proxy);
	    info->proxy = NULL;
	  }
	...
	if (info->proxy == NULL)
	  {
            ...
            if ((NODE_INFO (node->parent)->type == NODE_TYPE_TOOLITEM ||
              ...
              {
                menu = __gtk_action_create_menu (action);
              }
            ...
            if (!menu)
              {
                ...
                menu = __gtk_menu_new ();
                __gtk_widget_set_name (menu, info->name);
                tearoff = __gtk_tearoff_menu_item_new ();
                __gtk_widget_set_no_show_all (tearoff, TRUE);
                __gtk_menu_shell_append (GTK_MENU_SHELL (menu), tearoff);
                filler = __gtk_menu_item_new_with_label (_("Empty"));
                g_object_set_data (G_OBJECT (filler),
                                   I_("gtk-empty-menu-item"),
                                   GINT_TO_POINTER (TRUE));
                __gtk_widget_set_sensitive (filler, FALSE);
                __gtk_widget_set_no_show_all (filler, TRUE);
                __gtk_menu_shell_append (GTK_MENU_SHELL (menu), filler);
              }
		...
		info->proxy = menu;
		g_object_ref_sink (info->proxy);
		__gtk_menu_tool_button_set_menu (GTK_MENU_TOOL_BUTTON (NODE_INFO (node->parent)->proxy),
					       menu);
	      }
	    else
	      {
		...
		if (find_menu_position (node, &menushell, &pos))
                  {
		     info->proxy = __gtk_action_create_menu_item (action);
		     g_object_ref_sink (info->proxy);
		     g_signal_connect (info->proxy, "notify::visible",
		   		       G_CALLBACK (update_smart_separators), NULL);
		     __gtk_widget_set_name (info->proxy, info->name);
		
		     __gtk_menu_item_set_submenu (GTK_MENU_ITEM (info->proxy), menu);
		     __gtk_menu_shell_insert (GTK_MENU_SHELL (menushell), info->proxy, pos);
                 }
	      }
	  }
	else
          __gtk_activatable_set_related_action (GTK_ACTIVATABLE (info->proxy), action);
	
	if (prev_submenu)
	  {
	    __gtk_menu_item_set_submenu (GTK_MENU_ITEM (info->proxy),
				       prev_submenu);
	  ...
	  !GTK_IS_SEPARATOR_MENU_ITEM (info->extra))
	{
	  ...
	  if (info->extra)
	    {
	      __gtk_container_remove (GTK_CONTAINER (gtk_widget_get_props (info->extra)->parent),
				    info->extra);
	      g_object_unref (info->extra);
	      info->extra = NULL;
	    }
      ...
      if (info->proxy == NULL)
	{
	  ...
	  if (find_menu_position (node, &menushell, &pos))
            {
	      info->proxy = __gtk_separator_menu_item_new ();
	      g_object_ref_sink (info->proxy);
	      g_object_set_data (G_OBJECT (info->proxy),
	  		         I_("gtk-separator-mode"),
			         GINT_TO_POINTER (SEPARATOR_MODE_HIDDEN));
	      __gtk_widget_set_no_show_all (info->proxy, TRUE);
	      __gtk_menu_shell_insert (GTK_MENU_SHELL (menushell),
	 			     NODE_INFO (node)->proxy, pos);
	  
	      info->extra = __gtk_separator_menu_item_new ();
	      g_object_ref_sink (info->extra);
	      g_object_set_data (G_OBJECT (info->extra),
			         I_("gtk-separator-mode"),
			         GINT_TO_POINTER (SEPARATOR_MODE_HIDDEN));
	      __gtk_widget_set_no_show_all (info->extra, TRUE);
	      __gtk_menu_shell_insert (GTK_MENU_SHELL (menushell),
      ...
      if (info->proxy == NULL)
	{
	  ...
	  if (find_toolbar_position (node, &toolbar, &pos))
            {
	      item = __gtk_separator_tool_item_new ();
	      __gtk_toolbar_insert (GTK_TOOLBAR (toolbar), item, pos);
	      ...
	      item = __gtk_separator_tool_item_new ();
	      __gtk_toolbar_insert (GTK_TOOLBAR (toolbar), item, pos+1);
	  ...
	  if (find_menu_position (node, &menushell, &pos))
	      ...
	      __gtk_widget_set_name (info->proxy, info->name);
              ...
              if (info->always_show_image_set &&
                ...
                __gtk_image_menu_item_set_always_show_image (GTK_IMAGE_MENU_ITEM (info->proxy),
      ...
      else
	{
      ...
      if (info->proxy)
          ...
          if (in_popup && !popup_accels)
	    {
	      ...
	      GtkWidget *child = __gtk_bin_get_child (GTK_BIN (info->proxy));
      ...
      if (info->proxy == NULL)
	{
	  ...
	  if (find_toolbar_position (node, &toolbar, &pos))
            {
	      info->proxy = __gtk_action_create_tool_item (action);
	      g_object_ref_sink (info->proxy);
	      __gtk_widget_set_name (info->proxy, info->name);
	      
	      __gtk_toolbar_insert (GTK_TOOLBAR (toolbar),
	  ...
	  NODE_INFO (node->parent)->type == NODE_TYPE_TOOLBAR_PLACEHOLDER)
	{
	  ...
	  if (find_toolbar_position (node, &toolbar, &pos))
	      ...
	      if (info->expand)
	        {
	          __gtk_tool_item_set_expand (GTK_TOOL_ITEM (item), TRUE);
	          __gtk_separator_tool_item_set_draw (GTK_SEPARATOR_TOOL_ITEM (item), FALSE);
 ...
 recurse_children:
  ...
  if (info->proxy) 
	...
	update_smart_separators (__gtk_menu_item_get_submenu (GTK_MENU_ITEM (info->proxy)));
  ...
  if (node->children == NULL && info->uifiles == NULL)
    {
      if (info->proxy)
	__gtk_widget_destroy (info->proxy);
      if (info->extra)
	__gtk_widget_destroy (info->extra);
      if (info->type == NODE_TYPE_ACCELERATOR && info->action != NULL)
	__gtk_action_disconnect_accelerator (info->action);
      free_node (node);
      g_node_destroy (node);
    }
}
...
queue_update (GtkUIManager *self)
{
  ...
  self->private_data->update_tag = __gdk_threads_add_idle (
...
/**
 * __gtk_ui_manager_ensure_update:
 * @self: a #GtkUIManager
 * 
 ...
 * __gtk_ui_manager_add_ui_from_file (merge, "my-menus");
 * __gtk_ui_manager_add_ui_from_file (merge, "my-toolbars");
 * __gtk_ui_manager_ensure_update (merge);  
 ...
 **/
void
__gtk_ui_manager_ensure_update (GtkUIManager *self)
{
  if (self->private_data->update_tag != 0)
    {
      g_source_remove (self->private_data->update_tag);
  ...
  if (strcmp (tagname, "ui") == 0)
    {
      ...
      ctx->current = NULL;
      ctx->merge_id = __gtk_ui_manager_new_merge_id (GTK_UI_MANAGER (buildable));
 ...
 **/
gchar *
__gtk_ui_manager_get_ui (GtkUIManager *self)
{
  GString *buffer;
...
#undef __gtk_ui_manager_add_ui_from_file
				 ...
				 GError      **error)
{
  ...
  retval = __gtk_ui_manager_add_ui_from_file_utf8 (self, utf8_filename, error);
