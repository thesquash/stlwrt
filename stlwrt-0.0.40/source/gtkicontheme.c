 ...
 * Usually, you'll want to use __gtk_icon_theme_get_default()
 * or __gtk_icon_theme_get_for_screen() rather than creating
 ...
 **/
GtkIconTheme *
__gtk_icon_theme_new (void)
{
  return g_object_new (GTK_TYPE_ICON_THEME, NULL);
}

/**
 * __gtk_icon_theme_get_default:
 * 
 * Gets the icon theme for the default screen. See
 * __gtk_icon_theme_get_for_screen().
 *
 ...
 **/
GtkIconTheme *
__gtk_icon_theme_get_default (void)
{
  return __gtk_icon_theme_get_for_screen (__gdk_screen_get_default ());
}
 ...
 * is usually a better choice than calling than __gtk_icon_theme_new()
 ...
 **/
GtkIconTheme *
__gtk_icon_theme_get_for_screen (GdkScreen *screen)
{
  ...
  if (!icon_theme)
    {
      ...
      icon_theme = __gtk_icon_theme_new ();
      __gtk_icon_theme_set_screen (icon_theme, screen);
		...
		GtkIconTheme *icon_theme)
{
  ...
  __gtk_icon_theme_set_screen (icon_theme, NULL);
  ...
  if (!priv->custom_theme)
    {
      ...
      if (priv->screen)
	{
	  GtkSettings *settings = __gtk_settings_get_for_screen (priv->screen);
...
unset_screen (GtkIconTheme *icon_theme)
{
  ...
  if (priv->screen)
    {
      settings = __gtk_settings_get_for_screen (priv->screen);
      display = __gdk_screen_get_display (priv->screen);
 ...
 **/
void
__gtk_icon_theme_set_screen (GtkIconTheme *icon_theme,
			   GdkScreen    *screen)
{
  GtkIconThemePrivate *priv;
  GtkSettings *settings;
...
do_theme_change (GtkIconTheme *icon_theme)
{
  ...
  if (!priv->reset_styles_idle)
    priv->reset_styles_idle = 
      __gdk_threads_add_idle_full (GTK_PRIORITY_RESIZE - 2, 
...
/**
 * __gtk_icon_theme_set_search_path:
 * @icon_theme: a #GtkIconTheme
 ...
 **/
void
__gtk_icon_theme_set_search_path (GtkIconTheme *icon_theme,
				const gchar  *path[],
				gint          n_elements)
{
  GtkIconThemePrivate *priv;
...
/**
 * __gtk_icon_theme_get_search_path:
 * @icon_theme: a #GtkIconTheme
 ...
 *              in @path, or %NULL
 * 
 * Gets the current search path. See __gtk_icon_theme_set_search_path().
 *
 * Since: 2.4
 **/
void
__gtk_icon_theme_get_search_path (GtkIconTheme      *icon_theme,
				gchar            **path[],
				gint              *n_elements)
{
  GtkIconThemePrivate *priv;
...
/**
 * __gtk_icon_theme_append_search_path:
 * @icon_theme: a #GtkIconTheme
 * @path: directory name to append to the icon path
 * 
 * Appends a directory to the search path. 
 * See __gtk_icon_theme_set_search_path(). 
 *
 * Since: 2.4
 **/
void
__gtk_icon_theme_append_search_path (GtkIconTheme *icon_theme,
				   const gchar  *path)
{
  GtkIconThemePrivate *priv;
...
/**
 * __gtk_icon_theme_prepend_search_path:
 * @icon_theme: a #GtkIconTheme
 ...
 **/
void
__gtk_icon_theme_prepend_search_path (GtkIconTheme *icon_theme,
				    const gchar  *path)
{
  GtkIconThemePrivate *priv;
  int i;
...
/**
 * __gtk_icon_theme_set_custom_theme:
 * @icon_theme: a #GtkIconTheme
 ...
 * on the icon theme objects returned from __gtk_icon_theme_get_default()
 * and __gtk_icon_theme_get_for_screen().
 *
 * Since: 2.4
 **/
void
__gtk_icon_theme_set_custom_theme (GtkIconTheme *icon_theme,
...
void
______gtk_icon_theme_ensure_builtin_cache (void)
{
...
ensure_valid_themes (GtkIconTheme *icon_theme)
{
  ...
  ______gtk_icon_theme_ensure_builtin_cache ();
      ...
      if (was_valid)
	{
	  ...
	  if (!priv->check_reload && priv->screen)
	    {	  
	      ...
	      GdkEvent *event = __gdk_event_new (GDK_CLIENT_EVENT);
	      int i;
		...
		event->client.data.l[i] = 0;
	      ...
	      __gdk_screen_broadcast_client_message (priv->screen, event);
	    }
	}
    }
 ...
 * __gtk_icon_info_load_icon(). (__gtk_icon_theme_load_icon()
 ...
 * __gtk_icon_info_free()
 *
 * Since: 2.4
 */
GtkIconInfo *
__gtk_icon_theme_lookup_icon (GtkIconTheme       *icon_theme,
			    const gchar        *icon_name,
			    gint                size,
			    GtkIconLookupFlags  flags)
{
 ...
 */
GtkIconInfo *
__gtk_icon_theme_choose_icon (GtkIconTheme       *icon_theme,
			    const gchar        *icon_names[],
			    gint                size,
			    GtkIconLookupFlags  flags)
{
 ...
 * __gtk_icon_theme_lookup_icon() followed by __gtk_icon_info_load_icon().
 *
 ...
 **/
GdkPixbuf *
__gtk_icon_theme_load_icon (GtkIconTheme         *icon_theme,
			  const gchar          *icon_name,
			  gint                  size,
			  GtkIconLookupFlags    flags,
			  GError              **error)
{
  ...
  icon_info = __gtk_icon_theme_lookup_icon (icon_theme, icon_name, size,
 ...
 **/
gboolean 
__gtk_icon_theme_has_icon (GtkIconTheme *icon_theme,
			 const char   *icon_name)
{
  GtkIconThemePrivate *priv;
  GList *l;
...
/**
 * __gtk_icon_theme_get_icon_sizes:
 * @icon_theme: a #GtkIconTheme
 * @icon_name: the name of an icon
 * 
 ...
 **/
gint *
__gtk_icon_theme_get_icon_sizes (GtkIconTheme *icon_theme,
			       const char   *icon_name)
{
  GList *l, *d, *icons;
  GHashTable *sizes;
 ...
 **/
GList *
__gtk_icon_theme_list_icons (GtkIconTheme *icon_theme,
			   const char   *context)
{
  GtkIconThemePrivate *priv;
  GHashTable *icons;
...
/**
 * __gtk_icon_theme_list_contexts:
 * @icon_theme: a #GtkIconTheme
 *
 ...
 **/
GList *
__gtk_icon_theme_list_contexts (GtkIconTheme *icon_theme)
{
  GtkIconThemePrivate *priv;
  GHashTable *contexts;
  GList *list, *l;
...
/**
 * __gtk_icon_theme_get_example_icon_name:
 * @icon_theme: a #GtkIconTheme
 * 
 ...
 **/
char *
__gtk_icon_theme_get_example_icon_name (GtkIconTheme *icon_theme)
{
  GtkIconThemePrivate *priv;
  GList *l;
  IconTheme *theme;
...
/**
 * __gtk_icon_theme_rescan_if_needed:
 * @icon_theme: a #GtkIconTheme
 * 
 ...
 **/
gboolean
__gtk_icon_theme_rescan_if_needed (GtkIconTheme *icon_theme)
{
  gboolean retval;
 ...
 **/
GtkIconInfo *
__gtk_icon_info_copy (GtkIconInfo *icon_info)
{
 ...
 **/
void
__gtk_icon_info_free (GtkIconInfo *icon_info)
{
  ...
  g_slist_foreach (icon_info->emblem_infos, (GFunc)__gtk_icon_info_free, NULL);
 ...
 **/
gint
__gtk_icon_info_get_base_size (GtkIconInfo *icon_info)
{
...
/**
 * __gtk_icon_info_get_filename:
 * @icon_info: a #GtkIconInfo
 * 
 * Gets the filename for the icon. If the
 * %GTK_ICON_LOOKUP_USE_BUILTIN flag was passed
 * to __gtk_icon_theme_lookup_icon(), there may be
 * no filename if a builtin icon is returned; in this
 * case, you should use __gtk_icon_info_get_builtin_pixbuf().
 * 
 * Return value: the filename for the icon, or %NULL
 *  if __gtk_icon_info_get_builtin_pixbuf() should
 ...
 **/
const gchar *
__gtk_icon_info_get_filename (GtkIconInfo *icon_info)
{
  g_return_val_if_fail (icon_info != NULL, NULL);
...
/**
 * __gtk_icon_info_get_builtin_pixbuf:
 ...
 **/
GdkPixbuf *
__gtk_icon_info_get_builtin_pixbuf (GtkIconInfo *icon_info)
{
  g_return_val_if_fail (icon_info != NULL, NULL);
...
/**
 * __gtk_icon_info_load_icon:
 * @icon_info: a #GtkIconInfo structure from __gtk_icon_theme_lookup_icon()
 * @error: (allow-none): location to store error information on failure,
 *     or %NULL.
 *
 * Renders an icon previously looked up in an icon theme using
 * __gtk_icon_theme_lookup_icon(); the size will be based on the size
 * passed to __gtk_icon_theme_lookup_icon(). Note that the resulting
 ...
 **/
GdkPixbuf *
__gtk_icon_info_load_icon (GtkIconInfo *icon_info,
			 GError     **error)
{
  g_return_val_if_fail (icon_info != NULL, NULL);
  g_return_val_if_fail (error == NULL || *error == NULL, NULL);
...
/**
 * __gtk_icon_info_set_raw_coordinates:
 * @icon_info: a #GtkIconInfo
 * @raw_coordinates: whether the coordinates of embedded rectangles
 *   and attached points should be returned in their original
 *   (unscaled) form.
 * 
 * Sets whether the coordinates returned by __gtk_icon_info_get_embedded_rect()
 * and __gtk_icon_info_get_attach_points() should be returned in their
 * original form as specified in the icon theme, instead of scaled
 * appropriately for the pixbuf returned by __gtk_icon_info_load_icon().
 *
 * Raw coordinates are somewhat strange; they are specified to be with
 * respect to the unscaled pixmap for PNG and XPM icons, but for SVG
 * icons, they are in a 1000x1000 coordinate space that is scaled
 * to the final size of the icon.  You can determine if the icon is an SVG
 * icon by using __gtk_icon_info_get_filename(), and seeing if it is non-%NULL
 * and ends in '.svg'.
 *
 ...
 **/
void
__gtk_icon_info_set_raw_coordinates (GtkIconInfo *icon_info,
...
/**
 * __gtk_icon_info_get_embedded_rect:
 * @icon_info: a #GtkIconInfo
 ...
 * See __gtk_icon_info_set_raw_coordinates() for further
 ...
 **/
gboolean
__gtk_icon_info_get_embedded_rect (GtkIconInfo  *icon_info,
...
/**
 * __gtk_icon_info_get_attach_points:
 * @icon_info: a #GtkIconInfo
 ...
 **/
gboolean
__gtk_icon_info_get_attach_points (GtkIconInfo *icon_info,
				 GdkPoint   **points,
				 gint        *n_points)
{
  g_return_val_if_fail (icon_info != NULL, FALSE);
...
/**
 * __gtk_icon_info_get_display_name:
 * @icon_info: a #GtkIconInfo
 * 
 ...
 **/
const gchar *
__gtk_icon_info_get_display_name (GtkIconInfo *icon_info)
{
  g_return_val_if_fail (icon_info != NULL, NULL);
...
/**
 * __gtk_icon_theme_add_builtin_icon:
 ...
 * as built-icons.
 *
 * In general, if you use __gtk_icon_theme_add_builtin_icon()
 ...
 **/
void
__gtk_icon_theme_add_builtin_icon (const gchar *icon_name,
				 gint         size,
				 GdkPixbuf   *pixbuf)
{
...
void
______gtk_icon_theme_check_reload (GdkDisplay *display)
{
  gint n_screens, i;
  GdkScreen *screen;
  GtkIconTheme *icon_theme;

  n_screens = __gdk_display_get_n_screens (display);
...
/**
 * __gtk_icon_theme_lookup_by_gicon:
 * @icon_theme: a #GtkIconTheme
 ...
 *     wasn't found. Free with __gtk_icon_info_free()
 *
 * Since: 2.14
 */
GtkIconInfo *
__gtk_icon_theme_lookup_by_gicon (GtkIconTheme       *icon_theme,
                                GIcon              *icon,
                                gint                size,
                                GtkIconLookupFlags  flags)
{
  ...
  if (G_IS_LOADABLE_ICON (icon))
  ...
  else if (G_IS_THEMED_ICON (icon))
    {
      ...
      info = __gtk_icon_theme_choose_icon (icon_theme, names, size, flags);
  ...
  else if (G_IS_EMBLEMED_ICON (icon))
    {
      ...
      info = __gtk_icon_theme_lookup_by_gicon (icon_theme, base, size, flags);
      if (info)
        {
	      ...
	      /* always force size for emblems */
              emblem_info = __gtk_icon_theme_lookup_by_gicon (icon_theme, emblem, size / 2, flags | GTK_ICON_LOOKUP_FORCE_SIZE);
              if (emblem_info)
      ...
      if ((flags & GTK_ICON_LOOKUP_FORCE_SIZE) != 0)
	{
	  ...
	  info = __gtk_icon_info_new_for_pixbuf (icon_theme, scaled);

	  g_object_unref (scaled);
	}
      else
	{
	  info = __gtk_icon_info_new_for_pixbuf (icon_theme, pixbuf);
	}
...
/**
 * __gtk_icon_info_new_for_pixbuf:
 * @icon_theme: a #GtkIconTheme
 ...
 */
GtkIconInfo *
__gtk_icon_info_new_for_pixbuf (GtkIconTheme *icon_theme,
                              GdkPixbuf    *pixbuf)
{
  GtkIconInfo *info;
...
#undef __gtk_icon_theme_set_search_path
				...
				gint          n_elements)
{
  ...
  __gtk_icon_theme_set_search_path_utf8 (icon_theme, utf8_path, n_elements);
...
#undef __gtk_icon_theme_get_search_path
				...
				gint              *n_elements)
{
  ...
  __gtk_icon_theme_get_search_path_utf8 (icon_theme, path, &n);
...
#undef __gtk_icon_theme_append_search_path
				   ...
				   const gchar  *path)
{
  ...
  __gtk_icon_theme_append_search_path_utf8 (icon_theme, utf8_path);

  g_free (utf8_path);
}

#undef __gtk_icon_theme_prepend_search_path
				    ...
				    const gchar  *path)
{
  ...
  __gtk_icon_theme_prepend_search_path_utf8 (icon_theme, utf8_path);

  g_free (utf8_path);
}

#undef __gtk_icon_info_get_filename
