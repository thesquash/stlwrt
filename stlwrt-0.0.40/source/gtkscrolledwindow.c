				     ...
				     GtkAdjustment     *hadjustment)
{
  ...
  if (!scrolled_window->hscrollbar)
    {
      ...
      __gtk_widget_set_parent (scrolled_window->hscrollbar, GTK_WIDGET (scrolled_window));
      g_object_ref (scrolled_window->hscrollbar);
      __gtk_widget_show (scrolled_window->hscrollbar);
    }
  else
    {
      GtkAdjustment *old_adjustment;
      
      old_adjustment = __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->hscrollbar));
	...
	return;
      ...
      g_signal_handlers_disconnect_by_func (old_adjustment,
					    ...
					    scrolled_window);
      __gtk_range_set_adjustment (GTK_RANGE (scrolled_window->hscrollbar),
				hadjustment);
    }
  hadjustment = __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->hscrollbar));
  ...
  if (bin->child)
    __gtk_widget_set_scroll_adjustments (bin->child,
				       __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->hscrollbar)),
				       __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->vscrollbar)));
				     ...
				     GtkAdjustment     *vadjustment)
{
  ...
  if (!scrolled_window->vscrollbar)
    {
      __gtk_widget_push_composite_child ();
      scrolled_window->vscrollbar = __gtk_vscrollbar_new (vadjustment);
      __gtk_widget_set_composite_name (scrolled_window->vscrollbar, "vscrollbar");
      __gtk_widget_pop_composite_child ();

      __gtk_widget_set_parent (scrolled_window->vscrollbar, GTK_WIDGET (scrolled_window));
      g_object_ref (scrolled_window->vscrollbar);
      __gtk_widget_show (scrolled_window->vscrollbar);
    }
  else
    {
      GtkAdjustment *old_adjustment;
      
      old_adjustment = __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->vscrollbar));
	...
	return;
      ...
      g_signal_handlers_disconnect_by_func (old_adjustment,
					    gtk_scrolled_window_adjustment_changed,
					    scrolled_window);
      __gtk_range_set_adjustment (GTK_RANGE (scrolled_window->vscrollbar),
				vadjustment);
    }
  vadjustment = __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->vscrollbar));
				  ...
				  gboolean           horizontal)
{
  ...
  if (horizontal)
    {
      if (scrolled_window->hscrollbar)
	adjustment = __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->hscrollbar));
    }
  else
    {
      if (scrolled_window->vscrollbar)
	adjustment = __gtk_range_get_adjustment (GTK_RANGE (scrolled_window->vscrollbar));
    }
				  ...
				  GtkRequisition *requisition)
{
  ...
  scrollbar_spacing = ______gtk_scrolled_window_get_scrollbar_spacing (scrolled_window);
  ...
  __gtk_widget_size_request (scrolled_window->hscrollbar,
			   &hscrollbar_requisition);
  __gtk_widget_size_request (scrolled_window->vscrollbar,
  ...
  if (bin->child && __gtk_widget_get_visible (bin->child))
	...
	{
	  GtkWidgetAuxInfo *aux_info = ______gtk_widget_get_aux_info (bin->child, FALSE);
					 ...
					 GtkAllocation *allocation)
{
  ...
  if (scrolled_window->vscrollbar_visible)
    {
      ...
      __gtk_widget_get_child_requisition (scrolled_window->vscrollbar,
					&vscrollbar_requisition);
  ...
  if (scrolled_window->hscrollbar_visible)
    {
      GtkRequisition hscrollbar_requisition;
      __gtk_widget_get_child_requisition (scrolled_window->hscrollbar,
					&hscrollbar_requisition);
  ...
  if (scrolled_window->hscrollbar_visible)
    {
      ...
      if (!__gtk_widget_get_visible (scrolled_window->hscrollbar))
	__gtk_widget_show (scrolled_window->hscrollbar);
      ...
      if (scrolled_window->shadow_type != GTK_SHADOW_NONE)
	{
      ...
      __gtk_widget_size_allocate (scrolled_window->hscrollbar, &child_allocation);
    }
  else if (__gtk_widget_get_visible (scrolled_window->hscrollbar))
    __gtk_widget_hide (scrolled_window->hscrollbar);

  if (scrolled_window->vscrollbar_visible)
    {
      GtkRequisition vscrollbar_requisition;
      if (!__gtk_widget_get_visible (scrolled_window->vscrollbar))
	__gtk_widget_show (scrolled_window->vscrollbar);
      ...
      if (scrolled_window->shadow_type != GTK_SHADOW_NONE)
	{
      ...
      __gtk_widget_size_allocate (scrolled_window->vscrollbar, &child_allocation);
    }
  else if (__gtk_widget_get_visible (scrolled_window->vscrollbar))
    __gtk_widget_hide (scrolled_window->vscrollbar);
}
  ...
  if (range && __gtk_widget_get_visible (range))
    {
      ...
      delta = ______gtk_range_get_wheel_delta (GTK_RANGE (range), event->direction);
					...
					gpointer       data)
{
  ...
  if (scrolled_win->hscrollbar &&
      adjustment == __gtk_range_get_adjustment (GTK_RANGE (scrolled_win->hscrollbar)))
    {
      if (scrolled_win->hscrollbar_policy == GTK_POLICY_AUTOMATIC)
	{
	  ...
	  if (scrolled_win->hscrollbar_visible != visible)
	   ...
	   adjustment == __gtk_range_get_adjustment (GTK_RANGE (scrolled_win->vscrollbar)))
    {
 ...
 */
gint
______gtk_scrolled_window_get_scrollbar_spacing (GtkScrolledWindow *scrolled_window)
{
