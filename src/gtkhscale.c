...
STLWRT_DEFINE_FTYPE_VPARENT (GtkHScale, gtk_hscale, GTK_TYPE_SCALE, G_TYPE_FLAG_NONE, ;)
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (hscale),
                                  GTK_ORIENTATION_HORIZONTAL);
}

GtkWidget *
__gtk_hscale_new (GtkAdjustment *adjustment)
{
 ...
 **/
GtkWidget *
__gtk_hscale_new_with_range (gdouble min,
                           gdouble max,
                           gdouble step)
{
  GObject *adj;
