 ...
 *
 * A #GtkToolPalette is created with a call to __gtk_tool_palette_new().
 *
 * #GtkToolItem<!-- -->s cannot be added directly to a #GtkToolPalette - 
 * instead they are added to a #GtkToolItemGroup which can than be added
 * to a #GtkToolPalette. To add a #GtkToolItemGroup to a #GtkToolPalette,
 * use __gtk_container_add().
 *
 * |[
 * GtkWidget *palette, *group;
 * GtkToolItem *item;
 *
 * palette = __gtk_tool_palette_new ();
 * group = __gtk_tool_item_group_new (_("Test Category"));
 * __gtk_container_add (GTK_CONTAINER (palette), group);
 *
 * item = __gtk_tool_button_new_from_stock (GTK_STOCK_OK);
 * __gtk_tool_item_group_insert (GTK_TOOL_ITEM_GROUP (group), item, -1);
 * ]|
 *
 * The easiest way to use drag and drop with #GtkToolPalette is to call
 * __gtk_tool_palette_add_drag_dest() with the desired drag source @palette
 * and the desired drag target @widget. Then __gtk_tool_palette_get_drag_item()
 ...
 *   palette = __gtk_widget_get_ancestor (__gtk_drag_get_source_widget (context),
 *                                      GTK_TYPE_TOOL_PALETTE);
 *   if (palette != NULL)
 *     item = __gtk_tool_palette_get_drag_item (GTK_TOOL_PALETTE (palette),
 *                                            selection);
 *
 ...
 *
 * palette = __gtk_tool_palette_new ();
 * target = __gtk_drawing_area_new ();
 *
 * g_signal_connect (G_OBJECT (target), "drag-data-received",
 *                   G_CALLBACK (passive_canvas_drag_data_received), NULL);
 * __gtk_tool_palette_add_drag_dest (GTK_TOOL_PALETTE (palette), target,
...
STLWRT_DEFINE_TYPE_WITH_CODE (GtkToolPalette,
               gtk_tool_palette,
               GTK_TYPE_CONTAINER,
...
gtk_tool_palette_reconfigured (GtkToolPalette *palette)
{
  ...
  __gtk_widget_queue_resize_no_redraw (GTK_WIDGET (palette));
}
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
      case PROP_ICON_SIZE:
        g_value_set_enum (value, __gtk_tool_palette_get_icon_size (palette));
        break;
      ...
      case PROP_TOOLBAR_STYLE:
        g_value_set_enum (value, __gtk_tool_palette_get_style (palette));
        break;
      ...
      if (__gtk_tool_item_group_get_n_items (group->widget))
        {
          ...
          if (group->expand && !__gtk_tool_item_group_get_collapsed (group->widget))
            n_expand_groups += 1;
        }
      else
        size = 0;
  ...
  switch (prop_id)
    {
      case CHILD_PROP_EXCLUSIVE:
        __gtk_tool_palette_set_exclusive (palette, GTK_TOOL_ITEM_GROUP (child), 
          g_value_get_boolean (value));
        break;

      case CHILD_PROP_EXPAND:
        __gtk_tool_palette_set_expand (palette, GTK_TOOL_ITEM_GROUP (child), 
          g_value_get_boolean (value));
        break;
  ...
  switch (prop_id)
    {
      case CHILD_PROP_EXCLUSIVE:
        g_value_set_boolean (value, 
          __gtk_tool_palette_get_exclusive (palette, GTK_TOOL_ITEM_GROUP (child)));
        break;

      case CHILD_PROP_EXPAND:
        g_value_set_boolean (value, 
          __gtk_tool_palette_get_expand (palette, GTK_TOOL_ITEM_GROUP (child)));
        break;
  ...
  if (!priv->style_set)
    {
      ...
      priv->style_set = TRUE;
      __gtk_tool_palette_unset_style (palette);
    }
}
  ...
  if (!priv->icon_size_set)
    {
      ...
      __gtk_tool_palette_unset_icon_size (palette);
    }
}
                                 ...
                                 GdkScreen *previous_screen)
{
  ...
  if (__gtk_widget_has_screen (GTK_WIDGET (palette)))
    settings = __gtk_widget_get_settings (GTK_WIDGET (palette));
  else
    settings = NULL;
...
gtk_tool_palette_class_init (GtkToolPaletteClass *cls)
{
   ...
   * Since: 2.20
   */
  __gtk_container_class_install_child_property (cclass, CHILD_PROP_EXCLUSIVE,
 ...
 */
GtkWidget*
__gtk_tool_palette_new (void)
{
  return g_object_new (GTK_TYPE_TOOL_PALETTE, NULL);
}

/**
 * __gtk_tool_palette_set_icon_size:
 ...
 */
void
__gtk_tool_palette_set_icon_size (GtkToolPalette *palette,
                                GtkIconSize     icon_size)
{
...
/**
 * __gtk_tool_palette_unset_icon_size:
 * @palette: a #GtkToolPalette
 *
 * Unsets the tool palette icon size set with __gtk_tool_palette_set_icon_size(),
 ...
 */
void
__gtk_tool_palette_set_style (GtkToolPalette  *palette,
                            GtkToolbarStyle  style)
{
  g_return_if_fail (GTK_IS_TOOL_PALETTE (palette));
...
/**
 * __gtk_tool_palette_unset_style:
 * @palette: a #GtkToolPalette
 *
 * Unsets a toolbar style set with __gtk_tool_palette_set_style(),
...
/**
 * __gtk_tool_palette_get_icon_size:
 * @palette: a #GtkToolPalette
 *
 * Gets the size of icons in the tool palette.
 * See __gtk_tool_palette_set_icon_size().
 *
 ...
 */
GtkIconSize
__gtk_tool_palette_get_icon_size (GtkToolPalette *palette)
{
 ...
 */
GtkToolbarStyle
__gtk_tool_palette_get_style (GtkToolPalette *palette)
{
...
/**
 * __gtk_tool_palette_set_group_position:
 * @palette: a #GtkToolPalette
 ...
 */
void
__gtk_tool_palette_set_group_position (GtkToolPalette   *palette,
  ...
  for (i = 0; i < palette->priv->groups->len; ++i)
    {
      ...
      if (current_group && current_group != group)
        __gtk_tool_item_group_set_collapsed (current_group, TRUE);
    }
}

/**
 * __gtk_tool_palette_set_exclusive:
 * @palette: a #GtkToolPalette
 * @group: a #GtkToolItemGroup which is a child of palette
 ...
 */
void
__gtk_tool_palette_set_exclusive (GtkToolPalette   *palette,
                                GtkToolItemGroup *group,
                                gboolean          exclusive)
{
  ...
  __gtk_widget_child_notify (GTK_WIDGET (group), "exclusive");
}

/**
 * __gtk_tool_palette_set_expand:
 * @palette: a #GtkToolPalette
 * @group: a #GtkToolItemGroup which is a child of palette
 ...
 */
void
__gtk_tool_palette_set_expand (GtkToolPalette   *palette,
                             GtkToolItemGroup *group,
                             gboolean        expand)
{
  GtkToolItemGroupInfo *group_info;
  ...
  if (expand != group_info->expand)
    {
      ...
      __gtk_widget_queue_resize (GTK_WIDGET (palette));
      __gtk_widget_child_notify (GTK_WIDGET (group), "expand");
    }
}

/**
 * __gtk_tool_palette_get_group_position:
 * @palette: a #GtkToolPalette
 * @group: a #GtkToolItemGroup
 *
 * Gets the position of @group in @palette as index.
 * See __gtk_tool_palette_set_group_position().
 *
 ...
 */
gint
__gtk_tool_palette_get_group_position (GtkToolPalette   *palette,
                                     GtkToolItemGroup *group)
{
  guint i;
...
/**
 * __gtk_tool_palette_get_exclusive:
 * @palette: a #GtkToolPalette
 * @group: a #GtkToolItemGroup which is a child of palette
 *
 * Gets whether @group is exclusive or not.
 * See __gtk_tool_palette_set_exclusive().
 *
 ...
 */
gboolean
__gtk_tool_palette_get_exclusive (GtkToolPalette   *palette,
                                GtkToolItemGroup *group)
{
  gint position;
...
/**
 * __gtk_tool_palette_get_expand:
 * @palette: a #GtkToolPalette
 * @group: a #GtkToolItemGroup which is a child of palette
 *
 * Gets whether group should be given extra space.
 * See __gtk_tool_palette_set_expand().
 *
 ...
 */
gboolean
__gtk_tool_palette_get_expand (GtkToolPalette   *palette,
                             GtkToolItemGroup *group)
{
  gint position;
  GtkToolItemGroupInfo *info;
...
/**
 * __gtk_tool_palette_get_drop_item:
 * @palette: a #GtkToolPalette
 * @x: the x position
 * @y: the y position
 *
 * Gets the item at position (x, y).
 * See __gtk_tool_palette_get_drop_group().
 *
 ...
 */
GtkToolItem*
__gtk_tool_palette_get_drop_item (GtkToolPalette *palette,
                                gint            x,
                                gint            y)
{
  GtkToolItemGroup *group = __gtk_tool_palette_get_drop_group (palette, x, y);
...
/**
 * __gtk_tool_palette_get_drop_group:
 * @palette: a #GtkToolPalette
 * @x: the x position
 * @y: the y position
 *
 ...
 */
GtkToolItemGroup*
__gtk_tool_palette_get_drop_group (GtkToolPalette *palette,
                                 gint            x,
                                 gint            y)
{
  GtkAllocation *allocation;
...
/**
 * __gtk_tool_palette_get_drag_item:
 * @palette: a #GtkToolPalette
 ...
 */
GtkWidget*
__gtk_tool_palette_get_drag_item (GtkToolPalette         *palette,
...
/**
 * __gtk_tool_palette_set_drag_source:
 * @palette: a #GtkToolPalette
 ...
 * See __gtk_drag_source_set().
 *
 * Since: 2.20
 */
void
__gtk_tool_palette_set_drag_source (GtkToolPalette            *palette,
...
/**
 * __gtk_tool_palette_add_drag_dest:
 * @palette: a #GtkToolPalette
 ...
 *
 * Sets @palette as drag source (see __gtk_tool_palette_set_drag_source())
 * and sets @widget as a drag destination for drags from @palette.
 * See __gtk_drag_dest_set().
 *
 * Since: 2.20
 */
void
__gtk_tool_palette_add_drag_dest (GtkToolPalette            *palette,
                                GtkWidget                 *widget,
                                ...
                                GdkDragAction              actions)
{
  ...
  __gtk_tool_palette_set_drag_source (palette,
                                    targets);
  ...
  __gtk_drag_dest_set (widget, flags, entries, n_entries, actions);
}
                                     ...
                                     gpointer          data)
{
  ...
  if (selection->target == dnd_target_atom_item)
    drag_data.item = __gtk_widget_get_ancestor (widget, GTK_TYPE_TOOL_ITEM);

  if (drag_data.item)
    __gtk_selection_data_set (selection, selection->target, 8,
                                      ...
                                      gpointer          data)
{
  ...
  if (selection->target == dnd_target_atom_group)
    drag_data.item = __gtk_widget_get_ancestor (widget, GTK_TYPE_TOOL_ITEM_GROUP);
  ...
  if (GTK_IS_TOOL_ITEM (child) &&
      (palette->priv->drag_source & GTK_TOOL_PALETTE_DRAG_ITEMS))
    {
      ...
      if (GTK_IS_TOOL_BUTTON (child))
        child = __gtk_bin_get_child (GTK_BIN (child));
...
/**
 * __gtk_tool_palette_get_drag_target_item:
 *
...
__gtk_tool_palette_get_drag_target_item (void)
{
  return &dnd_targets[0];
}

/**
 * __gtk_tool_palette_get_drag_target_group:
 *
 ...
 */
const GtkTargetEntry*
__gtk_tool_palette_get_drag_target_group (void)
{
  return &dnd_targets[1];
}

void
___gtk_tool_palette_set_expanding_child (GtkToolPalette *palette,
                                       GtkWidget      *widget)
{
  g_return_if_fail (GTK_IS_TOOL_PALETTE (palette));
...
/**
 * __gtk_tool_palette_get_hadjustment:
 * @palette: a #GtkToolPalette
 *
 ...
 */
GtkAdjustment*
__gtk_tool_palette_get_hadjustment (GtkToolPalette *palette)
{
  g_return_val_if_fail (GTK_IS_TOOL_PALETTE (palette), NULL);
...
/**
 * __gtk_tool_palette_get_vadjustment:
 * @palette: a #GtkToolPalette
 *
 ...
 */
GtkAdjustment*
__gtk_tool_palette_get_vadjustment (GtkToolPalette *palette)
{
  g_return_val_if_fail (GTK_IS_TOOL_PALETTE (palette), NULL);
