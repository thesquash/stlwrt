...
real_queue_resize (GtkWidget *widget)
{
  ...
  if (widget->parent)
    ______gtk_container_queue_resize (GTK_CONTAINER (widget->parent));
...
get_base_dimension (GtkWidget        *widget,
		    GtkSizeGroupMode  mode)
{
  GtkWidgetAuxInfo *aux_info = ______gtk_widget_get_aux_info (widget, FALSE);
...
/**
 * ______gtk_size_group_get_child_requisition:
 * @widget: a #GtkWidget
 ...
 **/
void
______gtk_size_group_get_child_requisition (GtkWidget      *widget,
				       GtkRequisition *requisition)
{
  initialize_size_group_quarks ();
...
/**
 * ______gtk_size_group_compute_requisition:
 * @widget: a #GtkWidget
 * @requisition: location to store computed requisition.
 * 
 ...
 **/
void
______gtk_size_group_compute_requisition (GtkWidget      *widget,
				     GtkRequisition *requisition)
{
  gint width;
  gint height;
...
/**
 * ______gtk_size_group_queue_resize:
 * @widget: a #GtkWidget
 * 
 * Queue a resize on a widget, and on all other widgets grouped with this widget.
 **/
void
______gtk_size_group_queue_resize (GtkWidget *widget)
{
  initialize_size_group_quarks ();
