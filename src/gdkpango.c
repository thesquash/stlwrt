  ...
  if (!gdk_renderer->priv->screen)
    {
      ...
      gdk_renderer->priv->screen = __gdk_screen_get_default ();
    }
  ...
  if (!priv->cr)
    {
      ...
      priv->cr = __gdk_cairo_create ((GdkDrawable *) (priv->drawable));
...
gdk_pango_renderer_begin (PangoRenderer *renderer)
{
  ...
  if (!priv->drawable || !priv->base_gc)
    {
      g_warning ("__gdk_pango_renderer_set_drawable() and __gdk_pango_renderer_set_drawable()"
				...
				PangoLayoutRun *run)
{
  ...
  __gdk_pango_renderer_set_stipple (gdk_renderer, PANGO_RENDER_PART_FOREGROUND, stipple);
  __gdk_pango_renderer_set_stipple (gdk_renderer, PANGO_RENDER_PART_BACKGROUND, stipple);
  __gdk_pango_renderer_set_stipple (gdk_renderer, PANGO_RENDER_PART_UNDERLINE, stipple);
  __gdk_pango_renderer_set_stipple (gdk_renderer, PANGO_RENDER_PART_STRIKETHROUGH, stipple);
...
/**
 * __gdk_pango_renderer_new:
 * @screen: a #GdkScreen
 * 
 * Creates a new #PangoRenderer for @screen. Normally you can use the
 * results of __gdk_pango_renderer_get_default() rather than creating a new
 * renderer.
 * 
 ...
 **/
PangoRenderer *
__gdk_pango_renderer_new (GdkScreen *screen)
{
...
/**
 * __gdk_pango_renderer_get_default:
 * @screen: a #GdkScreen
 * 
 ...
 * by functions such as __gdk_draw_layout().
 *
 * Before using the renderer, you need to call __gdk_pango_renderer_set_drawable()
 * and __gdk_pango_renderer_set_gc() to set the drawable and graphics context
 * to use for drawing.
 * 
 ...
 **/
PangoRenderer *
__gdk_pango_renderer_get_default (GdkScreen *screen)
{
  ...
  if (!renderer)
    {
      renderer = __gdk_pango_renderer_new (screen);
      g_object_set_data_full (G_OBJECT (screen), 
                              g_intern_static_string ("gdk-pango-renderer"), renderer,
			      (GDestroyNotify)g_object_unref);

      g_signal_connect (__gdk_screen_get_display (screen), "closed",
...
/**
 * __gdk_pango_renderer_set_drawable:
 ...
 **/
void
__gdk_pango_renderer_set_drawable (GdkPangoRenderer *gdk_renderer,
				 GdkDrawable      *drawable)
{
 ...
 **/
void
__gdk_pango_renderer_set_gc (GdkPangoRenderer *gdk_renderer,
			   GdkGC            *gc)
{
  GdkPangoRendererPrivate *priv;
...
/**
 * __gdk_pango_renderer_set_stipple:
 * @gdk_renderer: a #GdkPangoRenderer
 ...
 **/
void
__gdk_pango_renderer_set_stipple (GdkPangoRenderer *gdk_renderer,
				PangoRenderPart   part,
				GdkBitmap        *stipple)
{
  g_return_if_fail (GDK_IS_PANGO_RENDERER (gdk_renderer));
...
/**
 * __gdk_pango_renderer_set_override_color:
 * @gdk_renderer: a #GdkPangoRenderer
 ...
 **/
void
__gdk_pango_renderer_set_override_color (GdkPangoRenderer *gdk_renderer,
				       PangoRenderPart   part,
...
/**
 * __gdk_pango_context_set_colormap:
 ...
 **/
void
__gdk_pango_context_set_colormap (PangoContext *context,
	      ...
	      const GdkColor  *background)
{
  ...
  PangoRenderer *renderer = __gdk_pango_renderer_get_default (screen);
  GdkPangoRenderer *gdk_renderer = GDK_PANGO_RENDERER (renderer);

  __gdk_pango_renderer_set_drawable (gdk_renderer, drawable);
  __gdk_pango_renderer_set_gc (gdk_renderer, gc);  

  __gdk_pango_renderer_set_override_color (gdk_renderer,
					 PANGO_RENDER_PART_FOREGROUND,
					 foreground);
  __gdk_pango_renderer_set_override_color (gdk_renderer,
...
release_renderer (PangoRenderer *renderer)
{
  ...
  __gdk_pango_renderer_set_drawable (gdk_renderer, NULL);
  __gdk_pango_renderer_set_gc (gdk_renderer, NULL);
}

/**
 * __gdk_draw_layout_line_with_colors:
 ...
 */
void 
__gdk_draw_layout_line_with_colors (GdkDrawable      *drawable,
                                  GdkGC            *gc,
                                  gint              x, 
                                  gint              y,
 ...
 * is __gtk_widget_create_pango_layout().
 */
void 
__gdk_draw_layout_with_colors (GdkDrawable     *drawable,
                             GdkGC           *gc,
                             int              x, 
                             int              y,
                             PangoLayout     *layout,
 ...
 */
void 
__gdk_draw_layout_line (GdkDrawable      *drawable,
		      GdkGC            *gc,
		      gint              x, 
		      gint              y,
		      PangoLayoutLine  *line)
{
  ...
  __gdk_draw_layout_line_with_colors (drawable, gc, x, y, line, NULL, NULL);
}
 ...
 */
void 
__gdk_draw_layout (GdkDrawable     *drawable,
		 GdkGC           *gc,
		 int              x, 
		 int              y,
		 PangoLayout     *layout)
{
  ...
  __gdk_draw_layout_with_colors (drawable, gc, x, y, layout, NULL, NULL);
}
...
gdk_pango_attr_stipple_copy (const PangoAttribute *attr)
{
  ...
  return __gdk_pango_attr_stipple_new (src->stipple);
}
...
PangoAttribute *
__gdk_pango_attr_stipple_new (GdkBitmap *stipple)
{
...
gdk_pango_attr_embossed_copy (const PangoAttribute *attr)
{
  ...
  return __gdk_pango_attr_embossed_new (e->embossed);
}
...
PangoAttribute *
__gdk_pango_attr_embossed_new (gboolean embossed)
{
...
/**
 * __gdk_pango_attr_emboss_color_new:
 ...
 **/
PangoAttribute *
__gdk_pango_attr_emboss_color_new (const GdkColor *color)
{
  ...
  while (i < n_ranges)
	...
	pango_layout_line_get_x_ranges (line,
	  ...
	  y_off = PANGO_PIXELS (baseline - logical_rect.y);
          ...
          __gdk_region_union_with_rect (clip_region, &rect);
        }
...
/**
 * __gdk_pango_layout_line_get_clip_region:
 * @line: a #PangoLayoutLine 
 ...
 * position you would pass to __gdk_draw_layout_line(). @index_ranges
 ...
 **/
GdkRegion*
__gdk_pango_layout_line_get_clip_region (PangoLayoutLine *line,
                                       gint             x_origin,
                                       gint             y_origin,
                                       const gint      *index_ranges,
                                       gint             n_ranges)
...
/**
 * __gdk_pango_layout_get_clip_region:
 * @layout: a #PangoLayout 
 ...
 * you would pass to __gdk_draw_layout_line(). @index_ranges should contain
 ...
 **/
GdkRegion*
__gdk_pango_layout_get_clip_region (PangoLayout *layout,
                                  gint         x_origin,
                                  gint         y_origin,
                                  const gint  *index_ranges,
                                  gint         n_ranges)
  ...
  do
    {
      ...
      __gdk_region_union (clip_region, line_region);
      __gdk_region_destroy (line_region);
    }
...
/**
 * __gdk_pango_context_get:
 * 
 * Creates a #PangoContext for the default GDK screen.
 *
 * The context must be freed when you're finished with it.
 * 
 * When using GTK+, normally you should use __gtk_widget_get_pango_context()
 * instead of this function, to get the appropriate context for
 * the widget you intend to render text onto.
 * 
 * The newly created context will have the default font options (see
 * #cairo_font_options_t) for the default screen; if these options
 * change it will not be updated. Using __gtk_widget_get_pango_context()
 ...
 **/
PangoContext *
__gdk_pango_context_get (void)
{
  return __gdk_pango_context_get_for_screen (__gdk_screen_get_default ());
}

/**
 * __gdk_pango_context_get_for_screen:
 ...
 **/
PangoContext *
__gdk_pango_context_get_for_screen (GdkScreen *screen)
{
  ...
  options = __gdk_screen_get_font_options (screen);
  pango_cairo_context_set_font_options (context, options);

  dpi = __gdk_screen_get_resolution (screen);
