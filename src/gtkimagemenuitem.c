                                  ...
                                  GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_IMAGE:
      __gtk_image_menu_item_set_image (image_menu_item, (GtkWidget *) g_value_get_object (value));
      break;
    case PROP_USE_STOCK:
      __gtk_image_menu_item_set_use_stock (image_menu_item, g_value_get_boolean (value));
      break;
    case PROP_ALWAYS_SHOW_IMAGE:
      __gtk_image_menu_item_set_always_show_image (image_menu_item, g_value_get_boolean (value));
      break;
    case PROP_ACCEL_GROUP:
      __gtk_image_menu_item_set_accel_group (image_menu_item, g_value_get_object (value));
      break;
    default:
                                  ...
                                  GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_IMAGE:
      g_value_set_object (value, __gtk_image_menu_item_get_image (image_menu_item));
      break;
    case PROP_USE_STOCK:
      g_value_set_boolean (value, __gtk_image_menu_item_get_use_stock (image_menu_item));      
      break;
    case PROP_ALWAYS_SHOW_IMAGE:
      g_value_set_boolean (value, __gtk_image_menu_item_get_always_show_image (image_menu_item));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
...
{
  GtkImageMenuItemPrivate *priv = GET_PRIVATE (image_menu_item);
  GtkSettings *settings = __gtk_widget_get_settings (GTK_WIDGET (image_menu_item));
  gboolean show;
...
gtk_image_menu_item_recalculate (GtkImageMenuItem *image_menu_item)
{
  ...
  if (priv->use_stock && priv->label)
      ...
      if (!image_menu_item->image)
	{
      ...
      if (__gtk_stock_lookup (priv->label, &stock_item))
	  resolved_label = stock_item.label;

	__gtk_menu_item_set_use_underline (GTK_MENU_ITEM (image_menu_item), TRUE);
    }
...
activatable_update_stock_id (GtkImageMenuItem *image_menu_item, GtkAction *action)
{
  ...
  image = __gtk_image_menu_item_get_image (image_menu_item);
	  
  if (GTK_IS_IMAGE (image) &&
      stock_id && __gtk_icon_factory_lookup_default (stock_id))
    {
      __gtk_image_set_from_stock (GTK_IMAGE (image), stock_id, GTK_ICON_SIZE_MENU);
      return TRUE;
    }
...
activatable_update_gicon (GtkImageMenuItem *image_menu_item, GtkAction *action)
{
  ...
  if (icon && GTK_IS_IMAGE (image) &&
      !(stock_id && __gtk_icon_factory_lookup_default (stock_id)))
    {
      __gtk_image_set_from_gicon (GTK_IMAGE (image), icon, GTK_ICON_SIZE_MENU);
      return TRUE;
    }
...
{
  GtkWidget   *image;
  const gchar *icon_name = __gtk_action_get_icon_name (action);
  ...
  if (GTK_IS_IMAGE (image) && 
    ...
    {
      __gtk_image_set_from_icon_name (GTK_IMAGE (image), icon_name, GTK_ICON_SIZE_MENU);
    }
}
			    ...
			    const gchar    *property_name)
{
  ...
  use_appearance = __gtk_activatable_get_use_action_appearance (activatable);
  if (!use_appearance)
    return;
			                    ...
			                    GtkAction      *action)
{
  ...
  if (image && !GTK_IS_IMAGE (image))
    {
      __gtk_image_menu_item_set_image (image_menu_item, NULL);
      image = NULL;
    }
  ...
  if (!image)
    {
      ...
      __gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (activatable),
				     image);
    }
  ...
  __gtk_image_menu_item_set_always_show_image (image_menu_item,
                                             __gtk_action_get_always_show_image (action));
}


/**
 * __gtk_image_menu_item_new:
 * @returns: a new #GtkImageMenuItem.
 *
 * Creates a new #GtkImageMenuItem with an empty label.
 **/
GtkWidget*
__gtk_image_menu_item_new (void)
{
  return g_object_new (GTK_TYPE_IMAGE_MENU_ITEM, NULL);
}

/**
 * __gtk_image_menu_item_new_with_label:
 ...
 **/
GtkWidget*
__gtk_image_menu_item_new_with_label (const gchar *label)
{
...
/**
 * __gtk_image_menu_item_new_with_mnemonic:
 ...
 **/
GtkWidget*
__gtk_image_menu_item_new_with_mnemonic (const gchar *label)
{
  return g_object_new (GTK_TYPE_IMAGE_MENU_ITEM, 
		       "use-underline", TRUE,
		       "label", label,
...
/**
 * __gtk_image_menu_item_new_from_stock:
 ...
 * %NULL for accel_group. Next call __gtk_menu_item_set_accel_path() with an
 * appropriate path for the menu item, use __gtk_stock_lookup() to look up the
 * standard accelerator for the stock item, and if one is found, call
 * __gtk_accel_map_add_entry() to register it.
 **/
GtkWidget*
__gtk_image_menu_item_new_from_stock (const gchar      *stock_id,
...
/**
 * __gtk_image_menu_item_set_use_stock:
 ...
 */
void
__gtk_image_menu_item_set_use_stock (GtkImageMenuItem *image_menu_item,
				   gboolean          use_stock)
{
...
/**
 * __gtk_image_menu_item_get_use_stock:
 * @image_menu_item: a #GtkImageMenuItem
 *
 ...
 */
gboolean
__gtk_image_menu_item_get_use_stock (GtkImageMenuItem *image_menu_item)
{
  GtkImageMenuItemPrivate *priv;
...
/**
 * __gtk_image_menu_item_set_always_show_image:
 * @image_menu_item: a #GtkImageMenuItem
 ...
 */
void
__gtk_image_menu_item_set_always_show_image (GtkImageMenuItem *image_menu_item,
...
/**
 * __gtk_image_menu_item_get_always_show_image:
 * @image_menu_item: a #GtkImageMenuItem
 *
 ...
 */
gboolean
__gtk_image_menu_item_get_always_show_image (GtkImageMenuItem *image_menu_item)
{
  GtkImageMenuItemPrivate *priv;
...
/**
 * __gtk_image_menu_item_set_accel_group:
 * @image_menu_item: a #GtkImageMenuItem
 * @accel_group: the #GtkAccelGroup
 *
 * Specifies an @accel_group to add the menu items accelerator to
 * (this only applies to stock items so a stock item must already
 * be set, make sure to call __gtk_image_menu_item_set_use_stock()
 * and __gtk_menu_item_set_label() with a valid stock item first).
 *
 * If you want this menu item to have changeable accelerators then
 * you shouldnt need this (see __gtk_image_menu_item_new_from_stock()).
 *
 * Since: 2.16
 */
void
__gtk_image_menu_item_set_accel_group (GtkImageMenuItem *image_menu_item, 
				     GtkAccelGroup    *accel_group)
{
  GtkImageMenuItemPrivate *priv;
  GtkStockItem             stock_item;
  ...
  if (priv->use_stock && priv->label && __gtk_stock_lookup (priv->label, &stock_item))
    if (stock_item.keyval)
      {
	__gtk_widget_add_accelerator (GTK_WIDGET (image_menu_item),
				    "activate",
				    accel_group,
				    stock_item.keyval,
				    stock_item.modifier,
...
/** 
 * __gtk_image_menu_item_set_image:
 * @image_menu_item: a #GtkImageMenuItem.
 ...
 **/ 
void
__gtk_image_menu_item_set_image (GtkImageMenuItem *image_menu_item,
                               GtkWidget        *image)
{
  g_return_if_fail (GTK_IS_IMAGE_MENU_ITEM (image_menu_item));
  ...
  __gtk_widget_set_parent (image, GTK_WIDGET (image_menu_item));
  g_object_set (image,
		"visible", show_image (image_menu_item),
		"no-show-all", TRUE,
		NULL);
...
/**
 * __gtk_image_menu_item_get_image:
 * @image_menu_item: a #GtkImageMenuItem
 *
 * Gets the widget that is currently set as the image of @image_menu_item.
 * See __gtk_image_menu_item_set_image().
 *
 * Return value: (transfer none): the widget set as image of @image_menu_item
 **/
GtkWidget*
__gtk_image_menu_item_get_image (GtkImageMenuItem *image_menu_item)
{
