...
/**
 * __gtk_tree_sortable_sort_column_changed:
 * @sortable: A #GtkTreeSortable
 * 
 * Emits a #GtkTreeSortable::sort-column-changed signal on @sortable.
 */
void
__gtk_tree_sortable_sort_column_changed (GtkTreeSortable *sortable)
{
...
/**
 * __gtk_tree_sortable_get_sort_column_id:
 * @sortable: A #GtkTreeSortable
 ...
 **/
gboolean
__gtk_tree_sortable_get_sort_column_id (GtkTreeSortable  *sortable,
				      gint             *sort_column_id,
				      GtkSortType      *order)
{
...
/**
 * __gtk_tree_sortable_set_sort_column_id:
 * @sortable: A #GtkTreeSortable
 ...
 */
void
__gtk_tree_sortable_set_sort_column_id (GtkTreeSortable  *sortable,
				      gint              sort_column_id,
				      GtkSortType       order)
{
  GtkTreeSortableIface *iface;
...
/**
 * __gtk_tree_sortable_set_sort_func:
 * @sortable: A #GtkTreeSortable
 ...
 */
void
__gtk_tree_sortable_set_sort_func (GtkTreeSortable        *sortable,
				 gint                    sort_column_id,
...
/**
 * __gtk_tree_sortable_set_default_sort_func:
 * @sortable: A #GtkTreeSortable
 * @sort_func: The comparison function
 * @user_data: (allow-none): User data to pass to @sort_func, or %NULL
 * @destroy: (allow-none): Destroy notifier of @user_data, or %NULL
 ...
 */
void
__gtk_tree_sortable_set_default_sort_func (GtkTreeSortable        *sortable,
					 GtkTreeIterCompareFunc  sort_func,
					 gpointer                user_data,
					 GDestroyNotify          destroy)
{
...
/**
 * __gtk_tree_sortable_has_default_sort_func:
 * @sortable: A #GtkTreeSortable
 * 
 ...
 */
gboolean
__gtk_tree_sortable_has_default_sort_func (GtkTreeSortable *sortable)
{
  GtkTreeSortableIface *iface;
