 ...
 * to add buttons to the action area with __gtk_info_bar_add_button() or
 * __gtk_info_bar_new_with_buttons(). The sensitivity of action widgets
 * can be controlled with __gtk_info_bar_set_response_sensitive().
 * To add widgets to the main content area of a #GtkInfoBar, use
 * __gtk_info_bar_get_content_area() and add your widgets to the container.
 *
 * Similar to #GtkMessageDialog, the contents of a #GtkInfoBar can by
 * classified as error message, warning, informational message, etc,
 * by using __gtk_info_bar_set_message_type(). GTK+ uses the message type
 ...
 * info_bar = __gtk_info_bar_new ();
 * __gtk_widget_set_no_show_all (info_bar, TRUE);
 * message_label = __gtk_label_new ("");
 * __gtk_widget_show (message_label);
 * content_area = __gtk_info_bar_get_content_area (GTK_INFO_BAR (info_bar));
 * __gtk_container_add (GTK_CONTAINER (content_area), message_label);
 * __gtk_info_bar_add_button (GTK_INFO_BAR (info_bar),
 *                          GTK_STOCK_OK, GTK_RESPONSE_OK);
 * g_signal_connect (info_bar, "response",
 *                   G_CALLBACK (__gtk_widget_hide), NULL);
 * __gtk_table_attach (GTK_TABLE (table),
 *                   info_bar,
 *                   0, 1, 2, 3,
 ...
 * __gtk_label_set_text (GTK_LABEL (message_label), error_message);
 * __gtk_info_bar_set_message_type (GTK_INFO_BAR (info_bar),
 *                                GTK_MESSAGE_ERROR);
 * __gtk_widget_show (info_bar);
 * </programlisting>
 * </example>
 *
                           ...
                           GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_MESSAGE_TYPE:
      __gtk_info_bar_set_message_type (info_bar, g_value_get_enum (value));
      break;
    default:
                           ...
                           GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_MESSAGE_TYPE:
      g_value_set_enum (value, __gtk_info_bar_get_message_type (info_bar));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
...
gtk_info_bar_close (GtkInfoBar *info_bar)
{
  ...
  __gtk_info_bar_response (GTK_INFO_BAR (info_bar),
                         GTK_RESPONSE_CANCEL);
}
...
gtk_info_bar_class_init (GtkInfoBarClass *klass)
{
   ...
   * calls __gtk_dialog_response(). The @response_id depends on which action
   * widget was clicked.
   *
   * Since: 2.18
   */
...
gtk_info_bar_update_colors (GtkInfoBar *info_bar)
{
  ...
  if (__gtk_style_lookup_color (style, fg_color_name[priv->message_type], &sym_fg) &&
      __gtk_style_lookup_color (style, bg_color_name[priv->message_type], &sym_bg))
    {
      fg = &sym_fg;
      bg = &sym_bg;
    }
...
gtk_info_bar_init (GtkInfoBar *info_bar)
{
  ...
  __gtk_box_pack_start (GTK_BOX (info_bar), content_area, TRUE, TRUE, 0);

  action_area = __gtk_vbutton_box_new ();
  __gtk_widget_show (action_area);
  __gtk_button_box_set_layout (GTK_BUTTON_BOX (action_area), GTK_BUTTONBOX_END);
  __gtk_box_pack_start (GTK_BOX (info_bar), action_area, FALSE, TRUE, 0);
                         ...
                         GtkInfoBar *info_bar)
{
  ...
  __gtk_info_bar_response (info_bar, response_id);
}

/**
 * __gtk_info_bar_add_action_widget:
 ...
 */
void
__gtk_info_bar_add_action_widget (GtkInfoBar *info_bar,
                                GtkWidget  *child,
                                gint        response_id)
{
  ResponseData *ad;
...
/**
 * __gtk_info_bar_get_action_area:
 * @info_bar: a #GtkInfoBar
 *
 ...
 */
GtkWidget*
__gtk_info_bar_get_action_area (GtkInfoBar *info_bar)
{
...
/**
 * __gtk_info_bar_get_content_area:
 * @info_bar: a #GtkInfoBar
 *
 ...
 */
GtkWidget*
__gtk_info_bar_get_content_area (GtkInfoBar *info_bar)
{
  g_return_val_if_fail (GTK_IS_INFO_BAR (info_bar), NULL);
 ...
 */
GtkWidget*
__gtk_info_bar_add_button (GtkInfoBar  *info_bar,
                         ...
                         gint         response_id)
{
  ...
  __gtk_info_bar_add_action_widget (info_bar, button, response_id);
                    ...
                    va_list      args)
{
  ...
  while (text != NULL)
    {
      __gtk_info_bar_add_button (info_bar, text, response_id);
...
/**
 * __gtk_info_bar_add_buttons:
 * @info_bar: a #GtkInfoBar
 * @first_button_text: button text or stock ID
 * @...: response ID for first button, then more text-response_id pairs,
 *     ending with %NULL
 *
 * Adds more buttons, same as calling __gtk_info_bar_add_button()
 * repeatedly. The variable argument list should be %NULL-terminated
 * as with __gtk_info_bar_new_with_buttons(). Each button must have both
 * text and response ID.
 *
 * Since: 2.18
 */
void
__gtk_info_bar_add_buttons (GtkInfoBar  *info_bar,
                          const gchar *first_button_text,
                          ...)
{
  va_list args;
 ...
 */
GtkWidget *
__gtk_info_bar_new (void)
{
   return g_object_new (GTK_TYPE_INFO_BAR, NULL);
}

/**
 * __gtk_info_bar_new_with_buttons:
 ...
 */
GtkWidget*
__gtk_info_bar_new_with_buttons (const gchar *first_button_text,
                               ...)
{
  GtkInfoBar *info_bar;
  va_list args;

  info_bar = GTK_INFO_BAR (__gtk_info_bar_new ());
...
/**
 * __gtk_info_bar_set_response_sensitive:
 * @info_bar: a #GtkInfoBar
 * @response_id: a response ID
 * @setting: TRUE for sensitive
 *
 * Calls __gtk_widget_set_sensitive (widget, setting) for each
 ...
 */
void
__gtk_info_bar_set_response_sensitive (GtkInfoBar *info_bar,
                                     gint        response_id,
                                     gboolean    setting)
{
  GList *children, *list;
...
/**
 * __gtk_info_bar_set_default_response:
 * @info_bar: a #GtkInfoBar
 * @response_id: a response ID
 *
 ...
 */
void
__gtk_info_bar_set_default_response (GtkInfoBar *info_bar,
                                   gint        response_id)
{
  GList *children, *list;
 ...
 */
void
__gtk_info_bar_response (GtkInfoBar *info_bar,
                       gint        response_id)
{
  g_return_if_fail (GTK_IS_INFO_BAR (info_bar));
...
/**
 * __gtk_info_bar_set_message_type:
 * @info_bar: a #GtkInfoBar
 ...
 */
void
__gtk_info_bar_set_message_type (GtkInfoBar     *info_bar,
                               GtkMessageType  message_type)
{
  GtkInfoBarPrivate *priv;
  AtkObject *atk_obj;
  ...
  if (priv->message_type != message_type)
    {
      ...
      gtk_info_bar_update_colors (info_bar);
      __gtk_widget_queue_draw (GTK_WIDGET (info_bar));

      atk_obj = __gtk_widget_get_accessible (GTK_WIDGET (info_bar));
...
/**
 * __gtk_info_bar_get_message_type:
 * @info_bar: a #GtkInfoBar
 *
 ...
 */
GtkMessageType
__gtk_info_bar_get_message_type (GtkInfoBar *info_bar)
{
  GtkInfoBarPrivate *priv;
