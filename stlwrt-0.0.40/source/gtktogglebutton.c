  ...
  if (strcmp (property_name, "active") == 0)
    {
      ...
      __gtk_toggle_button_set_active (button, __gtk_toggle_action_get_active (GTK_TOGGLE_ACTION (action)));
...
GtkWidget*
__gtk_toggle_button_new (void)
{
  return g_object_new (GTK_TYPE_TOGGLE_BUTTON, NULL);
}

GtkWidget*
__gtk_toggle_button_new_with_label (const gchar *label)
{
  return g_object_new (GTK_TYPE_TOGGLE_BUTTON, "label", label, NULL);
}

/**
 * __gtk_toggle_button_new_with_mnemonic:
 ...
 **/
GtkWidget*
__gtk_toggle_button_new_with_mnemonic (const gchar *label)
{
				...
				GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_ACTIVE:
      __gtk_toggle_button_set_active (tb, g_value_get_boolean (value));
      break;
    case PROP_INCONSISTENT:
      __gtk_toggle_button_set_inconsistent (tb, g_value_get_boolean (value));
      break;
    case PROP_DRAW_INDICATOR:
      __gtk_toggle_button_set_mode (tb, g_value_get_boolean (value));
      break;
    default:
 ...
 */
void
__gtk_toggle_button_set_mode (GtkToggleButton *toggle_button,
...
/**
 * __gtk_toggle_button_get_mode:
 * @toggle_button: a #GtkToggleButton
 *
 * Retrieves whether the button is displayed as a separate indicator
 * and label. See __gtk_toggle_button_set_mode().
 *
 * Return value: %TRUE if the togglebutton is drawn as a separate indicator
 *   and label.
 **/
gboolean
__gtk_toggle_button_get_mode (GtkToggleButton *toggle_button)
{
...
void
__gtk_toggle_button_set_active (GtkToggleButton *toggle_button,
			      gboolean         is_active)
{
  g_return_if_fail (GTK_IS_TOGGLE_BUTTON (toggle_button));
...
gboolean
__gtk_toggle_button_get_active (GtkToggleButton *toggle_button)
{
  g_return_val_if_fail (GTK_IS_TOGGLE_BUTTON (toggle_button), FALSE);
...
void
__gtk_toggle_button_toggled (GtkToggleButton *toggle_button)
{
  g_return_if_fail (GTK_IS_TOGGLE_BUTTON (toggle_button));
...
/**
 * __gtk_toggle_button_set_inconsistent:
 * @toggle_button: a #GtkToggleButton
 ...
 * done manually, __gtk_toggle_button_set_inconsistent() only affects
 * visual appearance, it doesn't affect the semantics of the button.
 * 
 **/
void
__gtk_toggle_button_set_inconsistent (GtkToggleButton *toggle_button,
                                    gboolean         setting)
{
  g_return_if_fail (GTK_IS_TOGGLE_BUTTON (toggle_button));
...
/**
 * __gtk_toggle_button_get_inconsistent:
 * @toggle_button: a #GtkToggleButton
 * 
 * Gets the value set by __gtk_toggle_button_set_inconsistent().
 * 
 * Return value: %TRUE if the button is displayed as inconsistent, %FALSE otherwise
 **/
gboolean
__gtk_toggle_button_get_inconsistent (GtkToggleButton *toggle_button)
{
  g_return_val_if_fail (GTK_IS_TOGGLE_BUTTON (toggle_button), FALSE);
			  ...
			  GdkEventExpose *event)
{
  if (__gtk_widget_is_drawable (widget))
	...
	shadow_type = button->depressed ? GTK_SHADOW_IN : GTK_SHADOW_OUT;
      ...
      ______gtk_button_paint (button, &event->area, state_type, shadow_type,
