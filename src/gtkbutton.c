...
static gint __gtk_button_enter_notify (GtkWidget * widget,
				     GdkEventCrossing * event);
static gint __gtk_button_leave_notify (GtkWidget * widget,
				     GdkEventCrossing * event);
...
gtk_button_class_init (GtkButtonClass *klass)
{
  ...
  widget_class->enter_notify_event = __gtk_button_enter_notify;
  widget_class->leave_notify_event = __gtk_button_leave_notify;
   ...
   * For more information about default widgets, see __gtk_widget_grab_default().
   */
...
gtk_button_init (GtkButton *button)
{
  ...
  __gtk_widget_set_can_focus (GTK_WIDGET (button), TRUE);
  ...
  if (GTK_IS_MISC (widget))
    {
      ...
      if (priv->align_set)
	__gtk_misc_set_alignment (misc, priv->xalign, priv->yalign);
    }
...
gtk_button_dispose (GObject *object)
{
  ...
  if (priv->action)
    {
      __gtk_activatable_do_set_related_action (GTK_ACTIVATABLE (button), NULL);
      priv->action = NULL;
    }
                         ...
                         GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_LABEL:
      __gtk_button_set_label (button, g_value_get_string (value));
      break;
    case PROP_IMAGE:
      __gtk_button_set_image (button, (GtkWidget *) g_value_get_object (value));
      break;
    case PROP_RELIEF:
      __gtk_button_set_relief (button, g_value_get_enum (value));
      break;
    case PROP_USE_UNDERLINE:
      __gtk_button_set_use_underline (button, g_value_get_boolean (value));
      break;
    case PROP_USE_STOCK:
      __gtk_button_set_use_stock (button, g_value_get_boolean (value));
      break;
    case PROP_FOCUS_ON_CLICK:
      __gtk_button_set_focus_on_click (button, g_value_get_boolean (value));
      break;
    case PROP_XALIGN:
      __gtk_button_set_alignment (button, g_value_get_float (value), priv->yalign);
      break;
    case PROP_YALIGN:
      __gtk_button_set_alignment (button, priv->xalign, g_value_get_float (value));
      break;
    case PROP_IMAGE_POSITION:
      __gtk_button_set_image_position (button, g_value_get_enum (value));
      break;
...
activatable_update_stock_id (GtkButton *button,
			     GtkAction *action)
{
  if (!__gtk_button_get_use_stock (button))
    return;

  __gtk_button_set_label (button, __gtk_action_get_stock_id (action));
}
				...
				GtkAction *action)
{
  ...
  image = __gtk_button_get_image (button);

  /* Dont touch custom child... */
  if (GTK_IS_IMAGE (image) ||
      gtk_bin_get_props (GTK_BIN (button))->child == NULL || 
      GTK_IS_LABEL (gtk_bin_get_props (GTK_BIN (button))->child))
    {
      __gtk_button_set_label (button, __gtk_action_get_short_label (action));
      __gtk_button_set_use_underline (button, TRUE);
    }
}
			      ...
			      GtkAction *action)
{
  ...
  if (GTK_IS_IMAGE (image) &&
      (__gtk_image_get_storage_type (GTK_IMAGE (image)) == GTK_IMAGE_EMPTY ||
       __gtk_image_get_storage_type (GTK_IMAGE (image)) == GTK_IMAGE_ICON_NAME))
    __gtk_image_set_from_icon_name (GTK_IMAGE (image),
				  __gtk_action_get_icon_name (action), GTK_ICON_SIZE_MENU);
}
...
activatable_update_gicon (GtkButton *button,
			  GtkAction *action)
{
  GtkWidget *image = __gtk_button_get_image (button);
  GIcon *icon = __gtk_action_get_gicon (action);
  
  if (GTK_IS_IMAGE (image) &&
      (__gtk_image_get_storage_type (GTK_IMAGE (image)) == GTK_IMAGE_EMPTY ||
       __gtk_image_get_storage_type (GTK_IMAGE (image)) == GTK_IMAGE_GICON))
    __gtk_image_set_from_gicon (GTK_IMAGE (image), icon, GTK_ICON_SIZE_BUTTON);
}
			       ...
			       GtkAction *action)
{
  ...
  __gtk_activatable_do_set_related_action (GTK_ACTIVATABLE (button), action);
  ...
  if (priv->use_action_appearance != use_appearance)
    {
      ...
      __gtk_activatable_sync_action_properties (GTK_ACTIVATABLE (button), priv->action);
    }
}

GtkWidget*
__gtk_button_new (void)
{
  ...
  if (gtk_button_get_props (button)->label_text)
    {
      ...
      settings = __gtk_widget_get_settings (GTK_WIDGET (button));        
...
gtk_button_construct_child (GtkButton *button)
{
  ...
  if (gtk_bin_get_props (GTK_BIN (button))->child)
    __gtk_container_remove (GTK_CONTAINER (button),
			  gtk_bin_get_props (GTK_BIN (button))->child);
  ...
  if (image)
	...
	box = __gtk_hbox_new (FALSE, image_spacing);
      else
	box = __gtk_vbox_new (FALSE, image_spacing);

      if (priv->align_set)
	align = __gtk_alignment_new (priv->xalign, priv->yalign, 0.0, 0.0);
      else
	align = __gtk_alignment_new (0.5, 0.5, 0.0, 0.0);

      if (priv->image_position == GTK_POS_LEFT ||
	  priv->image_position == GTK_POS_TOP)
	__gtk_box_pack_start (GTK_BOX (box), priv->image, FALSE, FALSE, 0);
      else
	__gtk_box_pack_end (GTK_BOX (box), priv->image, FALSE, FALSE, 0);
      ...
      if (label_text)
	{
	  ...
	  if (priv->image_position == GTK_POS_RIGHT ||
	    ...
	    __gtk_box_pack_start (GTK_BOX (box), label, FALSE, FALSE, 0);
	  else
	    __gtk_box_pack_end (GTK_BOX (box), label, FALSE, FALSE, 0);
	}

      __gtk_container_add (GTK_CONTAINER (button), align);
      __gtk_container_add (GTK_CONTAINER (align), box);
      __gtk_widget_show_all (align);
  ...
  __gtk_container_add (GTK_CONTAINER (button), label);
}


GtkWidget*
__gtk_button_new_with_label (const gchar *label)
{
  return g_object_new (GTK_TYPE_BUTTON, "label", label, NULL);
}

/**
 * __gtk_button_new_from_stock:
 ...
 * label (as for __gtk_button_new_with_mnemonic()).
 *
 * Returns: a new #GtkButton
 **/
GtkWidget*
__gtk_button_new_from_stock (const gchar *stock_id)
{
...
/**
 * __gtk_button_new_with_mnemonic:
 ...
 **/
GtkWidget*
__gtk_button_new_with_mnemonic (const gchar *label)
{
  return g_object_new (GTK_TYPE_BUTTON, "label", label, "use-underline", TRUE,  NULL);
}

void
__gtk_button_pressed (GtkButton *button)
{
...
void
__gtk_button_released (GtkButton *button)
{
  g_return_if_fail (GTK_IS_BUTTON (button));
...
void
__gtk_button_clicked (GtkButton *button)
{
  g_return_if_fail (GTK_IS_BUTTON (button));
...
void
__gtk_button_enter (GtkButton *button)
{
  g_return_if_fail (GTK_IS_BUTTON (button));
...
void
__gtk_button_leave (GtkButton *button)
{
  g_return_if_fail (GTK_IS_BUTTON (button));
...
void
__gtk_button_set_relief (GtkButton *button,
...
GtkReliefStyle
__gtk_button_get_relief (GtkButton *button)
{
...
gtk_button_update_image_spacing (GtkButton *button)
{
  ...
  child = gtk_bin_get_props (GTK_BIN (button))->child;
  if (GTK_IS_ALIGNMENT (child))
    {
      child = gtk_bin_get_props (GTK_BIN (child))->child;
      if (GTK_IS_BOX (child))
        {
          __gtk_widget_style_get (GTK_WIDGET (button),
          ...
          __gtk_box_set_spacing (GTK_BOX (child), spacing);
        }
    }   
}
...
static void
get_button_properties (GtkButton *button,
		       ...
		       gboolean  *interior_focus)
{
  ...
  if (default_border)
    {
      __gtk_widget_style_get (widget, "default-border", &tmp_border, NULL);
  ...
  if (default_outside_border)
    {
      __gtk_widget_style_get (widget, "default-outside-border", &tmp_border, NULL);
  ...
  if (inner_border)
    {
      __gtk_widget_style_get (widget, "inner-border", &tmp_border, NULL);
  ...
  if (interior_focus)
    __gtk_widget_style_get (widget, "interior-focus", interior_focus, NULL);
}
			 ...
			 GtkRequisition *requisition)
{
  ...
  get_button_properties (button, &default_border, NULL, &inner_border, NULL);
  ...
  if (__gtk_widget_get_can_default (widget))
    {
  ...
  if (gtk_bin_get_props (GTK_BIN (button))->child && __gtk_widget_get_visible (gtk_bin_get_props (GTK_BIN (button))->child))
    {
      ...
      __gtk_widget_size_request (gtk_bin_get_props (GTK_BIN (button))->child, &child_requisition);
			  ...
			  GtkAllocation *allocation)
{
  ...
  gint xthickness = gtk_widget_get_props (GTK_WIDGET (widget))->style->xthickness;
  gint ythickness = gtk_widget_get_props (GTK_WIDGET (widget))->style->ythickness;
  GtkBorder default_border;
  GtkBorder inner_border;
  gint focus_width;
  gint focus_pad;
  ...
  if (gtk_bin_get_props (GTK_BIN (button))->child && __gtk_widget_get_visible (gtk_bin_get_props (GTK_BIN (button))->child))
    {
      ...
      if (__gtk_widget_get_can_default (GTK_WIDGET (button)))
	{
      ...
      if (__gtk_widget_get_can_focus (GTK_WIDGET (button)))
	{
...
void
___gtk_button_paint (GtkButton          *button,
  ...
  if (__gtk_widget_is_drawable (widget))
    {
      ...
      get_button_properties (button, &default_border, &default_outside_border, NULL, &interior_focus);
      __gtk_widget_style_get (widget,
			    "focus-line-width", &focus_width,
			    "focus-padding", &focus_pad,
			    NULL); 
	  ...
	  gtk_button_get_props (GTK_BUTTON (widget))->relief == GTK_RELIEF_NORMAL)
	{
      ...
      else if (__gtk_widget_get_can_default (widget))
	{
      ...
      if (!interior_focus && __gtk_widget_has_focus (widget))
	{
...
static gboolean
__gtk_button_enter_notify (GtkWidget        *widget,
			 GdkEventCrossing *event)
{
  GtkButton *button;
...
static gboolean
__gtk_button_leave_notify (GtkWidget        *widget,
			 GdkEventCrossing *event)
{
  GtkButton *button;
  GtkWidget *event_widget;
			    ...
			    gboolean   do_it)
{
  ...
  if (priv->has_grab)
    {
      __gdk_display_keyboard_ungrab (__gtk_widget_get_display (widget),
				   priv->grab_time);
    }
...
/**
 * __gtk_button_set_label:
 * @button: a #GtkButton
 * @label: a string
 *
 * Sets the text of the label of the button to @str. This text is
 * also used to select the stock item if __gtk_button_set_use_stock()
 * is used.
 *
 * This will also clear any previously set labels.
 **/
void
__gtk_button_set_label (GtkButton   *button,
		      const gchar *label)
{
  gchar *new_label;
...
/**
 * __gtk_button_get_label:
 * @button: a #GtkButton
 *
 * Fetches the text from the label of the button, as set by
 * __gtk_button_set_label(). If the label text has not 
 * been set the return value will be %NULL. This will be the 
 * case if you create an empty button with __gtk_button_new() to 
 * use as a container.
 *
 ...
 **/
const gchar *
__gtk_button_get_label (GtkButton *button)
{
...
/**
 * __gtk_button_set_use_underline:
 * @button: a #GtkButton
 ...
 */
void
__gtk_button_set_use_underline (GtkButton *button,
...
/**
 * __gtk_button_get_use_underline:
 * @button: a #GtkButton
 *
 * Returns whether an embedded underline in the button label indicates a
 * mnemonic. See __gtk_button_set_use_underline ().
 *
 * Return value: %TRUE if an embedded underline in the button label
 *               indicates the mnemonic accelerator keys.
 **/
gboolean
__gtk_button_get_use_underline (GtkButton *button)
{
 ...
 */
void
__gtk_button_set_use_stock (GtkButton *button,
			  gboolean   use_stock)
{
  g_return_if_fail (GTK_IS_BUTTON (button));
 ...
 */
gboolean
__gtk_button_get_use_stock (GtkButton *button)
{
  g_return_val_if_fail (GTK_IS_BUTTON (button), FALSE);
...
/**
 * __gtk_button_set_focus_on_click:
 * @button: a #GtkButton
 ...
 **/
void
__gtk_button_set_focus_on_click (GtkButton *button,
...
/**
 * __gtk_button_get_focus_on_click:
 * @button: a #GtkButton
 * 
 * Returns whether the button grabs focus when it is clicked with the mouse.
 * See __gtk_button_set_focus_on_click().
 *
 ...
 **/
gboolean
__gtk_button_get_focus_on_click (GtkButton *button)
{
  g_return_val_if_fail (GTK_IS_BUTTON (button), FALSE);
 ...
 */
void
__gtk_button_set_alignment (GtkButton *button,
			  gfloat     xalign,
			  gfloat     yalign)
{
  GtkButtonPrivate *priv;
  ...
  maybe_set_alignment (button, gtk_bin_get_props (GTK_BIN (button))->child);
 ...
 */
void
__gtk_button_get_alignment (GtkButton *button,
			  gfloat    *xalign,
			  gfloat    *yalign)
{
  GtkButtonPrivate *priv;
 ...
 **/
void
___gtk_button_set_depressed (GtkButton *button,
			   gboolean   depressed)
{
  GtkWidget *widget = GTK_WIDGET (button);
...
gtk_button_update_state (GtkButton *button)
{
  ...
  g_object_get (__gtk_widget_get_settings (GTK_WIDGET (button)),
 ...
 * __gtk_widget_show() on @image yourself.
 *
 * Since: 2.6
 */ 
void
__gtk_button_set_image (GtkButton *button,
		      GtkWidget *image)
{
  GtkButtonPrivate *priv;
...
/**
 * __gtk_button_get_image:
 * @button: a #GtkButton
 *
 * Gets the widget that is currenty set as the image of @button.
 * This may have been explicitly set by __gtk_button_set_image()
 * or constructed by __gtk_button_new_from_stock().
 *
 ...
 */
GtkWidget *
__gtk_button_get_image (GtkButton *button)
{
  GtkButtonPrivate *priv;
...
/**
 * __gtk_button_set_image_position:
 * @button: a #GtkButton
 ...
 */ 
void
__gtk_button_set_image_position (GtkButton       *button,
...
/**
 * __gtk_button_get_image_position:
 * @button: a #GtkButton
 *
 ...
 */
GtkPositionType
__gtk_button_get_image_position (GtkButton *button)
{
  GtkButtonPrivate *priv;
 ...
 */
GdkWindow*
__gtk_button_get_event_window (GtkButton *button)
{
  g_return_val_if_fail (GTK_IS_BUTTON (button), NULL);
