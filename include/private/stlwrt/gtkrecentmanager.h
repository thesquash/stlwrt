...
#define GTK_TYPE_RECENT_INFO			(__gtk_recent_info_get_type ())

#define GTK_TYPE_RECENT_MANAGER			(__gtk_recent_manager_get_type ())
...
GType 		  __gtk_recent_manager_get_type       (void) G_GNUC_CONST;
...
GType	              __gtk_recent_info_get_type             (void) G_GNUC_CONST;
