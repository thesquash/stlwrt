...
#undef STLWRT_DATADIR
#define STLWRT_DATADIR _gtk_get_datadir ()
#undef STLWRT_LIBDIR
#define STLWRT_LIBDIR _gtk_get_libdir ()
#undef STLWRT_LOCALEDIR
#define STLWRT_LOCALEDIR _gtk_get_localedir ()
#undef STLWRT_SYSCONFDIR
#define STLWRT_SYSCONFDIR _gtk_get_sysconfdir ()
#undef STLWRT_DATA_PREFIX
#define STLWRT_DATA_PREFIX _gtk_get_data_prefix ()
