  ...
  if (priv->orientation == GTK_ORIENTATION_VERTICAL)
    {
      ...
      x += (gtk_widget_get_props (widget)->allocation.width - priv->dock->allocation.width) / 2;
      y -= startoff;
  ...
  else
    {
      ...
      x -= startoff;
      y += (gtk_widget_get_props (widget)->allocation.height - priv->dock->allocation.height) / 2;
