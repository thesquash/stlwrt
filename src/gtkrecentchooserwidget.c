...
{
  gtk_recent_chooser_widget_get_props (widget)->priv = G_TYPE_INSTANCE_GET_PRIVATE (gtk_recent_chooser_widget_get_props (widget), GTK_TYPE_RECENT_CHOOSER_WIDGET,
				       ...
				       GObjectConstructParam *params)
{
  ...
  __gtk_container_add (GTK_CONTAINER (object), priv->chooser);
...
/**
 * __gtk_recent_chooser_widget_new:
 * 
 ...
 */
GtkWidget *
__gtk_recent_chooser_widget_new (void)
{
  return g_object_new (GTK_TYPE_RECENT_CHOOSER_WIDGET, NULL);
}

/**
 * __gtk_recent_chooser_widget_new_for_manager:
 ...
 */
GtkWidget *
__gtk_recent_chooser_widget_new_for_manager (GtkRecentManager *manager)
{
