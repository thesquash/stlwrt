...
#define GTK_TYPE_TREE_DRAG_SOURCE            (__gtk_tree_drag_source_get_type ())
...
GType           __gtk_tree_drag_source_get_type   (void) G_GNUC_CONST;
...
#define GTK_TYPE_TREE_DRAG_DEST            (__gtk_tree_drag_dest_get_type ())
...
GType           __gtk_tree_drag_dest_get_type   (void) G_GNUC_CONST;
