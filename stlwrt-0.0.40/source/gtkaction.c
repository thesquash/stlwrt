 ...
 */
GtkAction *
__gtk_action_new (const gchar *name,
		const gchar *label,
		const gchar *tooltip,
			 ...
			 GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_NAME:
      ...
      break;
    case PROP_LABEL:
      __gtk_action_set_label (action, g_value_get_string (value));
      break;
    case PROP_SHORT_LABEL:
      __gtk_action_set_short_label (action, g_value_get_string (value));
      break;
    case PROP_TOOLTIP:
      __gtk_action_set_tooltip (action, g_value_get_string (value));
      break;
    case PROP_STOCK_ID:
      __gtk_action_set_stock_id (action, g_value_get_string (value));
      break;
    case PROP_GICON:
      __gtk_action_set_gicon (action, g_value_get_object (value));
      break;
    case PROP_ICON_NAME:
      __gtk_action_set_icon_name (action, g_value_get_string (value));
      break;
    case PROP_VISIBLE_HORIZONTAL:
      __gtk_action_set_visible_horizontal (action, g_value_get_boolean (value));
      break;
    case PROP_VISIBLE_VERTICAL:
      __gtk_action_set_visible_vertical (action, g_value_get_boolean (value));
      break;
    case PROP_VISIBLE_OVERFLOWN:
      action->private_data->visible_overflown = g_value_get_boolean (value);
      break;
    case PROP_IS_IMPORTANT:
      __gtk_action_set_is_important (action, g_value_get_boolean (value));
      break;
    case PROP_HIDE_IF_EMPTY:
      action->private_data->hide_if_empty = g_value_get_boolean (value);
      break;
    case PROP_SENSITIVE:
      __gtk_action_set_sensitive (action, g_value_get_boolean (value));
      break;
    case PROP_VISIBLE:
      __gtk_action_set_visible (action, g_value_get_boolean (value));
      break;
    case PROP_ACTION_GROUP:
      gtk_action_set_action_group (action, g_value_get_object (value));
      break;
    case PROP_ALWAYS_SHOW_IMAGE:
      __gtk_action_set_always_show_image (action, g_value_get_boolean (value));
      break;
    default:
	       ...
	       GtkWidget *proxy)
{
  ...
  if (action->private_data->action_group)
    ______gtk_action_group_emit_connect_proxy (action->private_data->action_group, action, proxy);
		  ...
		  GtkWidget *proxy)
{
  ...
  if (action->private_data->action_group)
    ______gtk_action_group_emit_disconnect_proxy (action->private_data->action_group, action, proxy);
}

/**
 * ______gtk_action_sync_menu_visible:
 ...
 **/
void
______gtk_action_sync_menu_visible (GtkAction *action,
			       GtkWidget *proxy,
			       gboolean   empty)
{
  ...
  if (action == NULL)
    action = __gtk_activatable_get_related_action (GTK_ACTIVATABLE (proxy));

  if (action)
    {
      /* a GtkMenu for a <popup/> doesn't have to have an action */
      visible = __gtk_action_is_visible (action);
      hide_if_empty = action->private_data->hide_if_empty;
    }

  if (visible && !(empty && hide_if_empty))
    __gtk_widget_show (proxy);
  else
    __gtk_widget_hide (proxy);
}

void
______gtk_action_emit_activate (GtkAction *action)
{
  ...
  if (group != NULL)
    {
      g_object_ref (action);
      g_object_ref (group);
      ______gtk_action_group_emit_pre_activate (group, action);
    }
  ...
  if (group != NULL)
    {
      ______gtk_action_group_emit_post_activate (group, action);
 ...
 */
void
__gtk_action_activate (GtkAction *action)
{
  ...
  if (__gtk_action_is_sensitive (action))
    ______gtk_action_emit_activate (action);
}

/**
 * __gtk_action_block_activate:
 * @action: a #GtkAction
 *
 * Disable activation signals from the action 
 *
 * This is needed when updating the state of your proxy
 * #GtkActivatable widget could result in calling __gtk_action_activate(),
 ...
 */
void
__gtk_action_block_activate (GtkAction *action)
{
  g_return_if_fail (GTK_IS_ACTION (action));
 ...
 */
void
__gtk_action_unblock_activate (GtkAction *action)
{
  g_return_if_fail (GTK_IS_ACTION (action));
 ...
 */
GtkWidget *
__gtk_action_create_icon (GtkAction *action, GtkIconSize icon_size)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);

  if (action->private_data->stock_id &&
      __gtk_icon_factory_lookup_default (action->private_data->stock_id))
    return __gtk_image_new_from_stock (action->private_data->stock_id, icon_size);
  else if (action->private_data->gicon)
    return __gtk_image_new_from_gicon (action->private_data->gicon, icon_size);
  else if (action->private_data->icon_name)
    return __gtk_image_new_from_icon_name (action->private_data->icon_name, icon_size);
  else
    return NULL;
}

/**
 * __gtk_action_create_menu_item:
 * @action: the action object
 *
 ...
 */
GtkWidget *
__gtk_action_create_menu_item (GtkAction *action)
{
  GtkWidget *menu_item;
  ...
  __gtk_activatable_set_use_action_appearance (GTK_ACTIVATABLE (menu_item), TRUE);
  __gtk_activatable_set_related_action (GTK_ACTIVATABLE (menu_item), action);

  return menu_item;
}

/**
 * __gtk_action_create_tool_item:
 * @action: the action object
 *
 ...
 */
GtkWidget *
__gtk_action_create_tool_item (GtkAction *action)
{
  GtkWidget *button;
  ...
  __gtk_activatable_set_use_action_appearance (GTK_ACTIVATABLE (button), TRUE);
  __gtk_activatable_set_related_action (GTK_ACTIVATABLE (button), action);

  return button;
}

void
______gtk_action_add_to_proxy_list (GtkAction     *action,
			       GtkWidget     *proxy)
{
  g_return_if_fail (GTK_IS_ACTION (action));
...
void
______gtk_action_remove_from_proxy_list (GtkAction     *action,
				    GtkWidget     *proxy)
{
  g_return_if_fail (GTK_IS_ACTION (action));
  g_return_if_fail (GTK_IS_WIDGET (proxy));
 ...
 * Since: 2.4
 *
 * Deprecated: 2.16: Use __gtk_activatable_set_related_action() instead.
 */
void
__gtk_action_connect_proxy (GtkAction *action,
			  GtkWidget *proxy)
{
  g_return_if_fail (GTK_IS_ACTION (action));
  g_return_if_fail (GTK_IS_WIDGET (proxy));
  ...
  __gtk_activatable_set_use_action_appearance (GTK_ACTIVATABLE (proxy), TRUE);

  __gtk_activatable_set_related_action (GTK_ACTIVATABLE (proxy), action);
}

/**
 * __gtk_action_disconnect_proxy:
 * @action: the action object
 * @proxy: the proxy widget
 *
 ...
 */
void
__gtk_action_disconnect_proxy (GtkAction *action,
			     GtkWidget *proxy)
{
  g_return_if_fail (GTK_IS_ACTION (action));
  g_return_if_fail (GTK_IS_WIDGET (proxy));

  __gtk_activatable_set_related_action (GTK_ACTIVATABLE (proxy), NULL);
}

/**
 * __gtk_action_get_proxies:
 * @action: the action object
 * 
 * Returns the proxy widgets for an action.
 * See also __gtk_widget_get_action().
 *
 ...
 **/
GSList*
__gtk_action_get_proxies (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
...
/**
 * __gtk_widget_get_action:
 * @widget: a #GtkWidget
 *
 * Returns the #GtkAction that @widget is a proxy for. 
 * See also __gtk_action_get_proxies().
 *
 ...
 * Since: 2.10
 *
 * Deprecated: 2.16: Use __gtk_activatable_get_related_action() instead.
 */
GtkAction*
__gtk_widget_get_action (GtkWidget *widget)
{
  g_return_val_if_fail (GTK_IS_WIDGET (widget), NULL);

  if (GTK_IS_ACTIVATABLE (widget))
    return __gtk_activatable_get_related_action (GTK_ACTIVATABLE (widget));

  return NULL;
}

/**
 * __gtk_action_get_name:
 * @action: the action object
 * 
 ...
 **/
const gchar *
__gtk_action_get_name (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
 ...
 **/
gboolean
__gtk_action_is_sensitive (GtkAction *action)
{
  ...
  return priv->sensitive &&
    (priv->action_group == NULL ||
     __gtk_action_group_get_sensitive (priv->action_group));
}

/**
 * __gtk_action_get_sensitive:
 * @action: the action object
 * 
 * Returns whether the action itself is sensitive. Note that this doesn't 
 * necessarily mean effective sensitivity. See __gtk_action_is_sensitive() 
 * for that.
 *
 ...
 **/
gboolean
__gtk_action_get_sensitive (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), FALSE);
 ...
 **/
void
__gtk_action_set_sensitive (GtkAction *action,
			  gboolean   sensitive)
{
  g_return_if_fail (GTK_IS_ACTION (action));
 ...
 **/
gboolean
__gtk_action_is_visible (GtkAction *action)
{
  GtkActionPrivate *priv;
  g_return_val_if_fail (GTK_IS_ACTION (action), FALSE);
  ...
  return priv->visible &&
    (priv->action_group == NULL ||
     __gtk_action_group_get_visible (priv->action_group));
}

/**
 * __gtk_action_get_visible:
 * @action: the action object
 * 
 * Returns whether the action itself is visible. Note that this doesn't 
 * necessarily mean effective visibility. See __gtk_action_is_sensitive() 
 * for that.
 *
 ...
 **/
gboolean
__gtk_action_get_visible (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), FALSE);
 ...
 **/
void
__gtk_action_set_visible (GtkAction *action,
			gboolean   visible)
{
  g_return_if_fail (GTK_IS_ACTION (action));
 ...
 */
void 
__gtk_action_set_is_important (GtkAction *action,
 ...
 */
gboolean 
__gtk_action_get_is_important (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), FALSE);
...
/**
 * __gtk_action_set_always_show_image:
 * @action: a #GtkAction
 ...
 */
void
__gtk_action_set_always_show_image (GtkAction *action,
...
/**
 * __gtk_action_get_always_show_image:
 * @action: a #GtkAction
 *
 ...
 */
gboolean
__gtk_action_get_always_show_image  (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), FALSE);
 ...
 */
void 
__gtk_action_set_label (GtkAction	  *action,
		      const gchar *label)
{
  gchar *tmp;
  ...
  if (!action->private_data->label_set && action->private_data->stock_id)
    {
      ...
      if (__gtk_stock_lookup (action->private_data->stock_id, &stock_item))
  ...
  if (!action->private_data->short_label_set)
    {
      __gtk_action_set_short_label (action, action->private_data->label);
      action->private_data->short_label_set = FALSE;
    }
}

/**
 * __gtk_action_get_label:
 * @action: a #GtkAction
 *
 ...
 */
const gchar *
__gtk_action_get_label (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
 ...
 */
void 
__gtk_action_set_short_label (GtkAction   *action,
 ...
 */
const gchar *
__gtk_action_get_short_label (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
...
/**
 * __gtk_action_set_visible_horizontal:
 * @action: a #GtkAction
 ...
 */
void
__gtk_action_set_visible_horizontal (GtkAction *action,
...
/**
 * __gtk_action_get_visible_horizontal:
 * @action: a #GtkAction
 *
 ...
 */
gboolean 
__gtk_action_get_visible_horizontal (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), FALSE);
...
/**
 * __gtk_action_set_visible_vertical:
 * @action: a #GtkAction
 ...
 */
void 
__gtk_action_set_visible_vertical (GtkAction *action,
...
/**
 * __gtk_action_get_visible_vertical:
 * @action: a #GtkAction
 *
 * Checks whether @action is visible when horizontal
 * 
 ...
 */
gboolean 
__gtk_action_get_visible_vertical (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), FALSE);
 ...
 */
void 
__gtk_action_set_tooltip (GtkAction   *action,
			const gchar *tooltip)
{
  gchar *tmp;
 ...
 */
const gchar *
__gtk_action_get_tooltip (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
 ...
 */
void 
__gtk_action_set_stock_id (GtkAction   *action,
			 const gchar *stock_id)
{
  gchar *tmp;
  ...
  if (!action->private_data->label_set)
    {
      ...
      if (action->private_data->stock_id &&
	  __gtk_stock_lookup (action->private_data->stock_id, &stock_item))
	__gtk_action_set_label (action, stock_item.label);
      else 
	__gtk_action_set_label (action, NULL);
 ...
 */
const gchar *
__gtk_action_get_stock_id (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
 ...
 */
void 
__gtk_action_set_icon_name (GtkAction   *action,
 ...
 */
const gchar *
__gtk_action_get_icon_name (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
 ...
 */
void
__gtk_action_set_gicon (GtkAction *action,
                      GIcon     *icon)
{
  g_return_if_fail (GTK_IS_ACTION (action));
 ...
 */
GIcon *
__gtk_action_get_gicon (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
...
/**
 * __gtk_action_block_activate_from:
 * @action: the action object
 * @proxy: a proxy widget
 *
 * Disables calls to the __gtk_action_activate()
 ...
 */
void
__gtk_action_block_activate_from (GtkAction *action, 
				GtkWidget *proxy)
{
  g_return_if_fail (GTK_IS_ACTION (action));
  
  g_signal_handlers_block_by_func (proxy, G_CALLBACK (__gtk_action_activate),
				   action);

  __gtk_action_block_activate (action);
}

/**
 * __gtk_action_unblock_activate_from:
 * @action: the action object
 * @proxy: a proxy widget
 *
 * Re-enables calls to the __gtk_action_activate()
 * function by signals on the given proxy widget.  This undoes the
 * blocking done by __gtk_action_block_activate_from().
 *
 * This function is intended for use by action implementations.
 * 
 * Since: 2.4
 ...
 */
void
__gtk_action_unblock_activate_from (GtkAction *action, 
				  GtkWidget *proxy)
{
  g_return_if_fail (GTK_IS_ACTION (action));

  g_signal_handlers_unblock_by_func (proxy, G_CALLBACK (__gtk_action_activate),
				     action);

  __gtk_action_unblock_activate (action);
}
...
closure_accel_activate (GClosure     *closure,
                        ...
                        gpointer      marshal_data)
{
  if (__gtk_action_is_sensitive (GTK_ACTION (closure->data)))
    {
      ______gtk_action_emit_activate (GTK_ACTION (closure->data));
 ...
 */
void
__gtk_action_set_accel_path (GtkAction   *action, 
 ...
 */
const gchar *
__gtk_action_get_accel_path (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
...
/**
 * __gtk_action_get_accel_closure:
 * @action: the action object
 *
 ...
 */
GClosure *
__gtk_action_get_accel_closure (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
 ...
 **/
void
__gtk_action_set_accel_group (GtkAction     *action,
			    GtkAccelGroup *accel_group)
{
  g_return_if_fail (GTK_IS_ACTION (action));
...
/**
 * __gtk_action_connect_accelerator:
 * @action: a #GtkAction
 * 
 * Installs the accelerator for @action if @action has an
 * accel path and group. See __gtk_action_set_accel_path() and 
 * __gtk_action_set_accel_group()
 *
 * Since multiple proxies may independently trigger the installation
 * of the accelerator, the @action counts the number of times this
 * function has been called and doesn't remove the accelerator until
 * __gtk_action_disconnect_accelerator() has been called as many times.
 *
 * Since: 2.4
 **/
void 
__gtk_action_connect_accelerator (GtkAction *action)
{
  g_return_if_fail (GTK_IS_ACTION (action));
  ...
  if (action->private_data->accel_count == 0)
	...
	g_quark_to_string (action->private_data->accel_quark);
      ...
      __gtk_accel_group_connect_by_path (action->private_data->accel_group,
				       accel_path,
				       action->private_data->accel_closure);
    }
...
/**
 * __gtk_action_disconnect_accelerator:
 * @action: a #GtkAction
 * 
 * Undoes the effect of one call to __gtk_action_connect_accelerator().
 *
 * Since: 2.4
 **/
void 
__gtk_action_disconnect_accelerator (GtkAction *action)
{
  g_return_if_fail (GTK_IS_ACTION (action));
  ...
  if (action->private_data->accel_count == 0)
    __gtk_accel_group_disconnect (action->private_data->accel_group,
				action->private_data->accel_closure);
}

/**
 * __gtk_action_create_menu:
 * @action: a #GtkAction
 *
 ...
 */
GtkWidget *
__gtk_action_create_menu (GtkAction *action)
{
  g_return_val_if_fail (GTK_IS_ACTION (action), NULL);
