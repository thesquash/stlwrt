...
default_forward_function (gint current_page, gpointer data)
{
  ...
  while (page_node && !__gtk_widget_get_visible (page_info->page))
    {
...
compute_last_button_state (GtkAssistant *assistant)
{
  ...
  count = 0;
  page_num = __gtk_assistant_get_current_page (assistant);
  n_pages  = __gtk_assistant_get_n_pages (assistant);
  ...
  if (count > 1 && page_info &&
    ...
    {
      __gtk_widget_show (assistant_props->last);
      __gtk_widget_set_sensitive (assistant_props->last,
				current_page_info->complete);
    }
  else
    __gtk_widget_hide (assistant_props->last);
}
...
compute_progress_state (GtkAssistant *assistant)
{
  ...
  if (page_num >= 0 && page_num < n_pages)
    __gtk_widget_show (assistant_props->forward);
  else
    __gtk_widget_hide (assistant_props->forward);
}
...
set_assistant_header_image (GtkAssistant *assistant)
{
  ...
  __gtk_image_set_from_pixbuf (GTK_IMAGE (priv->header_image),
...
set_assistant_sidebar_image (GtkAssistant *assistant)
{
  ...
  __gtk_image_set_from_pixbuf (GTK_IMAGE (priv->sidebar_image),
			     priv->current_page->sidebar_image);

  if (priv->current_page->sidebar_image)
    __gtk_widget_show (priv->sidebar_image);
  else
    __gtk_widget_hide (priv->sidebar_image);
}
...
set_assistant_buttons_state (GtkAssistant *assistant)
{
  ...
  switch (priv->current_page->type)
    ...
    case GTK_ASSISTANT_PAGE_INTRO:
      __gtk_widget_set_sensitive (assistant_props->cancel, TRUE);
      __gtk_widget_set_sensitive (assistant_props->forward, priv->current_page->complete);
      __gtk_widget_grab_default (assistant_props->forward);
      __gtk_widget_show (assistant_props->forward);
      __gtk_widget_hide (assistant_props->back);
      __gtk_widget_hide (assistant_props->apply);
      __gtk_widget_hide (assistant_props->close);
      compute_last_button_state (assistant);
      break;
    case GTK_ASSISTANT_PAGE_CONFIRM:
      __gtk_widget_set_sensitive (assistant_props->cancel, TRUE);
      __gtk_widget_set_sensitive (assistant_props->back, TRUE);
      __gtk_widget_set_sensitive (assistant_props->apply, priv->current_page->complete);
      __gtk_widget_grab_default (assistant_props->apply);
      __gtk_widget_show (assistant_props->back);
      __gtk_widget_show (assistant_props->apply);
      __gtk_widget_hide (assistant_props->forward);
      __gtk_widget_hide (assistant_props->close);
      __gtk_widget_hide (assistant_props->last);
      break;
    ...
    case GTK_ASSISTANT_PAGE_SUMMARY:
      __gtk_widget_set_sensitive (assistant_props->close, priv->current_page->complete);
      __gtk_widget_grab_default (assistant_props->close);
      __gtk_widget_show (assistant_props->close);
      __gtk_widget_hide (assistant_props->back);
      __gtk_widget_hide (assistant_props->forward);
      __gtk_widget_hide (assistant_props->apply);
      __gtk_widget_hide (assistant_props->last);
    ...
    case GTK_ASSISTANT_PAGE_PROGRESS:
      __gtk_widget_set_sensitive (assistant_props->cancel, priv->current_page->complete);
      __gtk_widget_set_sensitive (assistant_props->back, priv->current_page->complete);
      __gtk_widget_set_sensitive (assistant_props->forward, priv->current_page->complete);
      __gtk_widget_grab_default (assistant_props->forward);
      __gtk_widget_show (assistant_props->back);
      __gtk_widget_hide (assistant_props->apply);
  ...
  if (priv->committed)
    __gtk_widget_hide (assistant_props->cancel);
  else if (priv->current_page->type == GTK_ASSISTANT_PAGE_SUMMARY)
    __gtk_widget_hide (assistant_props->cancel);
  else
    __gtk_widget_show (assistant_props->cancel);
		  ...
		  GtkAssistantPage *page)
{
  ...
  if (priv->current_page &&
      __gtk_widget_is_drawable (priv->current_page->page))
  ...
  if (__gtk_widget_get_visible (priv->current_page->page) && __gtk_widget_get_mapped (GTK_WIDGET (assistant)))
    {
      __gtk_widget_set_child_visible (priv->current_page->page, TRUE);
      __gtk_widget_map (priv->current_page->page);
      __gtk_widget_map (priv->current_page->title);
    }
  
  if (old_page && __gtk_widget_get_mapped (old_page->page))
    {
      __gtk_widget_set_child_visible (old_page->page, FALSE);
      __gtk_widget_unmap (old_page->page);
      __gtk_widget_unmap (old_page->title);
    }

  if (!__gtk_widget_child_focus (priv->current_page->page, GTK_DIR_TAB_FORWARD))
    {
      GtkWidget *button[6];
      gint i;

      /* find the best button to focus */
      button[0] = assistant_props->apply;
      button[1] = assistant_props->close;
      button[2] = assistant_props->forward;
      button[3] = assistant_props->back;
      button[4] = assistant_props->cancel;
      button[5] = assistant_props->last;
      for (i = 0; i < 6; i++)
        {
          if (__gtk_widget_get_visible (button[i]) && __gtk_widget_get_sensitive (button[i]))
            {
              __gtk_widget_grab_focus (button[i]);
              break;
            }
        }
    }

  __gtk_widget_queue_resize (GTK_WIDGET (assistant));
}
...
compute_next_step (GtkAssistant *assistant)
{
  ...
  current_page = __gtk_assistant_get_current_page (assistant);
                   ...
                   GtkAssistant *assistant)
{
  ...
  while (page_info->type == GTK_ASSISTANT_PAGE_PROGRESS ||
	 !__gtk_widget_get_visible (page_info->page));
...
alternative_button_order (GtkAssistant *assistant)
{
  ...
  screen   = __gtk_widget_get_screen (GTK_WIDGET (assistant));
...
gtk_assistant_init (GtkAssistant *assistant)
{
  ...
  __gtk_container_set_reallocate_redraws (GTK_CONTAINER (assistant), TRUE);
  __gtk_container_set_border_width (GTK_CONTAINER (assistant), 12);

  __gtk_widget_push_composite_child ();

  /* Header */
  priv->header_image = __gtk_image_new ();
  __gtk_misc_set_alignment (GTK_MISC (priv->header_image), 1., 0.5);
  __gtk_widget_set_parent (priv->header_image, GTK_WIDGET (assistant));
  __gtk_widget_show (priv->header_image);

  /* Sidebar */
  priv->sidebar_image = __gtk_image_new ();
  __gtk_misc_set_alignment (GTK_MISC (priv->sidebar_image), 0., 0.);
  __gtk_widget_set_parent (priv->sidebar_image, GTK_WIDGET (assistant));
  __gtk_widget_show (priv->sidebar_image);

  /* Action area  */
  priv->action_area  = __gtk_hbox_new (FALSE, 6);
  
  assistant_props->close   = __gtk_button_new_from_stock (GTK_STOCK_CLOSE);
  assistant_props->apply   = __gtk_button_new_from_stock (GTK_STOCK_APPLY);
  assistant_props->forward = __gtk_button_new_from_stock (GTK_STOCK_GO_FORWARD);
  assistant_props->back    = __gtk_button_new_from_stock (GTK_STOCK_GO_BACK);
  assistant_props->cancel  = __gtk_button_new_from_stock (GTK_STOCK_CANCEL);
  assistant_props->last    = __gtk_button_new_from_stock (GTK_STOCK_GOTO_LAST);
  __gtk_widget_set_can_default (assistant_props->close, TRUE);
  __gtk_widget_set_can_default (assistant_props->apply, TRUE);
  __gtk_widget_set_can_default (assistant_props->forward, TRUE);

  priv->size_group   = __gtk_size_group_new (GTK_SIZE_GROUP_HORIZONTAL);
  __gtk_size_group_add_widget (priv->size_group, assistant_props->close);
  __gtk_size_group_add_widget (priv->size_group, assistant_props->apply);
  __gtk_size_group_add_widget (priv->size_group, assistant_props->forward);
  __gtk_size_group_add_widget (priv->size_group, assistant_props->back);
  __gtk_size_group_add_widget (priv->size_group, assistant_props->cancel);
  __gtk_size_group_add_widget (priv->size_group, assistant_props->last);

  if (!alternative_button_order (assistant))
    {
      __gtk_box_pack_end (GTK_BOX (priv->action_area), assistant_props->apply, FALSE, FALSE, 0);
      __gtk_box_pack_end (GTK_BOX (priv->action_area), assistant_props->forward, FALSE, FALSE, 0);
      __gtk_box_pack_end (GTK_BOX (priv->action_area), assistant_props->back, FALSE, FALSE, 0);
      __gtk_box_pack_end (GTK_BOX (priv->action_area), assistant_props->last, FALSE, FALSE, 0);
      __gtk_box_pack_end (GTK_BOX (priv->action_area), assistant_props->cancel, FALSE, FALSE, 0);
      __gtk_box_pack_end (GTK_BOX (priv->action_area), assistant_props->close, FALSE, FALSE, 0);
    }
  else
    {
      __gtk_box_pack_end (GTK_BOX (priv->action_area), assistant_props->close, FALSE, FALSE, 0);
  ...
  __gtk_widget_set_parent (priv->action_area, GTK_WIDGET (assistant));
  __gtk_widget_show (assistant_props->forward);
  __gtk_widget_show (assistant_props->back);
  __gtk_widget_show (assistant_props->cancel);
  __gtk_widget_show (priv->action_area);
  ...
  g_signal_connect (G_OBJECT (assistant_props->close), "clicked",
		    G_CALLBACK (on_assistant_close), assistant);
  g_signal_connect (G_OBJECT (assistant_props->apply), "clicked",
		    G_CALLBACK (on_assistant_apply), assistant);
  g_signal_connect (G_OBJECT (assistant_props->forward), "clicked",
		    G_CALLBACK (on_assistant_forward), assistant);
  g_signal_connect (G_OBJECT (assistant_props->back), "clicked",
		    G_CALLBACK (on_assistant_back), assistant);
  g_signal_connect (G_OBJECT (assistant_props->cancel), "clicked",
		    G_CALLBACK (on_assistant_cancel), assistant);
  g_signal_connect (G_OBJECT (assistant_props->last), "clicked",
				  ...
				  GParamSpec      *pspec)
{
  switch (property_id)
    ...
    case CHILD_PROP_PAGE_TYPE:
      __gtk_assistant_set_page_type (GTK_ASSISTANT (container), child,
				   g_value_get_enum (value));
      break;
    case CHILD_PROP_PAGE_TITLE:
      __gtk_assistant_set_page_title (GTK_ASSISTANT (container), child,
				    g_value_get_string (value));
      break;
    case CHILD_PROP_PAGE_HEADER_IMAGE:
      __gtk_assistant_set_page_header_image (GTK_ASSISTANT (container), child,
					   g_value_get_object (value));
      break;
    case CHILD_PROP_PAGE_SIDEBAR_IMAGE:
      __gtk_assistant_set_page_side_image (GTK_ASSISTANT (container), child,
					 g_value_get_object (value));
      break;
    case CHILD_PROP_PAGE_COMPLETE:
      __gtk_assistant_set_page_complete (GTK_ASSISTANT (container), child,
  ...
  switch (property_id)
    ...
    case CHILD_PROP_PAGE_TYPE:
      g_value_set_enum (value,
			__gtk_assistant_get_page_type (GTK_ASSISTANT (container), child));
      break;
    case CHILD_PROP_PAGE_TITLE:
      g_value_set_string (value,
			  __gtk_assistant_get_page_title (GTK_ASSISTANT (container), child));
      break;
    case CHILD_PROP_PAGE_HEADER_IMAGE:
      g_value_set_object (value,
			  __gtk_assistant_get_page_header_image (GTK_ASSISTANT (container), child));
      break;
    case CHILD_PROP_PAGE_SIDEBAR_IMAGE:
      g_value_set_object (value,
			  __gtk_assistant_get_page_side_image (GTK_ASSISTANT (container), child));
      break;
    case CHILD_PROP_PAGE_COMPLETE:
      g_value_set_boolean (value,
			   __gtk_assistant_get_page_complete (GTK_ASSISTANT (container), child));
      break;
    default:
      GTK_CONTAINER_WARN_INVALID_CHILD_PROPERTY_ID (container, property_id, pspec);
      break;
			   ...
			   gpointer    data)
{
  ...
  if (__gtk_widget_get_mapped (GTK_WIDGET (assistant)))
    set_assistant_buttons_state (assistant);
}
	     ...
	     GList        *element)
{
  ...
  if (page_info == priv->current_page)
    {
	  ...
	  while (page_node && !__gtk_widget_get_visible (((GtkAssistantPage *) page_node->data)->page))
	    page_node = page_node->next;
  ...
  __gtk_widget_unparent (page_info->page);
		  ...
		  GtkWidget *title_label)
{
  ...
  __gtk_widget_ensure_style (assistant);
  style = __gtk_widget_get_style (assistant);

  /* change colors schema, for making the header text visible */
  __gtk_widget_modify_bg (title_label, GTK_STATE_NORMAL, &style->bg[GTK_STATE_SELECTED]);
  __gtk_widget_modify_fg (title_label, GTK_STATE_NORMAL, &style->fg[GTK_STATE_SELECTED]);
}
		...
		GtkWidget *title_label)
{
  ...
  __gtk_widget_modify_font (title_label, desc);
			    ...
			    GtkRequisition *requisition)
{
  ...
  while (list)
    {
      ...
      __gtk_widget_size_request (page->page, &child_requisition);
      width  = MAX (width,  child_requisition.width);
      height = MAX (height, child_requisition.height);

      __gtk_widget_size_request (page->title, &child_requisition);
  ...
  __gtk_widget_size_request (priv->sidebar_image, &child_requisition);
  width  += child_requisition.width;
  height  = MAX (height, child_requisition.height);

  __gtk_widget_set_size_request (priv->header_image, header_width, header_height);
  __gtk_widget_size_request (priv->header_image, &child_requisition);
  width   = MAX (width, header_width) + 2 * header_padding;
  height += header_height + 2 * header_padding;

  __gtk_widget_size_request (priv->action_area, &child_requisition);
  width   = MAX (width, child_requisition.width);
  height += child_requisition.height + ACTION_AREA_SPACING;

  width += gtk_container_get_props (GTK_CONTAINER (widget))->border_width * 2 + content_padding * 2;
  height += gtk_container_get_props (GTK_CONTAINER (widget))->border_width * 2 + content_padding * 2;
			     ...
			     GtkAllocation  *allocation)
{
  ...
  header_allocation.x = gtk_container_get_props (GTK_CONTAINER (widget))->border_width + header_padding;
  header_allocation.y = gtk_container_get_props (GTK_CONTAINER (widget))->border_width + header_padding;
  header_allocation.width  = allocation->width - 2 * gtk_container_get_props (GTK_CONTAINER (widget))->border_width - 2 * header_padding;
  header_allocation.height = header_requisition.height;

  __gtk_widget_size_allocate (priv->header_image, &header_allocation);

  /* Action area */
  child_allocation.x = gtk_container_get_props (GTK_CONTAINER (widget))->border_width;
  child_allocation.y = allocation->height -
    gtk_container_get_props (GTK_CONTAINER (widget))->border_width - priv->action_area->requisition.height;
  ...
  if (rtl)
    child_allocation.x = allocation->width -
      gtk_container_get_props (GTK_CONTAINER (widget))->border_width - priv->sidebar_image->requisition.width;
  else
    child_allocation.x = gtk_container_get_props (GTK_CONTAINER (widget))->border_width;
  ...
  while (pages)
    {
      ...
      __gtk_widget_size_allocate (page->page, &child_allocation);
      __gtk_widget_size_allocate (page->title, &header_allocation);
      pages = pages->next;
    }
}
...
gtk_assistant_map (GtkWidget *widget)
{
  ...
  __gtk_widget_map (priv->header_image);
  __gtk_widget_map (priv->action_area);

  if (__gtk_widget_get_visible (priv->sidebar_image) &&
      !__gtk_widget_get_mapped (priv->sidebar_image))
    __gtk_widget_map (priv->sidebar_image);
  ...
  if (page &&
      __gtk_widget_get_visible (page->page) &&
      !__gtk_widget_get_mapped (page->page))
...
gtk_assistant_unmap (GtkWidget *widget)
{
  ...
  __gtk_widget_unmap (priv->header_image);
  __gtk_widget_unmap (priv->action_area);

  if (__gtk_widget_is_drawable (priv->sidebar_image))
    __gtk_widget_unmap (priv->sidebar_image);

  if (priv->current_page &&
      __gtk_widget_is_drawable (priv->current_page->page))
    __gtk_widget_unmap (priv->current_page->page);
  ...
  if (__gtk_widget_is_drawable (widget))
    {
      ...
      __gtk_container_propagate_expose (container, priv->header_image, event);
      __gtk_container_propagate_expose (container, priv->sidebar_image, event);
      __gtk_container_propagate_expose (container, priv->action_area, event);

      if (priv->current_page)
	{
	  __gtk_container_propagate_expose (container, priv->current_page->page, event);
	  __gtk_container_propagate_expose (container, priv->current_page->title, event);
	}
    }
  ...
  if (gtk_container_get_props (container)->focus_child == priv->action_area)
    {
	  ...
	  (priv->current_page == NULL ||
	   !__gtk_widget_child_focus (priv->current_page->page, direction)))
	{
	  ...
	  __gtk_container_set_focus_child (GTK_CONTAINER (priv->action_area), NULL);
	  __gtk_widget_child_focus (priv->action_area, direction);
	}
    }
  else
    {
...
gtk_assistant_add (GtkContainer *container,
		   GtkWidget    *page)
{
  __gtk_assistant_append_page (GTK_ASSISTANT (container), page);
}
  ...
  if (element)
    {
      ...
      __gtk_widget_queue_resize ((GtkWidget *) container);
    }
}
...
/**
 * __gtk_assistant_get_current_page:
 ...
 **/
gint
__gtk_assistant_get_current_page (GtkAssistant *assistant)
{
  GtkAssistantPrivate *priv;
...
/**
 * __gtk_assistant_set_current_page:
 * @assistant: a #GtkAssistant
 ...
 * __gtk_assistant_set_forward_page_func().
 *
 * Since: 2.10
 **/
void
__gtk_assistant_set_current_page (GtkAssistant *assistant,
				gint          page_num)
{
  GtkAssistantPrivate *priv;
  GtkAssistantPage *page;
 ...
 **/
gint
__gtk_assistant_get_n_pages (GtkAssistant *assistant)
{
  GtkAssistantPrivate *priv;
 ...
 **/
GtkWidget*
__gtk_assistant_get_nth_page (GtkAssistant *assistant,
			    gint          page_num)
{
  GtkAssistantPrivate *priv;
  GtkAssistantPage *page;
 ...
 **/
gint
__gtk_assistant_prepend_page (GtkAssistant *assistant,
			    GtkWidget    *page)
{
  g_return_val_if_fail (GTK_IS_ASSISTANT (assistant), 0);
  g_return_val_if_fail (GTK_IS_WIDGET (page), 0);

  return __gtk_assistant_insert_page (assistant, page, 0);
}

/**
 * __gtk_assistant_append_page:
 * @assistant: a #GtkAssistant
 * @page: a #GtkWidget
 *
 ...
 **/
gint
__gtk_assistant_append_page (GtkAssistant *assistant,
			   GtkWidget    *page)
{
  g_return_val_if_fail (GTK_IS_ASSISTANT (assistant), 0);
  g_return_val_if_fail (GTK_IS_WIDGET (page), 0);

  return __gtk_assistant_insert_page (assistant, page, -1);
}

/**
 * __gtk_assistant_insert_page:
 * @assistant: a #GtkAssistant
 * @page: a #GtkWidget
 ...
 **/
gint
__gtk_assistant_insert_page (GtkAssistant *assistant,
			   GtkWidget    *page,
			   gint          position)
{
  GtkAssistantPrivate *priv;
  ...
  __gtk_widget_set_child_visible (page_info->page, FALSE);
  __gtk_widget_set_parent (page_info->page,  GTK_WIDGET (assistant));
  __gtk_widget_set_parent (page_info->title, GTK_WIDGET (assistant));

  if (__gtk_widget_get_realized (GTK_WIDGET (assistant)))
    {
      __gtk_widget_realize (page_info->page);
      __gtk_widget_realize (page_info->title);
    }
 ...
 **/
void
__gtk_assistant_set_forward_page_func (GtkAssistant         *assistant,
...
/**
 * __gtk_assistant_add_action_widget:
 * @assistant: a #GtkAssistant
 * @child: a #GtkWidget
 * 
 ...
 **/
void
__gtk_assistant_add_action_widget (GtkAssistant *assistant,
				 GtkWidget    *child)
{
  GtkAssistantPrivate *priv;
  ...
  if (GTK_IS_BUTTON (child))
    __gtk_size_group_add_widget (priv->size_group, child);

  __gtk_box_pack_end (GTK_BOX (priv->action_area), child, FALSE, FALSE, 0);
}

/**
 * __gtk_assistant_remove_action_widget:
 * @assistant: a #GtkAssistant
 * @child: a #GtkWidget
 *
 ...
 **/
void
__gtk_assistant_remove_action_widget (GtkAssistant *assistant,
				    GtkWidget    *child)
{
  GtkAssistantPrivate *priv;
  ...
  if (GTK_IS_BUTTON (child))
    __gtk_size_group_remove_widget (priv->size_group, child);

  __gtk_container_remove (GTK_CONTAINER (priv->action_area), child);
}

/**
 * __gtk_assistant_set_page_title:
 * @assistant: a #GtkAssistant
 ...
 **/
void
__gtk_assistant_set_page_title (GtkAssistant *assistant,
			      GtkWidget    *page,
			      const gchar  *title)
{
  GtkAssistantPage *page_info;
  ...
  __gtk_label_set_text ((GtkLabel*) page_info->title, title);
  __gtk_widget_queue_resize (GTK_WIDGET (assistant));
  __gtk_widget_child_notify (page, "title");
}

/**
 * __gtk_assistant_get_page_title:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 * 
 ...
 **/
const gchar*
__gtk_assistant_get_page_title (GtkAssistant *assistant,
			      GtkWidget    *page)
{
  GtkAssistantPage *page_info;
  GList *child;
  ...
  return __gtk_label_get_text ((GtkLabel*) page_info->title);
}

/**
 * __gtk_assistant_set_page_type:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 ...
 **/
void
__gtk_assistant_set_page_type (GtkAssistant         *assistant,
			     GtkWidget            *page,
			     GtkAssistantPageType  type)
{
  GtkAssistantPrivate *priv;
  ...
  if (type != page_info->type)
    {
      ...
      if (type == GTK_ASSISTANT_PAGE_SUMMARY && !page_info->complete_set)
        {
          __gtk_assistant_set_page_complete (assistant, page, TRUE);
	 ...
	 might change current page buttons */
      ...
      __gtk_widget_child_notify (page, "page-type");
    }
}

/**
 * __gtk_assistant_get_page_type:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 *
...
__gtk_assistant_get_page_type (GtkAssistant *assistant,
			     GtkWidget    *page)
{
  GtkAssistantPage *page_info;
  GList *child;
...
/**
 * __gtk_assistant_set_page_header_image:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 ...
 **/
void
__gtk_assistant_set_page_header_image (GtkAssistant *assistant,
				     GtkWidget    *page,
				     GdkPixbuf    *pixbuf)
{
  GtkAssistantPrivate *priv;
  ...
  if (pixbuf != page_info->header_image)
	...
	set_assistant_header_image (assistant);
      ...
      __gtk_widget_child_notify (page, "header-image");
    }
}

/**
 * __gtk_assistant_get_page_header_image:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 *
 ...
 **/
GdkPixbuf*
__gtk_assistant_get_page_header_image (GtkAssistant *assistant,
				     GtkWidget    *page)
{
  GtkAssistantPage *page_info;
  GList *child;
...
/**
 * __gtk_assistant_set_page_side_image:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 * @pixbuf: (allow-none): the new header image @page
 *
 ...
 **/
void
__gtk_assistant_set_page_side_image (GtkAssistant *assistant,
				   GtkWidget    *page,
				   GdkPixbuf    *pixbuf)
{
  GtkAssistantPrivate *priv;
  ...
  if (pixbuf != page_info->sidebar_image)
	...
	set_assistant_sidebar_image (assistant);
      ...
      __gtk_widget_child_notify (page, "sidebar-image");
    }
}

/**
 * __gtk_assistant_get_page_side_image:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 *
 * Gets the header image for @page.
 ...
 **/
GdkPixbuf*
__gtk_assistant_get_page_side_image (GtkAssistant *assistant,
				   GtkWidget    *page)
{
  GtkAssistantPage *page_info;
  GList *child;
...
/**
 * __gtk_assistant_set_page_complete:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 ...
 **/
void
__gtk_assistant_set_page_complete (GtkAssistant *assistant,
				 GtkWidget    *page,
				 gboolean      complete)
{
  GtkAssistantPrivate *priv;
  ...
  if (complete != page_info->complete)
    {
	 ...
	 might change current page buttons */
      ...
      __gtk_widget_child_notify (page, "complete");
    }
}

/**
 * __gtk_assistant_get_page_complete:
 * @assistant: a #GtkAssistant
 * @page: a page of @assistant
 * 
 ...
 **/
gboolean
__gtk_assistant_get_page_complete (GtkAssistant *assistant,
				 GtkWidget    *page)
{
  GtkAssistantPage *page_info;
  GList *child;
...
/**
 * __gtk_assistant_update_buttons_state:
 * @assistant: a #GtkAssistant
 * 
 ...
 **/
void
__gtk_assistant_update_buttons_state (GtkAssistant *assistant)
{
  g_return_if_fail (GTK_IS_ASSISTANT (assistant));
 ...
 **/
void
__gtk_assistant_commit (GtkAssistant *assistant)
{
  g_return_if_fail (GTK_IS_ASSISTANT (assistant));

  g_slist_free (gtk_assistant_get_instance_private (assistant)->visited_pages);
  gtk_assistant_get_instance_private (assistant)->visited_pages = NULL;

  gtk_assistant_get_instance_private (assistant)->committed = TRUE;
...
gtk_assistant_accessible_get_n_children (AtkObject *accessible)
{
  ...
  return g_list_length (gtk_assistant_get_instance_private (assistant)->pages) + 1;
}
				    ...
				    gint       index)
{
  ...
  if (index < 0)
  ...
  else if (index < n_pages)
    {
      ...
      child = page->page;
      title = __gtk_assistant_get_page_title (assistant, child);
    }
  else if (index == n_pages)
    {
  ...
  obj = __gtk_widget_get_accessible (child);
