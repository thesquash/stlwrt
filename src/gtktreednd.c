 ...
 **/
gboolean
__gtk_tree_drag_source_row_draggable (GtkTreeDragSource *drag_source,
                                    GtkTreePath       *path)
{
...
/**
 * __gtk_tree_drag_source_drag_data_delete:
 * @drag_source: a #GtkTreeDragSource
 ...
 **/
gboolean
__gtk_tree_drag_source_drag_data_delete (GtkTreeDragSource *drag_source,
                                       GtkTreePath       *path)
{
  GtkTreeDragSourceIface *iface = GTK_TREE_DRAG_SOURCE_GET_IFACE (drag_source);
...
/**
 * __gtk_tree_drag_source_drag_data_get:
 * @drag_source: a #GtkTreeDragSource
 ...
 **/
gboolean
__gtk_tree_drag_source_drag_data_get    (GtkTreeDragSource *drag_source,
                                       GtkTreePath       *path,
...
/**
 * __gtk_tree_drag_dest_drag_data_received:
 ...
 **/
gboolean
__gtk_tree_drag_dest_drag_data_received (GtkTreeDragDest  *drag_dest,
                                       GtkTreePath      *dest,
                                       GtkSelectionData *selection_data)
{
...
/**
 * __gtk_tree_drag_dest_row_drop_possible:
 * @drag_dest: a #GtkTreeDragDest
 ...
 **/
gboolean
__gtk_tree_drag_dest_row_drop_possible (GtkTreeDragDest   *drag_dest,
 ...
 **/
gboolean
__gtk_tree_set_row_drag_data (GtkSelectionData *selection_data,
			    ...
			    GtkTreePath      *path)
{
  ...
  path_str = __gtk_tree_path_to_string (path);
  ...
  __gtk_selection_data_set (selection_data,
                          __gdk_atom_intern_static_string ("GTK_TREE_MODEL_ROW"),
                          8, /* bytes */
                          (void*)trd,
                          struct_size);
 ...
 **/
gboolean
__gtk_tree_get_row_drag_data (GtkSelectionData  *selection_data,
			    GtkTreeModel     **tree_model,
			    GtkTreePath      **path)
{
  TreeRowData *trd;
  ...
  if (path)
    *path = __gtk_tree_path_new_from_string (trd->path);
