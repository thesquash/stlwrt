 ...
 * __gtk_activatable_do_set_related_action() and
 * __gtk_activatable_sync_action_properties() at the appropriate times.
 * </para>
 * <example>
 ...
 * }
 * 
 * ... Break the reference using __gtk_activatable_do_set_related_action()...
 *
 * static void 
 ...
 *   if (priv->action)
 *     {
 *       __gtk_activatable_do_set_related_action (GTK_ACTIVATABLE (bar), NULL);
 *       priv->action = NULL;
 *     }
 ...
 *       
 *       __gtk_activatable_sync_action_properties (GTK_ACTIVATABLE (bar), priv->action);
 *     }
 * }
 * 
 * ... call __gtk_activatable_do_set_related_action() and then assign the action pointer, 
 * no need to reference the action here since __gtk_activatable_do_set_related_action() already 
 ...
 *     return;
 * 
 *   __gtk_activatable_do_set_related_action (GTK_ACTIVATABLE (bar), action);
 * 
 *   priv->action = action;
 * }
 * 
 ...
 *     {
 *       if (__gtk_action_get_stock_id (action))
 * 	foo_bar_set_stock (button, __gtk_action_get_stock_id (action));
 *       else if (__gtk_action_get_label (action))
 * 	foo_bar_set_label (button, __gtk_action_get_label (action));
 * 
 *       ...
 * 
 *     }
...
gtk_activatable_class_init (gpointer g_iface)
{
   ...
   * call __gtk_activatable_do_set_related_action() when it changes.</para></note>
   *
   * Since: 2.16
   */
   ...
   * and call __gtk_activatable_sync_action_properties() on the activatable
...
/**
 * __gtk_activatable_sync_action_properties:
 ...
 **/
void
__gtk_activatable_sync_action_properties (GtkActivatable *activatable,
		                        GtkAction      *action)
{
  GtkActivatableIface *iface;
...
/**
 * __gtk_activatable_set_related_action:
 * @activatable: a #GtkActivatable
 ...
 * property and call __gtk_activatable_do_set_related_action() when it changes.</para></note>
 *
 * Since: 2.16
 **/
void
__gtk_activatable_set_related_action (GtkActivatable *activatable,
				    GtkAction      *action)
{
  g_return_if_fail (GTK_IS_ACTIVATABLE (activatable));
...
/**
 * __gtk_activatable_do_set_related_action:
 * @activatable: a #GtkActivatable
 * @action: the #GtkAction to set
 * 
 ...
 */
void
__gtk_activatable_do_set_related_action (GtkActivatable *activatable,
				       GtkAction      *action)
{
  GtkAction *prev_action;

  prev_action = __gtk_activatable_get_related_action (activatable);
  ...
  if (prev_action != action)
      ...
      if (prev_action)
	{
	  g_signal_handlers_disconnect_by_func (prev_action, gtk_activatable_action_notify, activatable);
          ...
          if (GTK_IS_WIDGET (activatable))
            ______gtk_action_remove_from_proxy_list (prev_action, GTK_WIDGET (activatable));
           ...
           */ 
          __gtk_action_block_activate (prev_action);
	}
       ...
       */
      __gtk_activatable_sync_action_properties (activatable, action);

      if (prev_action)
        {
          __gtk_action_unblock_activate (prev_action);
      ...
      if (action)
	{
	  ...
	  g_signal_connect (G_OBJECT (action), "notify", G_CALLBACK (gtk_activatable_action_notify), activatable);
          ...
          if (GTK_IS_WIDGET (activatable))
            ______gtk_action_add_to_proxy_list (action, GTK_WIDGET (activatable));
...
/**
 * __gtk_activatable_get_related_action:
 * @activatable: a #GtkActivatable
 *
 ...
 **/
GtkAction *
__gtk_activatable_get_related_action (GtkActivatable *activatable)
{
  GtkAction *action;
...
/**
 * __gtk_activatable_set_use_action_appearance:
 * @activatable: a #GtkActivatable
 ...
 * __gtk_activatable_sync_action_properties() to update @activatable
 * if needed.</para></note>
 *
 * Since: 2.16
 **/
void
__gtk_activatable_set_use_action_appearance (GtkActivatable *activatable,
					   gboolean        use_appearance)
{
...
/**
 * __gtk_activatable_get_use_action_appearance:
 * @activatable: a #GtkActivatable
 *
 ...
 **/
gboolean
__gtk_activatable_get_use_action_appearance  (GtkActivatable *activatable)
{
  gboolean use_appearance;
