...
/**
 * __gtk_print_context_set_cairo_context:
 ...
 */
void
__gtk_print_context_set_cairo_context (GtkPrintContext *context,
				     cairo_t         *cr,
				     double           dpi_x,
				     double           dpi_y)
{
...
_gtk_print_context_rotate_according_to_orientation (GtkPrintContext *context)
{
  ...
  paper_size = __gtk_page_setup_get_paper_size (context->page_setup);

  width = __gtk_paper_size_get_width (paper_size, GTK_UNIT_INCH);
  width = width * context->surface_dpi_x / context->pixels_per_unit_x;
  height = __gtk_paper_size_get_height (paper_size, GTK_UNIT_INCH);
  height = height * context->surface_dpi_y / context->pixels_per_unit_y;
  
  switch (__gtk_page_setup_get_orientation (context->page_setup))
    {
    default:
...
_gtk_print_context_translate_into_margin (GtkPrintContext *context)
{
  ...
  left = __gtk_page_setup_get_left_margin (context->page_setup, GTK_UNIT_INCH);
  top = __gtk_page_setup_get_top_margin (context->page_setup, GTK_UNIT_INCH);
...
/**
 * __gtk_print_context_get_cairo_context:
 * @context: a #GtkPrintContext
 *
 ...
 */
cairo_t *
__gtk_print_context_get_cairo_context (GtkPrintContext *context)
{
...
/**
 * __gtk_print_context_get_page_setup:
 * @context: a #GtkPrintContext
 *
 ...
 */
GtkPageSetup *
__gtk_print_context_get_page_setup (GtkPrintContext *context)
{
  g_return_val_if_fail (GTK_IS_PRINT_CONTEXT (context), NULL);
 ...
 */
gdouble
__gtk_print_context_get_width (GtkPrintContext *context)
{
  GtkPrintOperationPrivate *priv;
  gdouble width;
  ...
  if (priv->use_full_page)
    width = __gtk_page_setup_get_paper_width (context->page_setup, GTK_UNIT_INCH);
  else
    width = __gtk_page_setup_get_page_width (context->page_setup, GTK_UNIT_INCH);
...
/**
 * __gtk_print_context_get_height:
 * @context: a #GtkPrintContext
 * 
 ...
 */
gdouble
__gtk_print_context_get_height (GtkPrintContext *context)
{
  GtkPrintOperationPrivate *priv;
  gdouble height;
  ...
  if (priv->use_full_page)
    height = __gtk_page_setup_get_paper_height (context->page_setup, GTK_UNIT_INCH);
  else
    height = __gtk_page_setup_get_page_height (context->page_setup, GTK_UNIT_INCH);
 ...
 */
gdouble
__gtk_print_context_get_dpi_x (GtkPrintContext *context)
{
  g_return_val_if_fail (GTK_IS_PRINT_CONTEXT (context), 0);
 ...
 */
gdouble
__gtk_print_context_get_dpi_y (GtkPrintContext *context)
{
  g_return_val_if_fail (GTK_IS_PRINT_CONTEXT (context), 0);
...
/**
 * __gtk_print_context_get_hard_margins:
 * @context: a #GtkPrintContext
 ...
 */
gboolean
__gtk_print_context_get_hard_margins (GtkPrintContext *context,
				    gdouble         *top,
				    gdouble         *bottom,
				    gdouble         *left,
				    gdouble         *right)
...
/**
 * __gtk_print_context_get_pango_fontmap:
 * @context: a #GtkPrintContext
 *
 ...
 */
PangoFontMap *
__gtk_print_context_get_pango_fontmap (GtkPrintContext *context)
{
  g_return_val_if_fail (GTK_IS_PRINT_CONTEXT (context), NULL);
...
/**
 * __gtk_print_context_create_pango_context:
 * @context: a #GtkPrintContext
 *
 ...
 */
PangoContext *
__gtk_print_context_create_pango_context (GtkPrintContext *context)
{
...
/**
 * __gtk_print_context_create_pango_layout:
 * @context: a #GtkPrintContext
 *
 ...
 */
PangoLayout *
__gtk_print_context_create_pango_layout (GtkPrintContext *context)
{
  PangoContext *pango_context;
  PangoLayout *layout;
  ...
  pango_context = __gtk_print_context_create_pango_context (context);
