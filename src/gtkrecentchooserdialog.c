  ...
  for (l = children; l; l = l->next)
    {
      ...
      if (response_id == GTK_RESPONSE_ACCEPT ||
          ...
          response_id == GTK_RESPONSE_APPLY)
        {
          ...
          __gtk_dialog_response (GTK_DIALOG (dialog), response_id);
...
gtk_recent_chooser_dialog_unmap (GtkWidget *widget)
{
  ...
  __gtk_widget_unmap (priv->chooser);
}

static GtkWidget *
__gtk_recent_chooser_dialog_new_valist (const gchar      *title,
				      GtkWindow        *parent,
				      GtkRecentManager *manager,
...
/**
 * __gtk_recent_chooser_dialog_new:
 ...
 */
GtkWidget *
__gtk_recent_chooser_dialog_new (const gchar *title,
			       GtkWindow   *parent,
			       const gchar *first_button_text,
			       ...)
{
  ...
  result = __gtk_recent_chooser_dialog_new_valist (title,
  						 parent,
  						 NULL,
  						 first_button_text,
  						 varargs);
...
/**
 * __gtk_recent_chooser_dialog_new_for_manager:
 * @title: (allow-none): Title of the dialog, or %NULL
 * @parent: (allow-none): Transient parent of the dialog, or %NULL,
 ...
 */
GtkWidget *
__gtk_recent_chooser_dialog_new_for_manager (const gchar      *title,
			                   GtkWindow        *parent,
			                   GtkRecentManager *manager,
			                   const gchar      *first_button_text,
			                   ...)
