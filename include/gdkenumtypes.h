...
#define GDK_TYPE_COLOR_INFO_FLAGS (SF(gdk_color_info_flags_get_type) ())
GType SF(gdk_event_filter_flags_get_type) (void) G_GNUC_CONST;
#define GDK_TYPE_EVENT_FILTER_FLAGS (SF(gdk_event_filter_flags_get_type) ())
GType SF(gdk_debug_flag_get_type) (void) G_GNUC_CONST;
#define GDK_TYPE_DEBUG_FLAG (SF(gdk_debug_flag_get_type) ())
GType SF(gdk_arg_type_get_type) (void) G_GNUC_CONST;
#define GDK_TYPE_ARG_TYPE (SF(gdk_arg_type_get_type) ())
GType SF(gdk_event_flags_get_type) (void) G_GNUC_CONST;
#define GDK_TYPE_EVENT_FLAGS (SF(gdk_event_flags_get_type) ())
