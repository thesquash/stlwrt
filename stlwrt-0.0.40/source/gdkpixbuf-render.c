...
/**
 * __gdk_pixbuf_render_threshold_alpha:
 * @pixbuf: A pixbuf.
 ...
 **/
void
__gdk_pixbuf_render_threshold_alpha (GdkPixbuf *pixbuf,
                                   GdkBitmap *bitmap,
                                   int        src_x,
                                   int        src_y,
                                   int        dest_x,
...
/**
 * __gdk_pixbuf_render_to_drawable:
 * @pixbuf: A pixbuf.
 ...
 *
 * Deprecated: 2.4: This function is obsolete. Use __gdk_draw_pixbuf() instead.
 **/
void
__gdk_pixbuf_render_to_drawable (GdkPixbuf   *pixbuf,
...
{
  __gdk_draw_pixbuf (drawable, gc, pixbuf,
...
/**
 * __gdk_pixbuf_render_to_drawable_alpha:
 * @pixbuf: A pixbuf.
 * @drawable: Destination drawable.
 * @src_x: Source X coordinate within pixbuf.
 ...
 * Otherwise a colormap must be set on them with __gdk_drawable_set_colormap.
 *
 ...
 **/
void
__gdk_pixbuf_render_to_drawable_alpha (GdkPixbuf   *pixbuf,
				     GdkDrawable *drawable,
				     int src_x,    int src_y,
				     int dest_x,   int dest_y,
				     int width,    int height,
				     ...
				     int x_dither, int y_dither)
{
  __gdk_draw_pixbuf (drawable, NULL, pixbuf,
		   src_x, src_y, dest_x, dest_y, width, height,
		   dither, x_dither, y_dither);
}

/**
 * __gdk_pixbuf_render_pixmap_and_mask:
 * @pixbuf: A pixbuf.
 ...
 * given drawables should use __gdk_draw_pixbuf() and __gdk_pixbuf_render_threshold_alpha().
 *
 * The pixmap that is created is created for the colormap returned
 * by __gdk_rgb_get_colormap(). You normally will want to instead use
 * the actual colormap for a widget, and use
 * __gdk_pixbuf_render_pixmap_and_mask_for_colormap().
 *
 * If the pixbuf does not have an alpha channel, then *@mask_return will be set
 * to %NULL.
 **/
void
__gdk_pixbuf_render_pixmap_and_mask (GdkPixbuf  *pixbuf,
 ...
 **/
void
__gdk_pixbuf_render_pixmap_and_mask_for_colormap (GdkPixbuf   *pixbuf,
