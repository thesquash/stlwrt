...
struct _GtkPrintUnixDialogPrivate
{
  GtkWidget *notebook;
                             ...
                             gint         response_id)
{
  ...
  __gtk_button_set_image (GTK_BUTTON (button),
                        __gtk_image_new_from_stock (stock_id,
...
error_dialogs (GtkPrintUnixDialog *print_dialog,
               ...
               gpointer            data)
{
  GtkPrintUnixDialogPrivate *priv = gtk_print_unix_dialog_get_props (print_dialog)->priv;
          ...
          if (gtk_printer_is_virtual (printer))
            {
              ...
              if (option != NULL &&
                  gtk_printer_option_get_props (option)->type == GTK_PRINTER_OPTION_TYPE_FILESAVE)
                {
                  file = g_file_new_for_uri (gtk_printer_option_get_props (option)->value);
                  ...
                  if (file != NULL &&
                      g_file_query_exists (file, NULL))
                    {
                      ...
                      __gtk_dialog_add_button (GTK_DIALOG (dialog),
                      ...
                      __gtk_dialog_set_alternative_button_order (GTK_DIALOG (dialog),
                                                               ...
                                                               GTK_RESPONSE_CANCEL,
                                                               -1);
                      __gtk_dialog_set_default_response (GTK_DIALOG (dialog),
                                                       GTK_RESPONSE_ACCEPT);

                      if (gtk_window_get_props (toplevel)->group)
                        __gtk_window_group_add_window (gtk_window_get_props (toplevel)->group,
                                                     GTK_WINDOW (dialog));
...
gtk_print_unix_dialog_init (GtkPrintUnixDialog *dialog)
{
  ...
  priv = gtk_print_unix_dialog_get_props (dialog)->priv = gtk_print_unix_dialog_get_instance_private (dialog);
  priv->print_backends = NULL;
  priv->current_page = -1;
  priv->number_up_layout_n_option = NULL;
  priv->number_up_layout_2_option = NULL;

  priv->page_setup = __gtk_page_setup_new ();
  ...
  priv->preview_button = __gtk_button_new_from_stock (GTK_STOCK_PRINT_PREVIEW);
  __gtk_widget_show (priv->preview_button);

  __gtk_dialog_add_action_widget (GTK_DIALOG (dialog),
                                priv->preview_button,
                                GTK_RESPONSE_APPLY);
  ...
  __gtk_dialog_set_response_sensitive (GTK_DIALOG (dialog), GTK_RESPONSE_OK, FALSE);

  priv->page_setup_list = __gtk_list_store_new (PAGE_SETUP_LIST_N_COLS,
                                              G_TYPE_OBJECT,
                                              G_TYPE_BOOLEAN);
  ...
  if (priv->request_details_tag)
    {
      ...
      if (details_failed)
        __gtk_list_store_set (GTK_LIST_STORE (priv->printer_list),
                                ...
                                gpointer           data)
{
  ...
  __gtk_tree_model_get (tree_model, iter, PRINTER_LIST_COL_PRINTER_OBJ, &printer, -1);
                   ...
                   GtkPrintUnixDialog *dialog)
{
  ...
  __gtk_list_store_set (GTK_LIST_STORE (priv->printer_list), iter,
  ...
  selection = __gtk_tree_view_get_selection (GTK_TREE_VIEW (priv->printer_treeview));
  selected_printer_changed (selection, dialog);

  if (gtk_print_backend_printer_list_is_done (backend) &&
      gtk_printer_is_default (printer) &&
      (__gtk_tree_selection_count_selected_rows (selection) == 0))
                  ...
                  GtkPrintUnixDialog *dialog)
{
  ...
  __gtk_list_store_append (GTK_LIST_STORE (priv->printer_list), &iter);
  ...
  __gtk_tree_model_filter_convert_child_iter_to_iter (priv->printer_list_filter,
                                                    &filter_iter, &iter);
  path = __gtk_tree_model_get_path (GTK_TREE_MODEL (priv->printer_list_filter), &filter_iter);
  ...
  if (priv->waiting_for_printer != NULL &&
              ...
              priv->waiting_for_printer) == 0)
    {
      ...
      __gtk_tree_selection_select_iter (selection, &filter_iter);
      __gtk_tree_view_scroll_to_cell (GTK_TREE_VIEW (priv->printer_treeview),
...
create_printer_list_model (GtkPrintUnixDialog *dialog)
{
  ...
  model = __gtk_list_store_new (PRINTER_LIST_N_COLS,
                              G_TYPE_STRING,
                              G_TYPE_STRING,
                              G_TYPE_STRING,
                              G_TYPE_INT,
  ...
  priv->printer_list_filter = (GtkTreeModelFilter *) __gtk_tree_model_filter_new ((GtkTreeModel *)model,
                                                                                        NULL);

  __gtk_tree_model_filter_set_visible_func (priv->printer_list_filter,
                                          (GtkTreeModelFilterVisibleFunc) is_printer_active,
                                          dialog,
                                          NULL);

  sort = GTK_TREE_SORTABLE (model);
  __gtk_tree_sortable_set_default_sort_func (sort,
                                           default_printer_list_sort_func,
                                           NULL,
                                           NULL);

  __gtk_tree_sortable_set_sort_column_id (sort,
  ...
  if (gtk_printer_option_widget_has_external_label (GTK_PRINTER_OPTION_WIDGET (widget)))
    {
      ...
      __gtk_label_set_mnemonic_widget (GTK_LABEL (label), widget);

      hbox = __gtk_hbox_new (FALSE, 12);
      __gtk_box_pack_start (GTK_BOX (hbox), label, FALSE, FALSE, 0);
      __gtk_box_pack_start (GTK_BOX (hbox), widget, FALSE, FALSE, 0);
      __gtk_widget_show (hbox);

      __gtk_box_pack_start (GTK_BOX (extension_point), hbox, FALSE, FALSE, 0);
    }
  else
    __gtk_box_pack_start (GTK_BOX (extension_point), widget, FALSE, FALSE, 0);
}
                     ...
                     gpointer          user_data)
{
  ...
  if (g_str_has_prefix (gtk_printer_option_get_props (option)->name, "gtk-"))
    return;
  ...
  if (gtk_printer_option_widget_has_external_label (GTK_PRINTER_OPTION_WIDGET (widget)))
    {
      ...
      __gtk_table_attach (table, label,
...
update_print_at_option (GtkPrintUnixDialog *dialog)
{
  ...
  if (__gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (priv->print_at_radio)))
    gtk_printer_option_set (option, "at");
  else if (__gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (priv->print_hold_radio)))
  ...
  if (option != NULL)
    {
      const char *text = __gtk_entry_get_text (GTK_ENTRY (priv->print_at_entry));
...
setup_print_at (GtkPrintUnixDialog *dialog)
{
  ...
  if (option == NULL)
    {
      __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->print_now_radio),
                                    TRUE);
      __gtk_widget_set_sensitive (priv->print_at_radio, FALSE);
      __gtk_widget_set_sensitive (priv->print_at_entry, FALSE);
      __gtk_widget_set_sensitive (priv->print_hold_radio, FALSE);
      __gtk_entry_set_text (GTK_ENTRY (priv->print_at_entry), "");
      return FALSE;
    }
  ...
  __gtk_widget_set_sensitive (priv->print_at_entry, FALSE);
  __gtk_widget_set_sensitive (priv->print_at_radio,
                            gtk_printer_option_has_choice (option, "at"));

  __gtk_widget_set_sensitive (priv->print_hold_radio,
                            gtk_printer_option_has_choice (option, "on-hold"));

  update_print_at_option (dialog);

  if (strcmp (gtk_printer_option_get_props (option)->value, "at") == 0)
    __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->print_at_radio),
                                  TRUE);
  else if (strcmp (gtk_printer_option_get_props (option)->value, "on-hold") == 0)
    __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->print_hold_radio),
                                  TRUE);
  else
    __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->print_now_radio),
                                  TRUE);
  ...
  option = gtk_printer_option_set_lookup (priv->options, "gtk-print-time-text");
  if (option != NULL)
    __gtk_entry_set_text (GTK_ENTRY (priv->print_at_entry), gtk_printer_option_get_props (option)->value);
...
update_dialog_from_settings (GtkPrintUnixDialog *dialog)
{
  ...
  if (priv->current_printer == NULL)
    {
       clear_per_printer_ui (dialog);
       __gtk_widget_hide (priv->job_page);
       __gtk_widget_hide (priv->advanced_page);
       __gtk_widget_hide (priv->image_quality_page);
       __gtk_widget_hide (priv->finishing_page);
       __gtk_widget_hide (priv->color_page);
       __gtk_dialog_set_response_sensitive (GTK_DIALOG (dialog), GTK_RESPONSE_OK, FALSE);
  ...
  if (has_job)
    __gtk_widget_show (priv->job_page);
  else
    __gtk_widget_hide (priv->job_page);
  ...
  for (gtk_widget_get_props (l) = groups; gtk_widget_get_props (l) != NULL; gtk_widget_get_props (l) = gtk_widget_get_props (l)->next)
    {
      ...
      table = __gtk_table_new (1, 2, FALSE);
      ...
      if (gtk_table_get_props (GTK_TABLE (table))->nrows == 1)
      ...
      else
        {
          ...
          __gtk_box_pack_start (GTK_BOX (priv->advanced_vbox),
                              frame, FALSE, FALSE, 0);
        }
    }

  if (has_advanced)
    __gtk_widget_show (priv->advanced_page);
  else
    __gtk_widget_hide (priv->advanced_page);
...
update_dialog_from_capabilities (GtkPrintUnixDialog *dialog)
{
  ...
  copies = __gtk_entry_get_text (GTK_ENTRY (priv->copies_spin));
  can_collate = (*copies != '\0' && atoi (copies) > 1);

  caps = priv->manual_capabilities | priv->printer_capabilities;

  __gtk_widget_set_sensitive (priv->page_set_combo,
                            caps & GTK_PRINT_CAPABILITY_PAGE_SET);
  __gtk_widget_set_sensitive (priv->copies_spin,
                            caps & GTK_PRINT_CAPABILITY_COPIES);
  __gtk_widget_set_sensitive (priv->collate_check,
                            can_collate &&
                            (caps & GTK_PRINT_CAPABILITY_COLLATE));
  __gtk_widget_set_sensitive (priv->reverse_check,
                            caps & GTK_PRINT_CAPABILITY_REVERSE);
  __gtk_widget_set_sensitive (priv->scale_spin,
                            caps & GTK_PRINT_CAPABILITY_SCALE);
  __gtk_widget_set_sensitive (GTK_WIDGET (priv->pages_per_sheet),
                            caps & GTK_PRINT_CAPABILITY_NUMBER_UP);

  if (caps & GTK_PRINT_CAPABILITY_PREVIEW)
    __gtk_widget_show (priv->preview_button);
  else
    __gtk_widget_hide (priv->preview_button);

  update_collate_icon (NULL, dialog);

  __gtk_tree_model_filter_refilter (priv->printer_list_filter);
}
...
{
  return
    __gtk_paper_size_is_equal (__gtk_page_setup_get_paper_size (a),
			     __gtk_page_setup_get_paper_size (b)) &&
    __gtk_page_setup_get_top_margin (a, GTK_UNIT_MM) == __gtk_page_setup_get_top_margin (b, GTK_UNIT_MM) &&
    __gtk_page_setup_get_bottom_margin (a, GTK_UNIT_MM) == __gtk_page_setup_get_bottom_margin (b, GTK_UNIT_MM) &&
    __gtk_page_setup_get_left_margin (a, GTK_UNIT_MM) == __gtk_page_setup_get_left_margin (b, GTK_UNIT_MM) &&
    __gtk_page_setup_get_right_margin (a, GTK_UNIT_MM) == __gtk_page_setup_get_right_margin (b, GTK_UNIT_MM);
}
...
page_setup_is_same_size (GtkPageSetup *a,
			 GtkPageSetup *b)
{
  return __gtk_paper_size_is_equal (__gtk_page_setup_get_paper_size (a),
				  __gtk_page_setup_get_paper_size (b));
}
		...
		gboolean            add_item)
{
  ...
  if (__gtk_tree_model_get_iter_first (model, &iter))
    {
      do
	{
	  __gtk_tree_model_get (GTK_TREE_MODEL (priv->page_setup_list), &iter,
	  ...
	  if ((size_only && page_setup_is_same_size (page_setup, list_page_setup)) ||
	    ...
	    {
	      __gtk_combo_box_set_active_iter (GTK_COMBO_BOX (priv->paper_size_combo),
					     &iter);
	      __gtk_combo_box_set_active (GTK_COMBO_BOX (priv->orientation_combo),
					__gtk_page_setup_get_orientation (page_setup));
  ...
  if (add_item)
    {
      __gtk_list_store_append (priv->page_setup_list, &iter);
      __gtk_list_store_set (priv->page_setup_list, &iter,
...
fill_custom_paper_sizes (GtkPrintUnixDialog *dialog)
{
  ...
  if (__gtk_tree_model_get_iter_first (model, &iter))
    {
      __gtk_list_store_append (priv->page_setup_list, &paper_iter);
      __gtk_list_store_set (priv->page_setup_list, &paper_iter,
			  PAGE_SETUP_LIST_COL_IS_SEPARATOR, TRUE,
			  -1);
      do
	{
                  ...
                  GtkPrinter         *printer)
{
  ...
  __gtk_list_store_clear (priv->page_setup_list);
  ...
  if (printer == NULL || (list = gtk_printer_list_papers (printer)) == NULL)
      ...
      for (i = 0; i < G_N_ELEMENTS (common_paper_sizes); i++)
	{
	  ...
	  paper_size = __gtk_paper_size_new (common_paper_sizes[i]);
	  __gtk_page_setup_set_paper_size_and_default_margins (page_setup, paper_size);
...
update_paper_sizes (GtkPrintUnixDialog *dialog)
{
  ...
  current_page_setup = __gtk_page_setup_copy (gtk_print_unix_dialog_get_page_setup (dialog));
...
mark_conflicts (GtkPrintUnixDialog *dialog)
{
  ...
  if (have_conflict)
    __gtk_widget_show (priv->conflicts_widget);
  else
    __gtk_widget_hide (priv->conflicts_widget);
}
...
schedule_idle_mark_conflicts (GtkPrintUnixDialog *dialog)
{
  ...
  priv->mark_conflicts_id = __gdk_threads_add_idle (mark_conflicts_callback,
                                        dialog);
}
...
clear_per_printer_ui (GtkPrintUnixDialog *dialog)
{
  ...
  __gtk_container_foreach (GTK_CONTAINER (priv->finishing_table),
                         (GtkCallback)__gtk_widget_destroy,
                         NULL);
  __gtk_table_resize (GTK_TABLE (priv->finishing_table), 1, 2);
  __gtk_container_foreach (GTK_CONTAINER (priv->image_quality_table),
                         (GtkCallback)__gtk_widget_destroy,
                         NULL);
  __gtk_table_resize (GTK_TABLE (priv->image_quality_table), 1, 2);
  __gtk_container_foreach (GTK_CONTAINER (priv->color_table),
                         (GtkCallback)__gtk_widget_destroy,
                         NULL);
  __gtk_table_resize (GTK_TABLE (priv->color_table), 1, 2);
  __gtk_container_foreach (GTK_CONTAINER (priv->advanced_vbox),
                         (GtkCallback)__gtk_widget_destroy,
                         NULL);
                          ...
                          GtkPrintUnixDialog *dialog)
{
  ...
  printer = NULL;
  if (__gtk_tree_selection_get_selected (selection, NULL, &filter_iter))
    {
      __gtk_tree_model_filter_convert_iter_to_child_iter (priv->printer_list_filter,
                                                        &iter,
                                                        &filter_iter);

      __gtk_tree_model_get (priv->printer_list, &iter,
                          PRINTER_LIST_COL_PRINTER_OBJ, &printer,
                          -1);
    }
      ...
      if (!gtk_printer_is_accepting_jobs (printer))
      ...
      else
        {
          if (priv->current_printer == printer && gtk_printer_has_details (printer))
            __gtk_dialog_set_response_sensitive (GTK_DIALOG (dialog), GTK_RESPONSE_OK, TRUE);
        }
    }
      ...
      if (!priv->page_setup_set)
        {
          ...
          if (page_setup && priv->page_setup)
            __gtk_page_setup_set_orientation (page_setup, __gtk_page_setup_get_orientation (priv->page_setup));
                     ...
                     GtkPrintUnixDialog *dialog)
{
  ...
  __gtk_widget_queue_draw (priv->collate_image);
}
            ...
            gint       text_x)
{
  ...
  __gdk_cairo_set_source_color (cr, &gtk_widget_get_props (widget)->style->base[GTK_STATE_NORMAL]);
  cairo_rectangle (cr, x, y, width, height);
  cairo_fill (cr);

  __gdk_cairo_set_source_color (cr, &gtk_widget_get_props (widget)->style->text[GTK_STATE_NORMAL]);
                 ...
                 GtkPrintUnixDialog *dialog)
{
  ...
  rtl = (__gtk_widget_get_direction (GTK_WIDGET (widget)) == GTK_TEXT_DIR_RTL);
  ...
  if (__gtk_widget_has_screen (widget))
    {
      ...
      __gtk_widget_set_size_request (priv->collate_image,
                                   (50 + 20) * scale,
                                   (15 + 26) * scale);
    }
}
                          ...
                          GtkWidget *range)
{
  ...
  active = __gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (button));

  __gtk_widget_set_sensitive (range, active);

  if (active)
    __gtk_widget_grab_focus (range);
}
                  ...
                  gpointer          *user_data)
{
  ...
  __gtk_dialog_response (GTK_DIALOG (print_dialog), GTK_RESPONSE_OK);
}
...
create_main_page (GtkPrintUnixDialog *dialog)
{
  ...
  __gtk_container_set_border_width (GTK_CONTAINER (main_vbox), 12);
  __gtk_widget_show (main_vbox);

  vbox = __gtk_vbox_new (FALSE, 6);
  __gtk_box_pack_start (GTK_BOX (main_vbox), vbox, TRUE, TRUE, 0);
  ...
  treeview = __gtk_tree_view_new_with_model ((GtkTreeModel *) priv->printer_list_filter);
  priv->printer_treeview = treeview;
  __gtk_tree_view_set_headers_visible (GTK_TREE_VIEW (treeview), TRUE);
  __gtk_tree_view_set_search_column (GTK_TREE_VIEW (treeview), PRINTER_LIST_COL_NAME);
  __gtk_tree_view_set_enable_search (GTK_TREE_VIEW (treeview), TRUE);
  ...
  column = __gtk_tree_view_column_new_with_attributes ("",
                                                     renderer,
                                                     "icon-name",
                                                     PRINTER_LIST_COL_ICON,
                                                     NULL);
  __gtk_tree_view_column_set_cell_data_func (column, renderer, set_cell_sensitivity_func, NULL, NULL);
  __gtk_tree_view_append_column (GTK_TREE_VIEW (treeview), column);

  renderer = __gtk_cell_renderer_text_new ();
  column = __gtk_tree_view_column_new_with_attributes (_("Printer"),
                                                     renderer,
                                                     "text",
                                                     PRINTER_LIST_COL_NAME,
                                                     NULL);
  ...
  column = __gtk_tree_view_column_new_with_attributes (_("Location"),
                                                     renderer,
                                                     "text",
                                                     PRINTER_LIST_COL_LOCATION,
                                                     NULL);
  ...
  column = __gtk_tree_view_column_new_with_attributes (_("Status"),
                                                     renderer,
                                                     "text",
                                                     PRINTER_LIST_COL_STATE,
                                                     NULL);
  ...
  custom_input = __gtk_hbox_new (FALSE, 18);
  __gtk_widget_show (custom_input);
  __gtk_box_pack_start (GTK_BOX (vbox), custom_input, FALSE, FALSE, 0);
  priv->extension_point = custom_input;

  hbox = __gtk_hbox_new (FALSE, 18);
  __gtk_widget_show (hbox);
  __gtk_box_pack_start (GTK_BOX (main_vbox), hbox, FALSE, FALSE, 0);

  table = __gtk_table_new (4, 2, FALSE);
  priv->range_table = table;
  __gtk_table_set_row_spacings (GTK_TABLE (table), 6);
  __gtk_table_set_col_spacings (GTK_TABLE (table), 12);
  frame = wrap_in_frame (_("Range"), table);
  __gtk_box_pack_start (GTK_BOX (hbox), frame, TRUE, TRUE, 0);
  __gtk_widget_show (table);

  radio = __gtk_radio_button_new_with_mnemonic (NULL, _("_All Pages"));
  priv->all_pages_radio = radio;
  __gtk_widget_show (radio);
  __gtk_table_attach (GTK_TABLE (table), radio,
                    0, 2, 0, 1,  GTK_FILL, 0,
                    0, 0);
  radio = __gtk_radio_button_new_with_mnemonic (__gtk_radio_button_get_group (GTK_RADIO_BUTTON (radio)),
                                              _("C_urrent Page"));
  if (priv->current_page == -1)
    __gtk_widget_set_sensitive (radio, FALSE);
  ...
  __gtk_widget_set_sensitive (radio, priv->has_selection);
  priv->selection_radio = radio;
  __gtk_table_attach (GTK_TABLE (table), radio,
                    0, 2, 2, 3,  GTK_FILL, 0,
                    0, 0);
  __gtk_table_set_row_spacing (GTK_TABLE (table), 2, 0);

  radio = __gtk_radio_button_new_with_mnemonic (__gtk_radio_button_get_group (GTK_RADIO_BUTTON (radio)), _("Pag_es:"));
  range_tooltip = _("Specify one or more page ranges,\n e.g. 1-3,7,11");
  __gtk_widget_set_tooltip_text (radio, range_tooltip);
  ...
  __gtk_widget_set_tooltip_text (entry, range_tooltip);
  __gtk_entry_set_activates_default (GTK_ENTRY (entry), TRUE);
  atk_object_set_name (__gtk_widget_get_accessible (entry), _("Pages"));
  atk_object_set_description (__gtk_widget_get_accessible (entry), range_tooltip);
  priv->page_range_entry = entry;
  __gtk_widget_show (entry);
  __gtk_table_attach (GTK_TABLE (table), entry,
                    1, 2, 3, 4,  GTK_FILL, 0,
                    0, 0);
  g_signal_connect (radio, "toggled", G_CALLBACK (update_entry_sensitivity), entry);
  update_entry_sensitivity (radio, entry);

  table = __gtk_table_new (3, 2, FALSE);
  __gtk_table_set_row_spacings (GTK_TABLE (table), 6);
  __gtk_table_set_col_spacings (GTK_TABLE (table), 12);
  ...
  label = __gtk_label_new_with_mnemonic (_("Copie_s:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 0, 1,  GTK_FILL, 0,
                    0, 0);
  spinbutton = __gtk_spin_button_new_with_range (1.0, 100.0, 1.0);
  __gtk_entry_set_activates_default (GTK_ENTRY (spinbutton), TRUE);
  priv->copies_spin = spinbutton;
  __gtk_widget_show (spinbutton);
  __gtk_table_attach (GTK_TABLE (table), spinbutton,
                    1, 2, 0, 1,  GTK_FILL, 0,
                    0, 0);
  __gtk_label_set_mnemonic_widget (GTK_LABEL (label), spinbutton);
  ...
  check = __gtk_check_button_new_with_mnemonic (_("C_ollate"));
  priv->collate_check = check;
  g_signal_connect (check, "toggled", G_CALLBACK (update_collate_icon), dialog);
  __gtk_widget_show (check);
  __gtk_table_attach (GTK_TABLE (table), check,
                    0, 1, 1, 2,  GTK_FILL, 0,
                    0, 0);

  check = __gtk_check_button_new_with_mnemonic (_("_Reverse"));
  g_signal_connect (check, "toggled", G_CALLBACK (update_collate_icon), dialog);
  ...
  image = __gtk_drawing_area_new ();
  __gtk_widget_set_has_window (image, FALSE);

  priv->collate_image = image;
  __gtk_widget_show (image);
  __gtk_widget_set_size_request (image, 70, 90);
  __gtk_table_attach (GTK_TABLE (table), image,
                    1, 2, 1, 3, GTK_FILL, 0,
                    0, 0);
  g_signal_connect (image, "expose-event",
                    G_CALLBACK (draw_collate_cb), dialog);

  label = __gtk_label_new (_("General"));
  __gtk_widget_show (label);

  __gtk_notebook_append_page (GTK_NOTEBOOK (priv->notebook), main_vbox, label);
}
                        ...
                        gint               *n_ranges_out)
{
  ...
  text = __gtk_entry_get_text (GTK_ENTRY (priv->page_range_entry));
                        ...
                        gint                n_ranges)
{
  ...
  __gtk_entry_set_text (GTK_ENTRY (priv->page_range_entry), s->str);
...
dialog_get_print_pages (GtkPrintUnixDialog *dialog)
{
  ...
  if (__gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (priv->all_pages_radio)))
    return GTK_PRINT_PAGES_ALL;
  else if (__gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (priv->current_page_radio)))
    return GTK_PRINT_PAGES_CURRENT;
  else if (__gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (priv->selection_radio)))
                        ...
                        GtkPrintPages       pages)
{
  ...
  if (pages == GTK_PRINT_PAGES_RANGES)
    __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->page_range_radio), TRUE);
  else if (pages == GTK_PRINT_PAGES_CURRENT)
    __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->current_page_radio), TRUE);
  else if (pages == GTK_PRINT_PAGES_SELECTION)
    __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->selection_radio), TRUE);
  else
    __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (priv->all_pages_radio), TRUE);
}

static gdouble
dialog_get_scale (GtkPrintUnixDialog *dialog)
{
  if (__gtk_widget_is_sensitive (gtk_print_unix_dialog_get_props (dialog)->priv->scale_spin))
    return __gtk_spin_button_get_value (GTK_SPIN_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->scale_spin));
  else
    return 100.0;
}
...
dialog_set_scale (GtkPrintUnixDialog *dialog,
                  gdouble             val)
{
  __gtk_spin_button_set_value (GTK_SPIN_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->scale_spin), val);
}

static GtkPageSet
dialog_get_page_set (GtkPrintUnixDialog *dialog)
{
  if (__gtk_widget_is_sensitive (gtk_print_unix_dialog_get_props (dialog)->priv->page_set_combo))
    return (GtkPageSet)__gtk_combo_box_get_active (GTK_COMBO_BOX (gtk_print_unix_dialog_get_props (dialog)->priv->page_set_combo));
  else
...
dialog_set_page_set (GtkPrintUnixDialog *dialog,
                     GtkPageSet          val)
{
  __gtk_combo_box_set_active (GTK_COMBO_BOX (gtk_print_unix_dialog_get_props (dialog)->priv->page_set_combo),
                            (int)val);
}
...
{
  if (__gtk_widget_is_sensitive (gtk_print_unix_dialog_get_props (dialog)->priv->copies_spin))
    return __gtk_spin_button_get_value_as_int (GTK_SPIN_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->copies_spin));
  return 1;
}
...
dialog_set_n_copies (GtkPrintUnixDialog *dialog,
                     gint                n_copies)
{
  __gtk_spin_button_set_value (GTK_SPIN_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->copies_spin),
                             n_copies);
}
...
{
  if (__gtk_widget_is_sensitive (gtk_print_unix_dialog_get_props (dialog)->priv->collate_check))
    return __gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->collate_check));
  return FALSE;
}
...
dialog_set_collate (GtkPrintUnixDialog *dialog,
                    gboolean            collate)
{
  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->collate_check),
                                collate);
}
...
{
  if (__gtk_widget_is_sensitive (gtk_print_unix_dialog_get_props (dialog)->priv->reverse_check))
    return __gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->reverse_check));
  return FALSE;
}
...
dialog_set_reverse (GtkPrintUnixDialog *dialog,
                    gboolean            reverse)
{
  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (gtk_print_unix_dialog_get_props (dialog)->priv->reverse_check),
                                reverse);
}
...
dialog_get_number_up_layout (GtkPrintUnixDialog *dialog)
{
  ...
  if (__gtk_widget_get_direction (GTK_WIDGET (dialog)) == GTK_TEXT_DIR_LTR)
  ...
  if (val[0] == '\0' && priv->options)
    {
      ...
      if (option)
        val = gtk_printer_option_get_props (option)->value;
    }
              ...
              GtkPrintUnixDialog *dialog)
{
  ...
  orientation = __gtk_page_setup_get_orientation (priv->page_setup);
  landscape =
  ...
  if (page_setup != NULL)
    {
      if (!landscape)
        {
          paper_width = __gtk_page_setup_get_paper_width (page_setup, GTK_UNIT_MM);
          paper_height = __gtk_page_setup_get_paper_height (page_setup, GTK_UNIT_MM);
        }
      else
        {
          paper_width = __gtk_page_setup_get_paper_height (page_setup, GTK_UNIT_MM);
          paper_height = __gtk_page_setup_get_paper_width (page_setup, GTK_UNIT_MM);
        }
  ...
  pos_x = gtk_widget_get_props (widget)->allocation.x + (gtk_widget_get_props (widget)->allocation.width - w) / 2;
  pos_y = gtk_widget_get_props (widget)->allocation.y + (gtk_widget_get_props (widget)->allocation.height - h) / 2 - 10;
  ...
  if (page_setup != NULL)
    {
      ...
      if (pages_per_sheet == 2 || pages_per_sheet == 6)
        {
          paper_width = __gtk_page_setup_get_paper_height (page_setup, _gtk_print_get_default_user_units ());
          paper_height = __gtk_page_setup_get_paper_width (page_setup, _gtk_print_get_default_user_units ());
        }
      else
        {
          paper_width = __gtk_page_setup_get_paper_width (page_setup, _gtk_print_get_default_user_units ());
          paper_height = __gtk_page_setup_get_paper_height (page_setup, _gtk_print_get_default_user_units ());
        }
      ...
      pango_c = __gtk_widget_get_pango_context (widget);
      if (pango_c != NULL)
        {
      ...
      ltr = __gtk_widget_get_direction (GTK_WIDGET (dialog)) == GTK_TEXT_DIR_LTR;

      if (ltr)
        cairo_translate (cr, pos_x - layout_w / PANGO_SCALE - 2 * RULER_DISTANCE,
                             gtk_widget_get_props (widget)->allocation.y + (gtk_widget_get_props (widget)->allocation.height - layout_h / PANGO_SCALE) / 2);
      else
      ...
      cairo_translate (cr, gtk_widget_get_props (widget)->allocation.x + (gtk_widget_get_props (widget)->allocation.width - layout_w / PANGO_SCALE) / 2,
...
redraw_page_layout_preview (GtkPrintUnixDialog *dialog)
{
  ...
  if (priv->page_layout_preview)
    __gtk_widget_queue_draw (priv->page_layout_preview);
}
...
update_number_up_layout (GtkPrintUnixDialog *dialog)
{
  ...
  if (caps & GTK_PRINT_CAPABILITY_NUMBER_UP_LAYOUT)
    {
      ...
      page_orientation = __gtk_page_setup_get_orientation (priv->page_setup);
  ...
  if (priv->number_up_layout != NULL)
    __gtk_widget_set_sensitive (GTK_WIDGET (priv->number_up_layout),
				 ...
				 gpointer   user_data)
{
          ...
          do
            {
              ...
              if (page_setup &&
                  g_strcmp0 (__gtk_paper_size_get_display_name (__gtk_page_setup_get_paper_size (page_setup)),
                             __gtk_paper_size_get_display_name (__gtk_page_setup_get_paper_size (priv->page_setup))) == 0)
  ...
  __gtk_widget_destroy (GTK_WIDGET (custom_paper_dialog));
}
                     ...
                     GtkPrintUnixDialog *dialog)
{
  ...
  orientation = (GtkPageOrientation) __gtk_combo_box_get_active (GTK_COMBO_BOX (priv->orientation_combo));

  if (priv->page_setup)
    {
      page_setup = __gtk_page_setup_copy (priv->page_setup);
      if (page_setup)
        __gtk_page_setup_set_orientation (page_setup, orientation);
                    ...
                    GtkPrintUnixDialog *dialog)
{
  ...
  if (__gtk_combo_box_get_active_iter (combo_box, &iter))
    {
      __gtk_tree_model_get (__gtk_combo_box_get_model (combo_box),
      ...
      if (page_setup == NULL)
        {
          ...
          if (priv->page_setup)
            ...
            last_page_setup = __gtk_page_setup_new (); /* "good" default */
          ...
          __gtk_window_present (GTK_WINDOW (custom_paper_dialog));
                             ...
                             gpointer      data)
{
  ...
  __gtk_tree_model_get (model, iter, PAGE_SETUP_LIST_COL_IS_SEPARATOR, &separator, -1);
  return separator;
}
...
create_page_setup_page (GtkPrintUnixDialog *dialog)
{
  ...
  label = __gtk_label_new_with_mnemonic (_("T_wo-sided:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 0, 1,  GTK_FILL, 0,
  ...
  label = __gtk_label_new_with_mnemonic (_("Pages per _side:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 1, 2,  GTK_FILL, 0,
  ...
  label = __gtk_label_new_with_mnemonic (_("Page or_dering:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 2, 3,  GTK_FILL, 0,
  ...
  label = __gtk_label_new_with_mnemonic (_("_Only print:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 3, 4,  GTK_FILL, 0,
  ...
  combo = __gtk_combo_box_text_new ();
  priv->page_set_combo = combo;
  __gtk_widget_show (combo);
  __gtk_table_attach (GTK_TABLE (table), combo,
                    1, 2, 3, 4,  GTK_FILL, 0,
                    0, 0);
  __gtk_label_set_mnemonic_widget (GTK_LABEL (label), combo);
  /* In enum order */
  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("All sheets"));
  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Even sheets"));
  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Odd sheets"));
  __gtk_combo_box_set_active (GTK_COMBO_BOX (combo), 0);

  label = __gtk_label_new_with_mnemonic (_("Sc_ale:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 4, 5,  GTK_FILL, 0,
  ...
  hbox2 = __gtk_hbox_new (FALSE, 6);
  __gtk_widget_show (hbox2);
  __gtk_table_attach (GTK_TABLE (table), hbox2,
                    1, 2, 4, 5,  GTK_FILL, 0,
                    0, 0);

  spinbutton = __gtk_spin_button_new_with_range (1.0, 1000.0, 1.0);
  priv->scale_spin = spinbutton;
  __gtk_spin_button_set_digits (GTK_SPIN_BUTTON (spinbutton), 1);
  __gtk_spin_button_set_value (GTK_SPIN_BUTTON (spinbutton), 100.0);
  __gtk_box_pack_start (GTK_BOX (hbox2), spinbutton, FALSE, FALSE, 0);
  __gtk_label_set_mnemonic_widget (GTK_LABEL (label), spinbutton);
  __gtk_widget_show (spinbutton);
  label = __gtk_label_new ("%"); /* FIXMEchpe does there exist any language where % needs to be translated? */
  __gtk_widget_show (label);
  __gtk_box_pack_start (GTK_BOX (hbox2), label, FALSE, FALSE, 0);

  table = __gtk_table_new (4, 2, FALSE);
  __gtk_table_set_row_spacings (GTK_TABLE (table), 6);
  __gtk_table_set_col_spacings (GTK_TABLE (table), 12);
  frame = wrap_in_frame (_("Paper"), table);
  __gtk_box_pack_start (GTK_BOX (hbox), frame, TRUE, TRUE, 6);
  __gtk_widget_show (table);

  label = __gtk_label_new_with_mnemonic (_("Paper _type:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 0, 1,  GTK_FILL, 0,
  ...
  label = __gtk_label_new_with_mnemonic (_("Paper _source:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 1, 2,  GTK_FILL, 0,
  ...
  label = __gtk_label_new_with_mnemonic (_("Output t_ray:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 2, 3,  GTK_FILL, 0,
  ...
  label = __gtk_label_new_with_mnemonic (_("_Paper size:"));
  ...
  combo = __gtk_combo_box_new_with_model (GTK_TREE_MODEL (priv->page_setup_list));
  priv->paper_size_combo = GTK_WIDGET (combo);
  __gtk_combo_box_set_row_separator_func (GTK_COMBO_BOX (combo), 
  ...
  __gtk_table_attach (GTK_TABLE (table), combo,
		    ...
		    0, 0);
  __gtk_label_set_mnemonic_widget (GTK_LABEL (label), combo);
  __gtk_widget_set_sensitive (combo, FALSE);
  __gtk_widget_show (combo);


  label = __gtk_label_new_with_mnemonic (_("Or_ientation:"));
  ...
  __gtk_label_set_mnemonic_widget (GTK_LABEL (label), combo);
  /* In enum order */
  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Portrait"));
  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Landscape"));
  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Reverse portrait"));
  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Reverse landscape"));
  __gtk_combo_box_set_active (GTK_COMBO_BOX (combo), 0);
  __gtk_widget_set_sensitive (combo, FALSE);
  __gtk_widget_show (combo);
  ...
  hbox2 = __gtk_hbox_new (FALSE, 0);
  __gtk_widget_show (hbox2);
  __gtk_box_pack_start (GTK_BOX (main_vbox), hbox2, TRUE, TRUE, 0);

  draw = __gtk_drawing_area_new ();
  __gtk_widget_set_has_window (draw, FALSE);
  priv->page_layout_preview = draw;
  __gtk_widget_set_size_request (draw, 280, 160);
  g_signal_connect (draw, "expose-event", G_CALLBACK (draw_page_cb), dialog);
  __gtk_widget_show (draw);

  __gtk_box_pack_start (GTK_BOX (hbox2), draw, TRUE, FALSE, 0);

  label = __gtk_label_new (_("Page Setup"));
  __gtk_widget_show (label);

  __gtk_notebook_append_page (GTK_NOTEBOOK (priv->notebook),
                            main_vbox, label);
}
...
create_job_page (GtkPrintUnixDialog *dialog)
{
  ...
  main_table = __gtk_table_new (2, 2, FALSE);
  __gtk_container_set_border_width (GTK_CONTAINER (main_table), 12);
  __gtk_table_set_row_spacings (GTK_TABLE (main_table), 18);
  __gtk_table_set_col_spacings (GTK_TABLE (main_table), 18);

  table = __gtk_table_new (2, 2, FALSE);
  __gtk_table_set_row_spacings (GTK_TABLE (table), 6);
  __gtk_table_set_col_spacings (GTK_TABLE (table), 12);
  frame = wrap_in_frame (_("Job Details"), table);
  __gtk_table_attach (GTK_TABLE (main_table), frame,
                    0, 1, 0, 1,  GTK_FILL, 0,
                    0, 0);
  __gtk_widget_show (table);

  label = __gtk_label_new_with_mnemonic (_("Pri_ority:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 0, 1,  GTK_FILL, 0,
  ...
  label = __gtk_label_new_with_mnemonic (_("_Billing info:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 1, 2,  GTK_FILL, 0,
   ...
   * in the print dialog
   */
  radio = __gtk_radio_button_new_with_mnemonic (NULL, _("_Now"));
  ...
  __gtk_widget_set_tooltip_text (radio, at_tooltip);
  ...
  entry = __gtk_entry_new ();
  __gtk_widget_set_tooltip_text (entry, at_tooltip);
  atk_object_set_name (__gtk_widget_get_accessible (entry), _("Time of print"));
  atk_object_set_description (__gtk_widget_get_accessible (entry), at_tooltip);
  ...
  __gtk_widget_set_tooltip_text (radio, on_hold_tooltip);
   ...
   */
  label = __gtk_label_new_with_mnemonic (_("Be_fore:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 0, 1,  GTK_FILL, 0,
   ...
   */
  label = __gtk_label_new_with_mnemonic (_("_After:"));
  __gtk_misc_set_alignment (GTK_MISC (label), 0.0, 0.5);
  __gtk_widget_show (label);
  __gtk_table_attach (GTK_TABLE (table), label,
                    0, 1, 1, 2,  GTK_FILL, 0,
                      ...
                      GtkWidget          **page_out)
{
  ...
  __gtk_table_set_row_spacings (GTK_TABLE (table), 6);
  __gtk_table_set_col_spacings (GTK_TABLE (table), 12);
  __gtk_container_set_border_width (GTK_CONTAINER (table), 12);
  __gtk_widget_show (table);
...
create_advanced_page (GtkPrintUnixDialog *dialog)
{
  ...
  label = __gtk_label_new (_("Advanced"));
  __gtk_widget_show (label);
...
populate_dialog (GtkPrintUnixDialog *print_dialog)
{
  ...
  vbox = __gtk_vbox_new (FALSE, 6);
  __gtk_container_set_border_width (GTK_CONTAINER (vbox), 5);
  __gtk_box_pack_start (GTK_BOX (gtk_dialog_get_props (dialog)->vbox), vbox, TRUE, TRUE, 0);
  __gtk_widget_show (vbox);

  priv->notebook = __gtk_notebook_new ();
  __gtk_box_pack_start (GTK_BOX (vbox), priv->notebook, TRUE, TRUE, 0);
  __gtk_widget_show (priv->notebook);
  ...
  priv->conflicts_widget = conflict_hbox = __gtk_hbox_new (FALSE, 12);
  __gtk_box_pack_end (GTK_BOX (vbox), conflict_hbox, FALSE, FALSE, 0);
  image = __gtk_image_new_from_stock (GTK_STOCK_DIALOG_WARNING, GTK_ICON_SIZE_MENU);
  __gtk_widget_show (image);
  __gtk_box_pack_start (GTK_BOX (conflict_hbox), image, FALSE, TRUE, 0);
  label = __gtk_label_new (_("Some of the settings in the dialog conflict"));
  __gtk_widget_show (label);
  __gtk_box_pack_start (GTK_BOX (conflict_hbox), label, FALSE, TRUE, 0);
...
gtk_print_unix_dialog_get_selected_printer (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->current_printer;
}
                                      ...
                                      GtkPageSetup       *page_setup)
{
  ...
  priv = gtk_print_unix_dialog_get_props (dialog)->priv;
...
gtk_print_unix_dialog_get_page_setup (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->page_setup;
}
...
gtk_print_unix_dialog_get_page_setup_set (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->page_setup_set;
}
  ...
  if (priv->current_page != current_page)
    {
      ...
      if (priv->current_page_radio)
        __gtk_widget_set_sensitive (priv->current_page_radio, current_page != -1);
...
gtk_print_unix_dialog_get_current_page (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->current_page;
}
  ...
  if (__gtk_tree_model_get_iter_first (model, &iter))
    {
      do
        {
          __gtk_tree_model_get (GTK_TREE_MODEL (priv->printer_list), &iter,
                                    ...
                                    GtkPrintSettings   *settings)
{
  ...
  if (settings != NULL)
    {
      dialog_set_collate (dialog, __gtk_print_settings_get_collate (settings));
      dialog_set_reverse (dialog, __gtk_print_settings_get_reverse (settings));
      dialog_set_n_copies (dialog, __gtk_print_settings_get_n_copies (settings));
      dialog_set_scale (dialog, __gtk_print_settings_get_scale (settings));
      dialog_set_page_set (dialog, __gtk_print_settings_get_page_set (settings));
      dialog_set_print_pages (dialog, __gtk_print_settings_get_print_pages (settings));
      ranges = __gtk_print_settings_get_page_ranges (settings, &num_ranges);
      if (ranges)
        {
      ...
      priv->format_for_printer =
        g_strdup (__gtk_print_settings_get (settings, "format-for-printer"));
    }
  ...
  if (settings)
    {
      ...
      printer = __gtk_print_settings_get_printer (settings);
...
gtk_print_unix_dialog_get_settings (GtkPrintUnixDialog *dialog)
{
  ...
  priv = gtk_print_unix_dialog_get_props (dialog)->priv;
  settings = __gtk_print_settings_new ();

  if (priv->current_printer)
    __gtk_print_settings_set_printer (settings,
                                    gtk_printer_get_name (priv->current_printer));
  else
    __gtk_print_settings_set_printer (settings, "default");

  __gtk_print_settings_set (settings, "format-for-printer",
                          priv->format_for_printer);

  __gtk_print_settings_set_collate (settings,
                                  dialog_get_collate (dialog));

  __gtk_print_settings_set_reverse (settings,
                                  dialog_get_reverse (dialog));

  __gtk_print_settings_set_n_copies (settings,
                                   dialog_get_n_copies (dialog));

  __gtk_print_settings_set_scale (settings,
                                dialog_get_scale (dialog));

  __gtk_print_settings_set_page_set (settings,
                                   dialog_get_page_set (dialog));

  print_pages = dialog_get_print_pages (dialog);
  __gtk_print_settings_set_print_pages (settings, print_pages);

  ranges = dialog_get_page_ranges (dialog, &n_ranges);
  if (ranges)
    {
      __gtk_print_settings_set_page_ranges  (settings, ranges, n_ranges);
      g_free (ranges);
    }
...
gtk_print_unix_dialog_add_custom_tab (GtkPrintUnixDialog *dialog,
                                      ...
                                      GtkWidget          *tab_label)
{
  __gtk_notebook_insert_page (GTK_NOTEBOOK (gtk_print_unix_dialog_get_props (dialog)->priv->notebook),
                            child, tab_label, 2);
...
gtk_print_unix_dialog_get_manual_capabilities (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->manual_capabilities;
}
      ...
      if (priv->selection_radio)
        {
          if (support_selection)
            {
              __gtk_widget_set_sensitive (priv->selection_radio, priv->has_selection);
              __gtk_table_set_row_spacing (GTK_TABLE (priv->range_table),
                                         2,
                                         __gtk_table_get_default_row_spacing (GTK_TABLE (priv->range_table)));
              __gtk_widget_show (priv->selection_radio);
            }
          else
            {
              __gtk_widget_set_sensitive (priv->selection_radio, FALSE);
              __gtk_table_set_row_spacing (GTK_TABLE (priv->range_table), 2, 0);
              __gtk_widget_hide (priv->selection_radio);
            }
        }
...
gtk_print_unix_dialog_get_support_selection (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->support_selection;
}
      ...
      if (priv->selection_radio)
        {
          if (priv->support_selection)
            __gtk_widget_set_sensitive (priv->selection_radio, has_selection);
          else
            __gtk_widget_set_sensitive (priv->selection_radio, FALSE);
        }
...
gtk_print_unix_dialog_get_has_selection (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->has_selection;
}
  ...
  if (priv->embed_page_setup != embed)
    {
      ...
      __gtk_widget_set_sensitive (priv->paper_size_combo, priv->embed_page_setup);
      __gtk_widget_set_sensitive (priv->orientation_combo, priv->embed_page_setup);
...
gtk_print_unix_dialog_get_embed_page_setup (GtkPrintUnixDialog *dialog)
{
  ...
  return gtk_print_unix_dialog_get_props (dialog)->priv->embed_page_setup;
}
