		     ...
		     gint    spacing)
{
  ...
  if (spacing != box->spacing)
    {
      box->spacing = spacing;
      ______gtk_box_set_spacing_set (box, TRUE);
...
void
______gtk_box_set_spacing_set (GtkBox  *box,
...
gboolean
______gtk_box_get_spacing_set (GtkBox *box)
{
  GtkBoxPrivate *private;
...
void
______gtk_box_set_old_defaults (GtkBox *box)
{
  GtkBoxPrivate *private;
