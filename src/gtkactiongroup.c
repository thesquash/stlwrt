...
gtk_action_group_init (GtkActionGroup *self)
{
  ...
  private = gtk_action_group_get_instance_private (self);
...
gtk_action_group_buildable_add_child (GtkBuildable  *buildable,
				      ...
				      const gchar   *type)
{
  __gtk_action_group_add_action_with_accel (GTK_ACTION_GROUP (buildable),
				     ...
				     const gchar  *name)
{
  ...
  GtkActionGroupPrivate *private = gtk_action_group_get_instance_private (self);
  ...
  if (strcmp (tagname, "accelerator") == 0)
    {
      ...
      private = gtk_action_group_get_instance_private (action_group);
      action = GTK_ACTION (child);
	
      accel_path = g_strconcat ("<Actions>/",
				private->name, "/",
				__gtk_action_get_name (action), NULL);

      if (__gtk_accel_map_lookup_entry (accel_path, NULL))
	__gtk_accel_map_change_entry (accel_path, data->key, data->modifiers, TRUE);
      else
	__gtk_accel_map_add_entry (accel_path, data->key, data->modifiers);

      __gtk_action_set_accel_path (action, accel_path);
 ...
 */
GtkActionGroup *
__gtk_action_group_new (const gchar *name)
{
  GtkActionGroup *self;
  GtkActionGroupPrivate *private;
			       ...
			       GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_NAME:
      ...
      break;
    case PROP_SENSITIVE:
      __gtk_action_group_set_sensitive (self, g_value_get_boolean (value));
      break;
    case PROP_VISIBLE:
      __gtk_action_group_set_visible (self, g_value_get_boolean (value));
      break;
    default:
 ...
 */
const gchar *
__gtk_action_group_get_name (GtkActionGroup *action_group)
{
  GtkActionGroupPrivate *private;
...
/**
 * __gtk_action_group_get_sensitive:
 * @action_group: the action group
 *
 * Returns %TRUE if the group is sensitive.  The constituent actions
 * can only be logically sensitive (see __gtk_action_is_sensitive()) if
 * they are sensitive (see __gtk_action_get_sensitive()) and their group
 * is sensitive.
 * 
 ...
 */
gboolean
__gtk_action_group_get_sensitive (GtkActionGroup *action_group)
{
  GtkActionGroupPrivate *private;
...
/**
 * __gtk_action_group_set_sensitive:
 * @action_group: the action group
 ...
 */
void
__gtk_action_group_set_sensitive (GtkActionGroup *action_group, 
				gboolean        sensitive)
{
  GtkActionGroupPrivate *private;
...
/**
 * __gtk_action_group_get_visible:
 * @action_group: the action group
 *
 * Returns %TRUE if the group is visible.  The constituent actions
 * can only be logically visible (see __gtk_action_is_visible()) if
 * they are visible (see __gtk_action_get_visible()) and their group
 * is visible.
 * 
 ...
 */
gboolean
__gtk_action_group_get_visible (GtkActionGroup *action_group)
{
  GtkActionGroupPrivate *private;
...
/**
 * __gtk_action_group_set_visible:
 * @action_group: the action group
 ...
 */
void
__gtk_action_group_set_visible (GtkActionGroup *action_group, 
			      gboolean        visible)
{
  GtkActionGroupPrivate *private;
 ...
 */
GtkAction *
__gtk_action_group_get_action (GtkActionGroup *action_group,
			     const gchar    *action_name)
{
  g_return_val_if_fail (GTK_IS_ACTION_GROUP (action_group), NULL);
...
check_unique_action (GtkActionGroup *action_group,
	             const gchar    *action_name)
{
  if (__gtk_action_group_get_action (action_group, action_name) != NULL)
    {
      GtkActionGroupPrivate *private;
 ...
 * __gtk_action_set_accel_path(), or use 
 * <literal>__gtk_action_group_add_action_with_accel (..., NULL)</literal>.
 *
 * Since: 2.4
 */
void
__gtk_action_group_add_action (GtkActionGroup *action_group,
			     GtkAction      *action)
{
  GtkActionGroupPrivate *private;
  const gchar *name;
  ...
  name = __gtk_action_get_name (action);
...
/**
 * __gtk_action_group_add_action_with_accel:
 * @action_group: the action group
 * @action: the action to add
 * @accelerator: (allow-none): the accelerator for the action, in
 *   the format understood by __gtk_accelerator_parse(), or "" for no accelerator, or
 ...
 */
void
__gtk_action_group_add_action_with_accel (GtkActionGroup *action_group,
					GtkAction      *action,
					const gchar    *accelerator)
{
  ...
  if (accelerator)
	...
	{
	  __gtk_accelerator_parse (accelerator, &accel_key, &accel_mods);
	  if (accel_key == 0)
  ...
  else 
    {
      ...
      if (stock_id && __gtk_stock_lookup (stock_id, &stock_item))
        {
  ...
  if (accel_key)
    __gtk_accel_map_add_entry (accel_path, accel_key, accel_mods);

  __gtk_action_set_accel_path (action, accel_path);
  __gtk_action_group_add_action (action_group, action);

  g_free (accel_path);
}

/**
 * __gtk_action_group_remove_action:
 * @action_group: the action group
 * @action: an action
 *
 ...
 */
void
__gtk_action_group_remove_action (GtkActionGroup *action_group,
				GtkAction      *action)
{
  GtkActionGroupPrivate *private;
  const gchar *name;
...
/**
 * __gtk_action_group_list_actions:
 * @action_group: the action group
 *
 ...
 */
GList *
__gtk_action_group_list_actions (GtkActionGroup *action_group)
{
  GtkActionGroupPrivate *private;
  GList *actions = NULL;
...
/**
 * __gtk_action_group_add_actions:
 * @action_group: the action group
 ...
 */
void
__gtk_action_group_add_actions (GtkActionGroup       *action_group,
			      const GtkActionEntry *entries,
			      guint                 n_entries,
			      gpointer              user_data)
{
  __gtk_action_group_add_actions_full (action_group, 
				     entries, n_entries, 
				     user_data, NULL);
}
...
/**
 * __gtk_action_group_add_actions_full:
 * @action_group: the action group
 * @entries: an array of action descriptions
 * @n_entries: the number of entries
 * @user_data: data to pass to the action callbacks
 ...
 *
 * This variant of __gtk_action_group_add_actions() adds a #GDestroyNotify
 * callback for @user_data. 
 * 
 * Since: 2.4
 */
void
__gtk_action_group_add_actions_full (GtkActionGroup       *action_group,
				   const GtkActionEntry *entries,
				   guint                 n_entries,
				   gpointer              user_data,
				   GDestroyNotify        destroy)
  ...
  for (i = 0; i < n_entries; i++)
    {
      ...
      label = __gtk_action_group_translate_string (action_group, entries[i].label);
      tooltip = __gtk_action_group_translate_string (action_group, entries[i].tooltip);

      action = __gtk_action_new (entries[i].name,
			       label,
			       tooltip,
			       NULL);
      ...
      if (entries[i].stock_id) 
	{
	  ...
	  if (__gtk_icon_theme_has_icon (__gtk_icon_theme_get_default (), 
				       entries[i].stock_id))
      ...
      if (entries[i].callback)
	{
      ...
      __gtk_action_group_add_action_with_accel (action_group, 
					      action,
...
/**
 * __gtk_action_group_add_toggle_actions:
 * @action_group: the action group
 ...
 */
void
__gtk_action_group_add_toggle_actions (GtkActionGroup             *action_group,
				     const GtkToggleActionEntry *entries,
				     guint                       n_entries,
				     gpointer                    user_data)
{
  __gtk_action_group_add_toggle_actions_full (action_group, 
					    entries, n_entries, 
					    user_data, NULL);
}
...
/**
 * __gtk_action_group_add_toggle_actions_full:
 * @action_group: the action group
 * @entries: an array of toggle action descriptions
 * @n_entries: the number of entries
 * @user_data: data to pass to the action callbacks
 * @destroy: destroy notification callback for @user_data
 *
 * This variant of __gtk_action_group_add_toggle_actions() adds a 
 * #GDestroyNotify callback for @user_data. 
 * 
 * Since: 2.4
 */
void
__gtk_action_group_add_toggle_actions_full (GtkActionGroup             *action_group,
					  const GtkToggleActionEntry *entries,
					  guint                       n_entries,
					  gpointer                    user_data,
					  GDestroyNotify              destroy)
  ...
  for (i = 0; i < n_entries; i++)
    {
      ...
      action = __gtk_toggle_action_new (entries[i].name,
				      label,
				      tooltip,
				      NULL);
      ...
      if (entries[i].stock_id) 
	{
	  if (__gtk_icon_factory_lookup_default (entries[i].stock_id))
	    g_object_set (action, "stock-id", entries[i].stock_id, NULL);
	  else
	    g_object_set (action, "icon-name", entries[i].stock_id, NULL);
	}

      __gtk_toggle_action_set_active (action, entries[i].is_active);
...
/**
 * __gtk_action_group_add_radio_actions:
 * @action_group: the action group
 ...
 **/
void            
__gtk_action_group_add_radio_actions (GtkActionGroup            *action_group,
				    ...
				    gpointer                   user_data)
{
  __gtk_action_group_add_radio_actions_full (action_group, 
					   entries, n_entries, 
					   value,
...
/**
 * __gtk_action_group_add_radio_actions_full:
 * @action_group: the action group
 * @entries: an array of radio action descriptions
 * @n_entries: the number of entries
 * @value: the value of the action to activate initially, or -1 if
 ...
 * @destroy: destroy notification callback for @user_data
 *
 * This variant of __gtk_action_group_add_radio_actions() adds a 
 * #GDestroyNotify callback for @user_data. 
 * 
 * Since: 2.4
 **/
void            
__gtk_action_group_add_radio_actions_full (GtkActionGroup            *action_group,
					 const GtkRadioActionEntry *entries,
					 guint                      n_entries,
					 gint                       value,
					 GCallback                  on_change,
  ...
  for (i = 0; i < n_entries; i++)
    {
      ...
      action = __gtk_radio_action_new (entries[i].name,
				     label,
				     tooltip,
				     NULL,
				     entries[i].value);
...
/**
 * __gtk_action_group_set_translate_func:
 ...
 * #GtkActionGroupEntry<!-- -->s added by __gtk_action_group_add_actions().
 *
 * If you're using gettext(), it is enough to set the translation domain
 * with __gtk_action_group_set_translation_domain().
 *
 * Since: 2.4 
 **/
void
__gtk_action_group_set_translate_func (GtkActionGroup   *action_group,
...
/**
 * __gtk_action_group_set_translation_domain:
 * @action_group: a #GtkActionGroup
 ...
 **/
void 
__gtk_action_group_set_translation_domain (GtkActionGroup *action_group,
					 const gchar    *domain)
{
  g_return_if_fail (GTK_IS_ACTION_GROUP (action_group));

  __gtk_action_group_set_translate_func (action_group, 
...
/**
 * __gtk_action_group_translate_string:
 * @action_group: a #GtkActionGroup
 * @string: a string
 *
 ...
 **/
const gchar *
__gtk_action_group_translate_string (GtkActionGroup *action_group,
				   const gchar    *string)
{
  GtkActionGroupPrivate *private;
...
void
___gtk_action_group_emit_connect_proxy  (GtkActionGroup *action_group,
                                       GtkAction      *action,
                                       GtkWidget      *proxy)
{
...
void
___gtk_action_group_emit_disconnect_proxy  (GtkActionGroup *action_group,
                                          GtkAction      *action,
                                          GtkWidget      *proxy)
{
...
void
___gtk_action_group_emit_pre_activate  (GtkActionGroup *action_group,
				      GtkAction      *action)
{
...
void
___gtk_action_group_emit_post_activate (GtkActionGroup *action_group,
				      GtkAction      *action)
{
