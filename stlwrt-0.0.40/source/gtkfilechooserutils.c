...
delegate_select_file (GtkFileChooser    *chooser,
		      ...
		      GError           **error)
{
  return __gtk_file_chooser_select_file (get_delegate (chooser), file, error);
}
...
delegate_unselect_file (GtkFileChooser *chooser,
			GFile          *file)
{
  __gtk_file_chooser_unselect_file (get_delegate (chooser), file);
}

static void
delegate_select_all (GtkFileChooser *chooser)
{
  __gtk_file_chooser_select_all (get_delegate (chooser));
}

static void
delegate_unselect_all (GtkFileChooser *chooser)
{
  __gtk_file_chooser_unselect_all (get_delegate (chooser));
}

static GSList *
delegate_get_files (GtkFileChooser *chooser)
{
  return __gtk_file_chooser_get_files (get_delegate (chooser));
}

static GFile *
delegate_get_preview_file (GtkFileChooser *chooser)
{
  return __gtk_file_chooser_get_preview_file (get_delegate (chooser));
}
...
delegate_add_filter (GtkFileChooser *chooser,
		     GtkFileFilter  *filter)
{
  __gtk_file_chooser_add_filter (get_delegate (chooser), filter);
}
...
delegate_remove_filter (GtkFileChooser *chooser,
			GtkFileFilter  *filter)
{
  __gtk_file_chooser_remove_filter (get_delegate (chooser), filter);
}

static GSList *
delegate_list_filters (GtkFileChooser *chooser)
{
  return __gtk_file_chooser_list_filters (get_delegate (chooser));
}
...
delegate_set_current_folder (GtkFileChooser  *chooser,
			     ...
			     GError         **error)
{
  return __gtk_file_chooser_set_current_folder_file (get_delegate (chooser), file, error);
}

static GFile *
delegate_get_current_folder (GtkFileChooser *chooser)
{
  return __gtk_file_chooser_get_current_folder_file (get_delegate (chooser));
}
...
delegate_set_current_name (GtkFileChooser *chooser,
			   const gchar    *name)
{
  __gtk_file_chooser_set_current_name (get_delegate (chooser), name);
}
