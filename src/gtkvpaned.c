...
STLWRT_DEFINE_FTYPE_VPARENT (GtkVPaned, gtk_vpaned, GTK_TYPE_PANED, G_TYPE_FLAG_NONE, ;)
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (vpaned),
