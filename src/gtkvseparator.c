...
STLWRT_DEFINE_TYPE (GtkVSeparator, gtk_vseparator, GTK_TYPE_SEPARATOR)
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (vseparator),
                                  GTK_ORIENTATION_VERTICAL);
}

/**
 * __gtk_vseparator_new:
 *
