  ...
  if (accel && *accel)
    {
	  ...
	  menubars = ______gtk_container_focus_sort (GTK_CONTAINER (widget), tmp_menubars,
...
/**
 * ______gtk_menu_bar_cycle_focus:
 ...
 **/
void
______gtk_menu_bar_cycle_focus (GtkMenuBar       *menubar,
  ...
  if (__gtk_widget_is_toplevel (toplevel))
    {
      ...
      menubars = ______gtk_container_focus_sort (GTK_CONTAINER (toplevel), tmp_menubars,
