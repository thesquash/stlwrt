...
#define GTK_TOOLTIP_VISIBLE(tooltip) ((tooltip)->current_window && __gtk_widget_get_visible (GTK_WIDGET((tooltip)->current_window)))
                   ...
                   GtkTooltip *tooltip)
{
  ...
  screen = __gtk_widget_get_screen (window);

  cmap = NULL;
  if (__gdk_screen_is_composited (screen))
    cmap = __gdk_screen_get_rgba_colormap (screen);
  if (cmap == NULL)
    cmap = __gdk_screen_get_rgb_colormap (screen);

  __gtk_widget_set_colormap (window, cmap);
}
...
gtk_tooltip_init (GtkTooltip *tooltip)
{
  ...
  tooltip->window = g_object_ref (__gtk_window_new (GTK_WINDOW_POPUP));

  on_screen_changed (tooltip->window, NULL, tooltip);

  __gtk_window_set_type_hint (GTK_WINDOW (tooltip->window),
			    GDK_WINDOW_TYPE_HINT_TOOLTIP);

  __gtk_widget_set_app_paintable (tooltip->window, TRUE);
  __gtk_window_set_resizable (GTK_WINDOW (tooltip->window), FALSE);
  __gtk_widget_set_name (tooltip->window, "gtk-tooltip");
  ...
  tooltip->image = __gtk_image_new ();
  __gtk_box_pack_start (GTK_BOX (tooltip->box), tooltip->image,
		      FALSE, FALSE, 0);

  tooltip->label = __gtk_label_new ("");
  __gtk_label_set_line_wrap (GTK_LABEL (tooltip->label), TRUE);
  __gtk_box_pack_start (GTK_BOX (tooltip->box), tooltip->label,
		      FALSE, FALSE, 0);
...
gtk_tooltip_dispose (GObject *object)
{
  ...
  __gtk_tooltip_set_custom (tooltip, NULL);
  ...
  if (tooltip->window)
    {
      ...
      display = __gtk_widget_get_display (tooltip->window);
      g_signal_handlers_disconnect_by_func (display,
					    gtk_tooltip_display_closed,
					    tooltip);
      __gtk_widget_destroy (tooltip->window);
      tooltip->window = NULL;
    }
 ...
 */
void
__gtk_tooltip_set_markup (GtkTooltip  *tooltip,
			const gchar *markup)
{
  g_return_if_fail (GTK_IS_TOOLTIP (tooltip));

  __gtk_label_set_markup (GTK_LABEL (tooltip->label), markup);

  if (markup)
    __gtk_widget_show (tooltip->label);
  else
    __gtk_widget_hide (tooltip->label);
}
 ...
 * will be hidden. See also __gtk_tooltip_set_markup().
 *
 * Since: 2.12
 */
void
__gtk_tooltip_set_text (GtkTooltip  *tooltip,
                      const gchar *text)
{
  g_return_if_fail (GTK_IS_TOOLTIP (tooltip));

  __gtk_label_set_text (GTK_LABEL (tooltip->label), text);
 ...
 */
void
__gtk_tooltip_set_icon (GtkTooltip *tooltip,
		      GdkPixbuf  *pixbuf)
{
  g_return_if_fail (GTK_IS_TOOLTIP (tooltip));
  if (pixbuf)
  ...
  __gtk_image_set_from_pixbuf (GTK_IMAGE (tooltip->image), pixbuf);

  if (pixbuf)
    __gtk_widget_show (tooltip->image);
  else
    __gtk_widget_hide (tooltip->image);
}

/**
 * __gtk_tooltip_set_icon_from_stock:
 * @tooltip: a #GtkTooltip
 ...
 */
void
__gtk_tooltip_set_icon_from_stock (GtkTooltip  *tooltip,
				 const gchar *stock_id,
				 GtkIconSize  size)
{
  g_return_if_fail (GTK_IS_TOOLTIP (tooltip));

  __gtk_image_set_from_stock (GTK_IMAGE (tooltip->image), stock_id, size);
...
/**
 * __gtk_tooltip_set_icon_from_icon_name:
 * @tooltip: a #GtkTooltip
 ...
 */
void
__gtk_tooltip_set_icon_from_icon_name (GtkTooltip  *tooltip,
				     const gchar *icon_name,
				     GtkIconSize  size)
{
  g_return_if_fail (GTK_IS_TOOLTIP (tooltip));

  __gtk_image_set_from_icon_name (GTK_IMAGE (tooltip->image), icon_name, size);
...
/**
 * __gtk_tooltip_set_icon_from_gicon:
 * @tooltip: a #GtkTooltip
 ...
 */
void
__gtk_tooltip_set_icon_from_gicon (GtkTooltip  *tooltip,
				 GIcon       *gicon,
				 GtkIconSize  size)
{
  g_return_if_fail (GTK_IS_TOOLTIP (tooltip));

  __gtk_image_set_from_gicon (GTK_IMAGE (tooltip->image), gicon, size);
 ...
 * the tooltip, which can be configured using __gtk_tooltip_set_markup() 
 * and __gtk_tooltip_set_icon().

 *
 * Since: 2.12
 */
void
__gtk_tooltip_set_custom (GtkTooltip *tooltip,
			GtkWidget  *custom_widget)
{
  g_return_if_fail (GTK_IS_TOOLTIP (tooltip));
  if (custom_widget)
  ...
  if (tooltip->custom_widget)
    {
       ...
       * since __gtk_container_remove() will recurse into 
       * __gtk_tooltip_set_custom()
       */
      tooltip->custom_widget = NULL;
      __gtk_container_remove (GTK_CONTAINER (tooltip->box), custom);
  ...
  if (custom_widget)
    {
      ...
      __gtk_container_add (GTK_CONTAINER (tooltip->box), custom_widget);
      __gtk_widget_show (custom_widget);
    }
}
 ...
 * functions for this: __gtk_tree_view_set_tooltip_row() and
 * __gtk_tree_view_set_tooltip_cell().
 *
 * Since: 2.12
 */
void
__gtk_tooltip_set_tip_area (GtkTooltip         *tooltip,
...
/**
 * __gtk_tooltip_trigger_tooltip_query:
 ...
 */
void
__gtk_tooltip_trigger_tooltip_query (GdkDisplay *display)
{
  gint x, y;
  GdkWindow *window;
  GdkEvent event;
  ...
  window = __gdk_display_get_window_at_pointer (display, &x, &y);
  if (!window)
    return;
  ...
  __gdk_window_get_root_coords (window, x, y, &x, &y);
  event.motion.x_root = x;
  event.motion.y_root = y;

  ______gtk_tooltip_handle_event (&event);
}
...
{
  __gtk_tooltip_set_markup (tooltip, NULL);
  __gtk_tooltip_set_icon (tooltip, NULL);
  __gtk_tooltip_set_tip_area (tooltip, NULL);
                 ...
                 guchar      alpha)
{
  ...
  if (!__gtk_widget_is_composited (widget))
    alpha = 255;
...
update_shape (GtkTooltip *tooltip)
{
  ...
  __gtk_widget_style_get (tooltip->window,
                        "tooltip-radius", &tooltip_radius,
                        NULL);

  if (tooltip_radius == 0 ||
      __gtk_widget_is_composited (tooltip->window))
    {
      __gtk_widget_shape_combine_mask (tooltip->window, NULL, 0, 0);
      return;
    }
			...
			gpointer   data)
{
  ...
  if (!child_loc->child &&
      __gtk_widget_translate_coordinates (child_loc->container, child,
	  ...
	  if (GTK_IS_CONTAINER (child))
	    {
	      ...
	      __gtk_container_forall (GTK_CONTAINER (child),
 ...
 */
GtkWidget *
______gtk_widget_find_at_coords (GdkWindow *window,
                            gint       window_x,
                            gint       window_y,
                            gint      *widget_x,
                            gint      *widget_y)
{
  ...
  __gdk_window_get_user_data (window, (void **)&event_widget);
  ...
  g_print ("event window %p (belonging to %p (%s))  (%d, %d)\n",
	   window, event_widget, __gtk_widget_get_name (event_widget),
	   window_x, window_y);
#endif
  ...
  while (window && window != event_widget->window)
    {
      ...
      __gdk_window_coords_to_parent (window,
                                   child_loc.x, child_loc.y,
                                   &px, &py);
      child_loc.x = px;
      child_loc.y = py;
  ...
  if (GTK_IS_CONTAINER (event_widget))
    {
      ...
      __gtk_container_forall (GTK_CONTAINER (event_widget),
	...
	event_widget = child_loc.container;
      ...
      __gtk_widget_translate_coordinates (container, event_widget,
					child_loc.x, child_loc.y,
					&child_loc.x, &child_loc.y);
    }
				       ...
				       gint     *y)
{
  ...
  __gdk_event_get_coords (event, &dx, &dy);

  /* Returns coordinates relative to tmp's allocation. */
  tmp = ______gtk_widget_find_at_coords (event->any.window, dx, dy, &tx, &ty);
...
tooltip_browse_mode_expired (gpointer data)
{
  ...
  /* destroy tooltip */
  g_object_set_data (G_OBJECT (__gtk_widget_get_display (tooltip->window)),
                  ...
                  GdkRectangle *bounds)
{
  ...
  __gdk_window_get_root_coords (window, x, y + h, &x3, &y3);
  __gdk_window_get_root_coords (window, x + w, y + h, &x4, &y4);
		      ...
		      GtkWidget  *new_tooltip_widget)
{
  ...
  if (tooltip->keyboard_mode_enabled)
  ...
  else
    {
       ...
       */
      cursor_size = __gdk_display_get_default_cursor_size (display);
      x += cursor_size / 2;
      y += cursor_size / 2;
    }

  screen = __gtk_widget_get_screen (new_tooltip_widget);
  ...
  if (tooltip->current_window)
    {
      ...
      __gtk_widget_size_request (GTK_WIDGET (tooltip->current_window),
                               &requisition);
      ...
      __gtk_window_move (GTK_WINDOW (tooltip->current_window), x, y);
      __gtk_widget_show (GTK_WIDGET (tooltip->current_window));
    }
}
...
gtk_tooltip_show_tooltip (GdkDisplay *display)
{
  ...
  if (tooltip->keyboard_mode_enabled)
	...
	return;
      ...
      __gdk_window_get_pointer (window, &x, &y, NULL);

      __gdk_window_get_root_coords (window, x, y, &tx, &ty);
      tooltip->last_x = tx;
      tooltip->last_y = ty;

      pointer_widget = tooltip_widget = ______gtk_widget_find_at_coords (window,
                                                                    x, y,
                                                                    &x, &y);
    }
  ...
  if (!tooltip->current_window)
    {
      if (__gtk_widget_get_tooltip_window (tooltip_widget))
	tooltip->current_window = __gtk_widget_get_tooltip_window (tooltip_widget);
      else
	tooltip->current_window = GTK_WINDOW (GTK_TOOLTIP (tooltip)->window);
    }

  screen = __gtk_widget_get_screen (tooltip_widget);

  /* FIXME: should use tooltip->current_window iso tooltip->window */
  if (screen != __gtk_widget_get_screen (tooltip->window))
    {
      g_signal_handlers_disconnect_by_func (display,
					    gtk_tooltip_display_closed,
					    tooltip);

      __gtk_window_set_screen (GTK_WINDOW (tooltip->window), screen);
...
_____gtk_tooltip_hide_tooltip (GtkTooltip *tooltip)
{
  ...
  if (!tooltip->keyboard_mode_enabled)
    {
      ...
      settings = __gtk_widget_get_settings (GTK_WIDGET (tooltip->window));
	...
	tooltip->browse_mode_timeout_id =
	  __gdk_threads_add_timeout_full (0, timeout,
  ...
  if (tooltip->current_window)
    {
      __gtk_widget_hide (GTK_WIDGET (tooltip->current_window));
      tooltip->current_window = NULL;
    }
}
...
gtk_tooltip_start_delay (GdkDisplay *display)
{
  ...
  tooltip->timeout_id = __gdk_threads_add_timeout_full (0, timeout,
...
void
______gtk_tooltip_focus_in (GtkWidget *widget)
{
  gint x, y;
  gboolean return_value = FALSE;
  GdkDisplay *display;
  ...
  if (!tooltip->current_window)
    {
      if (__gtk_widget_get_tooltip_window (widget))
	tooltip->current_window = __gtk_widget_get_tooltip_window (widget);
      else
	tooltip->current_window = GTK_WINDOW (GTK_TOOLTIP (tooltip)->window);
    }
...
void
______gtk_tooltip_focus_out (GtkWidget *widget)
{
  GdkDisplay *display;
  GtkTooltip *tooltip;
...
void
______gtk_tooltip_toggle_keyboard_mode (GtkWidget *widget)
{
  GdkDisplay *display;
  GtkTooltip *tooltip;
...
void
______gtk_tooltip_hide (GtkWidget *widget)
{
  GtkWidget *toplevel;
  GdkDisplay *display;
  GtkTooltip *tooltip;
...
void
______gtk_tooltip_handle_event (GdkEvent *event)
{
  gint x, y;
  gboolean return_value = FALSE;
  ...
  display = __gdk_window_get_display (event->any.window);
  ...
  __gdk_event_request_motions (&event->motion);
