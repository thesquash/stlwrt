...
STLWRT_DEFINE_ABSTRACT_TYPE (GtkIMContext, gtk_im_context, G_TYPE_OBJECT)
 ...
 * @set_client_window: Called via __gtk_im_context_set_client_window() when the
 ...
 * @get_preedit_string: Called via __gtk_im_context_get_preedit_string() to
 ...
 * @filter_keypress: Called via __gtk_im_context_filter_keypress() on every
 ...
 *   character.
 * @focus_in: Called via __gtk_im_context_focus_in() when the input widget
 *   has gained focus. May be overridden to keep track of the current focus.
 * @focus_out: Called via __gtk_im_context_focus_in() when the input widget
 *   has lost focus. May be overridden to keep track of the current focus.
 * @reset: Called via __gtk_im_context_reset() to signal a change such as a
 ...
 * @set_cursor_location: Called via __gtk_im_context_set_cursor_location()
 ...
 * @set_use_preedit: Called via __gtk_im_context_set_use_preedit() to control
 *   the use of the preedit string. Override this to display feedback by some
 *   other means if turned off.
 * @set_surrounding: Called via __gtk_im_context_set_surrounding() in response
 ...
 *   __gtk_im_context_get_surrounding() to work.
 * @get_surrounding: Called via __gtk_im_context_get_surrounding() to update
...
gtk_im_context_class_init (GtkIMContextClass *klass)
{
   ...
   * __gtk_im_context_get_preedit_string() returns the empty string.
   */
   ...
   * __gtk_im_context_set_surrounding() method.
   *
...
/**
 * __gtk_im_context_set_client_window:
 ...
 **/
void
__gtk_im_context_set_client_window (GtkIMContext *context,
				  GdkWindow    *window)
{
...
/**
 * __gtk_im_context_get_preedit_string:
 * @context:    a #GtkIMContext
 ...
 **/
void
__gtk_im_context_get_preedit_string (GtkIMContext   *context,
				   gchar         **str,
				   PangoAttrList **attrs,
				   gint           *cursor_pos)
{
 ...
 **/
gboolean
__gtk_im_context_filter_keypress (GtkIMContext *context,
				GdkEventKey  *key)
{
  GtkIMContextClass *klass;
 ...
 **/
void
__gtk_im_context_focus_in (GtkIMContext   *context)
{
  GtkIMContextClass *klass;
 ...
 **/
void
__gtk_im_context_focus_out (GtkIMContext   *context)
{
  GtkIMContextClass *klass;
 ...
 **/
void
__gtk_im_context_reset (GtkIMContext   *context)
{
  GtkIMContextClass *klass;
...
/**
 * __gtk_im_context_set_cursor_location:
 * @context: a #GtkIMContext
 * @area: new location
 *
 ...
 **/
void
__gtk_im_context_set_cursor_location (GtkIMContext       *context,
...
/**
 * __gtk_im_context_set_use_preedit:
 * @context: a #GtkIMContext
 ...
 **/
void
__gtk_im_context_set_use_preedit (GtkIMContext *context,
...
/**
 * __gtk_im_context_set_surrounding:
 * @context: a #GtkIMContext 
 ...
 **/
void
__gtk_im_context_set_surrounding (GtkIMContext  *context,
				const gchar   *text,
				gint           len,
				gint           cursor_index)
{
...
/**
 * __gtk_im_context_get_surrounding:
 * @context: a #GtkIMContext
 ...
 * __gtk_im_context_set_surrounding(). Note that there is no obligation
 ...
 **/
gboolean
__gtk_im_context_get_surrounding (GtkIMContext *context,
				gchar       **text,
				gint         *cursor_index)
{
  GtkIMContextClass *klass;
...
/**
 * __gtk_im_context_delete_surrounding:
 * @context: a #GtkIMContext
 ...
 * __gtk_im_context_get_surrounding() to get the current context, and
 ...
 **/
gboolean
__gtk_im_context_delete_surrounding (GtkIMContext *context,
				   gint          offset,
				   gint          n_chars)
{
  gboolean result;
