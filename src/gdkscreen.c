...
STLWRT_DEFINE_TYPE (GdkScreen, gdk_screen, G_TYPE_OBJECT)
		     ...
		     gint       y)
{
  ...
  num_monitors = __gdk_screen_get_n_monitors (screen);
  ...
  for (i = 0; i < num_monitors; i++)
    {
      ...
      __gdk_screen_get_monitor_geometry (screen, i, &monitor);
...
/**
 * __gdk_screen_get_monitor_at_point:
 * @screen: a #GdkScreen.
 ...
 **/
gint 
__gdk_screen_get_monitor_at_point (GdkScreen *screen,
				 gint       x,
				 gint       y)
{
  gint num_monitors, i;
...
/**
 * __gdk_screen_get_monitor_at_window:
 * @screen: a #GdkScreen.
 * @window: a #GdkWindow
 ...
 **/
gint 
__gdk_screen_get_monitor_at_window (GdkScreen      *screen,
				  GdkWindow	 *window)
{
  ...
  __gdk_window_get_geometry (window, &win_rect.x, &win_rect.y, &win_rect.width,
			   &win_rect.height, NULL);
  __gdk_window_get_origin (window, &win_rect.x, &win_rect.y);
  num_monitors = __gdk_screen_get_n_monitors (screen);
  ...
  for (i=0;i<num_monitors;i++)
    {
      ...
      __gdk_screen_get_monitor_geometry (screen, i, &tmp_monitor);
      __gdk_rectangle_intersect (&win_rect, &tmp_monitor, &intersect);
 ...
 **/
gint
__gdk_screen_width (void)
{
  return __gdk_screen_get_width (__gdk_screen_get_default ());
}
 ...
 **/
gint
__gdk_screen_height (void)
{
  return __gdk_screen_get_height (__gdk_screen_get_default ());
}

/**
 * __gdk_screen_width_mm:
 * 
 ...
 **/
gint
__gdk_screen_width_mm (void)
{
  return __gdk_screen_get_width_mm (__gdk_screen_get_default ());
}

/**
 * __gdk_screen_height_mm:
 * 
 ...
 **/
gint
__gdk_screen_height_mm (void)
{
  return __gdk_screen_get_height_mm (__gdk_screen_get_default ());
}

/**
 * __gdk_screen_set_font_options:
 * @screen: a #GdkScreen
 ...
 * with __gdk_pango_context_get_for_screen(). Changing the
 ...
 **/
void
__gdk_screen_set_font_options (GdkScreen                  *screen,
...
/**
 * __gdk_screen_get_font_options:
 * @screen: a #GdkScreen
 * 
 * Gets any options previously set with __gdk_screen_set_font_options().
 * 
...
__gdk_screen_get_font_options (GdkScreen *screen)
{
 ...
 **/
void
__gdk_screen_set_resolution (GdkScreen *screen,
			   gdouble    dpi)
{
  g_return_if_fail (GDK_IS_SCREEN (screen));
...
/**
 * __gdk_screen_get_resolution:
 * @screen: a #GdkScreen
 * 
 * Gets the resolution for font handling on the screen; see
 * __gdk_screen_set_resolution() for full details.
 * 
 ...
 **/
gdouble
__gdk_screen_get_resolution (GdkScreen *screen)
{
			 ...
			 GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_FONT_OPTIONS:
      g_value_set_pointer (value, (gpointer) __gdk_screen_get_font_options (screen));
      break;
    case PROP_RESOLUTION:
      g_value_set_double (value, __gdk_screen_get_resolution (screen));
      break;
    default:
			 ...
			 GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_FONT_OPTIONS:
      __gdk_screen_set_font_options (screen, g_value_get_pointer (value));
      break;
    case PROP_RESOLUTION:
      __gdk_screen_set_resolution (screen, g_value_get_double (value));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
