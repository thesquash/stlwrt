...
static void gdk_pixmap_init       (GdkPixmap      *pixmap);
static void gdk_pixmap_class_init (GdkPixmapClass *klass);
...
static void
gdk_pixmap_init (GdkPixmap *pixmap)
{
...
static void
gdk_pixmap_class_init (GdkPixmapClass *klass)
{
...
{
  GdkPixmap *obj = (GdkPixmap *) object;
...
GdkPixmap *
__gdk_pixmap_new (GdkDrawable *drawable,
                gint         width,
                gint         height,
                gint         depth)
{
...
gdk_pixmap_create_gc (GdkDrawable     *drawable,
                      ...
                      GdkGCValuesMask  mask)
{
  return __gdk_gc_new_with_values (((GdkPixmap *) drawable)->impl,
                                 values, mask);
}
...
gdk_pixmap_draw_rectangle (GdkDrawable *drawable,
			   ...
			   gint         height)
{
  GdkPixmap *private = (GdkPixmap *)drawable;

  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_rectangle (private->impl, gc, filled,
                      x, y, width, height);
}
		     ...
		     gint         angle2)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_arc (private->impl, gc, filled,
                x, y,
			 ...
			 gint         npoints)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_polygon (private->impl, gc, filled, points, npoints);
}
		      ...
		      gint         text_length)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_text (private->impl, font, gc,
			 ...
			 gint            text_length)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_text_wc (private->impl, font, gc,
                    x, y, text, text_length);
}
			...
			gint         npoints)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_points (private->impl, gc, points, npoints);
}
			  ...
			  gint         nsegs)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_segments (private->impl, gc, segs, nsegs);
}
		       ...
		       gint         npoints)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_lines (private->impl, gc, points, npoints);
}
                        ...
                        PangoGlyphString *glyphs)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_glyphs (private->impl, gc, font, x, y, glyphs);
}
				    ...
				    PangoGlyphString *glyphs)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_glyphs_transformed (private->impl, gc, matrix, font, x, y, glyphs);
}
                       ...
                       gint             height)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_image (private->impl, gc, image, xsrc, ysrc, xdest, ydest,
                  width, height);
}
			...
			gint             y_dither)
{
  ...
  if (gc)
    _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_pixbuf (private->impl, gc, pixbuf,
			    ...
			    gint             n_trapezoids)
{
  ...
  _gdk_gc_remove_drawable_clip (gc);  
  __gdk_draw_trapezoids (private->impl, gc, trapezoids, n_trapezoids);
}
                          ...
                          gint *height)
{
  ...
  __gdk_drawable_get_size (GDK_DRAWABLE (((GdkPixmap*)drawable)->impl),
                         width, height);
}
                              ...
                              GdkColormap *cmap)
{
  ...
  __gdk_drawable_set_colormap (((GdkPixmap*)drawable)->impl, cmap);
}
...
gdk_pixmap_real_get_colormap (GdkDrawable *drawable)
{
  ...
  return __gdk_drawable_get_colormap (((GdkPixmap*)drawable)->impl);
}
			  ...
			  gint             height)
{
  ...
  return __gdk_drawable_copy_to_image (((GdkPixmap*)drawable)->impl,
				     image,
...
{
  return _gdk_drawable_ref_cairo_surface (((GdkPixmap*)drawable)->impl);
}
				     ...
				     GdkPixbuf      *pixbuf)
{
  ...
  if (mask)
    __gdk_pixbuf_render_pixmap_and_mask_for_colormap (pixbuf, colormap, NULL, mask, 128);
...
/**
 * __gdk_pixmap_colormap_create_from_xpm:
 ...
 * If you must use a pixmap, use __gdk_pixmap_new() to
 * create it and Cairo to draw the pixbuf onto it.
 */
GdkPixmap*
__gdk_pixmap_colormap_create_from_xpm (GdkDrawable    *drawable,
				     GdkColormap    *colormap,
				     GdkBitmap     **mask,
				     const GdkColor *transparent_color,
 ...
 */
GdkPixmap*
__gdk_pixmap_create_from_xpm (GdkDrawable    *drawable,
			    GdkBitmap     **mask,
			    const GdkColor *transparent_color,
			    const gchar    *filename)
{
  return __gdk_pixmap_colormap_create_from_xpm (drawable, NULL, mask,
					      transparent_color, filename);
}

/**
 * __gdk_pixmap_colormap_create_from_xpm_d:
 * @drawable: a #GdkDrawable, used to determine default values
 *     for the new pixmap. Can be %NULL if @colormap is given.
 * @colormap: the #GdkColormap that the new pixmap will be use.
 *     If omitted, the colormap for @window will be used.
 ...
 */
GdkPixmap*
__gdk_pixmap_colormap_create_from_xpm_d (GdkDrawable     *drawable,
				       GdkColormap     *colormap,
				       GdkBitmap      **mask,
				       const GdkColor  *transparent_color,
				       gchar          **data)
...
/**
 * __gdk_pixmap_create_from_xpm_d:
 * @drawable: a #GdkDrawable, used to determine default values
 *     for the new pixmap.
 ...
 */
GdkPixmap*
__gdk_pixmap_create_from_xpm_d (GdkDrawable    *drawable,
			      GdkBitmap     **mask,
			      const GdkColor *transparent_color,
			      gchar         **data)
{
  return __gdk_pixmap_colormap_create_from_xpm_d (drawable, NULL, mask,
...
{
    return __gdk_drawable_get_screen (GDK_PIXMAP_OBJECT (drawable)->impl);
}

/**
 * __gdk_pixmap_get_size:
 * @pixmap: a #GdkPixmap
 ...
 * It is identical to __gdk_drawable_get_size(), but for pixmaps.
 *
 * Since: 2.24
 **/
void
__gdk_pixmap_get_size (GdkPixmap *pixmap,
                     gint      *width,
                     gint      *height)
{
