...
STLWRT_DEFINE_TYPE_WITH_CODE (GtkFileChooserWidget, gtk_file_chooser_widget, GTK_TYPE_VBOX,
				     ...
				     GObjectConstructParam *construct_params)
{
  ...
  __gtk_box_pack_start (GTK_BOX (object), priv->impl, TRUE, TRUE, 0);
  __gtk_widget_show (priv->impl);
 ...
 **/
GtkWidget *
__gtk_file_chooser_widget_new (GtkFileChooserAction action)
{
...
/**
 * __gtk_file_chooser_widget_new_with_backend:
 * @action: Open or save mode for the widget
 ...
 *
 * Since: 2.4
 * Deprecated: 2.14: Use __gtk_file_chooser_widget_new() instead.
 **/
GtkWidget *
__gtk_file_chooser_widget_new_with_backend (GtkFileChooserAction  action,
					  const gchar          *backend)
{
  return g_object_new (GTK_TYPE_FILE_CHOOSER_WIDGET,
		       "action", action,
