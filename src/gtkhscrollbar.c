...
STLWRT_DEFINE_TYPE (GtkHScrollbar, gtk_hscrollbar, GTK_TYPE_SCROLLBAR)
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (hscrollbar),
                                  GTK_ORIENTATION_HORIZONTAL);
}

/**
 * __gtk_hscrollbar_new:
 ...
 */
GtkWidget *
__gtk_hscrollbar_new (GtkAdjustment *adjustment)
{
