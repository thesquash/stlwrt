...
GQuark
__gtk_recent_chooser_error_quark (void)
{
...
/**
 * __gtk_recent_chooser_set_show_private:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_show_private (GtkRecentChooser *chooser,
...
/**
 * __gtk_recent_chooser_get_show_private:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
gboolean
__gtk_recent_chooser_get_show_private (GtkRecentChooser *chooser)
{
  gboolean show_private;
...
/**
 * __gtk_recent_chooser_set_show_not_found:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_show_not_found (GtkRecentChooser *chooser,
...
/**
 * __gtk_recent_chooser_get_show_not_found:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
gboolean
__gtk_recent_chooser_get_show_not_found (GtkRecentChooser *chooser)
{
  gboolean show_not_found;
...
/**
 * __gtk_recent_chooser_set_show_icons:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_show_icons (GtkRecentChooser *chooser,
				   gboolean          show_icons)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
...
/**
 * __gtk_recent_chooser_get_show_icons:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
gboolean
__gtk_recent_chooser_get_show_icons (GtkRecentChooser *chooser)
{
  gboolean show_icons;
...
/**
 * __gtk_recent_chooser_set_select_multiple:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_select_multiple (GtkRecentChooser *chooser,
...
/**
 * __gtk_recent_chooser_get_select_multiple:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
gboolean
__gtk_recent_chooser_get_select_multiple (GtkRecentChooser *chooser)
{
  gboolean select_multiple;
...
/**
 * __gtk_recent_chooser_set_local_only:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_local_only (GtkRecentChooser *chooser,
				   gboolean          local_only)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
...
/**
 * __gtk_recent_chooser_get_local_only:
 * @chooser: a #GtkRecentChooser
 *
 * Gets whether only local resources should be shown in the recently used
 * resources selector.  See __gtk_recent_chooser_set_local_only()
 *
 ...
 */
gboolean
__gtk_recent_chooser_get_local_only (GtkRecentChooser *chooser)
{
  gboolean local_only;
...
/**
 * __gtk_recent_chooser_set_limit:
 * @chooser: a #GtkRecentChooser
 * @limit: a positive integer, or -1 for all items
 *
 * Sets the number of items that should be returned by
 * __gtk_recent_chooser_get_items() and __gtk_recent_chooser_get_uris().
 *
 * Since: 2.10
 */
void
__gtk_recent_chooser_set_limit (GtkRecentChooser *chooser,
			      gint              limit)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
...
/**
 * __gtk_recent_chooser_get_limit:
 * @chooser: a #GtkRecentChooser
 *
 * Gets the number of items returned by __gtk_recent_chooser_get_items()
 * and __gtk_recent_chooser_get_uris().
 *
 ...
 */
gint
__gtk_recent_chooser_get_limit (GtkRecentChooser *chooser)
{
  gint limit;
...
/**
 * __gtk_recent_chooser_set_show_tips:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_show_tips (GtkRecentChooser *chooser,
				  gboolean          show_tips)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
...
/**
 * __gtk_recent_chooser_get_show_tips:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
gboolean
__gtk_recent_chooser_get_show_tips (GtkRecentChooser *chooser)
{
  gboolean show_tips;
...
/**
 * __gtk_recent_chooser_set_show_numbers:
 * @chooser: a #GtkRecentChooser
 * @show_numbers: %TRUE to show numbers, %FALSE otherwise
 *
 * Whether to show recently used resources prepended by a unique number.
 *
 * Deprecated: 2.12: Use __gtk_recent_chooser_menu_set_show_numbers() instead.
 *
 * Since: 2.10
 */
void
__gtk_recent_chooser_set_show_numbers (GtkRecentChooser *chooser,
...
/**
 * __gtk_recent_chooser_get_show_numbers:
 * @chooser: a #GtkRecentChooser
 *
 * Returns whether @chooser should display recently used resources
 * prepended by a unique number.
 *
 * Deprecated: 2.12: use __gtk_recent_chooser_menu_get_show_numbers() instead.
 *
 ...
 */
gboolean
__gtk_recent_chooser_get_show_numbers (GtkRecentChooser *chooser)
{
  GParamSpec *pspec;
  gboolean show_numbers;
...
/**
 * __gtk_recent_chooser_set_sort_type:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_sort_type (GtkRecentChooser  *chooser,
...
/**
 * __gtk_recent_chooser_get_sort_type:
 * @chooser: a #GtkRecentChooser
 *
 * Gets the value set by __gtk_recent_chooser_set_sort_type().
 *
 ...
 */
GtkRecentSortType
__gtk_recent_chooser_get_sort_type (GtkRecentChooser *chooser)
{
  GtkRecentSortType sort_type;
...
/**
 * __gtk_recent_chooser_set_sort_func:
 * @chooser: a #GtkRecentChooser
 ...
 */
void
__gtk_recent_chooser_set_sort_func  (GtkRecentChooser  *chooser,
...
/**
 * __gtk_recent_chooser_set_current_uri:
 * @chooser: a #GtkRecentChooser
 * @uri: a URI
 ...
 */
gboolean
__gtk_recent_chooser_set_current_uri (GtkRecentChooser  *chooser,
				    const gchar       *uri,
				    GError           **error)
{
  g_return_val_if_fail (GTK_IS_RECENT_CHOOSER (chooser), FALSE);
...
/**
 * __gtk_recent_chooser_get_current_uri:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
gchar *
__gtk_recent_chooser_get_current_uri (GtkRecentChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_RECENT_CHOOSER (chooser), NULL);
...
/**
 * __gtk_recent_chooser_get_current_item:
 * @chooser: a #GtkRecentChooser
 * 
 * Gets the #GtkRecentInfo currently selected by @chooser.
 *
 * Return value: a #GtkRecentInfo.  Use __gtk_recent_info_unref() when
 *   when you have finished using it.
 *
 * Since: 2.10
 */
GtkRecentInfo *
__gtk_recent_chooser_get_current_item (GtkRecentChooser *chooser)
{
  ...
  uri = __gtk_recent_chooser_get_current_uri (chooser);
  if (!uri)
    return NULL;
  
  manager = _gtk_recent_chooser_get_recent_manager (chooser);
  retval = __gtk_recent_manager_lookup_item (manager, uri, NULL);
  g_free (uri);
...
/**
 * __gtk_recent_chooser_select_uri:
 * @chooser: a #GtkRecentChooser
 * @uri: a URI
 * @error: (allow-none): return location for a #GError, or %NULL
 *
 ...
 */
gboolean
__gtk_recent_chooser_select_uri (GtkRecentChooser  *chooser,
			       const gchar       *uri,
			       GError           **error)
{
  g_return_val_if_fail (GTK_IS_RECENT_CHOOSER (chooser), FALSE);
...
/**
 * __gtk_recent_chooser_unselect_uri:
 * @chooser: a #GtkRecentChooser
 * @uri: a URI
 *
 ...
 */
void
__gtk_recent_chooser_unselect_uri (GtkRecentChooser *chooser,
				 const gchar      *uri)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
...
/**
 * __gtk_recent_chooser_select_all:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
void
__gtk_recent_chooser_select_all (GtkRecentChooser *chooser)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
...
/**
 * __gtk_recent_chooser_unselect_all:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
void
__gtk_recent_chooser_unselect_all (GtkRecentChooser *chooser)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
...
/**
 * __gtk_recent_chooser_get_items:
 * @chooser: a #GtkRecentChooser
 *
 ...
 *   use __gtk_recent_info_unref() on every item of the list, and then free
 *   the list itself using g_list_free().
 *
 * Since: 2.10
 */
GList *
__gtk_recent_chooser_get_items (GtkRecentChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_RECENT_CHOOSER (chooser), NULL);
 ...
 */
gchar **
__gtk_recent_chooser_get_uris (GtkRecentChooser *chooser,
                             gsize            *length)
{
  GList *items, *l;
  gchar **retval;
  ...
  items = __gtk_recent_chooser_get_items (chooser);
...
/**
 * __gtk_recent_chooser_add_filter:
 * @chooser: a #GtkRecentChooser
 ...
 * __gtk_recent_chooser_set_filter().
 *
 * Since: 2.10
 */
void
__gtk_recent_chooser_add_filter (GtkRecentChooser *chooser,
...
/**
 * __gtk_recent_chooser_remove_filter:
 * @chooser: a #GtkRecentChooser
 * @filter: a #GtkRecentFilter
 *
 ...
 */
void
__gtk_recent_chooser_remove_filter (GtkRecentChooser *chooser,
				  GtkRecentFilter  *filter)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
  g_return_if_fail (GTK_IS_RECENT_FILTER (filter));
...
/**
 * __gtk_recent_chooser_list_filters:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
GSList *
__gtk_recent_chooser_list_filters (GtkRecentChooser *chooser)
{
  g_return_val_if_fail (GTK_IS_RECENT_CHOOSER (chooser), NULL);
 ...
 */
void
__gtk_recent_chooser_set_filter (GtkRecentChooser *chooser,
			       GtkRecentFilter  *filter)
{
  g_return_if_fail (GTK_IS_RECENT_CHOOSER (chooser));
  g_return_if_fail (GTK_IS_RECENT_FILTER (filter));
...
/**
 * __gtk_recent_chooser_get_filter:
 * @chooser: a #GtkRecentChooser
 *
 ...
 */
GtkRecentFilter *
__gtk_recent_chooser_get_filter (GtkRecentChooser *chooser)
{
  GtkRecentFilter *filter;
   ...
   * of the returned object; see also __gtk_file_chooser_get_filter()
			    ...
			    const gchar    *property_name)
{
  ...
  if (strcmp (property_name, "show-numbers") == 0 && recent_chooser_has_show_numbers (recent_chooser))
    g_object_set (recent_chooser, "show-numbers",
                  __gtk_recent_action_get_show_numbers (recent_action), NULL);
  else if (strcmp (property_name, "show-private") == 0)
    __gtk_recent_chooser_set_show_private (recent_chooser, __gtk_recent_chooser_get_show_private (action_chooser));
  else if (strcmp (property_name, "show-not-found") == 0)
    __gtk_recent_chooser_set_show_not_found (recent_chooser, __gtk_recent_chooser_get_show_not_found (action_chooser));
  else if (strcmp (property_name, "show-tips") == 0)
    __gtk_recent_chooser_set_show_tips (recent_chooser, __gtk_recent_chooser_get_show_tips (action_chooser));
  else if (strcmp (property_name, "show-icons") == 0)
    __gtk_recent_chooser_set_show_icons (recent_chooser, __gtk_recent_chooser_get_show_icons (action_chooser));
  else if (strcmp (property_name, "limit") == 0)
    __gtk_recent_chooser_set_limit (recent_chooser, __gtk_recent_chooser_get_limit (action_chooser));
  else if (strcmp (property_name, "local-only") == 0)
    __gtk_recent_chooser_set_local_only (recent_chooser, __gtk_recent_chooser_get_local_only (action_chooser));
  else if (strcmp (property_name, "sort-type") == 0)
    __gtk_recent_chooser_set_sort_type (recent_chooser, __gtk_recent_chooser_get_sort_type (action_chooser));
  else if (strcmp (property_name, "filter") == 0)
    __gtk_recent_chooser_set_filter (recent_chooser, __gtk_recent_chooser_get_filter (action_chooser));
}
			                    ...
			                    GtkAction      *action)
{
  ...
  if (recent_chooser_has_show_numbers (recent_chooser))
    g_object_set (recent_chooser, "show-numbers", 
                  __gtk_recent_action_get_show_numbers (GTK_RECENT_ACTION (action)),
                  NULL);
  __gtk_recent_chooser_set_show_private (recent_chooser, __gtk_recent_chooser_get_show_private (action_chooser));
  __gtk_recent_chooser_set_show_not_found (recent_chooser, __gtk_recent_chooser_get_show_not_found (action_chooser));
  __gtk_recent_chooser_set_show_tips (recent_chooser, __gtk_recent_chooser_get_show_tips (action_chooser));
					...
					GtkAction        *action)
{
  ...
  __gtk_activatable_do_set_related_action (GTK_ACTIVATABLE (recent_chooser), action);
  ...
  if (use_action_appearance != use_appearance)
    {
      ...
      __gtk_activatable_sync_action_properties (GTK_ACTIVATABLE (recent_chooser), action);
    }
}
