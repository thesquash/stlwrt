...
STLWRT_DEFINE_FTYPE (GtkTextChildAnchor, gtk_text_child_anchor, G_TYPE_OBJECT, G_TYPE_FLAG_NONE, ;)
...
/**
 * __gtk_text_child_anchor_new:
 * 
 * Creates a new #GtkTextChildAnchor. Usually you would then insert
 * it into a #GtkTextBuffer with __gtk_text_buffer_insert_child_anchor().
 * To perform the creation and insertion in one step, use the
 * convenience function __gtk_text_buffer_create_child_anchor().
 * 
 * Return value: a new #GtkTextChildAnchor
 **/
GtkTextChildAnchor*
__gtk_text_child_anchor_new (void)
{
...
/**
 * __gtk_text_child_anchor_get_widgets:
 ...
 **/
GList*
__gtk_text_child_anchor_get_widgets (GtkTextChildAnchor *anchor)
{
...
/**
 * __gtk_text_child_anchor_get_deleted:
 * @anchor: a #GtkTextChildAnchor
 * 
 ...
 **/
gboolean
__gtk_text_child_anchor_get_deleted (GtkTextChildAnchor *anchor)
{
  GtkTextLineSegment *seg = anchor->segment;
                                    ...
                                    GtkTextLayout      *layout)
{
  ...
  __gtk_text_buffer_get_iter_at_child_anchor (gtk_text_layout_get_props (layout)->buffer,
                                            &start, anchor);
  end = start;
