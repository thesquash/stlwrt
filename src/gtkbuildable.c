...
STLWRT_DEFINE_INTERFACE (GtkBuildable, gtk_buildable, G_TYPE_OBJECT, NULL, ;)

/**
 * __gtk_buildable_set_name:
 ...
 **/
void
__gtk_buildable_set_name (GtkBuildable *buildable,
                        const gchar  *name)
{
 ...
 *
 * Returns: the name set with __gtk_buildable_set_name()
 *
 * Since: 2.12
 **/
const gchar *
__gtk_buildable_get_name (GtkBuildable *buildable)
{
  GtkBuildableIface *iface;
 ...
 **/
void
__gtk_buildable_add_child (GtkBuildable *buildable,
			 GtkBuilder   *builder,
			 GObject      *child,
			 const gchar  *type)
{
...
/**
 * __gtk_buildable_set_buildable_property:
 * @buildable: a #GtkBuildable
 * @builder: a #GtkBuilder
 ...
 **/
void
__gtk_buildable_set_buildable_property (GtkBuildable *buildable,
				      GtkBuilder   *builder,
				      const gchar  *name,
				      const GValue *value)
{
...
/**
 * __gtk_buildable_parser_finished:
 * @buildable: a #GtkBuildable
 * @builder: a #GtkBuilder
 *
 ...
 * __gtk_builder_add_from_file() or __gtk_builder_add_from_string() 
 * is called on a builder.
 *
 * Since: 2.12
 **/
void
__gtk_buildable_parser_finished (GtkBuildable *buildable,
			       GtkBuilder   *builder)
{
  GtkBuildableIface *iface;
...
/**
 * __gtk_buildable_construct_child:
 * @buildable: A #GtkBuildable
 ...
 **/
GObject *
__gtk_buildable_construct_child (GtkBuildable *buildable,
                               GtkBuilder   *builder,
                               const gchar  *name)
{
  GtkBuildableIface *iface;
...
/**
 * __gtk_buildable_custom_tag_start:
 * @buildable: a #GtkBuildable
 ...
 **/
gboolean
__gtk_buildable_custom_tag_start (GtkBuildable  *buildable,
                                GtkBuilder    *builder,
                                GObject       *child,
                                const gchar   *tagname,
...
/**
 * __gtk_buildable_custom_tag_end:
 * @buildable: A #GtkBuildable
 * @builder: #GtkBuilder used to construct this object
 * @child: (allow-none): child object or %NULL for non-child tags
 * @tagname: name of tag
 ...
 **/
void
__gtk_buildable_custom_tag_end (GtkBuildable  *buildable,
                              GtkBuilder    *builder,
                              GObject       *child,
                              const gchar   *tagname,
                              gpointer      *data)
...
/**
 * __gtk_buildable_custom_finished:
 * @buildable: a #GtkBuildable
 * @builder: a #GtkBuilder
 * @child: (allow-none): child object or %NULL for non-child tags
 ...
 *
 * This is similar to __gtk_buildable_parser_finished() but is
 * called once for each custom tag handled by the @buildable.
 * 
 * Since: 2.12
 **/
void
__gtk_buildable_custom_finished (GtkBuildable  *buildable,
			       GtkBuilder    *builder,
			       GObject       *child,
			       const gchar   *tagname,
			       gpointer       data)
...
/**
 * __gtk_buildable_get_internal_child:
 * @buildable: a #GtkBuildable
 * @builder: a #GtkBuilder
 ...
 **/
GObject *
__gtk_buildable_get_internal_child (GtkBuildable *buildable,
                                  GtkBuilder   *builder,
