...
static void     gtk_recent_manager_get_property        (GObject           *object,
						        ...
						        GValue            *value,
						        GParamSpec        *pspec);
static void     __gtk_recent_manager_add_item_query_info (GObject           *source_object,
                                                        GAsyncResult      *res,
                                                        gpointer           user_data);
...
GQuark
__gtk_recent_manager_error_quark (void)
{
...
gtk_recent_manager_class_init (GtkRecentManagerClass *klass)
{
   ...
   * __gtk_recent_manager_get_items() function.
   *
   * Since: 2.10
   *
  ...
  g_object_class_install_property (gobject_class,
  				   ...
  				   g_param_spec_int ("limit",
  				   		     P_("Limit"),
  				   		     P_("The maximum number of items to be returned by __gtk_recent_manager_get_items()"),
  				   		     -1,
  				   		     G_MAXINT,
  				   		     DEFAULT_LIMIT,
				 ...
				 GParamSpec            *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_FILENAME:
      ...
      break;      
    case PROP_LIMIT:
      __gtk_recent_manager_set_limit (recent_manager, g_value_get_int (value));
      break;
    default:
 ...
 * needed. You should use __gtk_recent_manager_get_default() instead.
 *
 ...
 */
GtkRecentManager *
__gtk_recent_manager_new (void)
{
  return g_object_new (GTK_TYPE_RECENT_MANAGER, NULL);
}

/**
 * __gtk_recent_manager_get_default:
 *
 ...
 */
GtkRecentManager *
__gtk_recent_manager_get_default (void)
{
  if (G_UNLIKELY (!recent_manager_singleton))
    recent_manager_singleton = __gtk_recent_manager_new ();

  return recent_manager_singleton;
}

/**
 * __gtk_recent_manager_get_for_screen:
 * @screen: a #GdkScreen
 *
 ...
 * __gtk_recent_manager_new() and setting the screen yourself; by using
 ...
 *   equivalent to calling __gtk_recent_manager_get_default().
 *
 * Since: 2.10
 */
GtkRecentManager *
__gtk_recent_manager_get_for_screen (GdkScreen *screen)
{
  return __gtk_recent_manager_get_default ();
}

/**
 * __gtk_recent_manager_set_screen:
 ...
 */
void
__gtk_recent_manager_set_screen (GtkRecentManager *manager,
			       GdkScreen        *screen)
{
...
/**
 * __gtk_recent_manager_set_limit:
 * @manager: a #GtkRecentManager
 * @limit: the maximum number of items to return, or -1.
 *
 * Sets the maximum number of item that the __gtk_recent_manager_get_items()
 ...
 */
void
__gtk_recent_manager_set_limit (GtkRecentManager *manager,
			      gint              limit)
{
  GtkRecentManagerPrivate *priv;
...
/**
 * __gtk_recent_manager_get_limit:
 * @manager: a #GtkRecentManager
 *
 * Gets the maximum number of items that the __gtk_recent_manager_get_items()
 ...
 */
gint
__gtk_recent_manager_get_limit (GtkRecentManager *manager)
{
  GtkRecentManagerPrivate *priv;
...
static void
__gtk_recent_manager_add_item_query_info (GObject      *source_object,
                                        GAsyncResult *res,
                                        gpointer      user_data)
{
   ...
   * fields are set */
  __gtk_recent_manager_add_full (manager, uri, &recent_data);
 ...
 * then feeds the data to __gtk_recent_manager_add_full().
 * 
 * See __gtk_recent_manager_add_full() if you want to explicitly
 ...
 */
gboolean
__gtk_recent_manager_add_item (GtkRecentManager  *manager,
			     const gchar       *uri)
{
  GFile* file;
  ...
  g_file_query_info_async (file,
                           ...
                           NULL,
                           __gtk_recent_manager_add_item_query_info,
                           g_object_ref (manager));
 ...
 */
gboolean
__gtk_recent_manager_add_full (GtkRecentManager     *manager,
			     const gchar          *uri,
...
/**
 * __gtk_recent_manager_remove_item:
 * @manager: a #GtkRecentManager
 ...
 */
gboolean
__gtk_recent_manager_remove_item (GtkRecentManager  *manager,
				const gchar       *uri,
				GError           **error)
{
  GtkRecentManagerPrivate *priv;
 ...
 */
gboolean
__gtk_recent_manager_has_item (GtkRecentManager *manager,
			     const gchar      *uri)
{
  GtkRecentManagerPrivate *priv;
...
/**
 * __gtk_recent_manager_lookup_item:
 * @manager: a #GtkRecentManager
 * @uri: a URI
 ...
 */
GtkRecentInfo *
__gtk_recent_manager_lookup_item (GtkRecentManager  *manager,
				const gchar       *uri,
				GError           **error)
{
  GtkRecentManagerPrivate *priv;
...
/**
 * __gtk_recent_manager_move_item:
 * @manager: a #GtkRecentManager
 ...
 */ 
gboolean
__gtk_recent_manager_move_item (GtkRecentManager  *recent_manager,
			      const gchar       *uri,
			      const gchar       *new_uri,
			      GError           **error)
{
...
/**
 * __gtk_recent_manager_get_items:
 * @manager: a #GtkRecentManager
 *
 ...
 *   __gtk_recent_info_unref() on each item inside the list, and then
 *   free the list itself using g_list_free().
 *
 * Since: 2.10
 */
GList *
__gtk_recent_manager_get_items (GtkRecentManager *manager)
{
  GtkRecentManagerPrivate *priv;
  GList *retval = NULL;
  gchar **uris;
...
/**
 * __gtk_recent_manager_purge_items:
 * @manager: a #GtkRecentManager
 * @error: (allow-none): a return location for a #GError, or %NULL
 *
 ...
 */
gint
__gtk_recent_manager_purge_items (GtkRecentManager  *manager,
				GError           **error)
{
  GtkRecentManagerPrivate *priv;
  gint count, purged;
...
gtk_recent_manager_changed (GtkRecentManager *manager)
{
  ...
  if (manager->priv->changed_timeout == 0)
    manager->priv->changed_timeout = __gdk_threads_add_timeout (250, emit_manager_changed, manager);
  else
    {
 ...
 */
GtkRecentInfo *
__gtk_recent_info_ref (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, NULL);
 ...
 */
void
__gtk_recent_info_unref (GtkRecentInfo *info)
{
 ...
 */
const gchar *
__gtk_recent_info_get_uri (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, NULL);
...
/**
 * __gtk_recent_info_get_display_name:
 * @info: a #GtkRecentInfo
 *
 ...
 */
const gchar *
__gtk_recent_info_get_display_name (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, NULL);
  
  if (!info->display_name)
    info->display_name = __gtk_recent_info_get_short_name (info);
  
  return info->display_name;
}

/**
 * __gtk_recent_info_get_description:
 * @info: a #GtkRecentInfo
 *
 ...
 **/
const gchar *
__gtk_recent_info_get_description (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, NULL);
...
/**
 * __gtk_recent_info_get_mime_type:
 * @info: a #GtkRecentInfo
 *
 ...
 */
const gchar *
__gtk_recent_info_get_mime_type (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, NULL);
 ...
 */
time_t
__gtk_recent_info_get_added (GtkRecentInfo *info)
{
...
/**
 * __gtk_recent_info_get_modified:
 * @info: a #GtkRecentInfo
 *
 * Gets the timestamp (seconds from system's Epoch) when the resource
 * was last modified.
 ...
 */
time_t
__gtk_recent_info_get_modified (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, (time_t) -1);
 ...
 */
time_t
__gtk_recent_info_get_visited (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, (time_t) -1);
...
/**
 * __gtk_recent_info_get_application_info:
 * @info: a #GtkRecentInfo
 ...
 */
gboolean
__gtk_recent_info_get_application_info (GtkRecentInfo  *info,
...
/**
 * __gtk_recent_info_get_applications:
 * @info: a #GtkRecentInfo
 ...
 */
gchar **
__gtk_recent_info_get_applications (GtkRecentInfo *info,
				  gsize         *length)
{
  GSList *l;
  gchar **retval;
...
/**
 * __gtk_recent_info_has_application:
 * @info: a #GtkRecentInfo
 ...
 */
gboolean
__gtk_recent_info_has_application (GtkRecentInfo *info,
				 const gchar   *app_name)
{
  g_return_val_if_fail (info != NULL, FALSE);
  g_return_val_if_fail (app_name != NULL, FALSE);
...
/**
 * __gtk_recent_info_last_application:
 * @info: a #GtkRecentInfo
 *
 ...
 */
gchar *
__gtk_recent_info_last_application (GtkRecentInfo  *info)
{
  GSList *l;
			...
			gint        pixel_size)
{
  ...
  icon_theme = __gtk_icon_theme_get_default ();
  ...
  pixbuf = __gtk_icon_info_load_icon (info, NULL);
		   ...
		   gint         size)
{
  ...
  retval = __gtk_icon_theme_load_icon (icon_theme, icon_name,
  				     size,
  				     GTK_ICON_LOOKUP_USE_BUILTIN,
  				     NULL);
 ...
 */
GdkPixbuf *
__gtk_recent_info_get_icon (GtkRecentInfo *info,
			  gint           size)
{
 ...
 */
gboolean
__gtk_recent_info_is_local (GtkRecentInfo *info)
{
  g_return_val_if_fail (info != NULL, FALSE);
 ...
 */
gboolean
__gtk_recent_info_exists (GtkRecentInfo *info)
{
  gchar *filename;
  ...
  if (!__gtk_recent_info_is_local (info))
    return FALSE;
 ...
 */
gboolean
__gtk_recent_info_match (GtkRecentInfo *info_a,
...
/**
 * __gtk_recent_info_get_short_name:
 ...
 */
gchar *
__gtk_recent_info_get_short_name (GtkRecentInfo *info)
{
  gchar *short_name;
...
/**
 * __gtk_recent_info_get_uri_display:
 * @info: a #GtkRecentInfo
 *
 * Gets a displayable version of the resource's URI.  If the resource
 * is local, it returns a local path; if the resource is not local,
 * it returns the UTF-8 encoded content of __gtk_recent_info_get_uri().
 *
 ...
 */
gchar *
__gtk_recent_info_get_uri_display (GtkRecentInfo *info)
{
  gchar *retval;
 ...
 */
gint
__gtk_recent_info_get_age (GtkRecentInfo *info)
{
  time_t now, delta;
  gint retval;
 ...
 */
gchar **
__gtk_recent_info_get_groups (GtkRecentInfo *info,
			    gsize         *length)
{
  GSList *l;
  gchar **retval;
 ...
 */
gboolean
__gtk_recent_info_has_group (GtkRecentInfo *info,
...
/*
 * ______gtk_recent_manager_sync:
 * 
 * Private function for synchronising the recent manager singleton.
 */
void
______gtk_recent_manager_sync (void)
{
