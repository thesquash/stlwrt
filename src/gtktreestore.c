...
static void __gtk_tree_store_set_n_columns   (GtkTreeStore *tree_store,
					    gint          n_columns);
static void __gtk_tree_store_set_column_type (GtkTreeStore *tree_store,
					    gint          column,
					    GType         type);
...
static gboolean gtk_tree_store_get_sort_column_id      (GtkTreeSortable        *sortable,
							gint                   *sort_column_id,
							GtkSortType            *order);
static void     __gtk_tree_store_set_sort_column_id      (GtkTreeSortable        *sortable,
							gint                    sort_column_id,
							GtkSortType             order);
static void     __gtk_tree_store_set_sort_func           (GtkTreeSortable        *sortable,
							gint                    sort_column_id,
							GtkTreeIterCompareFunc  func,
							gpointer                data,
							GDestroyNotify          destroy);
static void     __gtk_tree_store_set_default_sort_func   (GtkTreeSortable        *sortable,
							GtkTreeIterCompareFunc  func,
							gpointer                data,
							GDestroyNotify          destroy);
...
validate_tree (GtkTreeStore *tree_store)
{
  if (gtk_debug_flags & GTK_DEBUG_TREE)
    {
      g_assert (G_NODE (gtk_tree_store_get_props (tree_store)->root)->parent == NULL);

      validate_gnode (G_NODE (gtk_tree_store_get_props (tree_store)->root));
    }
}
...
gtk_tree_store_sortable_init (GtkTreeSortableIface *iface)
{
  ...
  iface->set_sort_column_id = __gtk_tree_store_set_sort_column_id;
  iface->set_sort_func = __gtk_tree_store_set_sort_func;
  iface->set_default_sort_func = __gtk_tree_store_set_default_sort_func;
...
{
  gtk_tree_store_get_props (tree_store)->root = g_node_new (NULL);
  /* While the odds are against us getting 0...
   */
  do
    {
      gtk_tree_store_get_props (tree_store)->stamp = g_random_int ();
    }
  while (gtk_tree_store_get_props (tree_store)->stamp == 0);

  gtk_tree_store_get_props (tree_store)->sort_list = NULL;
  gtk_tree_store_get_props (tree_store)->sort_column_id = GTK_TREE_SORTABLE_UNSORTED_SORT_COLUMN_ID;
  gtk_tree_store_get_props (tree_store)->columns_dirty = FALSE;
}

/**
 * __gtk_tree_store_new:
 ...
 * are supported. 
 *
 * As an example, <literal>__gtk_tree_store_new (3, G_TYPE_INT, G_TYPE_STRING,
 ...
 **/
GtkTreeStore *
__gtk_tree_store_new (gint n_columns,
			       ...)
{
  GtkTreeStore *retval;
  va_list args;
  ...
  __gtk_tree_store_set_n_columns (retval, n_columns);
  ...
  for (i = 0; i < n_columns; i++)
      ...
      if (! _gtk_tree_data_list_check_type (type))
	{
      ...
      __gtk_tree_store_set_column_type (retval, i, type);
    }
  va_end (args);
 ...
 **/
GtkTreeStore *
__gtk_tree_store_newv (gint   n_columns,
		     GType *types)
{
  GtkTreeStore *retval;
  gint i;
  ...
  __gtk_tree_store_set_n_columns (retval, n_columns);
   ...
   for (i = 0; i < n_columns; i++)
      ...
      if (! _gtk_tree_data_list_check_type (types[i]))
	{
      ...
      __gtk_tree_store_set_column_type (retval, i, types[i]);
    }
...
/**
 * __gtk_tree_store_set_column_types:
 ...
 **/
void
__gtk_tree_store_set_column_types (GtkTreeStore *tree_store,
				 gint          n_columns,
				 GType        *types)
{
  gint i;
  ...
  g_return_if_fail (gtk_tree_store_get_props (tree_store)->columns_dirty == 0);

  __gtk_tree_store_set_n_columns (tree_store, n_columns);
   for (i = 0; i < n_columns; i++)
    {
      if (! _gtk_tree_data_list_check_type (types[i]))
	{
      ...
      __gtk_tree_store_set_column_type (tree_store, i, types[i]);
    }
}

static void
__gtk_tree_store_set_n_columns (GtkTreeStore *tree_store,
			      gint          n_columns)
{
  int i;

  if (gtk_tree_store_get_props (tree_store)->n_columns == n_columns)
    return;

  gtk_tree_store_get_props (tree_store)->column_headers = g_renew (GType, gtk_tree_store_get_props (tree_store)->column_headers, n_columns);
  for (i = gtk_tree_store_get_props (tree_store)->n_columns; i < n_columns; i++)
    gtk_tree_store_get_props (tree_store)->column_headers[i] = G_TYPE_INVALID;
  gtk_tree_store_get_props (tree_store)->n_columns = n_columns;

  if (gtk_tree_store_get_props (tree_store)->sort_list)
    _gtk_tree_data_list_header_free (gtk_tree_store_get_props (tree_store)->sort_list);

  gtk_tree_store_get_props (tree_store)->sort_list = _gtk_tree_data_list_header_new (n_columns, gtk_tree_store_get_props (tree_store)->column_headers);
}

/**
 * __gtk_tree_store_set_column_type:
 * @tree_store: a #GtkTreeStore
 ...
 **/
static void
__gtk_tree_store_set_column_type (GtkTreeStore *tree_store,
				gint          column,
				GType         type)
{
  if (!_gtk_tree_data_list_check_type (type))
  ...
  gtk_tree_store_get_props (tree_store)->column_headers[column] = type;
}
...
gtk_tree_store_finalize (GObject *object)
{
  ...
  g_node_traverse (gtk_tree_store_get_props (tree_store)->root, G_POST_ORDER, G_TRAVERSE_ALL, -1,
		   node_free, gtk_tree_store_get_props (tree_store)->column_headers);
  g_node_destroy (gtk_tree_store_get_props (tree_store)->root);
  _gtk_tree_data_list_header_free (gtk_tree_store_get_props (tree_store)->sort_list);
  g_free (gtk_tree_store_get_props (tree_store)->column_headers);

  if (gtk_tree_store_get_props (tree_store)->default_sort_destroy)
    {
      GDestroyNotify d = gtk_tree_store_get_props (tree_store)->default_sort_destroy;

      gtk_tree_store_get_props (tree_store)->default_sort_destroy = NULL;
      d (gtk_tree_store_get_props (tree_store)->default_sort_data);
      gtk_tree_store_get_props (tree_store)->default_sort_data = NULL;
    }
...
gtk_tree_store_get_n_columns (GtkTreeModel *tree_model)
{
  ...
  gtk_tree_store_get_props (tree_store)->columns_dirty = TRUE;

  return gtk_tree_store_get_props (tree_store)->n_columns;
}
				...
				gint          index)
{
  ...
  g_return_val_if_fail (index < gtk_tree_store_get_props (tree_store)->n_columns, G_TYPE_INVALID);

  gtk_tree_store_get_props (tree_store)->columns_dirty = TRUE;

  return gtk_tree_store_get_props (tree_store)->column_headers[index];
}
			 ...
			 GtkTreePath  *path)
{
  ...
  parent.stamp = gtk_tree_store_get_props (tree_store)->stamp;
  parent.user_data = gtk_tree_store_get_props (tree_store)->root;
			 ...
			 GtkTreeIter  *iter)
{
  ...
  g_return_val_if_fail (iter->stamp == gtk_tree_store_get_props (tree_store)->stamp, NULL);

  validate_tree (tree_store);

  if (G_NODE (iter->user_data)->parent == NULL &&
      G_NODE (iter->user_data) == gtk_tree_store_get_props (tree_store)->root)
    return __gtk_tree_path_new ();
  g_assert (G_NODE (iter->user_data)->parent != NULL);

  if (G_NODE (iter->user_data)->parent == G_NODE (gtk_tree_store_get_props (tree_store)->root))
    {
      retval = __gtk_tree_path_new ();
      tmp_node = G_NODE (gtk_tree_store_get_props (tree_store)->root)->children;
    }
  else
    {
  ...
  __gtk_tree_path_append_index (retval, i);
			  ...
			  GValue       *value)
{
  ...
  g_return_if_fail (column < gtk_tree_store_get_props (tree_store)->n_columns);
  ...
  if (list)
    {
      _gtk_tree_data_list_node_to_value (list,
					 gtk_tree_store_get_props (tree_store)->column_headers[column],
					 value);
    }
  else
    {
      /* We want to return an initialized but empty (default) value */
      g_value_init (value, gtk_tree_store_get_props (tree_store)->column_headers[column]);
    }
}
			      ...
			      GtkTreeIter  *parent)
{
  ...
  if (parent)
    ...
    children = G_NODE (gtk_tree_store_get_props (tree_store)->root)->children;

  if (children)
    {
      iter->stamp = gtk_tree_store_get_props (tree_store)->stamp;
			       ...
			       gint          n)
{
  ...
  if (parent == NULL)
    parent_node = gtk_tree_store_get_props (tree_store)->root;
  else
			    ...
			    GtkTreeIter  *child)
{
  ...
  if (parent != gtk_tree_store_get_props (tree_store)->root)
    {
			       ...
			       gboolean      sort)
{
  ...
  if (! g_type_is_a (G_VALUE_TYPE (value), gtk_tree_store_get_props (tree_store)->column_headers[column]))
    {
      if (! (g_value_type_compatible (G_VALUE_TYPE (value), gtk_tree_store_get_props (tree_store)->column_headers[column]) &&
	     g_value_type_compatible (gtk_tree_store_get_props (tree_store)->column_headers[column], G_VALUE_TYPE (value))))
	{
	  g_warning ("%s: Unable to convert from %s to %s\n",
		     G_STRLOC,
		     g_type_name (G_VALUE_TYPE (value)),
		     g_type_name (gtk_tree_store_get_props (tree_store)->column_headers[column]));
	  return retval;
	}
 ...
 **/
void
__gtk_tree_store_set_value (GtkTreeStore *tree_store,
			  GtkTreeIter  *iter,
			  gint          column,
			  GValue       *value)
{
  g_return_if_fail (GTK_IS_TREE_STORE (tree_store));
  g_return_if_fail (VALID_ITER (iter, tree_store));
  g_return_if_fail (column >= 0 && column < gtk_tree_store_get_props (tree_store)->n_columns);
  ...
  if (gtk_tree_store_real_set_value (tree_store, iter, column, value, TRUE))
    {
      ...
      __gtk_tree_model_row_changed (GTK_TREE_MODEL (tree_store), path, iter);
...
gtk_tree_store_get_compare_func (GtkTreeStore *tree_store)
{
  ...
  if (GTK_TREE_STORE_IS_SORTED (tree_store))
    {
      if (gtk_tree_store_get_props (tree_store)->sort_column_id != -1)
	{
	  GtkTreeDataSortHeader *header;
	  header = _gtk_tree_data_list_get_header (gtk_tree_store_get_props (tree_store)->sort_list,
						   gtk_tree_store_get_props (tree_store)->sort_column_id);
	...
	{
	  func = gtk_tree_store_get_props (tree_store)->default_sort_func;
	}
    }
...
static void
__gtk_tree_store_set_vector_internal (GtkTreeStore *tree_store,
				    GtkTreeIter  *iter,
				    gboolean     *emit_signal,
  ...
  for (i = 0; i < n_values; i++)
    {
      *emit_signal = gtk_tree_store_real_set_value (tree_store, iter,
      ...
      if (func == _gtk_tree_data_list_compare_func &&
	  columns[i] == gtk_tree_store_get_props (tree_store)->sort_column_id)
	*maybe_need_sort = TRUE;
    }
}

static void
__gtk_tree_store_set_valist_internal (GtkTreeStore *tree_store,
                                    GtkTreeIter  *iter,
                                    gboolean     *emit_signal,
                                    gboolean     *maybe_need_sort,
                                    va_list       var_args)
  ...
  while (column != -1)
    {
      ...
      if (column < 0 || column >= gtk_tree_store_get_props (tree_store)->n_columns)
	{
      ...
      if (error)
	{
      ...
      *emit_signal = gtk_tree_store_real_set_value (tree_store,
      ...
      if (func == _gtk_tree_data_list_compare_func &&
	  column == gtk_tree_store_get_props (tree_store)->sort_column_id)
	*maybe_need_sort = TRUE;
 ...
 *
 * A variant of __gtk_tree_store_set_valist() which takes
 ...
 **/
void
__gtk_tree_store_set_valuesv (GtkTreeStore *tree_store,
			    GtkTreeIter  *iter,
			    gint         *columns,
			    GValue       *values,
			    gint          n_values)
{
  ...
  __gtk_tree_store_set_vector_internal (tree_store, iter,
				      &emit_signal,
				      &maybe_need_sort,
...
/**
 * __gtk_tree_store_set_valist:
 * @tree_store: A #GtkTreeStore
 * @iter: A valid #GtkTreeIter for the row being modified
 * @var_args: <type>va_list</type> of column/value pairs
 *
 * See __gtk_tree_store_set(); this version takes a <type>va_list</type> for
 * use by language bindings.
 *
 **/
void
__gtk_tree_store_set_valist (GtkTreeStore *tree_store,
                           GtkTreeIter  *iter,
                           va_list       var_args)
{
  gboolean emit_signal = FALSE;
  ...
  __gtk_tree_store_set_valist_internal (tree_store, iter,
				      &emit_signal,
				      &maybe_need_sort,
				      var_args);
 ...
 * <literal>__gtk_tree_store_set (store, iter, 0, "Foo", -1)</literal>.
 *
 * The value will be referenced by the store if it is a %G_TYPE_OBJECT, and it
 * will be copied if it is a %G_TYPE_STRING or %G_TYPE_BOXED.
 **/
void
__gtk_tree_store_set (GtkTreeStore *tree_store,
		    GtkTreeIter  *iter,
		    ...)
{
  va_list var_args;
  ...
  __gtk_tree_store_set_valist (tree_store, iter, var_args);
  va_end (var_args);
}

/**
 * __gtk_tree_store_remove:
 * @tree_store: A #GtkTreeStore
 ...
 **/
gboolean
__gtk_tree_store_remove (GtkTreeStore *tree_store,
		       GtkTreeIter  *iter)
{
  GtkTreePath *path;
  ...
  if (G_NODE (iter->user_data)->data)
    g_node_traverse (G_NODE (iter->user_data), G_POST_ORDER, G_TRAVERSE_ALL,
		     -1, node_free, gtk_tree_store_get_props (tree_store)->column_headers);

  path = gtk_tree_store_get_path (GTK_TREE_MODEL (tree_store), iter);
  g_node_destroy (G_NODE (iter->user_data));

  __gtk_tree_model_row_deleted (GTK_TREE_MODEL (tree_store), path);

  if (parent != G_NODE (gtk_tree_store_get_props (tree_store)->root))
    {
      /* child_toggled */
      if (parent->children == NULL)
	{
	  ...
	  new_iter.stamp = gtk_tree_store_get_props (tree_store)->stamp;
	  new_iter.user_data = parent;
	  __gtk_tree_model_row_has_child_toggled (GTK_TREE_MODEL (tree_store), path, &new_iter);
	}
    }
  __gtk_tree_path_free (path);
 ...
 * fill in values, you need to call __gtk_tree_store_set() or
 * __gtk_tree_store_set_value().
 *
 **/
void
__gtk_tree_store_insert (GtkTreeStore *tree_store,
		       GtkTreeIter  *iter,
		       GtkTreeIter  *parent,
		       gint          position)
{
  ...
  if (parent_node != gtk_tree_store_get_props (tree_store)->root)
    {
      if (new_node->prev == NULL && new_node->next == NULL)
        {
          __gtk_tree_path_up (path);
          __gtk_tree_model_row_has_child_toggled (GTK_TREE_MODEL (tree_store), path, parent);
        }
    }
...
/**
 * __gtk_tree_store_insert_before:
 * @tree_store: A #GtkTreeStore
 * @iter: (out): An unset #GtkTreeIter to set to the new row
 * @parent: (allow-none): A valid #GtkTreeIter, or %NULL
 ...
 * __gtk_tree_store_set() or __gtk_tree_store_set_value().
 *
 **/
void
__gtk_tree_store_insert_before (GtkTreeStore *tree_store,
			      GtkTreeIter  *iter,
			      GtkTreeIter  *parent,
			      GtkTreeIter  *sibling)
{
      ...
      if (new_node->prev == NULL && new_node->next == NULL)
        {
          ...
          parent_iter.stamp = gtk_tree_store_get_props (tree_store)->stamp;
          parent_iter.user_data = parent_node;

          __gtk_tree_path_up (path);
          __gtk_tree_model_row_has_child_toggled (GTK_TREE_MODEL (tree_store), path, &parent_iter);
        }
    }
 ...
 **/
void
__gtk_tree_store_insert_after (GtkTreeStore *tree_store,
			     GtkTreeIter  *iter,
			     GtkTreeIter  *parent,
			     GtkTreeIter  *sibling)
{
...
/**
 * __gtk_tree_store_insert_with_values:
 * @tree_store: A #GtkTreeStore
 ...
 *
 * Calling
 * <literal>__gtk_tree_store_insert_with_values (tree_store, iter, position, ...)</literal>
 * has the same effect as calling
 * |[
 * __gtk_tree_store_insert (tree_store, iter, position);
 * __gtk_tree_store_set (tree_store, iter, ...);
 * ]|
 * with the different that the former will only emit a row_inserted signal,
 * while the latter will emit row_inserted, row_changed and if the tree store
 * is sorted, rows_reordered.  Since emitting the rows_reordered signal
 * repeatedly can affect the performance of the program,
 * __gtk_tree_store_insert_with_values() should generally be preferred when
 * inserting rows in a sorted tree store.
 *
 * Since: 2.10
 */
void
__gtk_tree_store_insert_with_values (GtkTreeStore *tree_store,
				   GtkTreeIter  *iter,
				   GtkTreeIter  *parent,
				   gint          position,
				   ...)
...
/**
 * __gtk_tree_store_insert_with_valuesv:
 * @tree_store: A #GtkTreeStore
 * @iter: (out) (allow-none): An unset #GtkTreeIter to set the new row, or %NULL.
 * @parent: (allow-none): A valid #GtkTreeIter, or %NULL
 * @position: position to insert the new row
 ...
 * @n_values: the length of the @columns and @values arrays
 *
 * A variant of __gtk_tree_store_insert_with_values() which takes
 * the columns and values as two arrays, instead of varargs.  This
 ...
 */
void
__gtk_tree_store_insert_with_valuesv (GtkTreeStore *tree_store,
				    GtkTreeIter  *iter,
				    GtkTreeIter  *parent,
				    gint          position,
				    gint         *columns,
 ...
 * call __gtk_tree_store_set() or __gtk_tree_store_set_value().
 **/
void
__gtk_tree_store_prepend (GtkTreeStore *tree_store,
			GtkTreeIter  *iter,
			GtkTreeIter  *parent)
{
  GNode *parent_node;
  ...
  if (parent_node->children == NULL)
    ...
    {
      __gtk_tree_store_insert_after (tree_store, iter, parent, NULL);
    }
 ...
 **/
void
__gtk_tree_store_append (GtkTreeStore *tree_store,
		       GtkTreeIter  *iter,
		       GtkTreeIter  *parent)
{
  GNode *parent_node;
  ...
  if (parent_node->children == NULL)
    ...
    {
      __gtk_tree_store_insert_before (tree_store, iter, parent, NULL);
    }
 ...
 **/
gboolean
__gtk_tree_store_is_ancestor (GtkTreeStore *tree_store,
			    GtkTreeIter  *iter,
 ...
 **/
gint
__gtk_tree_store_iter_depth (GtkTreeStore *tree_store,
			   GtkTreeIter  *iter)
{
...
static gboolean
__gtk_tree_store_clear_traverse (GNode        *node,
			       GtkTreeStore *store)
{
  GtkTreeIter iter;
  ...
  if (node->children)
    {
	  ...
	  current = child;
	  child = current->next;
	  if (__gtk_tree_store_clear_traverse (current, store))
	    return TRUE;
	}

      if (node->parent)
        {
	  iter.stamp = gtk_tree_store_get_props (store)->stamp;
	  iter.user_data = node;
...
gtk_tree_store_increment_stamp (GtkTreeStore *tree_store)
{
  do
    {
      gtk_tree_store_get_props (tree_store)->stamp++;
    }
  while (gtk_tree_store_get_props (tree_store)->stamp == 0);
}

/**
 * __gtk_tree_store_clear:
 * @tree_store: a #GtkTreeStore
 * 
 * Removes all rows from @tree_store
 **/
void
__gtk_tree_store_clear (GtkTreeStore *tree_store)
{
  g_return_if_fail (GTK_IS_TREE_STORE (tree_store));

  __gtk_tree_store_clear_traverse (gtk_tree_store_get_props (tree_store)->root, gtk_tree_store_get_props (tree_store));
  gtk_tree_store_increment_stamp (tree_store);
}

static gboolean
__gtk_tree_store_iter_is_valid_helper (GtkTreeIter *iter,
				     GNode       *first)
{
  GNode *node;
  ...
  do
	...
	return TRUE;
      ...
      if (node->children)
	if (__gtk_tree_store_iter_is_valid_helper (iter, node->children))
	  return TRUE;
...
/**
 * __gtk_tree_store_iter_is_valid:
 * @tree_store: A #GtkTreeStore.
 * @iter: A #GtkTreeIter.
 *
 ...
 **/
gboolean
__gtk_tree_store_iter_is_valid (GtkTreeStore *tree_store,
                              GtkTreeIter  *iter)
{
  g_return_val_if_fail (GTK_IS_TREE_STORE (tree_store), FALSE);
  g_return_val_if_fail (iter != NULL, FALSE);
  ...
  return __gtk_tree_store_iter_is_valid_helper (iter, gtk_tree_store_get_props (tree_store)->root);
}
                                 ...
                                 GtkTreePath       *path)
{
  ...
  if (gtk_tree_store_get_iter (GTK_TREE_MODEL (drag_source),
                               ...
                               path))
    {
      __gtk_tree_store_remove (GTK_TREE_STORE (drag_source),
                             &iter);
      return TRUE;
    }
  else
                              ...
                              GtkSelectionData  *selection_data)
{
  ...
  if (__gtk_tree_set_row_drag_data (selection_data,
                ...
                GtkTreeIter  *dest_iter)
{
  ...
  while (dl)
    {
      copy_iter = _gtk_tree_data_list_node_copy (dl, gtk_tree_store_get_props (tree_store)->column_headers[col]);
  ...
  __gtk_tree_model_row_changed (GTK_TREE_MODEL (tree_store), path, dest_iter);
  __gtk_tree_path_free (path);
}
      ...
      do
        {
          ...
          __gtk_tree_store_append (tree_store,
                                 &copy,
                                 dest_iter);
                                   ...
                                   GtkSelectionData  *selection_data)
{
  ...
  if (__gtk_tree_get_row_drag_data (selection_data,
				  &src_model,
				  &src_path) &&
      src_model == tree_model)
    {
      ...
      prev = __gtk_tree_path_copy (dest);
      ...
      if (!__gtk_tree_path_prev (prev))
        {
          ...
          dest_parent_p = NULL;
          parent = __gtk_tree_path_copy (dest);
          if (__gtk_tree_path_up (parent) &&
	      __gtk_tree_path_get_depth (parent) > 0)
            {
          ...
          __gtk_tree_path_free (parent);
          parent = NULL;

          __gtk_tree_store_prepend (tree_store,
                                  &dest_iter,
                                  dest_parent_p);
          ...
          if (gtk_tree_store_get_iter (tree_model, &dest_iter, prev))
            {
              ...
              __gtk_tree_store_insert_after (tree_store, &dest_iter, NULL,
                                           &tmp_iter);
				  ...
				  GtkSelectionData *selection_data)
{
  ...
  if (__gtk_tree_path_is_ancestor (src_path,
                                 dest_path))
    goto out;
  ...
  /* Can't drop if dest_path's parent doesn't exist */
  {
    ...
    if (__gtk_tree_path_get_depth (dest_path) > 1)
      {
	tmp = __gtk_tree_path_copy (dest_path);
	__gtk_tree_path_up (tmp);
...
/* Reordering */
static gint
__gtk_tree_store_reorder_func (gconstpointer a,
			     gconstpointer b,
			     gpointer      user_data)
{
  SortTuple *a_reorder;
 ...
 **/
void
__gtk_tree_store_reorder (GtkTreeStore *tree_store,
			GtkTreeIter  *parent,
			gint         *new_order)
{
  gint i, length = 0;
  ...
  if (!parent)
    level = G_NODE (gtk_tree_store_get_props (tree_store)->root)->children;
  else
  ...
  if (parent)
    ...
    G_NODE (gtk_tree_store_get_props (tree_store)->root)->children = sort_array[0].node;
  ...
  __gtk_tree_model_rows_reordered (GTK_TREE_MODEL (tree_store), path,
				 parent, new_order);
  __gtk_tree_path_free (path);
  g_free (sort_array);
}
 ...
 **/
void
__gtk_tree_store_swap (GtkTreeStore *tree_store,
		     GtkTreeIter  *a,
		     GtkTreeIter  *b)
{
  ...
  __gtk_tree_path_up (path_a);
  __gtk_tree_path_up (path_b);

  if (__gtk_tree_path_get_depth (path_a) == 0
      || __gtk_tree_path_get_depth (path_b) == 0)
    {
      if (__gtk_tree_path_get_depth (path_a) != __gtk_tree_path_get_depth (path_b))
        {
          __gtk_tree_path_free (path_a);
          __gtk_tree_path_free (path_b);
                                                                                
          g_warning ("Given children are not in the same level\n");
          return;
        }
      parent_node = G_NODE (gtk_tree_store_get_props (tree_store)->root);
    }
  else
    {
      if (__gtk_tree_path_compare (path_a, path_b))
        {
          __gtk_tree_path_free (path_a);
          __gtk_tree_path_free (path_b);
  ...
  __gtk_tree_model_rows_reordered (GTK_TREE_MODEL (tree_store), path_a,
				 parent_node == gtk_tree_store_get_props (tree_store)->root 
				 ? NULL : &parent, order);
  __gtk_tree_path_free (path_a);
  g_free (order);
		     ...
		     gboolean      before)
{
  ...
  if (position)
    {
       ...
       *   moving the iter before path or "path - 1" doesn't make sense
       */
      if (!__gtk_tree_path_compare (path, pos_path))
	goto free_paths_and_out;

      if (before)
        __gtk_tree_path_next (path);
      else
        __gtk_tree_path_prev (path);
	...
	goto free_paths_and_out;
      ...
      if (__gtk_tree_path_get_depth (path) != __gtk_tree_path_get_depth (pos_path))
        {
          g_warning ("Given children are not in the same level\n");
      ...
      tmppath = __gtk_tree_path_copy (pos_path);
      __gtk_tree_path_up (path);
      __gtk_tree_path_up (tmppath);

      if (__gtk_tree_path_get_depth (path) > 0 &&
	  __gtk_tree_path_compare (path, tmppath))
        {
          g_warning ("Given children are not in the same level\n");
  ...
  if (depth)
    ...
    parent = G_NODE (gtk_tree_store_get_props (tree_store)->root);
  ...
  if (before && position)
    {
      ...
      if (__gtk_tree_path_get_indices (pos_path)[__gtk_tree_path_get_depth (pos_path) - 1] > 0)
        {
          __gtk_tree_path_prev (pos_path);
          if (gtk_tree_store_get_iter (GTK_TREE_MODEL (tree_store), 
				       &dst_a, pos_path))
            a = G_NODE (dst_a.user_data);
          else
            a = NULL;
          __gtk_tree_path_next (pos_path);
	}
  ...
  /* emit signal */
  if (position)
    new_pos = __gtk_tree_path_get_indices (pos_path)[__gtk_tree_path_get_depth (pos_path)-1];
  else if (before)
    {
      if (depth)
  ...
  if (depth)
    {
      tmppath = gtk_tree_store_get_path (GTK_TREE_MODEL (tree_store), 
					 &parent_iter);
      __gtk_tree_model_rows_reordered (GTK_TREE_MODEL (tree_store),
				     tmppath, &parent_iter, order);
    }
  else
    {
      tmppath = __gtk_tree_path_new ();
      __gtk_tree_model_rows_reordered (GTK_TREE_MODEL (tree_store),
				     tmppath, NULL, order);
    }
 ...
 **/
void
__gtk_tree_store_move_before (GtkTreeStore *tree_store,
                            GtkTreeIter  *iter,
			    GtkTreeIter  *position)
{
 ...
 **/
void
__gtk_tree_store_move_after (GtkTreeStore *tree_store,
                           GtkTreeIter  *iter,
			   GtkTreeIter  *position)
{
			     ...
			     gpointer      user_data)
{
  ...
  if (gtk_tree_store_get_props (tree_store)->sort_column_id != -1)
    ...
    {
      g_return_val_if_fail (gtk_tree_store_get_props (tree_store)->default_sort_func != NULL, 0);
      func = gtk_tree_store_get_props (tree_store)->default_sort_func;
      data = gtk_tree_store_get_props (tree_store)->default_sort_data;
    }

  node_a = ((SortTuple *) a)->node;
  node_b = ((SortTuple *) b)->node;

  iter_a.stamp = gtk_tree_store_get_props (tree_store)->stamp;
  iter_a.user_data = node_a;
  iter_b.stamp = gtk_tree_store_get_props (tree_store)->stamp;
  iter_b.user_data = node_b;

  retval = (* func) (GTK_TREE_MODEL (user_data), &iter_a, &iter_b, data);

  if (gtk_tree_store_get_props (tree_store)->order == GTK_SORT_DESCENDING)
    {
      if (retval > 0)
	retval = -1;
      else if (retval < 0)
				  ...
				  gboolean      emit_signal)
{
  ...
  tmp_iter.stamp = gtk_tree_store_get_props (tree_store)->stamp;
  if (gtk_tree_store_get_props (tree_store)->sort_column_id != -1)
    {
      GtkTreeDataSortHeader *header;
      header = _gtk_tree_data_list_get_header (gtk_tree_store_get_props (tree_store)->sort_list,
  ...
  if (func == _gtk_tree_data_list_compare_func &&
      gtk_tree_store_get_props (tree_store)->sort_column_id != column)
    return;
				   ...
				   GtkSortType      *order)
{
  ...
  if (sort_column_id)
    * sort_column_id = gtk_tree_store_get_props (tree_store)->sort_column_id;
  if (order)
    * order = gtk_tree_store_get_props (tree_store)->order;

  if (gtk_tree_store_get_props (tree_store)->sort_column_id == GTK_TREE_SORTABLE_DEFAULT_SORT_COLUMN_ID ||
      gtk_tree_store_get_props (tree_store)->sort_column_id == GTK_TREE_SORTABLE_UNSORTED_SORT_COLUMN_ID)
    return FALSE;
...
static void
__gtk_tree_store_set_sort_column_id (GtkTreeSortable  *sortable,
				   gint              sort_column_id,
				   GtkSortType       order)
{
  GtkTreeStore *tree_store = (GtkTreeStore *) sortable;
  ...
  if ((gtk_tree_store_get_props (tree_store)->sort_column_id == sort_column_id) &&
      (gtk_tree_store_get_props (tree_store)->order == order))
    return;
  ...
  gtk_tree_store_get_props (tree_store)->sort_column_id = sort_column_id;
  gtk_tree_store_get_props (tree_store)->order = order;
...
static void
__gtk_tree_store_set_sort_func (GtkTreeSortable        *sortable,
			      gint                    sort_column_id,
			      GtkTreeIterCompareFunc  func,
			      gpointer                data,
			      GDestroyNotify          destroy)
{
  ...
  gtk_tree_store_get_props (tree_store)->sort_list = _gtk_tree_data_list_set_header (gtk_tree_store_get_props (tree_store)->sort_list, 
							  sort_column_id, 
							  func, data, destroy);
...
static void
__gtk_tree_store_set_default_sort_func (GtkTreeSortable        *sortable,
				      GtkTreeIterCompareFunc  func,
				      gpointer                data,
				      GDestroyNotify          destroy)
{
  ...
  gtk_tree_store_get_props (tree_store)->default_sort_func = func;
  gtk_tree_store_get_props (tree_store)->default_sort_data = data;
  gtk_tree_store_get_props (tree_store)->default_sort_destroy = destroy;
...
gtk_tree_store_has_default_sort_func (GtkTreeSortable *sortable)
{
  ...
  return (gtk_tree_store_get_props (tree_store)->default_sort_func != NULL);
}
  ...
  if (strcmp (element_name, "columns") == 0)
    {
      ...
      __gtk_tree_store_set_column_types (GTK_TREE_STORE (data->object), i, types);
