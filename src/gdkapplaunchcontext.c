                                    ...
                                    GList             *files)
{
  ...
  if (priv->screen)
    return __gdk_screen_make_display_name (priv->screen);
  ...
  return g_strdup (__gdk_display_get_name (display));
}

/**
 * __gdk_app_launch_context_set_display:
 * @context: a #GdkAppLaunchContext
 * @display: a #GdkDisplay
 *
 * Sets the display on which applications will be launched when
 * using this context. See also __gdk_app_launch_context_set_screen().
 *
 * Since: 2.14
 */
void
__gdk_app_launch_context_set_display (GdkAppLaunchContext *context,
				    GdkDisplay          *display)
{
...
/**
 * __gdk_app_launch_context_set_screen:
 * @context: a #GdkAppLaunchContext
 * @screen: a #GdkScreen
 *
 * Sets the screen on which applications will be launched when
 * using this context. See also __gdk_app_launch_context_set_display().
 *
 ...
 */
void
__gdk_app_launch_context_set_screen (GdkAppLaunchContext *context,
				   GdkScreen           *screen)
{
  g_return_if_fail (GDK_IS_APP_LAUNCH_CONTEXT (context));
...
/**
 * __gdk_app_launch_context_set_desktop:
 * @context: a #GdkAppLaunchContext
 ...
 */
void
__gdk_app_launch_context_set_desktop (GdkAppLaunchContext *context,
				    gint                 desktop)
{
  g_return_if_fail (GDK_IS_APP_LAUNCH_CONTEXT (context));
...
/**
 * __gdk_app_launch_context_set_timestamp:
 * @context: a #GdkAppLaunchContext
 ...
 */
void
__gdk_app_launch_context_set_timestamp (GdkAppLaunchContext *context,
				      guint32              timestamp)
{
  g_return_if_fail (GDK_IS_APP_LAUNCH_CONTEXT (context));
...
/**
 * __gdk_app_launch_context_set_icon:
 * @context: a #GdkAppLaunchContext
 ...
 * notification.
 *
 * See also __gdk_app_launch_context_set_icon_name().
 *
 * Since: 2.14
 */
void
__gdk_app_launch_context_set_icon (GdkAppLaunchContext *context,
                                 GIcon               *icon)
{
  g_return_if_fail (GDK_IS_APP_LAUNCH_CONTEXT (context));
...
/**
 * __gdk_app_launch_context_set_icon_name:
 * @context: a #GdkAppLaunchContext
 * @icon_name: (allow-none): an icon name, or %NULL
 *
 * Sets the icon for applications that are launched with this context. 
 * The @icon_name will be interpreted in the same way as the Icon field 
 * in desktop files. See also __gdk_app_launch_context_set_icon(). 
 *
 ...
 */
void
__gdk_app_launch_context_set_icon_name (GdkAppLaunchContext *context,
 ...
 */
GdkAppLaunchContext *
__gdk_app_launch_context_new (void)
{
