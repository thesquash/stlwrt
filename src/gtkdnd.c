...
void
___gtk_drag_dest_handle_event (GtkWidget *toplevel,
			    GdkEvent  *event)
{
  GtkDragDestInfo *info;
  GdkDragContext *context;
                      ...
                      GtkDragDestCallback  callback)
{
   ...
   */
  widget = ___gtk_widget_find_at_coords (__gtk_widget_get_window (widget),
                                       x, y, &x, &y);
  if (!widget)
    return FALSE;
...
/*************************************************************
 * ___gtk_drag_source_handle_event:
 *     Called from widget event handling code on Drag events
 *     for drag sources.
 *
 *   arguments:
...
void
___gtk_drag_source_handle_event (GtkWidget *widget,
			       GdkEvent  *event)
{
  GtkDragSourceInfo *info;
  GdkDragContext *context;
