...
#endif
  _gtk_file_chooser_default_get_props (impl)->local_only = TRUE;
  _gtk_file_chooser_default_get_props (impl)->preview_widget_active = TRUE;
  _gtk_file_chooser_default_get_props (impl)->use_preview_label = TRUE;
  _gtk_file_chooser_default_get_props (impl)->select_multiple = FALSE;
  _gtk_file_chooser_default_get_props (impl)->show_hidden = FALSE;
  _gtk_file_chooser_default_get_props (impl)->show_size_column = TRUE;
  _gtk_file_chooser_default_get_props (impl)->icon_size = FALLBACK_ICON_SIZE;
  _gtk_file_chooser_default_get_props (impl)->load_state = LOAD_EMPTY;
  _gtk_file_chooser_default_get_props (impl)->reload_state = RELOAD_EMPTY;
  _gtk_file_chooser_default_get_props (impl)->pending_select_files = NULL;
  _gtk_file_chooser_default_get_props (impl)->location_mode = LOCATION_MODE_PATH_BAR;
  _gtk_file_chooser_default_get_props (impl)->operation_mode = OPERATION_MODE_BROWSE;
  _gtk_file_chooser_default_get_props (impl)->sort_column = MODEL_COL_NAME;
  _gtk_file_chooser_default_get_props (impl)->sort_order = GTK_SORT_ASCENDING;
  _gtk_file_chooser_default_get_props (impl)->recent_manager = __gtk_recent_manager_get_default ();
  _gtk_file_chooser_default_get_props (impl)->create_folders = TRUE;
			 ...
			 GtkTreeIter           *iter)
{
  ...
  __gtk_tree_model_get (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), iter,
...
shortcuts_free (GtkFileChooserDefault *impl)
{
  ...
  if (!_gtk_file_chooser_default_get_props (impl)->shortcuts_model)
    return;

  if (__gtk_tree_model_get_iter_first (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter))
    do
      {
	shortcuts_free_row_data (impl, &iter);
      }
    while (__gtk_tree_model_iter_next (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter));

  g_object_unref (_gtk_file_chooser_default_get_props (impl)->shortcuts_model);
  _gtk_file_chooser_default_get_props (impl)->shortcuts_model = NULL;
}

static void
pending_select_files_free (GtkFileChooserDefault *impl)
{
  g_slist_foreach (_gtk_file_chooser_default_get_props (impl)->pending_select_files, (GFunc) g_object_unref, NULL);
  g_slist_free (_gtk_file_chooser_default_get_props (impl)->pending_select_files);
  _gtk_file_chooser_default_get_props (impl)->pending_select_files = NULL;
}
...
pending_select_files_add (GtkFileChooserDefault *impl,
			  GFile                 *file)
{
  _gtk_file_chooser_default_get_props (impl)->pending_select_files =
    g_slist_prepend (_gtk_file_chooser_default_get_props (impl)->pending_select_files, g_object_ref (file));
}
...
gtk_file_chooser_default_finalize (GObject *object)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model)
    g_object_unref (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model);

  shortcuts_free (impl);

  g_free (_gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name);

  for (l = _gtk_file_chooser_default_get_props (impl)->filters; l; l = l->next)
    {
      GtkFileFilter *filter;
  ...
  g_slist_free (_gtk_file_chooser_default_get_props (impl)->filters);

  if (_gtk_file_chooser_default_get_props (impl)->current_filter)
    g_object_unref (_gtk_file_chooser_default_get_props (impl)->current_filter);

  if (_gtk_file_chooser_default_get_props (impl)->current_volume_file)
    g_object_unref (_gtk_file_chooser_default_get_props (impl)->current_volume_file);

  if (_gtk_file_chooser_default_get_props (impl)->current_folder)
    g_object_unref (_gtk_file_chooser_default_get_props (impl)->current_folder);

  if (_gtk_file_chooser_default_get_props (impl)->preview_file)
    g_object_unref (_gtk_file_chooser_default_get_props (impl)->preview_file);

  if (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group)
    g_object_unref (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group);
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->load_timeout_id == 0);

  g_free (_gtk_file_chooser_default_get_props (impl)->preview_display_name);
...
{
  if (_gtk_file_chooser_default_get_props (impl)->use_preview_label)
    {
      if (!_gtk_file_chooser_default_get_props (impl)->preview_label)
	{
	  _gtk_file_chooser_default_get_props (impl)->preview_label = __gtk_label_new (_gtk_file_chooser_default_get_props (impl)->preview_display_name);
	  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->preview_box), _gtk_file_chooser_default_get_props (impl)->preview_label, FALSE, FALSE, 0);
	  __gtk_box_reorder_child (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->preview_box), _gtk_file_chooser_default_get_props (impl)->preview_label, 0);
	  __gtk_label_set_ellipsize (GTK_LABEL (_gtk_file_chooser_default_get_props (impl)->preview_label), PANGO_ELLIPSIZE_MIDDLE);
	  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->preview_label);
	}
    }
  else
    {
      if (_gtk_file_chooser_default_get_props (impl)->preview_label)
	{
	  __gtk_widget_destroy (_gtk_file_chooser_default_get_props (impl)->preview_label);
	  _gtk_file_chooser_default_get_props (impl)->preview_label = NULL;
	}
    }

  if (_gtk_file_chooser_default_get_props (impl)->preview_widget_active && _gtk_file_chooser_default_get_props (impl)->preview_widget)
    __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->preview_box);
  else
    __gtk_widget_hide (_gtk_file_chooser_default_get_props (impl)->preview_box);
...
{
  if (preview_widget == _gtk_file_chooser_default_get_props (impl)->preview_widget)
    return;

  if (_gtk_file_chooser_default_get_props (impl)->preview_widget)
    __gtk_container_remove (GTK_CONTAINER (_gtk_file_chooser_default_get_props (impl)->preview_box),
			  _gtk_file_chooser_default_get_props (impl)->preview_widget);

  _gtk_file_chooser_default_get_props (impl)->preview_widget = preview_widget;
  if (_gtk_file_chooser_default_get_props (impl)->preview_widget)
    {
      __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->preview_widget);
      __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->preview_box), _gtk_file_chooser_default_get_props (impl)->preview_widget, TRUE, TRUE, 0);
      __gtk_box_reorder_child (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->preview_box),
			     _gtk_file_chooser_default_get_props (impl)->preview_widget,
			     (_gtk_file_chooser_default_get_props (impl)->use_preview_label && _gtk_file_chooser_default_get_props (impl)->preview_label) ? 1 : 0);
    }
...
render_recent_icon (GtkFileChooserDefault *impl)
{
  ...
  retval = __gtk_icon_theme_load_icon (theme, "document-open-recent",
                                     _gtk_file_chooser_default_get_props (impl)->icon_size, 0,
                                     NULL);
...
shortcuts_reload_icons (GtkFileChooserDefault *impl)
{
  ...
  for (l = _gtk_file_chooser_default_get_props (impl)->reload_icon_cancellables; l; l = l->next)
    {
      GCancellable *cancellable = G_CANCELLABLE (l->data);
      g_cancellable_cancel (cancellable);
    }
  g_slist_free (_gtk_file_chooser_default_get_props (impl)->reload_icon_cancellables);
  _gtk_file_chooser_default_get_props (impl)->reload_icon_cancellables = NULL;
	  ...
	  if (shortcut_type == SHORTCUT_TYPE_VOLUME)
	    {
	      ...
	      pixbuf = _gtk_file_system_volume_render_icon (volume, GTK_WIDGET (impl),
						 	    _gtk_file_chooser_default_get_props (impl)->icon_size, NULL);
	    }
		  ...
		  GCancellable *cancellable;
	          ...
	          tree_path = __gtk_tree_model_get_path (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter);
	          info->row_ref = __gtk_tree_row_reference_new (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), tree_path);
	          __gtk_tree_path_free (tree_path);

	          cancellable = _gtk_file_system_get_info (_gtk_file_chooser_default_get_props (impl)->file_system, file,
							   "standard::icon",
							   shortcuts_reload_icons_get_info_cb,
							   info);
	          _gtk_file_chooser_default_get_props (impl)->reload_icon_cancellables = g_slist_append (_gtk_file_chooser_default_get_props (impl)->reload_icon_cancellables, cancellable);
	        }
              else
	        {
	          ...
	          pixbuf = __gtk_icon_theme_load_icon (icon_theme, "folder-remote", 
						     _gtk_file_chooser_default_get_props (impl)->icon_size, 0, NULL);
	        }
            }
	  else if (shortcut_type == SHORTCUT_TYPE_SEARCH)
	    {
          ...
          __gtk_list_store_set (_gtk_file_chooser_default_get_props (impl)->shortcuts_model, &iter,
  	   	              SHORTCUTS_COL_PIXBUF, pixbuf,
	                      -1);
		       ...
		       GFile                 *folder)
{
  ...
  selection = __gtk_tree_view_get_selection (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view));
  ...
  for (; n_rows; n_rows--)
    {
      ...
      if (!__gtk_tree_model_get_iter (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter, path))
	g_assert_not_reached ();

      shortcuts_free_row_data (impl, &iter);
      __gtk_list_store_remove (_gtk_file_chooser_default_get_props (impl)->shortcuts_model, &iter);
    }
  ...
  switch (type)
    {
      case SHORTCUTS_CWD:
        if (value < 0)
	  _gtk_file_chooser_default_get_props (impl)->has_cwd = FALSE;
	else
	  _gtk_file_chooser_default_get_props (impl)->has_cwd = TRUE;
	break;
	
      case SHORTCUTS_HOME:
	if (value < 0)
	  _gtk_file_chooser_default_get_props (impl)->has_home = FALSE;
	else
	  _gtk_file_chooser_default_get_props (impl)->has_home = TRUE;
	break;

      case SHORTCUTS_DESKTOP:
	if (value < 0)
	  _gtk_file_chooser_default_get_props (impl)->has_desktop = FALSE;
	else
	  _gtk_file_chooser_default_get_props (impl)->has_desktop = TRUE;
	break;

      case SHORTCUTS_VOLUMES:
	_gtk_file_chooser_default_get_props (impl)->num_volumes += value;
	break;

      case SHORTCUTS_SHORTCUTS:
	_gtk_file_chooser_default_get_props (impl)->num_shortcuts += value;
	break;

      case SHORTCUTS_BOOKMARKS:
	_gtk_file_chooser_default_get_props (impl)->num_bookmarks += value;
	break;

      case SHORTCUTS_CURRENT_FOLDER:
	if (value < 0)
	  _gtk_file_chooser_default_get_props (impl)->shortcuts_current_folder_active = FALSE;
	else
	  _gtk_file_chooser_default_get_props (impl)->shortcuts_current_folder_active = TRUE;
	break;
			...
			gpointer      data)
{
  ...
  __gtk_tree_model_get_iter (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (request->impl)->shortcuts_model),
			   &iter, path);
  __gtk_tree_path_free (path);

  /* validate cancellable, else goto out */
  __gtk_tree_model_get (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (request->impl)->shortcuts_model), &iter,
  ...
  __gtk_list_store_set (_gtk_file_chooser_default_get_props (request->impl)->shortcuts_model, &iter,
  ...
  if (!info)
    {
      ...
      __gtk_list_store_remove (_gtk_file_chooser_default_get_props (request->impl)->shortcuts_model, &iter);
  ...
  pixbuf = _gtk_file_info_render_icon (info, GTK_WIDGET (request->impl),
				       _gtk_file_chooser_default_get_props (request->impl)->icon_size);
  ...
  if (_gtk_file_chooser_default_get_props (request->impl)->shortcuts_pane_filter_model)
    __gtk_tree_model_filter_refilter (GTK_TREE_MODEL_FILTER (_gtk_file_chooser_default_get_props (request->impl)->shortcuts_pane_filter_model));
		       ...
		       ShortcutsIndex         type)
{
  ...
  else if (shortcut_type == SHORTCUT_TYPE_FILE)
    {
	  ...
	  GCancellable *cancellable;
	    ...
	    request->label_copy = g_strdup (label);
          ...
          if (pos == -1)
	    __gtk_list_store_append (_gtk_file_chooser_default_get_props (impl)->shortcuts_model, &iter);
          else
	    __gtk_list_store_insert (_gtk_file_chooser_default_get_props (impl)->shortcuts_model, &iter, pos);

          p = __gtk_tree_model_get_path (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter);
          ...
          cancellable = _gtk_file_system_get_info (_gtk_file_chooser_default_get_props (request->impl)->file_system, request->file,
  ...
  if (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model)
    __gtk_tree_model_filter_refilter (GTK_TREE_MODEL_FILTER (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model));
...
shortcuts_append_search (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->has_search = TRUE;
}
  ...
  for (; bookmarks; bookmarks = bookmarks->next)
    {
      ...
      if (_gtk_file_chooser_default_get_props (impl)->local_only && !_gtk_file_has_native_path (file))
	continue;

      if (shortcut_find_position (impl, file) != -1)
        continue;

      label = _gtk_file_system_get_bookmark_label (_gtk_file_chooser_default_get_props (impl)->file_system, file);
		     ...
		     ShortcutsIndex         where)
{
  ...
  n += _gtk_file_chooser_default_get_props (impl)->has_search ? 1 : 0;
  ...
  n += _gtk_file_chooser_default_get_props (impl)->has_cwd ? 1 : 0;
  ...
  n += _gtk_file_chooser_default_get_props (impl)->has_home ? 1 : 0;

  if (where == SHORTCUTS_DESKTOP)
    goto out;

  n += _gtk_file_chooser_default_get_props (impl)->has_desktop ? 1 : 0;

  if (where == SHORTCUTS_VOLUMES)
    goto out;

  n += _gtk_file_chooser_default_get_props (impl)->num_volumes;

  if (where == SHORTCUTS_SHORTCUTS)
    goto out;

  n += _gtk_file_chooser_default_get_props (impl)->num_shortcuts;

  if (where == SHORTCUTS_BOOKMARKS_SEPARATOR)
    goto out;

  /* If there are no bookmarks there won't be a separator */
  n += (_gtk_file_chooser_default_get_props (impl)->num_bookmarks > 0) ? 1 : 0;

  if (where == SHORTCUTS_BOOKMARKS)
    goto out;

  n += _gtk_file_chooser_default_get_props (impl)->num_bookmarks;
...
shortcuts_add_volumes (GtkFileChooserDefault *impl)
{
  ...
  old_changing_folders = _gtk_file_chooser_default_get_props (impl)->changing_folder;
  ...
  for (l = list; l; l = l->next)
    {
      ...
      if (_gtk_file_chooser_default_get_props (impl)->local_only)
	{
  ...
  _gtk_file_chooser_default_get_props (impl)->num_volumes = n;
  g_slist_free (list);

  if (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model)
    __gtk_tree_model_filter_refilter (GTK_TREE_MODEL_FILTER (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model));

  _gtk_file_chooser_default_get_props (impl)->changing_folder = old_changing_folders;
			    ...
			    ShortcutsIndex         where)
{
  ...
  __gtk_list_store_insert (_gtk_file_chooser_default_get_props (impl)->shortcuts_model, &iter,
...
shortcuts_add_bookmarks (GtkFileChooserDefault *impl)
{
  ...
  if (shortcuts_get_selected (impl, &iter))
    {
      __gtk_tree_model_get (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), 
			  &iter, 
			  SHORTCUTS_COL_DATA, &col_data,
			  SHORTCUTS_COL_TYPE, &shortcut_type,
			  -1);
  ...
  if (_gtk_file_chooser_default_get_props (impl)->num_bookmarks > 0)
    shortcuts_remove_rows (impl,
			   shortcuts_get_index (impl, SHORTCUTS_BOOKMARKS_SEPARATOR),
			   _gtk_file_chooser_default_get_props (impl)->num_bookmarks + 1);

  _gtk_file_chooser_default_get_props (impl)->num_bookmarks = 0;
  shortcuts_insert_separator (impl, SHORTCUTS_BOOKMARKS_SEPARATOR);

  bookmarks = _gtk_file_system_list_bookmarks (_gtk_file_chooser_default_get_props (impl)->file_system);
...
shortcuts_add_current_folder (GtkFileChooserDefault *impl)
{
  ...
  g_assert (!_gtk_file_chooser_default_get_props (impl)->shortcuts_current_folder_active);
  ...
  if (pos == -1)
    {
      ...
      volume = _gtk_file_system_get_volume_for_file (_gtk_file_chooser_default_get_props (impl)->file_system, _gtk_file_chooser_default_get_props (impl)->current_folder);
      if (volume)
        base_file = _gtk_file_system_volume_get_root (volume);
      else
        base_file = NULL;
...
shortcuts_update_current_folder (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->shortcuts_current_folder_active)
    {
...
shortcuts_model_create (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->shortcuts_model = __gtk_list_store_new (SHORTCUTS_COL_NUM_COLUMNS,
  ...
  if (_gtk_file_chooser_default_get_props (impl)->recent_manager)
    {
      shortcuts_append_recent (impl);
      shortcuts_insert_separator (impl, SHORTCUTS_RECENT_SEPARATOR);
    }
  
  if (_gtk_file_chooser_default_get_props (impl)->file_system)
    {
  ...
  __gtk_tree_model_filter_set_visible_func (GTK_TREE_MODEL_FILTER (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model),
			   ...
			   GtkFileChooserDefault *impl)
{
  ...
  if (!_gtk_file_chooser_default_get_props (impl)->browse_files_model)
    return; /* FIXME: this sucks.  Disable the New Folder button or something. */

  /* Prevent button from being clicked twice */
  __gtk_widget_set_sensitive (_gtk_file_chooser_default_get_props (impl)->browse_new_folder_button, FALSE);

  _gtk_file_system_model_add_editable (_gtk_file_chooser_default_get_props (impl)->browse_files_model, &iter);

  path = __gtk_tree_model_get_path (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->browse_files_model), &iter);
  __gtk_tree_view_scroll_to_cell (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
				path, _gtk_file_chooser_default_get_props (impl)->list_name_column,
				FALSE, 0.0, 0.0);

  g_object_set (_gtk_file_chooser_default_get_props (impl)->list_name_renderer, "editable", TRUE, NULL);
  __gtk_tree_view_set_cursor (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
			    path,
			    _gtk_file_chooser_default_get_props (impl)->list_name_column,
			    TRUE);
...
edited_idle_cb (GtkFileChooserDefault *impl)
{
  ...
  g_source_destroy (_gtk_file_chooser_default_get_props (impl)->edited_idle);
  _gtk_file_chooser_default_get_props (impl)->edited_idle = NULL;

  _gtk_file_system_model_remove_editable (_gtk_file_chooser_default_get_props (impl)->browse_files_model);
  g_object_set (_gtk_file_chooser_default_get_props (impl)->list_name_renderer, "editable", FALSE, NULL);

  __gtk_widget_set_sensitive (_gtk_file_chooser_default_get_props (impl)->browse_new_folder_button, TRUE);

  if (_gtk_file_chooser_default_get_props (impl)->edited_new_text /* not cancelled? */
      && (strlen (_gtk_file_chooser_default_get_props (impl)->edited_new_text) != 0)
      && (strcmp (_gtk_file_chooser_default_get_props (impl)->edited_new_text, DEFAULT_NEW_FOLDER_NAME) != 0)) /* Don't create folder if name is empty or has not been edited */
    {
      GError *error = NULL;
      GFile *file;

      file = g_file_get_child_for_display_name (_gtk_file_chooser_default_get_props (impl)->current_folder,
						_gtk_file_chooser_default_get_props (impl)->edited_new_text,
						&error);
      if (file)
	{
	  GError *error = NULL;
	...
	error_creating_folder_dialog (impl, file, error);
      ...
      g_free (_gtk_file_chooser_default_get_props (impl)->edited_new_text);
      _gtk_file_chooser_default_get_props (impl)->edited_new_text = NULL;
    }
...
{
  _gtk_file_chooser_default_get_props (impl)->filter_combo = __gtk_combo_box_text_new ();
  __gtk_combo_box_set_focus_on_click (GTK_COMBO_BOX (_gtk_file_chooser_default_get_props (impl)->filter_combo), FALSE);

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->filter_combo, "changed",
		    G_CALLBACK (filter_combo_changed), impl);

  __gtk_widget_set_tooltip_text (_gtk_file_chooser_default_get_props (impl)->filter_combo,
                               _("Select which types of files are shown"));

  return _gtk_file_chooser_default_get_props (impl)->filter_combo;
}
			...
			GFile                 *file)
{
  ...
  if (current_folder_separator_idx >= _gtk_file_chooser_default_get_props (impl)->shortcuts_model->length)
    return -1;
#endif
  ...
  for (i = 0; i < current_folder_separator_idx; i++)
	...
	{
	  if (!__gtk_tree_model_iter_next (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter))
	    g_assert_not_reached ();
	}
    }
				  ...
				  int                    pos)
{
  ...
  error = NULL;
  if (!_gtk_file_system_insert_bookmark (_gtk_file_chooser_default_get_props (impl)->file_system, file, pos, &error))
    {
			...
			GtkTreeIter           *iter)
{
  ...
  if (!_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view)
    return FALSE;
  ...
  __gtk_tree_model_filter_convert_iter_to_child_iter (GTK_TREE_MODEL_FILTER (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model),
						    iter,
						    &parent_iter);
  return TRUE;
}
...
remove_selected_bookmarks (GtkFileChooserDefault *impl)
{
  ...
  error = NULL;
  if (!_gtk_file_system_remove_bookmark (_gtk_file_chooser_default_get_props (impl)->file_system, file, &error))
...
bookmarks_check_add_sensitivity (GtkFileChooserDefault *impl)
{
  ...
  __gtk_widget_set_sensitive (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_add_button, active);

  if (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_add_shortcut_item)
    __gtk_widget_set_sensitive (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_add_shortcut_item,
  ...
  if (active)
    {
      ...
      __gtk_widget_set_tooltip_text (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_add_button, tip);
      g_free (tip);
    }
}
  ...
  if (shortcuts_get_selected (impl, &iter))
    {
      __gtk_tree_model_get (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter,
                          ...
                          -1);
      __gtk_widget_set_sensitive (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_remove_button, removable);
      ...
      __gtk_widget_set_tooltip_text (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_remove_button, tip);
      g_free (tip);
    }
  else
    __gtk_widget_set_tooltip_text (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_remove_button,
...
shortcuts_check_popup_sensitivity (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu == NULL)
    return;
  ...
  __gtk_widget_set_sensitive (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu_remove_item, removable);
  __gtk_widget_set_sensitive (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu_rename_item, removable);
}
...
{
#if 0
  _gtk_file_chooser_default_get_props (impl)->shortcuts_drag_context = g_object_ref (context);
#endif
}
...
{
  if (!_gtk_file_chooser_default_get_props (impl)->shortcuts_drag_outside_idle)
    return;

  g_source_destroy (_gtk_file_chooser_default_get_props (impl)->shortcuts_drag_outside_idle);
  _gtk_file_chooser_default_get_props (impl)->shortcuts_drag_outside_idle = NULL;
}
#endif
...
{
#if 0
  g_object_unref (_gtk_file_chooser_default_get_props (impl)->shortcuts_drag_context);

  shortcuts_cancel_drag_outside_idle (impl);

  if (!_gtk_file_chooser_default_get_props (impl)->shortcuts_drag_outside)
    return;

  __gtk_button_clicked (GTK_BUTTON (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_remove_button));

  _gtk_file_chooser_default_get_props (impl)->shortcuts_drag_outside = FALSE;
#endif
}
...
{
#if 0
  if (__gtk_drag_get_source_widget (context) == widget && !_gtk_file_chooser_default_get_props (impl)->shortcuts_drag_outside_idle)
    {
      _gtk_file_chooser_default_get_props (impl)->shortcuts_drag_outside_idle = add_idle_while_impl_is_alive (_gtk_file_chooser_default_get_props (impl), G_CALLBACK (shortcuts_drag_outside_idle_cb));
    }
#endif

  __gtk_tree_view_set_drag_dest_row (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view),
				   NULL,
				 ...
				 GtkTreeViewDropPosition *pos)
{
  ...
  tree_view = GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view);
  ...
  if (!__gtk_tree_view_get_path_at_pos (tree_view,
				      ...
				      y - header_height,
                                      ...
                                      &cell_y))
    {
      row = bookmarks_index + _gtk_file_chooser_default_get_props (impl)->num_bookmarks - 1;
  ...
  else if (row > bookmarks_index + _gtk_file_chooser_default_get_props (impl)->num_bookmarks - 1)
    {
      row = bookmarks_index + _gtk_file_chooser_default_get_props (impl)->num_bookmarks - 1;
      *pos = GTK_TREE_VIEW_DROP_AFTER;
    }
			  ...
			  GtkFileChooserDefault *impl)
{
  ...
  __gtk_tree_view_set_drag_dest_row (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view), path, pos);
  __gtk_tree_path_free (path);
		   ...
		   int                    new_position)
{
  ...
  g_assert (model == _gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model);
  ...
  __gtk_tree_model_filter_convert_iter_to_child_iter (GTK_TREE_MODEL_FILTER (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model),
                                                    &iter,
						    &filter_iter);
  path = __gtk_tree_model_get_path (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter);
  ...
  g_assert (old_position >= 0 && old_position < _gtk_file_chooser_default_get_props (impl)->num_bookmarks);
  ...
  if (_gtk_file_system_remove_bookmark (_gtk_file_chooser_default_get_props (impl)->file_system, file, &error))
    {
      ...
      _gtk_file_system_set_bookmark_label (_gtk_file_chooser_default_get_props (impl)->file_system, file, name);
    }
  else
    error_adding_bookmark_dialog (impl, file, error);
				...
				GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->changing_folder)
    return;
				    ...
				    GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->location_entry)
    entry = _gtk_file_chooser_default_get_props (impl)->location_entry;
  else if (_gtk_file_chooser_default_get_props (impl)->search_entry)
    entry = _gtk_file_chooser_default_get_props (impl)->search_entry;
  else
    entry = NULL;
				...
				GtkMenu   *menu)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu = NULL;
  _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu_remove_item = NULL;
  _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu_rename_item = NULL;
}
...
rename_selected_bookmark (GtkFileChooserDefault *impl)
{
  ...
  if (shortcuts_get_selected (impl, &iter))
    {
      path = __gtk_tree_model_get_path (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter);
      column = __gtk_tree_view_get_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view), 0);
      renderers = __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (column));
      cell = g_list_nth_data (renderers, 1);
      g_list_free (renderers);
      g_object_set (cell, "editable", TRUE, NULL);
      __gtk_tree_view_set_cursor_on_cell (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view),
...
shortcuts_build_popup_menu (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu)
    return;

  _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu = __gtk_menu_new ();
  __gtk_menu_attach_to_widget (GTK_MENU (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu),
			     _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view,
			     shortcuts_popup_menu_detach_cb);

  item = __gtk_image_menu_item_new_with_label (_("Remove"));
  _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu_remove_item = item;
  ...
  __gtk_menu_shell_append (GTK_MENU_SHELL (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu), item);

  item = __gtk_menu_item_new_with_label (_("Rename..."));
  _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu_rename_item = item;
  g_signal_connect (item, "activate",
		      ...
		      GdkEventButton        *event)
{
  ...
  if (event)
    __gtk_menu_popup (GTK_MENU (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu),
		    NULL, NULL, NULL, NULL,
  ...
  else
    {
      __gtk_menu_popup (GTK_MENU (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu),
		      NULL, NULL,
		      popup_position_func, _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view,
		      0, GDK_CURRENT_TIME);
      __gtk_menu_shell_select_first (GTK_MENU_SHELL (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_popup_menu),
				   FALSE);
    }
}
				 ...
				 GtkFileChooserDefault *impl)
{
  ...
  in_press = TRUE;
  handled = __gtk_widget_event (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, (GdkEvent *) event);
  in_press = FALSE;
		  ...
		  GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_system_set_bookmark_label (_gtk_file_chooser_default_get_props (impl)->file_system, shortcut, new_text);
}
...
shortcuts_list_create (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view = __gtk_tree_view_new ();
  __gtk_tree_view_set_enable_search (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view), FALSE);
#ifdef PROFILE_FILE_CHOOSER
  g_object_set_data (G_OBJECT (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view), "fmq-name", "shortcuts");
#endif
   ...
   */
  g_signal_connect_after (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "key-press-event",
			  G_CALLBACK (shortcuts_key_press_event_after_cb), impl);

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "popup-menu",
		    G_CALLBACK (shortcuts_popup_menu_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "button-press-event",
		    G_CALLBACK (shortcuts_button_press_event_cb), impl);
  /* Accessible object name for the file chooser's shortcuts pane */
  atk_object_set_name (__gtk_widget_get_accessible (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view), _("Places"));

  __gtk_tree_view_set_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view), _gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model);

  __gtk_tree_view_enable_model_drag_source (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view),
					  GDK_BUTTON1_MASK,
					  tree_model_row_targets,
					  G_N_ELEMENTS (tree_model_row_targets),
					  GDK_ACTION_MOVE);

  __gtk_drag_dest_set (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view,
		     GTK_DEST_DEFAULT_ALL,
		     tree_model_row_targets,
		     G_N_ELEMENTS (tree_model_row_targets),
		     GDK_ACTION_COPY | GDK_ACTION_MOVE);
  __gtk_drag_dest_add_uri_targets (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view);
  ...
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "key-press-event",
		    G_CALLBACK (shortcuts_key_press_event_cb), impl);

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "drag-begin",
		    G_CALLBACK (shortcuts_drag_begin_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "drag-end",
		    G_CALLBACK (shortcuts_drag_end_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "drag-data-delete",
		    G_CALLBACK (shortcuts_drag_data_delete_cb), impl);

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "drag-leave",
		    G_CALLBACK (shortcuts_drag_leave_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "drag-motion",
		    G_CALLBACK (shortcuts_drag_motion_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "drag-drop",
		    G_CALLBACK (shortcuts_drag_drop_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "drag-data-received",
		    G_CALLBACK (shortcuts_drag_data_received_cb), impl);

  /* Support tooltips */
  __gtk_widget_set_has_tooltip (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, TRUE);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view, "query-tooltip",
		    G_CALLBACK (shortcuts_query_tooltip_cb), impl);

  __gtk_container_add (GTK_CONTAINER (swin), _gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view);
  ...
  __gtk_tree_view_set_row_separator_func (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view),
					shortcuts_row_separator_func,
					NULL, NULL);

  __gtk_tree_view_append_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view), column);
		       ...
		       GtkSizeGroup          *size_group)
{
  ...
  __gtk_toolbar_insert (GTK_TOOLBAR (toolbar), GTK_TOOL_ITEM (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_add_button), 0);
  __gtk_widget_set_tooltip_text (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_add_button,
  ...
  g_object_unref (icon);
  __gtk_toolbar_insert (GTK_TOOLBAR (toolbar), GTK_TOOL_ITEM (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_remove_button), 1);
  __gtk_widget_set_tooltip_text (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_remove_button,
                               _("Remove the selected bookmark"));
				 ...
				 gpointer     data)
{
  ...
  if (key_is_left_or_right (event))
    {
      __gtk_widget_grab_focus (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view);
      return TRUE;
    }
  ...
  if ((event->keyval == GDK_KEY_Return
      ...
      && !(_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER ||
	   _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER))
    {
      GtkWindow *window;
		      ...
		      GtkMenu   *menu)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu = NULL;
  _gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_add_shortcut_item = NULL;
  _gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_hidden_files_item = NULL;
}
...
show_size_column_toggled_cb (GtkCheckMenuItem *item,
                             GtkFileChooserDefault *impl)
{
  _gtk_file_chooser_default_get_props (impl)->show_size_column = __gtk_check_menu_item_get_active (item);

  __gtk_tree_view_column_set_visible (_gtk_file_chooser_default_get_props (impl)->list_size_column,
                                    _gtk_file_chooser_default_get_props (impl)->show_size_column);
}
  ...
  if (uris && uris[0])
    {
      ...
      if (_gtk_file_chooser_default_get_props (impl)->file_list_drag_data_received_cancellable)
        g_cancellable_cancel (_gtk_file_chooser_default_get_props (impl)->file_list_drag_data_received_cancellable);

      _gtk_file_chooser_default_get_props (impl)->file_list_drag_data_received_cancellable =
        _gtk_file_system_get_info (_gtk_file_chooser_default_get_props (impl)->file_system, file,
                                   "standard::type",
...
file_list_build_popup_menu (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu)
    return;

  _gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu = __gtk_menu_new ();
  __gtk_menu_attach_to_widget (GTK_MENU (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu),
			     _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view,
			     popup_menu_detach_cb);

  item = __gtk_image_menu_item_new_with_mnemonic (_("_Add to Bookmarks"));
  _gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_add_shortcut_item = item;
  __gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (item),
				 __gtk_image_new_from_stock (GTK_STOCK_ADD, GTK_ICON_SIZE_MENU));
  g_signal_connect (item, "activate",
		    G_CALLBACK (add_to_shortcuts_cb), impl);
  __gtk_widget_show (item);
  __gtk_menu_shell_append (GTK_MENU_SHELL (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu), item);
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_hidden_files_item = item;
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_size_column_item = item;
  g_signal_connect (item, "toggled",
...
file_list_update_popup_menu (GtkFileChooserDefault *impl)
{
  ...
  /* 'Show Hidden Files' */
  g_signal_handlers_block_by_func (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_hidden_files_item,
				   G_CALLBACK (show_hidden_toggled_cb), impl);
  __gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_hidden_files_item),
				  _gtk_file_chooser_default_get_props (impl)->show_hidden);
  g_signal_handlers_unblock_by_func (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_hidden_files_item,
				     G_CALLBACK (show_hidden_toggled_cb), impl);

  /* 'Show Size Column' */
  g_signal_handlers_block_by_func (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_size_column_item,
				   G_CALLBACK (show_size_column_toggled_cb), impl);
  __gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_size_column_item),
				  _gtk_file_chooser_default_get_props (impl)->show_size_column);
  g_signal_handlers_unblock_by_func (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu_size_column_item,
				     G_CALLBACK (show_size_column_toggled_cb), impl);
}
		      ...
		      GdkEventButton        *event)
{
  ...
  if (event)
    __gtk_menu_popup (GTK_MENU (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu),
		    NULL, NULL, NULL, NULL,
		    event->button, event->time);
  else
    {
      __gtk_menu_popup (GTK_MENU (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu),
		      NULL, NULL,
		      popup_position_func, _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view,
		      0, GDK_CURRENT_TIME);
      __gtk_menu_shell_select_first (GTK_MENU_SHELL (_gtk_file_chooser_default_get_props (impl)->browse_files_popup_menu),
				   FALSE);
    }
			    ...
			    GtkFileChooserDefault *impl)
{
  ...
  in_press = TRUE;
  __gtk_widget_event (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, (GdkEvent *) event);
  in_press = FALSE;
...
{
  __gtk_tree_view_column_set_sort_column_id (_gtk_file_chooser_default_get_props (impl)->list_name_column, MODEL_COL_NAME);
  __gtk_tree_view_column_set_sort_column_id (_gtk_file_chooser_default_get_props (impl)->list_mtime_column, MODEL_COL_MTIME);
  __gtk_tree_view_column_set_sort_column_id (_gtk_file_chooser_default_get_props (impl)->list_size_column, MODEL_COL_SIZE);
}
                            ...
                            gpointer    user_data)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_BROWSE)
    return FALSE;


  if (!__gtk_tree_view_get_tooltip_context (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
                                          &x, &y,
                                          keyboard_tip,
                                          &model, &path, &iter))
    return FALSE;
  ...
  parse_name = g_file_get_parse_name (file);
  __gtk_tooltip_set_text (tooltip, parse_name);
  __gtk_tree_view_set_tooltip_row (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
                                 tooltip,
                                 path);
...
set_icon_cell_renderer_fixed_size (GtkFileChooserDefault *impl, GtkCellRenderer *renderer)
{
  ...
  __gtk_cell_renderer_set_fixed_size (renderer, 
                                    xpad * 2 + _gtk_file_chooser_default_get_props (impl)->icon_size,
                                    ypad * 2 + _gtk_file_chooser_default_get_props (impl)->icon_size);
}
...
create_file_list (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view = __gtk_tree_view_new ();
#ifdef PROFILE_FILE_CHOOSER
  g_object_set_data (G_OBJECT (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), "fmq-name", "file_list");
#endif
  g_object_set_data (G_OBJECT (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), I_("GtkFileChooserDefault"), _gtk_file_chooser_default_get_props (impl));
  atk_object_set_name (__gtk_widget_get_accessible (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), _("Files"));

  __gtk_tree_view_set_rules_hint (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), TRUE);
  __gtk_container_add (GTK_CONTAINER (swin), _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view);

  __gtk_drag_dest_set (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view,
                     GTK_DEST_DEFAULT_ALL,
                     NULL, 0,
                     GDK_ACTION_COPY | GDK_ACTION_MOVE);
  __gtk_drag_dest_add_uri_targets (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view);
  
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "row-activated",
		    G_CALLBACK (list_row_activated), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "key-press-event",
    		    G_CALLBACK (browse_files_key_press_event_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "popup-menu",
		    G_CALLBACK (list_popup_menu_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "button-press-event",
		    G_CALLBACK (list_button_press_event_cb), impl);

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "drag-data-received",
                    G_CALLBACK (file_list_drag_data_received_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "drag-drop",
                    G_CALLBACK (file_list_drag_drop_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "drag-motion",
                    G_CALLBACK (file_list_drag_motion_cb), impl);

  g_object_set (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "has-tooltip", TRUE, NULL);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view, "query-tooltip",
  ...
  __gtk_tree_selection_set_select_function (selection,
					  list_select_func,
					  impl, NULL);
  __gtk_tree_view_enable_model_drag_source (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
					  GDK_BUTTON1_MASK,
					  NULL, 0,
					  GDK_ACTION_COPY | GDK_ACTION_MOVE);
  __gtk_drag_source_add_uri_targets (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view);
  ...
  _gtk_file_chooser_default_get_props (impl)->list_name_column = __gtk_tree_view_column_new ();
  __gtk_tree_view_column_set_expand (_gtk_file_chooser_default_get_props (impl)->list_name_column, TRUE);
  __gtk_tree_view_column_set_resizable (_gtk_file_chooser_default_get_props (impl)->list_name_column, TRUE);
  __gtk_tree_view_column_set_title (_gtk_file_chooser_default_get_props (impl)->list_name_column, _("Name"));
  ...
  __gtk_tree_view_column_pack_start (_gtk_file_chooser_default_get_props (impl)->list_name_column, renderer, FALSE);

  _gtk_file_chooser_default_get_props (impl)->list_name_renderer = __gtk_cell_renderer_text_new ();
  g_object_set (_gtk_file_chooser_default_get_props (impl)->list_name_renderer,
		"ellipsize", PANGO_ELLIPSIZE_END,
		NULL);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->list_name_renderer, "edited",
		    G_CALLBACK (renderer_edited_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->list_name_renderer, "editing-canceled",
		    G_CALLBACK (renderer_editing_canceled_cb), impl);
  __gtk_tree_view_column_pack_start (_gtk_file_chooser_default_get_props (impl)->list_name_column, _gtk_file_chooser_default_get_props (impl)->list_name_renderer, TRUE);

  __gtk_tree_view_append_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), _gtk_file_chooser_default_get_props (impl)->list_name_column);
  ...
  __gtk_tree_view_append_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), column);
  _gtk_file_chooser_default_get_props (impl)->list_size_column = column;
  ...
  __gtk_tree_view_column_pack_start (column, renderer, TRUE);
  __gtk_tree_view_append_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), column);
  _gtk_file_chooser_default_get_props (impl)->list_mtime_column = column;
		  ...
		  GtkSizeGroup          *size_group)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->preview_box = __gtk_vbox_new (FALSE, 12);
  __gtk_box_pack_start (GTK_BOX (hbox), _gtk_file_chooser_default_get_props (impl)->preview_box, FALSE, FALSE, 0);
  /* Don't show preview box initially */

  /* Filter combo */

  _gtk_file_chooser_default_get_props (impl)->filter_combo_hbox = __gtk_hbox_new (FALSE, 12);

  widget = filter_create (impl);

  __gtk_widget_show (widget);
  __gtk_box_pack_end (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->filter_combo_hbox), widget, FALSE, FALSE, 0);

  __gtk_box_pack_end (GTK_BOX (vbox), _gtk_file_chooser_default_get_props (impl)->filter_combo_hbox, FALSE, FALSE, 0);
...
{
  if (!_gtk_file_chooser_default_get_props (impl)->location_entry)
    _gtk_file_chooser_default_get_props (impl)->location_entry = _gtk_file_chooser_entry_new (TRUE);

  _gtk_file_chooser_entry_set_local_only (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), _gtk_file_chooser_default_get_props (impl)->local_only);
  _gtk_file_chooser_entry_set_action (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), _gtk_file_chooser_default_get_props (impl)->action);
  __gtk_entry_set_width_chars (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), 45);
  __gtk_entry_set_activates_default (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), TRUE);
}
...
save_widgets_create (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->save_widgets != NULL)
    return;
  ...
  _gtk_file_chooser_default_get_props (impl)->save_widgets_table = __gtk_table_new (2, 2, FALSE);
  __gtk_box_pack_start (GTK_BOX (vbox), _gtk_file_chooser_default_get_props (impl)->save_widgets_table, FALSE, FALSE, 0);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->save_widgets_table);
  __gtk_table_set_row_spacings (GTK_TABLE (_gtk_file_chooser_default_get_props (impl)->save_widgets_table), 12);
  __gtk_table_set_col_spacings (GTK_TABLE (_gtk_file_chooser_default_get_props (impl)->save_widgets_table), 12);

  /* Label */

  widget = __gtk_label_new_with_mnemonic (_("_Name:"));
  __gtk_misc_set_alignment (GTK_MISC (widget), 0.0, 0.5);
  __gtk_table_attach (GTK_TABLE (_gtk_file_chooser_default_get_props (impl)->save_widgets_table), widget,
		    0, 1, 0, 1,
		    GTK_FILL, GTK_FILL,
		    0, 0);
  __gtk_widget_show (widget);
  ...
  __gtk_table_attach (GTK_TABLE (_gtk_file_chooser_default_get_props (impl)->save_widgets_table), _gtk_file_chooser_default_get_props (impl)->location_entry,
		    1, 2, 0, 1,
		    GTK_EXPAND | GTK_FILL, 0,
		    0, 0);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->location_entry);
  __gtk_label_set_mnemonic_widget (GTK_LABEL (widget), _gtk_file_chooser_default_get_props (impl)->location_entry);

  /* Folder combo */
  _gtk_file_chooser_default_get_props (impl)->save_folder_label = __gtk_label_new (NULL);
  __gtk_misc_set_alignment (GTK_MISC (_gtk_file_chooser_default_get_props (impl)->save_folder_label), 0.0, 0.5);
  __gtk_table_attach (GTK_TABLE (_gtk_file_chooser_default_get_props (impl)->save_widgets_table), _gtk_file_chooser_default_get_props (impl)->save_folder_label,
		    0, 1, 1, 2,
		    GTK_FILL, GTK_FILL,
		    0, 0);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->save_folder_label);

  _gtk_file_chooser_default_get_props (impl)->save_widgets = vbox;
  __gtk_box_pack_start (GTK_BOX (impl), _gtk_file_chooser_default_get_props (impl)->save_widgets, FALSE, FALSE, 0);
  __gtk_box_reorder_child (GTK_BOX (impl), _gtk_file_chooser_default_get_props (impl)->save_widgets, 0);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->save_widgets);
}
...
save_widgets_destroy (GtkFileChooserDefault *impl)
{
  ...
  __gtk_widget_destroy (_gtk_file_chooser_default_get_props (impl)->save_widgets);
  _gtk_file_chooser_default_get_props (impl)->save_widgets = NULL;
  _gtk_file_chooser_default_get_props (impl)->save_widgets_table = NULL;
  _gtk_file_chooser_default_get_props (impl)->location_entry = NULL;
  _gtk_file_chooser_default_get_props (impl)->save_folder_label = NULL;
}
...
location_switch_to_path_bar (GtkFileChooserDefault *impl)
{
  if (_gtk_file_chooser_default_get_props (impl)->location_entry)
    {
      __gtk_widget_destroy (_gtk_file_chooser_default_get_props (impl)->location_entry);
      _gtk_file_chooser_default_get_props (impl)->location_entry = NULL;
    }

  __gtk_widget_hide (_gtk_file_chooser_default_get_props (impl)->location_entry_box);
}
...
location_switch_to_filename_entry (GtkFileChooserDefault *impl)
{
   ...
   * to it.
   */
  if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_SEARCH ||
      _gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_RECENT)
    return;
  ...
  location_entry_create (impl);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->location_entry_box), _gtk_file_chooser_default_get_props (impl)->location_entry, TRUE, TRUE, 0);
  __gtk_label_set_mnemonic_widget (GTK_LABEL (_gtk_file_chooser_default_get_props (impl)->location_label), _gtk_file_chooser_default_get_props (impl)->location_entry);

  /* Configure the entry */

  _gtk_file_chooser_entry_set_base_folder (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), _gtk_file_chooser_default_get_props (impl)->current_folder);

  /* Done */

  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->location_entry);
  __gtk_widget_grab_focus (_gtk_file_chooser_default_get_props (impl)->location_entry);
}
...
location_mode_set (GtkFileChooserDefault *impl,
		   ...
		   gboolean set_button)
{
  if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN ||
      _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      GtkWindow *toplevel;
	...
	case LOCATION_MODE_PATH_BAR:
	  ...
	  if (toplevel)
	    {
	      ...
	      if (!current_focus || current_focus == _gtk_file_chooser_default_get_props (impl)->location_entry)
	  ...
	  if (switch_to_file_list)
	    __gtk_widget_grab_focus (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view);
	...
	default:
      ...
      if (set_button)
	{
	  g_signal_handlers_block_by_func (_gtk_file_chooser_default_get_props (impl)->location_button,
					   G_CALLBACK (location_button_toggled_cb), impl);

	  __gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (_gtk_file_chooser_default_get_props (impl)->location_button), button_active);

	  g_signal_handlers_unblock_by_func (_gtk_file_chooser_default_get_props (impl)->location_button,
					     G_CALLBACK (location_button_toggled_cb), impl);
	}
    }

  _gtk_file_chooser_default_get_props (impl)->location_mode = new_mode;
}
...
location_toggle_popup_handler (GtkFileChooserDefault *impl)
{
  ...
  else if (_gtk_file_chooser_default_get_props (impl)->location_mode == LOCATION_MODE_FILENAME_ENTRY)
    {
      if (__gtk_widget_has_focus (_gtk_file_chooser_default_get_props (impl)->location_entry))
        {
			    ...
			    GtkFileChooserDefault *impl)
{
  ...
  if (is_active)
    {
      g_assert (_gtk_file_chooser_default_get_props (impl)->location_mode == LOCATION_MODE_PATH_BAR);
      new_mode = LOCATION_MODE_FILENAME_ENTRY;
    }
  else
    {
      g_assert (_gtk_file_chooser_default_get_props (impl)->location_mode == LOCATION_MODE_FILENAME_ENTRY);
...
location_button_create (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->location_button = g_object_new (GTK_TYPE_TOGGLE_BUTTON,
					"image", image,
					NULL);

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->location_button, "toggled",
		    G_CALLBACK (location_button_toggled_cb), impl);

  str = _("Type a file name");

  __gtk_widget_set_tooltip_text (_gtk_file_chooser_default_get_props (impl)->location_button, str);
  atk_object_set_name (__gtk_widget_get_accessible (_gtk_file_chooser_default_get_props (impl)->location_button), str);
}
...
info_bar_create (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_info_bar = __gtk_info_bar_new ();
  _gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_icon = __gtk_image_new_from_stock (GTK_STOCK_DIRECTORY, GTK_ICON_SIZE_MENU);
  _gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_label = __gtk_label_new (NULL);

  content_area = __gtk_info_bar_get_content_area (GTK_INFO_BAR (_gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_info_bar));

  __gtk_box_pack_start (GTK_BOX (content_area), _gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_icon, FALSE, FALSE, 0);
  __gtk_box_pack_start (GTK_BOX (content_area), _gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_label, FALSE, FALSE, 0);

  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_icon);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_label);
}
...
info_bar_set (GtkFileChooserDefault *impl, PathBarMode mode)
{
  ...
  __gtk_info_bar_set_message_type (GTK_INFO_BAR (_gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_info_bar), message_type);
  __gtk_image_set_from_stock (GTK_IMAGE (_gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_icon),
			    (message_type == GTK_MESSAGE_WARNING) ? GTK_STOCK_DIALOG_WARNING : GTK_STOCK_DIRECTORY,
			    GTK_ICON_SIZE_MENU);
  __gtk_label_set_markup (GTK_LABEL (_gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_label), str);
...
{
  _gtk_file_chooser_default_get_props (impl)->browse_special_mode_icon = __gtk_image_new ();
  __gtk_size_group_add_widget (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group, _gtk_file_chooser_default_get_props (impl)->browse_special_mode_icon);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox), _gtk_file_chooser_default_get_props (impl)->browse_special_mode_icon, FALSE, FALSE, 0);

  _gtk_file_chooser_default_get_props (impl)->browse_special_mode_label = __gtk_label_new (NULL);
  __gtk_size_group_add_widget (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group, _gtk_file_chooser_default_get_props (impl)->browse_special_mode_label);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox), _gtk_file_chooser_default_get_props (impl)->browse_special_mode_label, FALSE, FALSE, 0);
}
...
path_bar_widgets_create (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox = __gtk_hbox_new (FALSE, 12);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox);

  /* Size group that allows the path bar to be the same size between modes */
  _gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group = __gtk_size_group_new (GTK_SIZE_GROUP_VERTICAL);
  __gtk_size_group_set_ignore_hidden (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group, FALSE);

  /* Location button */
  location_button_create (impl);
  __gtk_size_group_add_widget (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group, _gtk_file_chooser_default_get_props (impl)->location_button);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox), _gtk_file_chooser_default_get_props (impl)->location_button, FALSE, FALSE, 0);

  /* Path bar */
  _gtk_file_chooser_default_get_props (impl)->browse_path_bar = g_object_new (GTK_TYPE_PATH_BAR, NULL);
  _gtk_path_bar_set_file_system (GTK_PATH_BAR (_gtk_file_chooser_default_get_props (impl)->browse_path_bar), _gtk_file_chooser_default_get_props (impl)->file_system);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_path_bar, "path-clicked", G_CALLBACK (path_bar_clicked), _gtk_file_chooser_default_get_props (impl));

  __gtk_size_group_add_widget (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group, _gtk_file_chooser_default_get_props (impl)->browse_path_bar);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox), _gtk_file_chooser_default_get_props (impl)->browse_path_bar, TRUE, TRUE, 0);

  /* Info bar */
  info_bar_create (impl);
  __gtk_size_group_add_widget (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group, _gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_info_bar);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox), _gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_info_bar, TRUE, TRUE, 0);

  /* Widgets for special modes (recently-used in Open mode, Search mode) */
  special_mode_widgets_create (impl);

  /* Create Folder */
  _gtk_file_chooser_default_get_props (impl)->browse_new_folder_button = __gtk_button_new_with_mnemonic (_("Create Fo_lder"));
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_new_folder_button, "clicked",
		    G_CALLBACK (new_folder_button_clicked), impl);
  __gtk_size_group_add_widget (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group, _gtk_file_chooser_default_get_props (impl)->browse_new_folder_button);
  __gtk_box_pack_end (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox), _gtk_file_chooser_default_get_props (impl)->browse_new_folder_button, FALSE, FALSE, 0);
}
...
path_bar_set_mode (GtkFileChooserDefault *impl, PathBarMode mode)
{
  ...
  switch (mode)
    ...
    case PATH_BAR_RECENTLY_USED:
      __gtk_image_set_from_icon_name (GTK_IMAGE (_gtk_file_chooser_default_get_props (impl)->browse_special_mode_icon), "document-open-recent", GTK_ICON_SIZE_BUTTON);

      tmp = g_strdup_printf ("<b>%s</b>", _("Recently Used"));
      __gtk_label_set_markup (GTK_LABEL (_gtk_file_chooser_default_get_props (impl)->browse_special_mode_label), tmp);
      g_free (tmp);
    ...
    case PATH_BAR_SEARCH:
      __gtk_image_set_from_stock (GTK_IMAGE (_gtk_file_chooser_default_get_props (impl)->browse_special_mode_icon), GTK_STOCK_FIND, GTK_ICON_SIZE_BUTTON);
  ...
  __gtk_widget_set_visible (_gtk_file_chooser_default_get_props (impl)->browse_path_bar,			path_bar_visible);
  __gtk_widget_set_visible (_gtk_file_chooser_default_get_props (impl)->browse_special_mode_icon,		special_mode_widgets_visible);
  __gtk_widget_set_visible (_gtk_file_chooser_default_get_props (impl)->browse_special_mode_label,		special_mode_widgets_visible);
  __gtk_widget_set_visible (_gtk_file_chooser_default_get_props (impl)->browse_select_a_folder_info_bar,	info_bar_visible);

  if (path_bar_visible)
    {
      if (_gtk_file_chooser_default_get_props (impl)->create_folders
	  && _gtk_file_chooser_default_get_props (impl)->action != GTK_FILE_CHOOSER_ACTION_OPEN
	  && _gtk_file_chooser_default_get_props (impl)->operation_mode != OPERATION_MODE_RECENT)
	create_folder_visible = TRUE;
    }

  __gtk_widget_set_visible (_gtk_file_chooser_default_get_props (impl)->browse_new_folder_button,		create_folder_visible);
}
...
browse_widgets_create (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_widgets_box = __gtk_vbox_new (FALSE, 12);
  __gtk_box_pack_start (GTK_BOX (impl), _gtk_file_chooser_default_get_props (impl)->browse_widgets_box, TRUE, TRUE, 0);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->browse_widgets_box);

  _gtk_file_chooser_default_get_props (impl)->browse_header_box = __gtk_vbox_new (FALSE, 12);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_widgets_box), _gtk_file_chooser_default_get_props (impl)->browse_header_box, FALSE, FALSE, 0);
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->browse_header_box);
  ...
  _gtk_file_chooser_default_get_props (impl)->location_entry_box = __gtk_hbox_new (FALSE, 12);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_header_box), _gtk_file_chooser_default_get_props (impl)->location_entry_box, FALSE, FALSE, 0);

  _gtk_file_chooser_default_get_props (impl)->location_label = __gtk_label_new_with_mnemonic (_("_Location:"));
  __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->location_label);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->location_entry_box), _gtk_file_chooser_default_get_props (impl)->location_label, FALSE, FALSE, 0);
  ...
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_widgets_box), hpaned, TRUE, TRUE, 0);
				      ...
				      GObjectConstructParam *construct_params)
{
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->file_system);
  ...
  _gtk_file_chooser_default_get_props (impl)->extra_align = __gtk_alignment_new (0.0, 0.5, 1.0, 1.0);
  __gtk_box_pack_start (GTK_BOX (impl), _gtk_file_chooser_default_get_props (impl)->extra_align, FALSE, FALSE, 0);
		  ...
		  GtkWidget             *extra_widget)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->extra_widget)
    {
      __gtk_container_remove (GTK_CONTAINER (_gtk_file_chooser_default_get_props (impl)->extra_align), _gtk_file_chooser_default_get_props (impl)->extra_widget);
      g_object_unref (_gtk_file_chooser_default_get_props (impl)->extra_widget);
    }

  _gtk_file_chooser_default_get_props (impl)->extra_widget = extra_widget;
  if (_gtk_file_chooser_default_get_props (impl)->extra_widget)
    {
      __gtk_container_add (GTK_CONTAINER (_gtk_file_chooser_default_get_props (impl)->extra_align), _gtk_file_chooser_default_get_props (impl)->extra_widget);
      __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->extra_align);
    }
  else
    __gtk_widget_hide (_gtk_file_chooser_default_get_props (impl)->extra_align);
}
...
set_local_only (GtkFileChooserDefault *impl,
		gboolean               local_only)
{
  if (local_only != _gtk_file_chooser_default_get_props (impl)->local_only)
    {
      _gtk_file_chooser_default_get_props (impl)->local_only = local_only;

      if (_gtk_file_chooser_default_get_props (impl)->location_entry)
	_gtk_file_chooser_entry_set_local_only (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), local_only);

      if (_gtk_file_chooser_default_get_props (impl)->shortcuts_model && _gtk_file_chooser_default_get_props (impl)->file_system)
	{
	  shortcuts_add_volumes (impl);
	  shortcuts_add_bookmarks (impl);
	}

      if (local_only && _gtk_file_chooser_default_get_props (impl)->current_folder &&
           !_gtk_file_has_native_path (_gtk_file_chooser_default_get_props (impl)->current_folder))
	{
		     ...
		     gboolean               property_notify)
{
  ...
  if (select_multiple == _gtk_file_chooser_default_get_props (impl)->select_multiple)
    return;
  ...
  __gtk_tree_view_set_rubber_banding (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), select_multiple);

  _gtk_file_chooser_default_get_props (impl)->select_multiple = select_multiple;
...
set_file_system_backend (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->file_system = _gtk_file_system_new ();

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->file_system, "volumes-changed",
		    G_CALLBACK (volumes_bookmarks_changed_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->file_system, "bookmarks-changed",
		    G_CALLBACK (volumes_bookmarks_changed_cb), impl);
...
{
  g_signal_handlers_disconnect_by_func (_gtk_file_chooser_default_get_props (impl)->file_system,
					G_CALLBACK (volumes_bookmarks_changed_cb), impl);

  g_object_unref (_gtk_file_chooser_default_get_props (impl)->file_system);

  _gtk_file_chooser_default_get_props (impl)->file_system = NULL;
}
...
save_path_bar (GtkFileChooserDefault *impl)
{
  ...
  g_object_ref (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox);

  parent = __gtk_widget_get_parent (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox);
  if (parent)
    __gtk_container_remove (GTK_CONTAINER (parent), _gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox);
}
...
restore_path_bar (GtkFileChooserDefault *impl)
{
  if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN
      || _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_header_box), _gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox, FALSE, FALSE, 0);
      __gtk_box_reorder_child (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_header_box), _gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox, 0);
    }
  else if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE
	   || _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER)
    {
      __gtk_table_attach (GTK_TABLE (_gtk_file_chooser_default_get_props (impl)->save_widgets_table), _gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox,
			1, 2, 1, 2,
			GTK_EXPAND | GTK_FILL, GTK_FILL,
			0, 0);
      __gtk_label_set_mnemonic_widget (GTK_LABEL (_gtk_file_chooser_default_get_props (impl)->save_folder_label), _gtk_file_chooser_default_get_props (impl)->browse_path_bar);
    }
  else
    g_assert_not_reached ();

  g_object_unref (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox);
}
...
put_recent_folder_in_pathbar (GtkFileChooserDefault *impl, GtkTreeIter *iter)
{
  ...
  __gtk_tree_model_get (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->recent_model), iter,
		      MODEL_COL_FILE, &file,
		      -1);
  _gtk_path_bar_set_file (GTK_PATH_BAR (_gtk_file_chooser_default_get_props (impl)->browse_path_bar), file, FALSE, NULL); /* NULL-GError */
  g_object_unref (file);
}
 ...
 * dealing with the pathbar's widgets; as long as _gtk_file_chooser_default_get_props (impl)->action and _gtk_file_chooser_default_get_props (impl)->operation_mode are set correctly, then calling this
...
path_bar_update (GtkFileChooserDefault *impl)
{
  ...
  switch (_gtk_file_chooser_default_get_props (impl)->operation_mode)
    {
    ...
    case OPERATION_MODE_RECENT:
      if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE)
	{
	  GtkTreeSelection *selection;
...
{
  if (_gtk_file_chooser_default_get_props (impl)->search_hbox)
    {
      __gtk_widget_destroy (_gtk_file_chooser_default_get_props (impl)->search_hbox);

      _gtk_file_chooser_default_get_props (impl)->search_hbox = NULL;
      _gtk_file_chooser_default_get_props (impl)->search_entry = NULL;
    }
}
...
{
  g_assert (_gtk_file_chooser_default_get_props (impl)->search_hbox == NULL);
  g_assert (_gtk_file_chooser_default_get_props (impl)->search_entry == NULL);
  g_assert (_gtk_file_chooser_default_get_props (impl)->search_model == NULL);
...
operation_mode_set_recent (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN ||
      _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      __gtk_widget_hide (_gtk_file_chooser_default_get_props (impl)->location_button);
      __gtk_widget_hide (_gtk_file_chooser_default_get_props (impl)->location_entry_box);
    }
...
update_appearance (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE ||
	...
	text = _("Create in _folder:");
      ...
      __gtk_label_set_text_with_mnemonic (GTK_LABEL (_gtk_file_chooser_default_get_props (impl)->save_folder_label), text);

      if (_gtk_file_chooser_default_get_props (impl)->select_multiple)
	{
  ...
  else if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN ||
	   _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->location_button);
   ...
   */
  __gtk_widget_queue_draw (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view);
...

{
  ...
  switch (prop_id)
	...
	if (action != _gtk_file_chooser_default_get_props (impl)->action)
	  {
	    gtk_file_chooser_default_unselect_all (GTK_FILE_CHOOSER (impl));
	    
	    if ((action == GTK_FILE_CHOOSER_ACTION_SAVE ||
                 action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER)
		&& _gtk_file_chooser_default_get_props (impl)->select_multiple)
	      {
	    ...
	    _gtk_file_chooser_default_get_props (impl)->action = action;
            update_cell_renderer_attributes (impl);
	    update_appearance (impl);
	    settings_load (impl);
	  }
    ...
    case GTK_FILE_CHOOSER_PROP_PREVIEW_WIDGET_ACTIVE:
      _gtk_file_chooser_default_get_props (impl)->preview_widget_active = g_value_get_boolean (value);
      update_preview_widget_visibility (impl);
      break;

    case GTK_FILE_CHOOSER_PROP_USE_PREVIEW_LABEL:
      _gtk_file_chooser_default_get_props (impl)->use_preview_label = g_value_get_boolean (value);
      update_preview_widget_visibility (impl);
      break;
	...
	if (show_hidden != _gtk_file_chooser_default_get_props (impl)->show_hidden)
	  {
	    _gtk_file_chooser_default_get_props (impl)->show_hidden = show_hidden;

	    if (_gtk_file_chooser_default_get_props (impl)->browse_files_model)
	      _gtk_file_system_model_set_show_hidden (_gtk_file_chooser_default_get_props (impl)->browse_files_model, show_hidden);
	  }
      }
      break;
	...
	_gtk_file_chooser_default_get_props (impl)->do_overwrite_confirmation = do_overwrite_confirmation;
      }
      break;
    ...
    case GTK_FILE_CHOOSER_PROP_CREATE_FOLDERS:
      {
        ...
        _gtk_file_chooser_default_get_props (impl)->create_folders = create_folders;
        update_appearance (impl);
      }
      break;
				       ...
				       GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case GTK_FILE_CHOOSER_PROP_ACTION:
      g_value_set_enum (value, _gtk_file_chooser_default_get_props (impl)->action);
      break;

    case GTK_FILE_CHOOSER_PROP_FILTER:
      g_value_set_object (value, _gtk_file_chooser_default_get_props (impl)->current_filter);
      break;

    case GTK_FILE_CHOOSER_PROP_LOCAL_ONLY:
      g_value_set_boolean (value, _gtk_file_chooser_default_get_props (impl)->local_only);
      break;

    case GTK_FILE_CHOOSER_PROP_PREVIEW_WIDGET:
      g_value_set_object (value, _gtk_file_chooser_default_get_props (impl)->preview_widget);
      break;

    case GTK_FILE_CHOOSER_PROP_PREVIEW_WIDGET_ACTIVE:
      g_value_set_boolean (value, _gtk_file_chooser_default_get_props (impl)->preview_widget_active);
      break;

    case GTK_FILE_CHOOSER_PROP_USE_PREVIEW_LABEL:
      g_value_set_boolean (value, _gtk_file_chooser_default_get_props (impl)->use_preview_label);
      break;

    case GTK_FILE_CHOOSER_PROP_EXTRA_WIDGET:
      g_value_set_object (value, _gtk_file_chooser_default_get_props (impl)->extra_widget);
      break;

    case GTK_FILE_CHOOSER_PROP_SELECT_MULTIPLE:
      g_value_set_boolean (value, _gtk_file_chooser_default_get_props (impl)->select_multiple);
      break;

    case GTK_FILE_CHOOSER_PROP_SHOW_HIDDEN:
      g_value_set_boolean (value, _gtk_file_chooser_default_get_props (impl)->show_hidden);
      break;

    case GTK_FILE_CHOOSER_PROP_DO_OVERWRITE_CONFIRMATION:
      g_value_set_boolean (value, _gtk_file_chooser_default_get_props (impl)->do_overwrite_confirmation);
      break;

    case GTK_FILE_CHOOSER_PROP_CREATE_FOLDERS:
      g_value_set_boolean (value, _gtk_file_chooser_default_get_props (impl)->create_folders);
      break;
...
cancel_all_operations (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->reload_icon_cancellables)
    {
      for (l = _gtk_file_chooser_default_get_props (impl)->reload_icon_cancellables; l; l = l->next)
        {
	  GCancellable *cancellable = G_CANCELLABLE (l->data);
  ...
  if (_gtk_file_chooser_default_get_props (impl)->loading_shortcuts)
    {
      for (l = _gtk_file_chooser_default_get_props (impl)->loading_shortcuts; l; l = l->next)
        {
	  GCancellable *cancellable = G_CANCELLABLE (l->data);
	  g_cancellable_cancel (cancellable);
        }
      g_slist_free (_gtk_file_chooser_default_get_props (impl)->loading_shortcuts);
      _gtk_file_chooser_default_get_props (impl)->loading_shortcuts = NULL;
    }

  if (_gtk_file_chooser_default_get_props (impl)->file_list_drag_data_received_cancellable)
    {
      g_cancellable_cancel (_gtk_file_chooser_default_get_props (impl)->file_list_drag_data_received_cancellable);
      _gtk_file_chooser_default_get_props (impl)->file_list_drag_data_received_cancellable = NULL;
    }

  if (_gtk_file_chooser_default_get_props (impl)->update_current_folder_cancellable)
    {
      g_cancellable_cancel (_gtk_file_chooser_default_get_props (impl)->update_current_folder_cancellable);
      _gtk_file_chooser_default_get_props (impl)->update_current_folder_cancellable = NULL;
    }

  if (_gtk_file_chooser_default_get_props (impl)->should_respond_get_info_cancellable)
    {
      g_cancellable_cancel (_gtk_file_chooser_default_get_props (impl)->should_respond_get_info_cancellable);
      _gtk_file_chooser_default_get_props (impl)->should_respond_get_info_cancellable = NULL;
    }

  if (_gtk_file_chooser_default_get_props (impl)->file_exists_get_info_cancellable)
    {
      g_cancellable_cancel (_gtk_file_chooser_default_get_props (impl)->file_exists_get_info_cancellable);
      _gtk_file_chooser_default_get_props (impl)->file_exists_get_info_cancellable = NULL;
    }

  if (_gtk_file_chooser_default_get_props (impl)->update_from_entry_cancellable)
    {
      g_cancellable_cancel (_gtk_file_chooser_default_get_props (impl)->update_from_entry_cancellable);
      _gtk_file_chooser_default_get_props (impl)->update_from_entry_cancellable = NULL;
    }

  if (_gtk_file_chooser_default_get_props (impl)->shortcuts_activate_iter_cancellable)
    {
      g_cancellable_cancel (_gtk_file_chooser_default_get_props (impl)->shortcuts_activate_iter_cancellable);
      _gtk_file_chooser_default_get_props (impl)->shortcuts_activate_iter_cancellable = NULL;
    }
...
remove_settings_signal (GtkFileChooserDefault *impl,
			GdkScreen             *screen)
{
  if (_gtk_file_chooser_default_get_props (impl)->settings_signal_id)
    {
      GtkSettings *settings;

      settings = __gtk_settings_get_for_screen (screen);
      g_signal_handler_disconnect (settings,
				   _gtk_file_chooser_default_get_props (impl)->settings_signal_id);
      _gtk_file_chooser_default_get_props (impl)->settings_signal_id = 0;
    }
}
...
gtk_file_chooser_default_dispose (GObject *object)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->extra_widget)
    {
      g_object_unref (_gtk_file_chooser_default_get_props (impl)->extra_widget);
      _gtk_file_chooser_default_get_props (impl)->extra_widget = NULL;
    }
...
gtk_file_chooser_default_show_all (GtkWidget *widget)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->extra_widget)
    __gtk_widget_show_all (_gtk_file_chooser_default_get_props (impl)->extra_widget);
}
...
toplevel_set_focus_cb (GtkWindow             *window,
		       ...
		       GtkFileChooserDefault *impl)
{
  _gtk_file_chooser_default_get_props (impl)->toplevel_last_focus_widget = __gtk_window_get_focus (window);
}
					    ...
					    GtkWidget *previous_toplevel)
{
  ...
  if (previous_toplevel)
    {
      if (_gtk_file_chooser_default_get_props (impl)->toplevel_set_focus_id != 0)
	{
	  g_signal_handler_disconnect (previous_toplevel, _gtk_file_chooser_default_get_props (impl)->toplevel_set_focus_id);
	  _gtk_file_chooser_default_get_props (impl)->toplevel_set_focus_id = 0;
	  _gtk_file_chooser_default_get_props (impl)->toplevel_last_focus_widget = NULL;
	}

      if (_gtk_file_chooser_default_get_props (impl)->toplevel_unmapped_id != 0)
	{
	  g_signal_handler_disconnect (previous_toplevel, _gtk_file_chooser_default_get_props (impl)->toplevel_unmapped_id);
	  _gtk_file_chooser_default_get_props (impl)->toplevel_unmapped_id = 0;
	}
    }

  if (__gtk_widget_is_toplevel (toplevel))
    {
      g_assert (_gtk_file_chooser_default_get_props (impl)->toplevel_set_focus_id == 0);
      _gtk_file_chooser_default_get_props (impl)->toplevel_set_focus_id = g_signal_connect (toplevel, "set-focus",
						      G_CALLBACK (toplevel_set_focus_cb), impl);
      _gtk_file_chooser_default_get_props (impl)->toplevel_last_focus_widget = __gtk_window_get_focus (GTK_WINDOW (toplevel));

      g_assert (_gtk_file_chooser_default_get_props (impl)->toplevel_unmapped_id == 0);
      _gtk_file_chooser_default_get_props (impl)->toplevel_unmapped_id = g_signal_connect (toplevel, "unmap",
...
change_icon_theme (GtkFileChooserDefault *impl)
{
  ...
  if (__gtk_icon_size_lookup_for_settings (settings, GTK_ICON_SIZE_MENU, &width, &height))
    _gtk_file_chooser_default_get_props (impl)->icon_size = MAX (width, height);
  else
    _gtk_file_chooser_default_get_props (impl)->icon_size = FALLBACK_ICON_SIZE;
  ...
  cells = __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (
        __gtk_tree_view_get_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), 0)));
  renderer = GTK_CELL_RENDERER (cells->data);
  set_icon_cell_renderer_fixed_size (impl, renderer);
  g_list_free (cells);
  if (_gtk_file_chooser_default_get_props (impl)->browse_files_model)
    _gtk_file_system_model_clear_cache (_gtk_file_chooser_default_get_props (impl)->browse_files_model, MODEL_COL_PIXBUF);
  __gtk_widget_queue_resize (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view);
...
check_icon_theme (GtkFileChooserDefault *impl)
{
  ...
  if (__gtk_widget_has_screen (GTK_WIDGET (impl)))
    {
      settings = __gtk_settings_get_for_screen (__gtk_widget_get_screen (GTK_WIDGET (impl)));
      _gtk_file_chooser_default_get_props (impl)->settings_signal_id = g_signal_connect (settings, "notify",
...
set_sort_column (GtkFileChooserDefault *impl)
{
  ...
  sortable = GTK_TREE_SORTABLE (__gtk_tree_view_get_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view)));
  /* can happen when we're still populating the model */
  if (sortable == NULL)
    return;

  __gtk_tree_sortable_set_sort_column_id (sortable,
                                        _gtk_file_chooser_default_get_props (impl)->sort_column,
                                        _gtk_file_chooser_default_get_props (impl)->sort_order);
}
...
settings_load (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->show_size_column = show_size_column;
  __gtk_tree_view_column_set_visible (_gtk_file_chooser_default_get_props (impl)->list_size_column, show_size_column);

  _gtk_file_chooser_default_get_props (impl)->sort_column = sort_column;
  _gtk_file_chooser_default_get_props (impl)->sort_order = sort_order;
  ...
  _gtk_file_chooser_default_get_props (impl)->startup_mode = startup_mode;
}
...
settings_save (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_settings_set_location_mode (settings, _gtk_file_chooser_default_get_props (impl)->location_mode);
  _gtk_file_chooser_settings_set_show_hidden (settings, __gtk_file_chooser_get_show_hidden (GTK_FILE_CHOOSER (impl)));
  _gtk_file_chooser_settings_set_show_size_column (settings, _gtk_file_chooser_default_get_props (impl)->show_size_column);
  _gtk_file_chooser_settings_set_sort_column (settings, _gtk_file_chooser_default_get_props (impl)->sort_column);
  _gtk_file_chooser_settings_set_sort_order (settings, _gtk_file_chooser_default_get_props (impl)->sort_order);
  _gtk_file_chooser_settings_set_startup_mode (settings, _gtk_file_chooser_default_get_props (impl)->startup_mode);
...
{
  switch (_gtk_file_chooser_default_get_props (impl)->startup_mode)
    {
...
gtk_file_chooser_default_map (GtkWidget *widget)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_BROWSE)
    {
      switch (_gtk_file_chooser_default_get_props (impl)->reload_state)
        {
        case RELOAD_EMPTY:
  ...
  volumes_bookmarks_changed_cb (_gtk_file_chooser_default_get_props (impl)->file_system, _gtk_file_chooser_default_get_props (impl));
...
{
  _gtk_file_system_model_set_filter (_gtk_file_chooser_default_get_props (impl)->browse_files_model,
                                     _gtk_file_chooser_default_get_props (impl)->current_filter);
}
...
#define COMPARE_DIRECTORIES										       \
  ...
  dir_b = g_value_get_boolean (_gtk_file_system_model_get_value (fs_model, b, MODEL_COL_IS_FOLDER));           \
													       \
  if (dir_a != dir_b)											       \
    return _gtk_file_chooser_default_get_props (impl)->list_sort_ascending ? (dir_a ? -1 : 1) : (dir_a ? 1 : -1) /* Directories *always* go first */
			     ...
			     GtkFileChooserDefault *impl)
{
  ...
  if (__gtk_tree_sortable_get_sort_column_id (sortable, &sort_column_id, &sort_type))
    {
      _gtk_file_chooser_default_get_props (impl)->list_sort_ascending = (sort_type == GTK_SORT_ASCENDING);
      _gtk_file_chooser_default_get_props (impl)->sort_column = sort_column_id;
      _gtk_file_chooser_default_get_props (impl)->sort_order = sort_type;
    }
}
...
load_set_model (GtkFileChooserDefault *impl)
{
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->browse_files_model != NULL);

  profile_msg ("    __gtk_tree_view_set_model start", NULL);
  __gtk_tree_view_set_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
			   GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->browse_files_model));
  __gtk_tree_view_columns_autosize (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view));
  __gtk_tree_view_set_search_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
				   MODEL_COL_NAME);
  file_list_set_sort_column_ids (impl);
  set_sort_column (impl);
  profile_msg ("    __gtk_tree_view_set_model end", NULL);
  _gtk_file_chooser_default_get_props (impl)->list_sort_ascending = TRUE;
...
load_timeout_cb (gpointer data)
{
  ...
  impl = GTK_FILE_CHOOSER_DEFAULT (data);
  g_assert (_gtk_file_chooser_default_get_props (impl)->load_state == LOAD_PRELOAD);
  g_assert (_gtk_file_chooser_default_get_props (impl)->load_timeout_id != 0);
  g_assert (_gtk_file_chooser_default_get_props (impl)->browse_files_model != NULL);

  _gtk_file_chooser_default_get_props (impl)->load_timeout_id = 0;
  _gtk_file_chooser_default_get_props (impl)->load_state = LOAD_LOADING;
...
load_setup_timer (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->load_timeout_id = __gdk_threads_add_timeout (MAX_LOADING_TIME, load_timeout_cb, _gtk_file_chooser_default_get_props (impl));
  _gtk_file_chooser_default_get_props (impl)->load_state = LOAD_PRELOAD;
}

/* Removes the load timeout; changes the _gtk_file_chooser_default_get_props (impl)->load_state to the specified value. */
static void
load_remove_timer (GtkFileChooserDefault *impl, LoadState new_load_state)
{
  if (_gtk_file_chooser_default_get_props (impl)->load_timeout_id != 0)
    {
      g_assert (_gtk_file_chooser_default_get_props (impl)->load_state == LOAD_PRELOAD);

      g_source_remove (_gtk_file_chooser_default_get_props (impl)->load_timeout_id);
      _gtk_file_chooser_default_get_props (impl)->load_timeout_id = 0;
    }
  else
    g_assert (_gtk_file_chooser_default_get_props (impl)->load_state == LOAD_EMPTY ||
	      _gtk_file_chooser_default_get_props (impl)->load_state == LOAD_LOADING ||
	      _gtk_file_chooser_default_get_props (impl)->load_state == LOAD_FINISHED);

  g_assert (new_load_state == LOAD_EMPTY ||
	    new_load_state == LOAD_LOADING ||
	    new_load_state == LOAD_FINISHED);
  _gtk_file_chooser_default_get_props (impl)->load_state = new_load_state;
}
...
browse_files_select_first_row (GtkFileChooserDefault *impl)
{
  ...
  tree_model = __gtk_tree_view_get_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view));
  ...
  if (__gtk_tree_model_get_iter (tree_model, &dummy_iter, path))
      __gtk_tree_view_set_cursor (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), path, NULL, FALSE);
				...
				gpointer           data)
{
  ...
  __gtk_tree_view_scroll_to_cell (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (closure->impl)->browse_files_tree_view), path, NULL, TRUE, 0.5, 0.0);
		       ...
		       GSList                *files)
{
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->load_state == LOAD_FINISHED);
  g_assert (_gtk_file_chooser_default_get_props (impl)->browse_files_model != NULL);

  selection = __gtk_tree_view_get_selection (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view));
  fsmodel = GTK_FILE_SYSTEM_MODEL (__gtk_tree_view_get_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view)));

  g_assert (fsmodel == _gtk_file_chooser_default_get_props (impl)->browse_files_model);

  enabled_hidden = _gtk_file_chooser_default_get_props (impl)->show_hidden;
  removed_filters = (_gtk_file_chooser_default_get_props (impl)->current_filter == NULL);
...
pending_select_files_process (GtkFileChooserDefault *impl)
{
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->pending_select_files == NULL);
}
...
show_error_on_reading_current_folder (GtkFileChooserDefault *impl, GError *error)
{
  ...
  info = g_file_query_info (_gtk_file_chooser_default_get_props (impl)->current_folder,
					...
					GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->load_state == LOAD_PRELOAD)
    {
      load_remove_timer (impl, LOAD_FINISHED);
      load_set_model (impl);
    }
  else if (_gtk_file_chooser_default_get_props (impl)->load_state == LOAD_LOADING)
    {
      /* Nothing */
    }
  else
                                   ...
                                   gboolean remove_from_treeview)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->browse_files_model)
    {
      g_object_unref (_gtk_file_chooser_default_get_props (impl)->browse_files_model);
      _gtk_file_chooser_default_get_props (impl)->browse_files_model = NULL;
    }

  if (remove_from_treeview)
    __gtk_tree_view_set_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), NULL);
}
      ...
      if (info)
        {
          ...
          if (_gtk_file_chooser_default_get_props (impl)->action != GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER &&
              _gtk_file_chooser_default_get_props (impl)->action != GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER)
            {
              sensitive = TRUE;
            }
      ...
      if (info)
        {
          if (g_file_info_has_attribute (info, G_FILE_ATTRIBUTE_STANDARD_ICON))
            {
              g_value_take_object (value, _gtk_file_info_render_icon (info, GTK_WIDGET (impl), _gtk_file_chooser_default_get_props (impl)->icon_size));
            }
          else
            {
              GtkTreeModel *tree_model;
              ...
              if (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view == NULL ||
              ...
              if (!_gtk_file_system_model_get_iter_for_file (model,
                                                             ...
                                                             file))
                g_assert_not_reached ();
              if (!__gtk_tree_view_get_visible_range (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), &start, &end))
                return FALSE;
		...
		GError               **error)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->browse_files_model = 
    _gtk_file_system_model_new_for_directory (_gtk_file_chooser_default_get_props (impl)->current_folder,
					      MODEL_ATTRIBUTES,
					      file_system_model_set,
					      impl,
					      MODEL_COLUMN_TYPES);

  _gtk_file_system_model_set_show_hidden (_gtk_file_chooser_default_get_props (impl)->browse_files_model, _gtk_file_chooser_default_get_props (impl)->show_hidden);

  profile_msg ("    set sort function", NULL);
  __gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->browse_files_model), MODEL_COL_NAME, name_sort_func, _gtk_file_chooser_default_get_props (impl), NULL);
  __gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->browse_files_model), MODEL_COL_SIZE, size_sort_func, _gtk_file_chooser_default_get_props (impl), NULL);
  __gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->browse_files_model), MODEL_COL_MTIME, mtime_sort_func, _gtk_file_chooser_default_get_props (impl), NULL);
  __gtk_tree_sortable_set_default_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->browse_files_model), NULL, NULL, NULL);
  set_sort_column (impl);
  _gtk_file_chooser_default_get_props (impl)->list_sort_ascending = TRUE;
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_model, "sort-column-changed",
		    G_CALLBACK (list_sort_column_changed_cb), impl);

  load_setup_timer (impl); /* This changes the state to LOAD_PRELOAD */

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->browse_files_model, "finished-loading",
...
update_chooser_entry (GtkFileChooserDefault *impl)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_SEARCH ||
      !_gtk_file_chooser_default_get_props (impl)->location_entry)
    return;
  ...
  if (!(_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE
        ...
        || ((_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN
             || _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER)
            && _gtk_file_chooser_default_get_props (impl)->location_mode == LOCATION_MODE_FILENAME_ENTRY)))
    return;

  g_assert (_gtk_file_chooser_default_get_props (impl)->location_entry != NULL);
  ...
  if (closure.num_selected == 0)
    {
      if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_RECENT)
	_gtk_file_chooser_entry_set_base_folder (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), NULL);
      else
      ...
      if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_BROWSE)
        {
          ...
          info = _gtk_file_system_model_get_info (_gtk_file_chooser_default_get_props (impl)->browse_files_model, &closure.first_selected_iter);
          ...
          g_free (_gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name);
          _gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name =
            g_strdup (g_file_info_get_display_name (info));

          if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN ||
              _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE ||
              _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER)
            {
          ...
          if (change_entry)
            {
              __gtk_entry_set_text (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), _gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name);

              if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE)
                _gtk_file_chooser_entry_select_filename (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry));
            }

          return;
        }
      else if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_RECENT
	       && _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE)
	{
	  GFile *folder;
	  ...
	  __gtk_tree_model_get (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->recent_model), &closure.first_selected_iter,
			      MODEL_COL_FILE, &folder,
			      -1);
	  _gtk_file_chooser_entry_set_base_folder (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), folder);
    ...
    {
      g_assert (!(_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE ||
                  _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER));

      /* Multiple selection, so just clear the entry. */
      g_free (_gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name);
      _gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name = NULL;

      __gtk_entry_set_text (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), "");
      return;
    }

 maybe_clear_entry:

  if ((_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN || _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER)
      && _gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name)
    {
      ...
      entry_text = __gtk_entry_get_text (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry));
          ...
          if (entry_text[len - 1] == G_DIR_SEPARATOR)
            {
              ...
              clear_entry = (compare_utf8_filenames (_gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name, tmp) == 0);
              g_free (tmp);
            }
          else
            clear_entry = (compare_utf8_filenames (_gtk_file_chooser_default_get_props (impl)->browse_files_last_selected_name, entry_text) == 0);
        }
      else
        clear_entry = FALSE;
                                                 ...
                                                 gpointer             user_data)
{
  ...
  if (cancellable != _gtk_file_chooser_default_get_props (impl)->update_current_folder_cancellable)
    goto out;
				   ...
				   gpointer      user_data)
{
  ...
  if (error)
    {
      ...
      if (g_error_matches (error, G_IO_ERROR, G_IO_ERROR_NOT_MOUNTED))
        {
          ...
          _gtk_file_chooser_default_get_props (impl)->update_current_folder_cancellable =
            _gtk_file_system_mount_enclosing_volume (_gtk_file_chooser_default_get_props (impl)->file_system, data->file,
                                                     mount_operation,
	  ...
	  _gtk_file_chooser_default_get_props (impl)->reload_state = RELOAD_HAS_FOLDER;

	  _gtk_file_chooser_default_get_props (impl)->update_current_folder_cancellable =
	    _gtk_file_system_get_info (_gtk_file_chooser_default_get_props (impl)->file_system, data->file,
				       "standard::type",
  ...
  if (!_gtk_path_bar_set_file (GTK_PATH_BAR (_gtk_file_chooser_default_get_props (impl)->browse_path_bar), data->file, data->keep_trail, NULL))
    goto out;

  if (_gtk_file_chooser_default_get_props (impl)->current_folder != data->file)
    {
      if (_gtk_file_chooser_default_get_props (impl)->current_folder)
	g_object_unref (_gtk_file_chooser_default_get_props (impl)->current_folder);

      _gtk_file_chooser_default_get_props (impl)->current_folder = g_object_ref (data->file);
    }
  ...
  if (!_gtk_file_chooser_default_get_props (impl)->changing_folder)
    {
      ...
      _gtk_file_chooser_default_get_props (impl)->changing_folder = FALSE;
    }
  ...
  if (_gtk_file_chooser_default_get_props (impl)->location_entry)
    {
      _gtk_file_chooser_entry_set_base_folder (GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry),
					       _gtk_file_chooser_default_get_props (impl)->current_folder);
...
gtk_file_chooser_default_get_current_folder (GtkFileChooser *chooser)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->current_folder)
    return g_object_ref (_gtk_file_chooser_default_get_props (impl)->current_folder);
					   ...
					   const gchar    *name)
{
  ...
  g_return_if_fail (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE ||
		    _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER);

  pending_select_files_free (impl);
  __gtk_entry_set_text (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), name);
}
				      ...
				      GError         **error)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_SEARCH ||
  ...
  else
    {
      ...
      same_path = g_file_equal (parent_file, _gtk_file_chooser_default_get_props (impl)->current_folder);
    }

  if (same_path && _gtk_file_chooser_default_get_props (impl)->load_state == LOAD_FINISHED)
    {
      gboolean result;
      GSList files;
...
{
  GtkFileChooserDefault *impl = GTK_FILE_CHOOSER_DEFAULT (chooser);
  GtkTreeView *tree_view = GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view);
  GtkTreeIter iter;

  if (!_gtk_file_chooser_default_get_props (impl)->browse_files_model)
    return;

  if (!_gtk_file_system_model_get_iter_for_file (_gtk_file_chooser_default_get_props (impl)->browse_files_model,
                                                 &iter,
                                                 file))
    return;
	      ...
	      gpointer     data)
{
  ...
  if (is_sensitive &&
      ((is_folder && _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER) ||
       (!is_folder && _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN)))
    __gtk_tree_selection_select_iter (selection, iter);
  else
...
gtk_file_chooser_default_select_all (GtkFileChooser *chooser)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->select_multiple)
    __gtk_tree_model_foreach (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->browse_files_model), 
			    maybe_select, impl);
}
...
{
  GtkFileChooserDefault *impl = GTK_FILE_CHOOSER_DEFAULT (chooser);
  GtkTreeSelection *selection = __gtk_tree_view_get_selection (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view));
		  ...
		  gboolean              *is_folder)
{
  ...
  chooser_entry = GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry);
		   ...
		   gpointer      data)
{
  ...
  info = data;
  fs_model = _gtk_file_chooser_default_get_props (info->impl)->browse_files_model;
...
gtk_file_chooser_default_get_files (GtkFileChooser *chooser)
{
  ...
  if (current_focus == _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view)
    {
      GtkTreeSelection *selection;
    ...
    file_list:
       ...
       */
      if (info.result == NULL && _gtk_file_chooser_default_get_props (impl)->location_entry)
	goto file_entry;
    }
  else if (_gtk_file_chooser_default_get_props (impl)->location_entry && current_focus == _gtk_file_chooser_default_get_props (impl)->location_entry)
    {
	...
	return NULL;
      ...
      if (is_file_part_empty && _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE)
	{
  ...
  else if (_gtk_file_chooser_default_get_props (impl)->toplevel_last_focus_widget == _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view)
    goto file_list;
  else if (_gtk_file_chooser_default_get_props (impl)->location_entry && _gtk_file_chooser_default_get_props (impl)->toplevel_last_focus_widget == _gtk_file_chooser_default_get_props (impl)->location_entry)
    goto file_entry;
  else
    {
...
gtk_file_chooser_default_get_preview_file (GtkFileChooser *chooser)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->preview_file)
    return g_object_ref (_gtk_file_chooser_default_get_props (impl)->preview_file);
  else
    return NULL;
}
...
gtk_file_chooser_default_get_file_system (GtkFileChooser *chooser)
{
  ...
  return _gtk_file_chooser_default_get_props (impl)->file_system;
}
...
{
  if (show)
    __gtk_widget_show (_gtk_file_chooser_default_get_props (impl)->filter_combo_hbox);
  else
    __gtk_widget_hide (_gtk_file_chooser_default_get_props (impl)->filter_combo_hbox);
}
				     ...
				     GtkFileFilter  *filter)
{
  ...
  if (g_slist_find (_gtk_file_chooser_default_get_props (impl)->filters, filter))
    {
  ...
  _gtk_file_chooser_default_get_props (impl)->filters = g_slist_append (_gtk_file_chooser_default_get_props (impl)->filters, filter);

  name = __gtk_file_filter_get_name (filter);
  if (!name)
    name = "Untitled filter";	/* Place-holder, doesn't need to be marked for translation */

  __gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (_gtk_file_chooser_default_get_props (impl)->filter_combo), name);

  if (!g_slist_find (_gtk_file_chooser_default_get_props (impl)->filters, _gtk_file_chooser_default_get_props (impl)->current_filter))
					...
					GtkFileFilter  *filter)
{
  ...
  filter_index = g_slist_index (_gtk_file_chooser_default_get_props (impl)->filters, filter);
  ...
  _gtk_file_chooser_default_get_props (impl)->filters = g_slist_remove (_gtk_file_chooser_default_get_props (impl)->filters, filter);
  ...
  model = __gtk_combo_box_get_model (GTK_COMBO_BOX (_gtk_file_chooser_default_get_props (impl)->filter_combo));
...
gtk_file_chooser_default_list_filters (GtkFileChooser *chooser)
{
  ...
  return g_slist_copy (_gtk_file_chooser_default_get_props (impl)->filters);
}
					      ...
					      GError         **error)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->loading_shortcuts = g_slist_append (_gtk_file_chooser_default_get_props (impl)->loading_shortcuts, cancellable);
  ...
  for (l = _gtk_file_chooser_default_get_props (impl)->loading_shortcuts; l; l = l->next)
    {
      ...
      if (f && g_file_equal (file, f))
        {
	  _gtk_file_chooser_default_get_props (impl)->loading_shortcuts = g_slist_remove (_gtk_file_chooser_default_get_props (impl)->loading_shortcuts, c);
	  g_cancellable_cancel (c);
          return TRUE;
	}
    }

  if (_gtk_file_chooser_default_get_props (impl)->num_shortcuts == 0)
    goto out;

  pos = shortcuts_get_pos_for_shortcut_folder (impl, 0);
  if (!__gtk_tree_model_iter_nth_child (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter, NULL, pos))
    g_assert_not_reached ();

  for (i = 0; i < _gtk_file_chooser_default_get_props (impl)->num_shortcuts; i++)
    {
      gpointer col_data;
      ShortcutType shortcut_type;
      GFile *shortcut;
      ...
      if (g_file_equal (shortcut, file))
	{
	  ...
	  _gtk_file_chooser_default_get_props (impl)->num_shortcuts--;
	  return TRUE;
	}
  ...
  for (i = 0; i < _gtk_file_chooser_default_get_props (impl)->num_shortcuts; i++)
    {
      ...
      if (i != _gtk_file_chooser_default_get_props (impl)->num_shortcuts - 1)
	{
	  if (!__gtk_tree_model_iter_next (GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->shortcuts_model), &iter))
	    g_assert_not_reached ();
	}
					   ...
					   gint                *default_height)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->preview_widget_active &&
      _gtk_file_chooser_default_get_props (impl)->preview_widget &&
      __gtk_widget_get_visible (_gtk_file_chooser_default_get_props (impl)->preview_widget))
    {
      __gtk_widget_size_request (_gtk_file_chooser_default_get_props (impl)->preview_box, &req);
      *default_width += PREVIEW_HBOX_SPACING + req.width;
    }

  if (_gtk_file_chooser_default_get_props (impl)->extra_widget &&
      __gtk_widget_get_visible (_gtk_file_chooser_default_get_props (impl)->extra_widget))
    {
      __gtk_widget_size_request (_gtk_file_chooser_default_get_props (impl)->extra_align, &req);
			  ...
			  gpointer           data)
{
  ...
  closure->file = _gtk_file_system_model_get_file (_gtk_file_chooser_default_get_props (closure->impl)->browse_files_model, iter);
  closure->num_selected++;
}
				       ...
				       gboolean              *had_selection)
{
  ...
  g_assert (!_gtk_file_chooser_default_get_props (impl)->select_multiple);
  selection = __gtk_tree_view_get_selection (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view));
  if (!__gtk_tree_selection_get_selected (selection, NULL, &iter))
    {
      *had_selection = FALSE;
  ...
  *had_selection = TRUE;
  ...
  info = _gtk_file_system_model_get_info (_gtk_file_chooser_default_get_props (impl)->browse_files_model, &iter);
  return info;
}
					...
					GFile                 *parent_file)
{
  ...
  if (!_gtk_file_chooser_default_get_props (impl)->do_overwrite_confirmation)
    return TRUE;
  ...
  switch (conf)
	...
	_gtk_file_chooser_default_get_props (impl)->should_respond_get_info_cancellable =
	  _gtk_file_system_get_info (_gtk_file_chooser_default_get_props (impl)->file_system, parent_file,
  ...
  for (l = files; l; l = l->next)
    {
      ...
      if (uri)
	{
	  __gtk_recent_manager_add_item (_gtk_file_chooser_default_get_props (impl)->recent_manager, uri);
	  g_free (uri);
	}
    }
...
gtk_file_chooser_default_should_respond (GtkFileChooserEmbed *chooser_embed)
{
  ...
  if (current_focus == _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view)
    {
      /* The following array encodes what we do based on the _gtk_file_chooser_default_get_props (impl)->action and the
    ...
    file_list:
      ...
      g_assert (_gtk_file_chooser_default_get_props (impl)->action >= GTK_FILE_CHOOSER_ACTION_OPEN && _gtk_file_chooser_default_get_props (impl)->action <= GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER);
	...
	k = num_selected;
      ...
      action = what_to_do [_gtk_file_chooser_default_get_props (impl)->action] [k];
  ...
  else if ((_gtk_file_chooser_default_get_props (impl)->location_entry != NULL) && (current_focus == _gtk_file_chooser_default_get_props (impl)->location_entry))
    {
      GFile *file;
    ...
    save_entry:
      ...
      entry = GTK_FILE_CHOOSER_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry);
      ...
      if (is_folder)
	{
	  ...
	  else if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER ||
		   _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER)
	    {
      ...
      else
	{
	  ...
	  _gtk_file_chooser_default_get_props (impl)->file_exists_get_info_cancellable =
	    _gtk_file_system_get_info (_gtk_file_chooser_default_get_props (impl)->file_system, file,
				       "standard::type",
  ...
  else if (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_SEARCH && _gtk_file_chooser_default_get_props (impl)->toplevel_last_focus_widget == _gtk_file_chooser_default_get_props (impl)->search_entry)
    {
      search_entry_activate_cb (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->search_entry), _gtk_file_chooser_default_get_props (impl));
      return FALSE;
    }
  else if (_gtk_file_chooser_default_get_props (impl)->location_entry && _gtk_file_chooser_default_get_props (impl)->toplevel_last_focus_widget == _gtk_file_chooser_default_get_props (impl)->location_entry)
    {
...
gtk_file_chooser_default_initial_focus (GtkFileChooserEmbed *chooser_embed)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_OPEN ||
      _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      if (_gtk_file_chooser_default_get_props (impl)->location_mode == LOCATION_MODE_PATH_BAR
	  || _gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_RECENT)
	widget = _gtk_file_chooser_default_get_props (impl)->browse_files_tree_view;
      else
	widget = _gtk_file_chooser_default_get_props (impl)->location_entry;
    }
  else if (_gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_SAVE ||
	   _gtk_file_chooser_default_get_props (impl)->action == GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER)
    widget = _gtk_file_chooser_default_get_props (impl)->location_entry;
...
search_should_respond (GtkFileChooserDefault *impl)
{
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_SEARCH);
		...
		gchar                 *uri)
{
  ...
  _gtk_file_system_model_add_and_query_file (_gtk_file_chooser_default_get_props (impl)->search_model,
                                             file,
                                             MODEL_ATTRIBUTES);
			   ...
			   gpointer         data)
{
   ...
   */
  __gtk_tree_view_set_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
                           GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->search_model));
  file_list_set_sort_column_ids (impl);
#endif
...
search_clear_model (GtkFileChooserDefault *impl, 
		    gboolean               remove_from_treeview)
{
  if (!_gtk_file_chooser_default_get_props (impl)->search_model)
    return;

  g_object_unref (_gtk_file_chooser_default_get_props (impl)->search_model);
  _gtk_file_chooser_default_get_props (impl)->search_model = NULL;
...
search_stop_searching (GtkFileChooserDefault *impl,
                       gboolean               remove_query)
{
  if (remove_query && _gtk_file_chooser_default_get_props (impl)->search_query)
    {
      g_object_unref (_gtk_file_chooser_default_get_props (impl)->search_query);
      _gtk_file_chooser_default_get_props (impl)->search_query = NULL;
    }
  
  if (_gtk_file_chooser_default_get_props (impl)->search_engine)
    {
      _gtk_search_engine_stop (_gtk_file_chooser_default_get_props (impl)->search_engine);
      
      g_object_unref (_gtk_file_chooser_default_get_props (impl)->search_engine);
      _gtk_file_chooser_default_get_props (impl)->search_engine = NULL;
    }
}
...
search_setup_model (GtkFileChooserDefault *impl)
{
  ...
  _gtk_file_chooser_default_get_props (impl)->search_model = _gtk_file_system_model_new (file_system_model_set,
                                                   impl,
						   MODEL_COLUMN_TYPES);

  __gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->search_model),
				   MODEL_COL_NAME,
				   name_sort_func,
				   impl, NULL);
  __gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->search_model),
		    ...
		    const gchar           *query_text)
{
  ...
  if (_gtk_file_chooser_default_get_props (impl)->search_engine == NULL)
    _gtk_file_chooser_default_get_props (impl)->search_engine = _gtk_search_engine_new ();
  ...
  if (!_gtk_file_chooser_default_get_props (impl)->search_query)
    {
      _gtk_file_chooser_default_get_props (impl)->search_query = _gtk_query_new ();
      _gtk_query_set_text (_gtk_file_chooser_default_get_props (impl)->search_query, query_text);
    }
  
  _gtk_search_engine_set_query (_gtk_file_chooser_default_get_props (impl)->search_engine, _gtk_file_chooser_default_get_props (impl)->search_query);

  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->search_engine, "hits-added",
		    G_CALLBACK (search_engine_hits_added_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->search_engine, "finished",
		    G_CALLBACK (search_engine_finished_cb), impl);
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->search_engine, "error",
		    G_CALLBACK (search_engine_error_cb), impl);

  _gtk_search_engine_start (_gtk_file_chooser_default_get_props (impl)->search_engine);
}
			  ...
			  gpointer data)
{
  ...
  text = __gtk_entry_get_text (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->search_entry));
  if (strlen (text) == 0)
    return;
...
focus_entry_idle_cb (GtkFileChooserDefault *impl)
{
  ...
  g_source_destroy (_gtk_file_chooser_default_get_props (impl)->focus_entry_idle);
  _gtk_file_chooser_default_get_props (impl)->focus_entry_idle = NULL;

  if (_gtk_file_chooser_default_get_props (impl)->search_entry)
    __gtk_widget_grab_focus (_gtk_file_chooser_default_get_props (impl)->search_entry);
...
{
  _gtk_file_chooser_default_get_props (impl)->search_hbox = __gtk_hbox_new (FALSE, 12);

  path_bar_update (impl);

  _gtk_file_chooser_default_get_props (impl)->search_entry = __gtk_entry_new ();
  g_signal_connect (_gtk_file_chooser_default_get_props (impl)->search_entry, "activate",
		    G_CALLBACK (search_entry_activate_cb),
		    impl);
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->search_hbox), _gtk_file_chooser_default_get_props (impl)->search_entry, TRUE, TRUE, 0);

  /* if there already is a query, restart it */
  if (_gtk_file_chooser_default_get_props (impl)->search_query)
    {
      gchar *query = _gtk_query_get_text (_gtk_file_chooser_default_get_props (impl)->search_query);

      if (query)
        {
          __gtk_entry_set_text (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->search_entry), query);
  ...
  __gtk_box_pack_start (GTK_BOX (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_hbox), _gtk_file_chooser_default_get_props (impl)->search_hbox, TRUE, TRUE, 0);
  __gtk_widget_show_all (_gtk_file_chooser_default_get_props (impl)->search_hbox);
  __gtk_size_group_add_widget (GTK_SIZE_GROUP (_gtk_file_chooser_default_get_props (impl)->browse_path_bar_size_group), _gtk_file_chooser_default_get_props (impl)->search_hbox);
...
recent_clear_model (GtkFileChooserDefault *impl,
                    gboolean               remove_from_treeview)
{
  if (!_gtk_file_chooser_default_get_props (impl)->recent_model)
    return;

  if (remove_from_treeview)
    __gtk_tree_view_set_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), NULL);

  g_object_unref (_gtk_file_chooser_default_get_props (impl)->recent_model);
  _gtk_file_chooser_default_get_props (impl)->recent_model = NULL;
}
...
{
  if (_gtk_file_chooser_default_get_props (impl)->load_recent_id)
    {
      g_source_remove (_gtk_file_chooser_default_get_props (impl)->load_recent_id);
      _gtk_file_chooser_default_get_props (impl)->load_recent_id = 0;
    }
}
...
{
  g_assert (_gtk_file_chooser_default_get_props (impl)->recent_model == NULL);

  _gtk_file_chooser_default_get_props (impl)->recent_model = _gtk_file_system_model_new (file_system_model_set,
                                                   impl,
						   MODEL_COLUMN_TYPES);

  _gtk_file_system_model_set_filter (_gtk_file_chooser_default_get_props (impl)->recent_model,
                                     _gtk_file_chooser_default_get_props (impl)->current_filter);
  __gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->recent_model),
				   MODEL_COL_NAME,
				   name_sort_func,
				   impl, NULL);
  __gtk_tree_sortable_set_sort_func (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->recent_model),
...
recent_idle_cleanup (gpointer data)
{
  ...
  __gtk_tree_view_set_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view),
                           GTK_TREE_MODEL (_gtk_file_chooser_default_get_props (impl)->recent_model));
  file_list_set_sort_column_ids (impl);
  __gtk_tree_sortable_set_sort_column_id (GTK_TREE_SORTABLE (_gtk_file_chooser_default_get_props (impl)->recent_model), MODEL_COL_MTIME, GTK_SORT_DESCENDING);
  ...
  for (l = items; l; l = l->next)
    {
      ...
      _gtk_file_system_model_add_and_query_file (_gtk_file_chooser_default_get_props (impl)->recent_model,
                                                 file,
                                                 MODEL_ATTRIBUTES);
      g_object_unref (file);
...
recent_idle_load (gpointer data)
{
  ...
  load_data->items = __gtk_recent_manager_get_items (_gtk_file_chooser_default_get_props (impl)->recent_manager);
  if (!load_data->items)
    return FALSE;
...
recent_start_loading (GtkFileChooserDefault *impl)
{
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->load_recent_id == 0);
  ...
  _gtk_file_chooser_default_get_props (impl)->load_recent_id = __gdk_threads_add_idle_full (G_PRIORITY_HIGH_IDLE + 30,
                                                    recent_idle_load,
                                                    load_data,
                                                    recent_idle_cleanup);
}
...
recent_should_respond (GtkFileChooserDefault *impl)
{
  ...
  g_assert (_gtk_file_chooser_default_get_props (impl)->operation_mode == OPERATION_MODE_RECENT);
...
set_current_filter (GtkFileChooserDefault *impl,
		    GtkFileFilter         *filter)
{
  if (_gtk_file_chooser_default_get_props (impl)->current_filter != filter)
    {
      int filter_index;
       ...
       */
      filter_index = g_slist_index (_gtk_file_chooser_default_get_props (impl)->filters, filter);
      if (_gtk_file_chooser_default_get_props (impl)->filters && filter && filter_index < 0)
	return;

      if (_gtk_file_chooser_default_get_props (impl)->current_filter)
	g_object_unref (_gtk_file_chooser_default_get_props (impl)->current_filter);
      _gtk_file_chooser_default_get_props (impl)->current_filter = filter;
      if (_gtk_file_chooser_default_get_props (impl)->current_filter)
	{
	  g_object_ref_sink (_gtk_file_chooser_default_get_props (impl)->current_filter);
	}

      if (_gtk_file_chooser_default_get_props (impl)->filters)
	__gtk_combo_box_set_active (GTK_COMBO_BOX (_gtk_file_chooser_default_get_props (impl)->filter_combo),
				  filter_index);
	...
	install_list_model_filter (impl);
      ...
      if (_gtk_file_chooser_default_get_props (impl)->search_model)
        _gtk_file_system_model_set_filter (_gtk_file_chooser_default_get_props (impl)->search_model, filter);

      if (_gtk_file_chooser_default_get_props (impl)->recent_model)
        _gtk_file_system_model_set_filter (_gtk_file_chooser_default_get_props (impl)->recent_model, filter);
		      ...
		      GtkFileChooserDefault *impl)
{
  ...
  GtkFileFilter *new_filter = g_slist_nth_data (_gtk_file_chooser_default_get_props (impl)->filters, new_index);
...
check_preview_change (GtkFileChooserDefault *impl)
{
  ...
  __gtk_tree_view_get_cursor (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), &cursor_path, NULL);
  model = __gtk_tree_view_get_model (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view));
  if (cursor_path)
    {
      GtkTreeIter iter;
  ...
  if (new_file != _gtk_file_chooser_default_get_props (impl)->preview_file &&
      !(new_file && _gtk_file_chooser_default_get_props (impl)->preview_file &&
	g_file_equal (new_file, _gtk_file_chooser_default_get_props (impl)->preview_file)))
    {
      if (_gtk_file_chooser_default_get_props (impl)->preview_file)
	{
	  g_object_unref (_gtk_file_chooser_default_get_props (impl)->preview_file);
      ...
      if (new_file)
	{
	  _gtk_file_chooser_default_get_props (impl)->preview_file = new_file;
	  _gtk_file_chooser_default_get_props (impl)->preview_display_name = new_display_name;
	}
      else
	{
	  _gtk_file_chooser_default_get_props (impl)->preview_file = NULL;
	  _gtk_file_chooser_default_get_props (impl)->preview_display_name = NULL;
          g_free (new_display_name);
	}

      if (_gtk_file_chooser_default_get_props (impl)->use_preview_label && _gtk_file_chooser_default_get_props (impl)->preview_label)
	__gtk_label_set_text (GTK_LABEL (_gtk_file_chooser_default_get_props (impl)->preview_label), _gtk_file_chooser_default_get_props (impl)->preview_display_name);
				    ...
				    gpointer             data)
{
  ...
  if (cancellable != _gtk_file_chooser_default_get_props (impl)->shortcuts_activate_iter_cancellable)
    goto out;
  ...
  if (!_gtk_file_system_volume_is_mounted (volume))
    {
      ...
      _gtk_file_chooser_default_get_props (impl)->shortcuts_activate_iter_cancellable =
        _gtk_file_system_mount_volume (_gtk_file_chooser_default_get_props (impl)->file_system, volume, mount_op,
			 ...
			 GtkTreeIter           *iter)
{
  ...
  if (shortcut_type == SHORTCUT_TYPE_SEPARATOR)
  ...
  else if (shortcut_type == SHORTCUT_TYPE_FILE)
    {
      ...
      volume = _gtk_file_system_get_volume_for_file (_gtk_file_chooser_default_get_props (impl)->file_system, col_data);
      ...
      if (!volume || !_gtk_file_system_volume_is_mounted (volume))
	{
	  ...
	  _gtk_file_chooser_default_get_props (impl)->shortcuts_activate_iter_cancellable =
	    _gtk_file_system_mount_enclosing_volume (_gtk_file_chooser_default_get_props (impl)->file_system, col_data,
						     mount_operation,
			...
			gpointer           data)
{
  ...
  if (!__gtk_tree_model_get_iter (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model, &filter_iter, path))
    g_assert_not_reached ();

  __gtk_tree_model_get (_gtk_file_chooser_default_get_props (impl)->shortcuts_pane_filter_model, &filter_iter, SHORTCUTS_COL_TYPE, &shortcut_type, -1);
...
update_cell_renderer_attributes (GtkFileChooserDefault *impl)
{
  ...
  /* name */
  column = __gtk_tree_view_get_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), 0);
  ...
  /* size */
  column = __gtk_tree_view_get_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), 1);
  list = __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (column));
  renderer = list->data;
  __gtk_tree_view_column_set_attributes (column, renderer, 
  ...
  /* mtime */
  column = __gtk_tree_view_get_column (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_files_tree_view), 2);
  list = __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (column));
  renderer = list->data;
  __gtk_tree_view_column_set_attributes (column, renderer, 
...
location_set_user_text (GtkFileChooserDefault *impl,
			const gchar           *path)
{
  __gtk_entry_set_text (GTK_ENTRY (_gtk_file_chooser_default_get_props (impl)->location_entry), path);
  __gtk_editable_set_position (GTK_EDITABLE (_gtk_file_chooser_default_get_props (impl)->location_entry), -1);
}
  ...
  if (_gtk_file_chooser_default_get_props (impl)->operation_mode != OPERATION_MODE_BROWSE)
    {
      ...
      if (_gtk_file_chooser_default_get_props (impl)->location_mode == LOCATION_MODE_PATH_BAR)
        ...
        widget_to_focus = _gtk_file_chooser_default_get_props (impl)->location_entry;
...
{
  _gtk_path_bar_up (GTK_PATH_BAR (_gtk_file_chooser_default_get_props (impl)->browse_path_bar));
}
...
{
  _gtk_path_bar_down (GTK_PATH_BAR (_gtk_file_chooser_default_get_props (impl)->browse_path_bar));
}
...
{
  if (_gtk_file_chooser_default_get_props (impl)->has_home)
...
{
  if (_gtk_file_chooser_default_get_props (impl)->has_desktop)
...
{
  if (_gtk_file_chooser_default_get_props (impl)->has_search)
    {
			...
			gint bookmark_index)
{
  ...
  if (bookmark_index < 0 || bookmark_index >= _gtk_file_chooser_default_get_props (impl)->num_bookmarks)
    return;
  ...
  __gtk_tree_view_scroll_to_cell (GTK_TREE_VIEW (_gtk_file_chooser_default_get_props (impl)->browse_shortcuts_tree_view),
				path, NULL,
				FALSE, 0.0, 0.0);
  __gtk_tree_path_free (path);
...
{
  g_object_set (impl,
		"show-hidden", !_gtk_file_chooser_default_get_props (impl)->show_hidden,
		NULL);
}
