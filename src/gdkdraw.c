...
STLWRT_DEFINE_FTYPE (GdkDrawable, gdk_drawable, G_TYPE_OBJECT, G_TYPE_FLAG_ABSTRACT, ;)
 ...
 **/
void          
__gdk_drawable_set_data (GdkDrawable   *drawable,
		       const gchar   *key,
		       gpointer	      data,
 ...
 **/
gpointer
__gdk_drawable_get_data (GdkDrawable   *drawable,
		       const gchar   *key)
{
 ...
 *
 * Deprecated: 2.24: Use __gdk_window_get_width() and __gdk_window_get_height() for
 *             #GdkWindows. Use __gdk_pixmap_get_size() for #GdkPixmaps.
 */
void
__gdk_drawable_get_size (GdkDrawable *drawable,
		       gint        *width,
		       gint        *height)
{
  g_return_if_fail (GDK_IS_DRAWABLE (drawable));
 ...
 *
 * Deprecated: 2.24: Use __gdk_window_get_visual()
 */
GdkVisual*
__gdk_drawable_get_visual (GdkDrawable *drawable)
{
  g_return_val_if_fail (GDK_IS_DRAWABLE (drawable), NULL);
 ...
 **/
gint
__gdk_drawable_get_depth (GdkDrawable *drawable)
{
 ...
 * Since: 2.2
 *
 * Deprecated: 2.24: Use __gdk_window_get_screen() instead
 **/
GdkScreen*
__gdk_drawable_get_screen (GdkDrawable *drawable)
{
  g_return_val_if_fail (GDK_IS_DRAWABLE (drawable), NULL);
 ...
 * Since: 2.2
 *
 * Deprecated: 2.24: Use __gdk_window_get_display() instead
 **/
GdkDisplay*
__gdk_drawable_get_display (GdkDrawable *drawable)
{
  g_return_val_if_fail (GDK_IS_DRAWABLE (drawable), NULL);

  return __gdk_screen_get_display (__gdk_drawable_get_screen (drawable));
}

/**
 * __gdk_drawable_set_colormap:
 * @drawable: a #GdkDrawable
 ...
 **/
void
__gdk_drawable_set_colormap (GdkDrawable *drawable,
                           GdkColormap *cmap)
{
  g_return_if_fail (GDK_IS_DRAWABLE (drawable));
  g_return_if_fail (cmap == NULL || __gdk_drawable_get_depth (drawable)
                    == cmap->visual->depth);
 ...
 **/
GdkColormap*
__gdk_drawable_get_colormap (GdkDrawable *drawable)
{
  g_return_val_if_fail (GDK_IS_DRAWABLE (drawable), NULL);
 ...
 **/
GdkDrawable*
__gdk_drawable_ref (GdkDrawable *drawable)
{
  return (GdkDrawable *) g_object_ref (drawable);
}

/**
 * __gdk_drawable_unref:
 * @drawable: a #GdkDrawable
 *
 ...
 **/
void
__gdk_drawable_unref (GdkDrawable *drawable)
{
  g_return_if_fail (GDK_IS_DRAWABLE (drawable));
 ...
 **/
void
__gdk_draw_point (GdkDrawable *drawable,
                GdkGC       *gc,
                gint         x,
                gint         y)
{
 ...
 **/
void
__gdk_draw_line (GdkDrawable *drawable,
	       GdkGC       *gc,
	       gint         x1,
	       gint         y1,
	       gint         x2,
 ...
 **/
void
__gdk_draw_rectangle (GdkDrawable *drawable,
		    GdkGC       *gc,
		    gboolean     filled,
		    gint         x,
		    gint         y,
  ...
  if (width < 0 || height < 0)
    {
      ...
      __gdk_drawable_get_size (drawable, &real_width, &real_height);
 ...
 **/
void
__gdk_draw_arc (GdkDrawable *drawable,
	      GdkGC       *gc,
	      gboolean     filled,
	      gint         x,
	      gint         y,
 ...
 **/
void
__gdk_draw_polygon (GdkDrawable    *drawable,
		  GdkGC          *gc,
		  gboolean        filled,
 ...
 * 
 * Deprecated: 2.4: Use __gdk_draw_layout() instead.
 **/
void
__gdk_draw_string (GdkDrawable *drawable,
		 GdkFont     *font,
		 GdkGC       *gc,
		 gint         x,
		 gint         y,
		 const gchar *string)
{
  __gdk_draw_text (drawable, font, gc, x, y, string, _gdk_font_strlen (font, string));
}
 ...
 **/
void
__gdk_draw_text (GdkDrawable *drawable,
	       GdkFont     *font,
	       GdkGC       *gc,
	       gint         x,
	       gint         y,
 ...
 **/
void
__gdk_draw_text_wc (GdkDrawable	 *drawable,
		  GdkFont	 *font,
		  GdkGC		 *gc,
		  gint		  x,
		  gint		  y,
 ...
 *
 * Deprecated: 2.22: Use __gdk_cairo_set_source_pixmap(), cairo_rectangle()
 ...
 **/
void
__gdk_draw_drawable (GdkDrawable *drawable,
		   GdkGC       *gc,
		   GdkDrawable *src,
		   gint         xsrc,
		   gint         ysrc,
  ...
  if (width < 0 || height < 0)
    {
      ...
      __gdk_drawable_get_size (src, &real_width, &real_height);
 ...
 **/
void
__gdk_draw_image (GdkDrawable *drawable,
		GdkGC       *gc,
		GdkImage    *image,
		gint         xsrc,
		gint         ysrc,
 ...
 *
 * If GDK is built with the Sun mediaLib library, the __gdk_draw_pixbuf
 ...
 * Since: 2.2
 *
 * Deprecated: 2.22: Use __gdk_cairo_set_source_pixbuf() and cairo_paint() or
 * cairo_rectangle() and cairo_fill() instead.
 **/
void
__gdk_draw_pixbuf (GdkDrawable     *drawable,
                 GdkGC           *gc,
 ...
 **/
void
__gdk_draw_points (GdkDrawable    *drawable,
		 GdkGC          *gc,
		 const GdkPoint *points,
		 gint            n_points)
{
 ...
 * instead. See the documentation of __gdk_draw_line() for notes on line drawing
 * with Cairo.
 **/
void
__gdk_draw_segments (GdkDrawable      *drawable,
		   GdkGC            *gc,
 ...
 * __gdk_gc_set_line_attributes().
 *
 * Deprecated: 2.22: Use cairo_line_to() and cairo_stroke() instead. See the
 * documentation of __gdk_draw_line() for notes on line drawing with Cairo.
 **/
void
__gdk_draw_lines (GdkDrawable    *drawable,
		GdkGC          *gc,
		const GdkPoint *points,
		gint            n_points)
{
 ...
 * using __gdk_draw_layout() instead.
 *
 * A glyph is a single image in a font. This function draws a sequence of
 * glyphs.  To obtain a sequence of glyphs you have to understand a
 * lot about internationalized text handling, which you don't want to
 * understand; thus, use __gdk_draw_layout() instead of this function,
 * __gdk_draw_layout() handles the details.
 * 
 * Deprecated: 2.22: Use pango_cairo_show_glyphs() instead.
 **/
void
__gdk_draw_glyphs (GdkDrawable      *drawable,
		 GdkGC            *gc,
		 PangoFont        *font,
		 gint              x,
		 gint              y,
 ...
 *
 * See also __gdk_draw_glyphs(), __gdk_draw_layout().
 *
 * Since: 2.6
 * 
 * Deprecated: 2.22: Use pango_cairo_show_glyphs() instead.
 **/
void
__gdk_draw_glyphs_transformed (GdkDrawable       *drawable,
			     GdkGC	       *gc,
			     const PangoMatrix *matrix,
			     PangoFont         *font,
			     gint               x,
 ...
 **/
void
__gdk_draw_trapezoids (GdkDrawable        *drawable,
		     GdkGC	        *gc,
 ...
 * and copies into that. See __gdk_drawable_get_image() for further details.
 * 
 ...
 **/
GdkImage*
__gdk_drawable_copy_to_image (GdkDrawable *drawable,
			    GdkImage    *image,
			    gint         src_x,
			    gint         src_y,
			    gint         dest_x,
  ...
  if (!image && retval)
    {
      ...
      if (cmap)
	__gdk_image_set_colormap (retval, cmap);
    }
 ...
 * objects. __gdk_drawable_get_image() obtains the pixels from a
 ...
 * most cases you should use __gdk_pixbuf_get_from_drawable() instead of
 ...
 **/
GdkImage*
__gdk_drawable_get_image (GdkDrawable *drawable,
                        gint         x,
                        gint         y,
                        gint         width,
                        gint         height)
...
gdk_drawable_real_get_image (GdkDrawable     *drawable,
			     ...
			     gint             height)
{
  return __gdk_drawable_copy_to_image (drawable, NULL, x, y, 0, 0, width, height);
}
...
/**
 * __gdk_drawable_get_clip_region:
 * @drawable: a #GdkDrawable
 * 
 ...
 * primitives.
 * 
 * Returns: a #GdkRegion. This must be freed with __gdk_region_destroy()
 *          when you are done.
 **/
GdkRegion *
__gdk_drawable_get_clip_region (GdkDrawable *drawable)
{
  g_return_val_if_fail (GDK_IS_DRAWABLE (drawable), NULL);
...
/**
 * __gdk_drawable_get_visible_region:
 * @drawable: a #GdkDrawable
 * 
 ...
 **/
GdkRegion *
__gdk_drawable_get_visible_region (GdkDrawable *drawable)
{
  g_return_val_if_fail (GDK_IS_DRAWABLE (drawable), NULL);
...
gdk_drawable_real_get_visible_region (GdkDrawable *drawable)
{
  ...
  __gdk_drawable_get_size (drawable, &rect.width, &rect.height);

  return __gdk_region_rectangle (&rect);
}
			       ...
			       gint          y_dither)
{
  ...
  __gdk_drawable_get_size (drawable, &dwidth, &dheight);
  ...
  drect = __gdk_region_rectangle (&tmp_rect);
  clip = __gdk_drawable_get_clip_region (drawable);

  __gdk_region_intersect (drect, clip);

  __gdk_region_get_clipbox (drect, &tmp_rect);
  
  __gdk_region_destroy (drect);
  ...
  if (gdk_pixbuf_get_has_alpha (pixbuf))
    {
      GdkVisual *visual = __gdk_drawable_get_visual (drawable);
      ...
      if (visual)
	{
	  gint bits_per_pixel = _gdk_windowing_get_bits_for_depth (__gdk_drawable_get_display (drawable),
								   visual->depth);
      ...
      if (composite_func && !(dither == GDK_RGB_DITHER_MAX && visual->depth != 24))
	{
	  ...
	  for (y0 = 0; y0 < height; y0 += GDK_SCRATCH_IMAGE_HEIGHT)
	      ...
	      for (x0 = 0; x0 < width; x0 += GDK_SCRATCH_IMAGE_WIDTH)
		{
		  ...
		  GdkImage *image = _gdk_image_get_scratch (__gdk_drawable_get_screen (drawable),
							    width1, height1,
							    __gdk_drawable_get_depth (drawable), &xs0, &ys0);
		  
		  __gdk_drawable_copy_to_image (drawable, image,
					      dest_x + x0, dest_y + y0,
					      xs0, ys0,
					      width1, height1);
		  (*composite_func) (gdk_pixbuf_get_pixels (pixbuf) + (src_y + y0) * gdk_pixbuf_get_rowstride (pixbuf) + (src_x + x0) * 4,
				     ...
				     visual->byte_order,
				     width1, height1);
		  __gdk_draw_image (real_drawable, gc, image,
				  xs0, ys0,
				  dest_x + x0, dest_y + y0,
				  width1, height1);
		}
      ...
      else
	{
	   ...
	   */
	  composited = __gdk_pixbuf_get_from_drawable (NULL,
						     drawable,
						     NULL,
						     dest_x, dest_y,
						     0, 0,
  ...
  if (gdk_pixbuf_get_n_channels (pixbuf) == 4)
    {
      ...
      __gdk_draw_rgb_32_image_dithalign (real_drawable, gc,
				       dest_x, dest_y,
				       width, height,
				       dither,
  ...
  else				/* n_channels == 3 */
    {
      ...
      __gdk_draw_rgb_image_dithalign (real_drawable, gc,
				    dest_x, dest_y,
				    width, height,
				    dither,
				    buf, gdk_pixbuf_get_rowstride (pixbuf),
			      ...
			      gboolean     graphics_exposures)
{
  ...
  screen = __gdk_drawable_get_screen (drawable);

  g_return_val_if_fail (!screen->closed, NULL);

  depth = __gdk_drawable_get_depth (drawable) - 1;
  ...
  if (graphics_exposures)
      ...
      if (!screen->exposure_gcs[depth])
	{
	  ...
	  screen->exposure_gcs[depth] =
	    __gdk_gc_new_with_values (drawable, &values, mask);
	}
