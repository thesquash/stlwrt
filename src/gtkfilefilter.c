...
/**
 * __gtk_file_filter_new:
 * 
 * Creates a new #GtkFileFilter with no rules added to it.
 * Such a filter doesn't accept any files, so is not
 * particularly useful until you add rules with
 * __gtk_file_filter_add_mime_type(), __gtk_file_filter_add_pattern(),
 * or __gtk_file_filter_add_custom(). To create a filter
 * that accepts any file, use:
 * |[
 * GtkFileFilter *filter = __gtk_file_filter_new ();
 * __gtk_file_filter_add_pattern (filter, "*");
 * ]|
 * 
 ...
 **/
GtkFileFilter *
__gtk_file_filter_new (void)
{
  return g_object_new (GTK_TYPE_FILE_FILTER, NULL);
}

/**
 * __gtk_file_filter_set_name:
 ...
 **/
void
__gtk_file_filter_set_name (GtkFileFilter *filter,
			  const gchar   *name)
{
...
/**
 * __gtk_file_filter_get_name:
 * @filter: a #GtkFileFilter
 * 
 * Gets the human-readable name for the filter. See __gtk_file_filter_set_name().
 * 
 ...
 **/
const gchar *
__gtk_file_filter_get_name (GtkFileFilter *filter)
{
...
/**
 * __gtk_file_filter_add_mime_type:
 * @filter: A #GtkFileFilter
 ...
 **/
void
__gtk_file_filter_add_mime_type (GtkFileFilter *filter,
 ...
 **/
void
__gtk_file_filter_add_pattern (GtkFileFilter *filter,
			     const gchar   *pattern)
{
  FilterRule *rule;
...
/**
 * __gtk_file_filter_add_pixbuf_formats:
 * @filter: a #GtkFileFilter
 * 
 ...
 **/
void
__gtk_file_filter_add_pixbuf_formats (GtkFileFilter *filter)
{
  FilterRule *rule;
 ...
 **/
void
__gtk_file_filter_add_custom (GtkFileFilter         *filter,
			    GtkFileFilterFlags     needed,
			    GtkFileFilterFunc      func,
			    gpointer               data,
			    GDestroyNotify         notify)
...
/**
 * __gtk_file_filter_get_needed:
 * @filter: a #GtkFileFilter
 * 
 * Gets the fields that need to be filled in for the structure
 * passed to __gtk_file_filter_filter()
 * 
 ...
 *   calling __gtk_file_filter_filter()
 * 
 * Since: 2.4
 **/
GtkFileFilterFlags
__gtk_file_filter_get_needed (GtkFileFilter *filter)
{
  return filter->needed;
}

/**
 * __gtk_file_filter_filter:
 * @filter: a #GtkFileFilter
 ...
 * the fields returned from __gtk_file_filter_get_needed().
 *
 * This function will not typically be used by applications; it
 * is intended principally for use in the implementation of
 * #GtkFileChooser.
 ...
 **/
gboolean
__gtk_file_filter_filter (GtkFileFilter           *filter,
