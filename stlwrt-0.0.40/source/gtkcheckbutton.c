...
void
______gtk_check_button_get_props (GtkCheckButton *check_button,
			     gint           *indicator_size,
  ...
  if (toggle_button->draw_indicator)
    {
      ...
      ______gtk_check_button_get_props (GTK_CHECK_BUTTON (widget),
  ...
  if (toggle_button->draw_indicator)
    {
      ...
      ______gtk_check_button_get_props (check_button, &indicator_size, &indicator_spacing);
      __gtk_widget_style_get (widget,
			    "focus-line-width", &focus_width,
			    "focus-padding", &focus_pad,
			    NULL);
      ...
      if (GTK_BIN (button)->child && __gtk_widget_get_visible (GTK_BIN (button)->child))
	{
	  ...
	  __gtk_widget_get_child_requisition (GTK_BIN (button)->child, &child_requisition);
