...
#define GTK_TYPE_CELL_RENDERER_COMBO		(__gtk_cell_renderer_combo_get_type ())
...
GType            __gtk_cell_renderer_combo_get_type (void) G_GNUC_CONST;
GtkCellRenderer *__gtk_cell_renderer_combo_new      (void);
