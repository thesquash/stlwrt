...
STLWRT_DEFINE_FTYPE (GdkDisplay, gdk_display, G_TYPE_OBJECT, 0, ;)
...
gdk_display_dispose (GObject *object)
{
  ...
  g_list_foreach (display->queued_events, (GFunc)__gdk_event_free, NULL);
  ...
  if (__gdk_display_get_default() == display)
    {
      if (_gdk_displays)
 ...
 */
void
__gdk_display_close (GdkDisplay *display)
{
 ...
 */
gboolean
__gdk_display_is_closed  (GdkDisplay  *display)
{
 ...
 * are pending. The returned #GdkEvent should be freed with __gdk_event_free().
 *
 * Since: 2.2
 **/
GdkEvent*
__gdk_display_get_event (GdkDisplay *display)
{
 ...
 **/
GdkEvent*
__gdk_display_peek_event (GdkDisplay *display)
{
  GList *tmp_list;
  ...
  if (tmp_list)
    return __gdk_event_copy (tmp_list->data);
  else
    return NULL;
}

/**
 * __gdk_display_put_event:
 * @display: a #GdkDisplay
 * @event: a #GdkEvent.
 *
 ...
 **/
void
__gdk_display_put_event (GdkDisplay     *display,
 ...
 **/
void
__gdk_pointer_ungrab (guint32 time)
{
  __gdk_display_pointer_ungrab (__gdk_display_get_default (), time);
}

/**
 * __gdk_pointer_is_grabbed:
 * 
 ...
 **/
gboolean
__gdk_pointer_is_grabbed (void)
{
  return __gdk_display_pointer_is_grabbed (__gdk_display_get_default ());
}

/**
 * __gdk_keyboard_ungrab:
 * @time_: a timestamp from a #GdkEvent, or %GDK_CURRENT_TIME if no
 *        timestamp is available.
 * 
 ...
 **/
void
__gdk_keyboard_ungrab (guint32 time)
{
  __gdk_display_keyboard_ungrab (__gdk_display_get_default (), time);
}
...
__gdk_beep (void)
{
  __gdk_display_beep (__gdk_display_get_default ());
}

/**
 * __gdk_event_send_client_message:
 ...
 **/
gboolean
__gdk_event_send_client_message (GdkEvent        *event,
			       GdkNativeWindow  winid)
{
  g_return_val_if_fail (event != NULL, FALSE);

  return __gdk_event_send_client_message_for_display (__gdk_display_get_default (),
						    event, winid);
}

/**
 * __gdk_event_send_clientmessage_toall:
 * @event: the #GdkEvent to send, which should be a #GdkEventClient.
 *
 ...
 **/
void
__gdk_event_send_clientmessage_toall (GdkEvent *event)
{
  g_return_if_fail (event != NULL);

  __gdk_screen_broadcast_client_message (__gdk_screen_get_default (), event);
}

/**
 * __gdk_device_get_core_pointer:
 * 
 ...
 **/
GdkDevice *
__gdk_device_get_core_pointer (void)
{
  return __gdk_display_get_core_pointer (__gdk_display_get_default ());
}

/**
 * __gdk_display_get_core_pointer:
 * @display: a #GdkDisplay
 * 
 ...
 **/
GdkDevice *
__gdk_display_get_core_pointer (GdkDisplay *display)
{
  return display->core_pointer;
}

/**
 * __gdk_set_sm_client_id:
 ...
 *
 * Deprecated:2.24: Use __gdk_x11_set_sm_client_id() instead
 **/
void
__gdk_set_sm_client_id (const gchar* sm_client_id)
{
 ...
 * 
 * Gets the client ID set with __gdk_set_sm_client_id(), if any.
 * 
 * Return value: Session ID, or %NULL if __gdk_set_sm_client_id()
 ...
 **/
void
__gdk_display_get_pointer (GdkDisplay      *display,
			 GdkScreen      **screen,
			 gint            *x,
			 gint            *y,
			 GdkModifierType *mask)
...
/**
 * __gdk_display_get_window_at_pointer:
 * @display: a #GdkDisplay
 ...
 **/
GdkWindow *
__gdk_display_get_window_at_pointer (GdkDisplay *display,
				   gint       *win_x,
				   gint       *win_y)
{
  gint tmp_x, tmp_y;
...
/**
 * __gdk_display_set_pointer_hooks:
 * @display: a #GdkDisplay
...
__gdk_display_set_pointer_hooks (GdkDisplay                   *display,
...
singlehead_get_pointer (GdkDisplay       *display,
			...
			GdkModifierType  *mask)
{
  GdkScreen *default_screen = __gdk_display_get_default_screen (display);
  GdkWindow *root_window = __gdk_screen_get_root_window (default_screen);
...
singlehead_default_window_at_pointer  (GdkScreen       *screen,
				       ...
				       gint            *win_y)
{
  return gdk_display_real_get_window_at_pointer (__gdk_screen_get_display (screen),
                                                 win_x, win_y);
}

/**
 * __gdk_set_pointer_hooks:
 * @new_hooks: a table of pointers to functions for getting
 *   quantities related to the current pointer position,
 *   or %NULL to restore the default table.
 * 
 ...
 * see __gdk_display_set_pointer_hooks().
 * 
 * Return value: the previous pointer hook table
 *
 * Deprecated: 2.24: This function will go away in GTK 3 for lack of use cases.
 **/
GdkPointerHooks *
__gdk_set_pointer_hooks (const GdkPointerHooks *new_hooks)
{
  ...
  __gdk_display_set_pointer_hooks (__gdk_display_get_default (),
			    ...
			    gulong serial)
{
  ...
  if (src_window)
    src_toplevel = __gdk_window_get_toplevel (src_window);
  else
    src_toplevel = NULL;
  if (dest_window)
    dest_toplevel = __gdk_window_get_toplevel (dest_window);
  else
    dest_toplevel = NULL;
  ...
  if (src_toplevel == NULL ||
    ...
    {
      /* Same toplevels */
      __gdk_window_get_pointer (dest_toplevel,
			      &x, &y, &state);
    ...
    {
      __gdk_window_get_pointer (src_toplevel,
			      &x, &y, &state);
      _gdk_synthesize_crossing_events (display,
				       src_window,
				       NULL,
...
/**
 * __gdk_keyboard_grab_info_libgtk_only:
 * @display: the display for which to get the grab information
 * @grab_window: location to store current grab window
 * @owner_events: location to store boolean indicating whether
 *   the @owner_events flag to __gdk_keyboard_grab() was %TRUE.
 * 
 ...
 **/
gboolean
__gdk_keyboard_grab_info_libgtk_only (GdkDisplay *display,
				    GdkWindow **grab_window,
				    gboolean   *owner_events)
{
  g_return_val_if_fail (GDK_IS_DISPLAY (display), FALSE);
...
/**
 * __gdk_pointer_grab_info_libgtk_only:
 * @display: the #GdkDisplay for which to get the grab information
 * @grab_window: location to store current grab window
 * @owner_events: location to store boolean indicating whether
 *   the @owner_events flag to __gdk_pointer_grab() was %TRUE.
 * 
 ...
 **/
gboolean
__gdk_pointer_grab_info_libgtk_only (GdkDisplay *display,
				   GdkWindow **grab_window,
				   gboolean   *owner_events)
{
...
/**
 * __gdk_display_pointer_is_grabbed:
 * @display: a #GdkDisplay
 *
 ...
 */
gboolean
__gdk_display_pointer_is_grabbed (GdkDisplay *display)
{
  GdkPointerGrabInfo *info;
