...
#define GTK_LIST_STORE_IS_SORTED(list) (gtk_list_store_get_props ((GtkListStore*)(list))->sort_column_id != GTK_TREE_SORTABLE_UNSORTED_SORT_COLUMN_ID)
#define VALID_ITER(iter, list_store) ((iter)!= NULL && (iter)->user_data != NULL && gtk_list_store_get_props (list_store)->stamp == (iter)->stamp && !g_sequence_iter_is_end ((iter)->user_data) && g_sequence_iter_get_sequence ((iter)->user_data) == gtk_list_store_get_props (list_store)->seq)
...
static void __gtk_list_store_set_n_columns   (GtkListStore *list_store,
					    gint          n_columns);
static void __gtk_list_store_set_column_type (GtkListStore *list_store,
					    gint          column,
					    GType         type);
...
static gboolean gtk_list_store_get_sort_column_id    (GtkTreeSortable        *sortable,
						      gint                   *sort_column_id,
						      GtkSortType            *order);
static void     __gtk_list_store_set_sort_column_id    (GtkTreeSortable        *sortable,
						      gint                    sort_column_id,
						      GtkSortType             order);
static void     __gtk_list_store_set_sort_func         (GtkTreeSortable        *sortable,
						      gint                    sort_column_id,
						      GtkTreeIterCompareFunc  func,
						      gpointer                data,
						      GDestroyNotify          destroy);
static void     __gtk_list_store_set_default_sort_func (GtkTreeSortable        *sortable,
						      GtkTreeIterCompareFunc  func,
						      gpointer                data,
						      GDestroyNotify          destroy);
...
gtk_list_store_sortable_init (GtkTreeSortableIface *iface)
{
  ...
  iface->set_sort_column_id = __gtk_list_store_set_sort_column_id;
  iface->set_sort_func = __gtk_list_store_set_sort_func;
  iface->set_default_sort_func = __gtk_list_store_set_default_sort_func;
 ...
 **/
GtkListStore *
__gtk_list_store_new (gint n_columns,
		    ...)
{
  GtkListStore *retval;
  va_list args;
  ...
  __gtk_list_store_set_n_columns (retval, n_columns);
  ...
  for (i = 0; i < n_columns; i++)
      ...
      if (! _gtk_tree_data_list_check_type (type))
	{
      ...
      __gtk_list_store_set_column_type (retval, i, type);
    }
 ...
 **/
GtkListStore *
__gtk_list_store_newv (gint   n_columns,
		     GType *types)
{
  GtkListStore *retval;
  gint i;
  ...
  for (i = 0; i < n_columns; i++)
      ...
      if (! _gtk_tree_data_list_check_type (types[i]))
	{
      ...
      __gtk_list_store_set_column_type (retval, i, types[i]);
    }
...
/**
 * __gtk_list_store_set_column_types:
 ...
 **/
void
__gtk_list_store_set_column_types (GtkListStore *list_store,
				 gint          n_columns,
				 GType        *types)
{
  gint i;
  ...
  for (i = 0; i < n_columns; i++)
      ...
      if (! _gtk_tree_data_list_check_type (types[i]))
	{
      ...
      __gtk_list_store_set_column_type (list_store, i, types[i]);
    }
}

static void
__gtk_list_store_set_n_columns (GtkListStore *list_store,
			      gint          n_columns)
{
  int i;
...
static void
__gtk_list_store_set_column_type (GtkListStore *list_store,
				gint          column,
				GType         type)
{
  if (!_gtk_tree_data_list_check_type (type))
			 ...
			 GtkTreeIter  *iter)
{
  ...
  __gtk_tree_path_append_index (path, g_sequence_iter_get_position (iter->user_data));
 ...
 **/
void
__gtk_list_store_set_value (GtkListStore *list_store,
			  GtkTreeIter  *iter,
			  gint          column,
			  GValue       *value)
{
  ...
  if (gtk_list_store_real_set_value (list_store, iter, column, value, TRUE))
    {
      ...
      __gtk_tree_model_row_changed (GTK_TREE_MODEL (list_store), path, iter);
...
static void
__gtk_list_store_set_vector_internal (GtkListStore *list_store,
				    GtkTreeIter  *iter,
...
static void
__gtk_list_store_set_valist_internal (GtkListStore *list_store,
				    GtkTreeIter  *iter,
				    gboolean     *emit_signal,
				    gboolean     *maybe_need_sort,
				    va_list	  var_args)
 ...
 *
 * A variant of __gtk_list_store_set_valist() which
 ...
 */
void
__gtk_list_store_set_valuesv (GtkListStore *list_store,
			    GtkTreeIter  *iter,
			    gint         *columns,
			    GValue       *values,
			    gint          n_values)
{
  ...
  if (maybe_need_sort && GTK_LIST_STORE_IS_SORTED (list_store))
    gtk_list_store_sort_iter_changed (list_store, iter, gtk_list_store_get_props (list_store)->sort_column_id);
...
/**
 * __gtk_list_store_set_valist:
 * @list_store: A #GtkListStore
 * @iter: A valid #GtkTreeIter for the row being modified
 * @var_args: va_list of column/value pairs
 *
 * See __gtk_list_store_set(); this version takes a va_list for use by language
 * bindings.
 *
 **/
void
__gtk_list_store_set_valist (GtkListStore *list_store,
                           GtkTreeIter  *iter,
                           va_list	 var_args)
{
  gboolean emit_signal = FALSE;
 ...
 * %G_TYPE_STRING to "Foo", you would write <literal>__gtk_list_store_set (store, iter,
 * 0, "Foo", -1)</literal>.
 *
 ...
 **/
void
__gtk_list_store_set (GtkListStore *list_store,
		    GtkTreeIter  *iter,
		    ...)
{
  va_list var_args;
  ...
  __gtk_list_store_set_valist (list_store, iter, var_args);
  va_end (var_args);
}

/**
 * __gtk_list_store_remove:
 * @list_store: A #GtkListStore
 ...
 **/
gboolean
__gtk_list_store_remove (GtkListStore *list_store,
		       GtkTreeIter  *iter)
{
  GtkTreePath *path;
 ...
 * __gtk_list_store_set() or __gtk_list_store_set_value().
 *
 **/
void
__gtk_list_store_insert (GtkListStore *list_store,
		       GtkTreeIter  *iter,
		       gint          position)
{
  GtkTreePath *path;
  ...
  __gtk_tree_model_row_inserted (GTK_TREE_MODEL (list_store), path, iter);
  __gtk_tree_path_free (path);
}

/**
 * __gtk_list_store_insert_before:
 * @list_store: A #GtkListStore
 * @iter: (out): An unset #GtkTreeIter to set to the new row
 ...
 * values, you need to call __gtk_list_store_set() or __gtk_list_store_set_value().
 *
 **/
void
__gtk_list_store_insert_before (GtkListStore *list_store,
			      GtkTreeIter  *iter,
			      GtkTreeIter  *sibling)
{
  GSequenceIter *after;
  ...
  __gtk_list_store_insert (list_store, iter, g_sequence_iter_get_position (after));
}

/**
 * __gtk_list_store_insert_after:
 * @list_store: A #GtkListStore
 * @iter: (out): An unset #GtkTreeIter to set to the new row
 * @sibling: (allow-none): A valid #GtkTreeIter, or %NULL
 *
 ...
 * in values, you need to call __gtk_list_store_set() or __gtk_list_store_set_value().
 *
 **/
void
__gtk_list_store_insert_after (GtkListStore *list_store,
			     GtkTreeIter  *iter,
			     GtkTreeIter  *sibling)
{
  GSequenceIter *after;
 ...
 **/
void
__gtk_list_store_prepend (GtkListStore *list_store,
			GtkTreeIter  *iter)
{
  g_return_if_fail (GTK_IS_LIST_STORE (list_store));
  g_return_if_fail (iter != NULL);

  __gtk_list_store_insert (list_store, iter, 0);
}

/**
 * __gtk_list_store_append:
 * @list_store: A #GtkListStore
 ...
 **/
void
__gtk_list_store_append (GtkListStore *list_store,
		       GtkTreeIter  *iter)
{
  g_return_if_fail (GTK_IS_LIST_STORE (list_store));
  g_return_if_fail (iter != NULL);

  __gtk_list_store_insert (list_store, iter, g_sequence_get_length (gtk_list_store_get_props (list_store)->seq));
}
 ...
 **/
void
__gtk_list_store_clear (GtkListStore *list_store)
{
  GtkTreeIter iter;
  g_return_if_fail (GTK_IS_LIST_STORE (list_store));
...
/**
 * __gtk_list_store_iter_is_valid:
 * @list_store: A #GtkListStore.
 * @iter: A #GtkTreeIter.
 *
 ...
 **/
gboolean
__gtk_list_store_iter_is_valid (GtkListStore *list_store,
                              GtkTreeIter  *iter)
{
  g_return_val_if_fail (GTK_IS_LIST_STORE (list_store), FALSE);
                                 ...
                                 GtkTreePath       *path)
{
  ...
  if (gtk_list_store_get_iter (GTK_TREE_MODEL (drag_source),
                               ...
                               path))
    {
      __gtk_list_store_remove (GTK_LIST_STORE (drag_source), &iter);
      return TRUE;
    }
  return FALSE;
}
                                   ...
                                   GtkSelectionData  *selection_data)
{
  ...
  if (__gtk_tree_get_row_drag_data (selection_data,
      ...
      src_model == tree_model)
    {
      ...
      if (!__gtk_tree_path_prev (prev))
        {
           ...
           * to prepend.
           */
          __gtk_list_store_prepend (list_store, &dest_iter);
          ...
          if (gtk_list_store_get_iter (tree_model, &dest_iter, prev))
            {
              ...
              __gtk_list_store_insert_after (list_store, &dest_iter, &tmp_iter);
	  ...
	  __gtk_tree_model_row_changed (tree_model, path, &dest_iter);
	  __gtk_tree_path_free (path);
	}
    }
  else
...
/* Reordering */
static gint
__gtk_list_store_reorder_func (GSequenceIter *a,
			     GSequenceIter *b,
			     gpointer       user_data)
{
 ...
 **/
void
__gtk_list_store_reorder (GtkListStore *store,
			gint         *new_order)
{
  gint i;
  GtkTreePath *path;
 ...
 **/
void
__gtk_list_store_swap (GtkListStore *store,
		     GtkTreeIter  *a,
		     GtkTreeIter  *b)
{
  GHashTable *old_positions;
 ...
 **/
void
__gtk_list_store_move_before (GtkListStore *store,
                            GtkTreeIter  *iter,
 ...
 **/
void
__gtk_list_store_move_after (GtkListStore *store,
			   GtkTreeIter  *iter,
			   GtkTreeIter  *position)
{
  gint pos;
...
static void
__gtk_list_store_set_sort_column_id (GtkTreeSortable  *sortable,
				   gint              sort_column_id,
				   GtkSortType       order)
{
  GtkListStore *list_store = (GtkListStore *) sortable;
...
static void
__gtk_list_store_set_sort_func (GtkTreeSortable        *sortable,
			      gint                    sort_column_id,
			      GtkTreeIterCompareFunc  func,
			      gpointer                data,
			      GDestroyNotify          destroy)
...
static void
__gtk_list_store_set_default_sort_func (GtkTreeSortable        *sortable,
				      GtkTreeIterCompareFunc  func,
				      gpointer                data,
				      GDestroyNotify          destroy)
{
...
/**
 * __gtk_list_store_insert_with_values:
 * @list_store: A #GtkListStore
 ...
 * 
 * Calling
 * <literal>__gtk_list_store_insert_with_values(list_store, iter, position...)</literal> 
 ...
 * __gtk_list_store_insert_with_values() should generally be preferred when
 * inserting rows in a sorted list store.
 *
 * Since: 2.6
 */
void
__gtk_list_store_insert_with_values (GtkListStore *list_store,
				   GtkTreeIter  *iter,
				   gint          position,
				   ...)
{
  ...
  /* FIXME: refactor to reduce overlap with __gtk_list_store_set() */
  g_return_if_fail (GTK_IS_LIST_STORE (list_store));
...
/**
 * __gtk_list_store_insert_with_valuesv:
 * @list_store: A #GtkListStore
 * @iter: (out) (allow-none): An unset #GtkTreeIter to set to the new row, or %NULL.
 * @position: position to insert the new row
 * @columns: (array length=n_values): an array of column numbers
 ...
 * @n_values: the length of the @columns and @values arrays
 * 
 * A variant of __gtk_list_store_insert_with_values() which
 * takes the columns and values as two arrays, instead of
 * varargs. This function is mainly intended for 
 * language-bindings.
 *
 ...
 */
void
__gtk_list_store_insert_with_valuesv (GtkListStore *list_store,
				    GtkTreeIter  *iter,
				    gint          position,
				    gint         *columns, 
				    GValue       *values,
  ...
  if (strcmp (element_name, "row") == 0)
    {
      ...
      __gtk_list_store_insert_with_valuesv (GTK_LIST_STORE (data->object),
					  &iter,
					  data->last_row,
					  data->colids,
					  data->values,
      ...
      for (l = data->column_type_names, i = 0; l; l = l->next, i++)
	{
      ...
      __gtk_list_store_set_column_types (GTK_LIST_STORE (data->object), i,
				       column_types);
		 ...
		 GError             **error)
{
  ...
  if (info->translatable && text_len)
    {
       ...
       * However, it will work for __gtk_builder_set_translation_domain() calls.
       */
  ...
  if (!__gtk_builder_value_from_string_type (data->builder,
					   ...
					   gpointer      *data)
{
  ...
  if (strcmp (tagname, "columns") == 0)
	...
	g_error ("Cannot append data to an empty model");
      ...
      parser_data->domain = __gtk_builder_get_translation_domain (builder);
