...
gboolean
______gtk_selection_request (GtkWidget *widget,
			GdkEventSelection *event)
{
...
/*************************************************************
 * ______gtk_selection_incr_event:
...
gboolean
______gtk_selection_incr_event (GdkWindow	   *window,
...
gboolean
______gtk_selection_notify (GtkWidget	       *widget,
		       GdkEventSelection *event)
{
  GList *tmp_list;
...
/*************************************************************
 * ______gtk_selection_property_notify:
...
gboolean
______gtk_selection_property_notify (GtkWidget	*widget,
				GdkEventProperty *event)
{
  GList *tmp_list;
  GtkRetrievalInfo *info = NULL;
