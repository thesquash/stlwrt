...
#define GTK_TYPE_FILE_CHOOSER_ENTRY    (___gtk_file_chooser_entry_get_type ())
...
typedef struct _GtkFileChooserEntry      GtkFileChooserEntrySkinny;

GType              ___gtk_file_chooser_entry_get_type           (void) G_GNUC_CONST;
