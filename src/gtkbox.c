...
gtk_box_init (GtkBox *box)
{
  ...
  gtk_box_get_props (box)->children = NULL;
  gtk_box_get_props (box)->spacing = 0;
                      ...
                      GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_ORIENTATION:
      ...
      __gtk_widget_queue_resize (GTK_WIDGET (box));
      break;
    case PROP_SPACING:
      __gtk_box_set_spacing (box, g_value_get_int (value));
      break;
    case PROP_HOMOGENEOUS:
      __gtk_box_set_homogeneous (box, g_value_get_boolean (value));
      break;
    default:
                      ...
                      GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_ORIENTATION:
      ...
      break;
    case PROP_SPACING:
      g_value_set_int (value, gtk_box_get_props (box)->spacing);
      break;
    case PROP_HOMOGENEOUS:
      g_value_set_boolean (value, gtk_box_get_props (box)->homogeneous);
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
                      ...
                      GtkRequisition *requisition)
{
  ...
  children = gtk_box_get_props (box)->children;
  while (children)
    {
      child = children->data;
      ...
      if (__gtk_widget_get_visible (child->widget))
	{
	  ...
	  if (gtk_box_get_props (box)->homogeneous)
	    {
  ...
  if (nvis_children > 0)
    {
      ...
      if (private->orientation == GTK_ORIENTATION_HORIZONTAL)
        requisition->width += (nvis_children - 1) * gtk_box_get_props (box)->spacing;
      else
        requisition->height += (nvis_children - 1) * gtk_box_get_props (box)->spacing;
    }

  requisition->width += gtk_container_get_props (GTK_CONTAINER (box))->border_width * 2;
  requisition->height += gtk_container_get_props (GTK_CONTAINER (box))->border_width * 2;
}
                       ...
                       GtkAllocation *allocation)
{
  ...
  for (children = gtk_box_get_props (box)->children; children; children = children->next)
    {
      child = children->data;
  ...
  if (nvis_children > 0)
          ...
          if (private->orientation == GTK_ORIENTATION_HORIZONTAL)
            {
              width = (allocation->width -
                       gtk_container_get_props (GTK_CONTAINER (box))->border_width * 2 -
                       (nvis_children - 1) * gtk_box_get_props (box)->spacing);
      ...
      else if (nexpand_children > 0)
	{
          if (private->orientation == GTK_ORIENTATION_HORIZONTAL)
            {
              width = (gint) allocation->width - (gint) gtk_widget_get_props (widget)->requisition.width;
              extra = width / nexpand_children;
            }
          else
            {
              height = (gint) allocation->height - (gint) gtk_widget_get_props (widget)->requisition.height;
      ...
      if (private->orientation == GTK_ORIENTATION_HORIZONTAL)
        {
          x = allocation->x + gtk_container_get_props (GTK_CONTAINER (box))->border_width;
          child_allocation.y = allocation->y + gtk_container_get_props (GTK_CONTAINER (box))->border_width;
          child_allocation.height = MAX (1, (gint) allocation->height - (gint) gtk_container_get_props (GTK_CONTAINER (box))->border_width * 2);
        }
      else
        {
          y = allocation->y + gtk_container_get_props (GTK_CONTAINER (box))->border_width;
          child_allocation.x = allocation->x + gtk_container_get_props (GTK_CONTAINER (box))->border_width;
          child_allocation.width = MAX (1, (gint) allocation->width - (gint) gtk_container_get_props (GTK_CONTAINER (box))->border_width * 2);
        }
      ...
      while (children)
	{
	  ...
	  if ((child->pack == GTK_PACK_START) && __gtk_widget_get_visible (child->widget))
	    {
	      if (gtk_box_get_props (box)->homogeneous)
		{
		  if (nvis_children == 1)
	      ...
	      else
		{
	      ...
	      x += child_width + gtk_box_get_props (box)->spacing;
	      y += child_height + gtk_box_get_props (box)->spacing;
	    }
	}

      x = allocation->x + allocation->width - gtk_container_get_props (GTK_CONTAINER (box))->border_width;
      y = allocation->y + allocation->height - gtk_container_get_props (GTK_CONTAINER (box))->border_width;
      ...
      while (children)
	{
	  ...
	  if ((child->pack == GTK_PACK_END) && __gtk_widget_get_visible (child->widget))
	    {
	      GtkRequisition child_requisition;
                            ...
                            GParamSpec   *pspec)
{
  ...
  if (property_id != CHILD_PROP_POSITION)
    __gtk_box_query_child_packing (GTK_BOX (container),
				 child,
				 &expand,
				 &fill,
				 &padding,
  ...
  switch (property_id)
    ...
    case CHILD_PROP_EXPAND:
      __gtk_box_set_child_packing (GTK_BOX (container),
				 child,
    ...
    case CHILD_PROP_POSITION:
      __gtk_box_reorder_child (GTK_BOX (container),
			     child,
			    ...
			    GParamSpec   *pspec)
{
  ...
  switch (property_id)
    ...
    case CHILD_PROP_POSITION:
      i = 0;
      for (list = gtk_box_get_props (GTK_BOX (container))->children; list; list = list->next)
	{
              ...
              GtkPackType  pack_type)
{
  ...
  gtk_box_get_props (box)->children = g_list_append (gtk_box_get_props (box)->children, child_info);

  __gtk_widget_freeze_child_notify (child);

  __gtk_widget_set_parent (child, GTK_WIDGET (box));
  
  __gtk_widget_child_notify (child, "expand");
  __gtk_widget_child_notify (child, "fill");
  __gtk_widget_child_notify (child, "padding");
  __gtk_widget_child_notify (child, "pack-type");
 ...
 **/
GtkWidget*
 __gtk_box_new (GtkOrientation orientation,
 ...
 */
void
__gtk_box_pack_start (GtkBox    *box,
		    GtkWidget *child,
		    gboolean   expand,
		    gboolean   fill,
		    guint      padding)
 ...
 *
 * Deprecated: 2.14: Use __gtk_box_pack_start()
 */
void
__gtk_box_pack_start_defaults (GtkBox    *box,
			     GtkWidget *child)
{
  __gtk_box_pack_start (box, child, TRUE, TRUE, 0);
}

/**
 * __gtk_box_pack_end_defaults:
 * @box: a #GtkBox
 * @widget: the #GtkWidget to be added to @box
 *
 ...
 * values, %TRUE, %TRUE, and 0, respectively.
 *
 * Deprecated: 2.14: Use __gtk_box_pack_end()
 */
void
__gtk_box_pack_end_defaults (GtkBox    *box,
			   GtkWidget *child)
{
  __gtk_box_pack_end (box, child, TRUE, TRUE, 0);
}

/**
 * __gtk_box_set_homogeneous:
 * @box: a #GtkBox
 ...
 */
void
__gtk_box_set_homogeneous (GtkBox  *box,
			 gboolean homogeneous)
{
  g_return_if_fail (GTK_IS_BOX (box));

  if ((homogeneous ? TRUE : FALSE) != gtk_box_get_props (box)->homogeneous)
    {
      gtk_box_get_props (box)->homogeneous = homogeneous ? TRUE : FALSE;
...
/**
 * __gtk_box_get_homogeneous:
 * @box: a #GtkBox
 *
 * Returns whether the box is homogeneous (all children are the
 * same size). See __gtk_box_set_homogeneous().
 *
 * Return value: %TRUE if the box is homogeneous.
 **/
gboolean
__gtk_box_get_homogeneous (GtkBox *box)
{
  g_return_val_if_fail (GTK_IS_BOX (box), FALSE);

  return gtk_box_get_props (box)->homogeneous;
}

/**
 * __gtk_box_set_spacing:
 * @box: a #GtkBox
 ...
 */
void
__gtk_box_set_spacing (GtkBox *box,
		     gint    spacing)
{
  g_return_if_fail (GTK_IS_BOX (box));

  if (spacing != gtk_box_get_props (box)->spacing)
    {
      gtk_box_get_props (box)->spacing = spacing;
      ___gtk_box_set_spacing_set (box, TRUE);
...
/**
 * __gtk_box_get_spacing:
 * @box: a #GtkBox
 * 
 * Gets the value set by __gtk_box_set_spacing().
 * 
 * Return value: spacing between children
 **/
gint
__gtk_box_get_spacing (GtkBox *box)
{
  g_return_val_if_fail (GTK_IS_BOX (box), 0);

  return gtk_box_get_props (box)->spacing;
}

void
___gtk_box_set_spacing_set (GtkBox  *box,
...
gboolean
___gtk_box_get_spacing_set (GtkBox *box)
{
  GtkBoxPrivate *private;
 ...
 */ 
void
__gtk_box_reorder_child (GtkBox    *box,
		       GtkWidget *child,
		       gint       position)
{
  GList *old_link;
  ...
  old_link = gtk_box_get_props (box)->children;
  old_position = 0;
  while (old_link)
    {
  ...
  gtk_box_get_props (box)->children = g_list_delete_link (gtk_box_get_props (box)->children, old_link);

  if (position < 0)
    new_link = NULL;
  else
    new_link = g_list_nth (gtk_box_get_props (box)->children, position);

  gtk_box_get_props (box)->children = g_list_insert_before (gtk_box_get_props (box)->children, new_link, child_info);

  __gtk_widget_child_notify (child, "position");
  if (__gtk_widget_get_visible (child)
      && __gtk_widget_get_visible (GTK_WIDGET (box)))
    __gtk_widget_queue_resize (child);
}

/**
 * __gtk_box_query_child_packing:
 * @box: a #GtkBox
 ...
 */
void
__gtk_box_query_child_packing (GtkBox      *box,
			     GtkWidget   *child,
			     gboolean    *expand,
			     gboolean    *fill,
			     guint       *padding,
			     GtkPackType *pack_type)
{
  ...
  list = gtk_box_get_props (box)->children;
  while (list)
    {
 ...
 */
void
__gtk_box_set_child_packing (GtkBox      *box,
			   GtkWidget   *child,
			   gboolean     expand,
			   gboolean     fill,
			   guint        padding,
...
void
___gtk_box_set_old_defaults (GtkBox *box)
{
  GtkBoxPrivate *private;
		...
		GtkWidget    *widget)
{
  ...
  while (children)
      ...
      if (child->widget == widget)
	{
	  ...
	  gtk_box_get_props (box)->children = g_list_remove_link (gtk_box_get_props (box)->children, children);
		...
		gpointer      callback_data)
{
  ...
  children = g_list_last (gtk_box_get_props (box)->children);
  while (children)
    {
      child = children->data;
