...
STLWRT_DEFINE_TYPE (GtkStatusIcon, gtk_status_icon, G_TYPE_OBJECT)
 ...
 */
   ...
   * language</link>. Also see __gtk_tooltip_set_markup().
   *
   * This is a convenience property which will take care of getting the
   * tooltip shown if the given string is not %NULL.
   * #GtkStatusIcon:has-tooltip will automatically be set to %TRUE and
   ...
   * passed as the last to arguments to __gtk_menu_popup().
   *
   * Unlike most G_SIGNAL_ACTION signals, this signal is meant to 
   * be used by applications and should be wrapped by language bindings.
   *
		    ...
		    guint                 button)
{
  ...
  __gdk_screen_get_monitor_geometry (__gdk_screen_get_default (), 0, &monitor0);
  e->window = g_object_ref (__gdk_get_default_root_window ());
  e->send_event = TRUE;
  e->time = GetTickCount ();
  GetCursorPos (&pos);
  ...
  e->state = 0;
  e->button = button;
  e->device = __gdk_display_get_default ()->core_pointer;
  e->x_root = e->x;
  e->y_root = e->y;
}
...
button_callback (gpointer data)
{
  ...
  __gdk_event_free ((GdkEvent *) bc->event);
  g_free (data);
	 ...
	 LPARAM lparam)
{
  ...
  if (message == WM_GTK_TRAY_NOTIFICATION)
	...
	buttondown0:
	  ...
	  bc->event = (GdkEventButton *) __gdk_event_new (GDK_BUTTON_PRESS);
	...
	buttonup0:
	  bc = g_new (ButtonCallbackData, 1);
	  bc->event = (GdkEventButton *) __gdk_event_new (GDK_BUTTON_RELEASE);
	  bc->status_icon = find_status_icon (wparam);
	  build_button_event (bc->status_icon->priv, bc->event, button);
	  g_idle_add (button_callback, bc);
	  break;
...
gtk_status_icon_init (GtkStatusIcon *status_icon)
{
  ...
  __gtk_widget_add_events (GTK_WIDGET (priv->tray_icon),
  ...
  __gtk_widget_set_can_focus (priv->image, TRUE);
  __gtk_container_add (GTK_CONTAINER (priv->tray_icon), priv->image);
                             ...
                             GObjectConstructParam *construct_params)
{
  ...
  if (priv->visible)
    __gtk_widget_show (priv->tray_icon);
#endif
...
gtk_status_icon_finalize (GObject *object)
{
  ...
  __gtk_widget_destroy (priv->image);
  __gtk_widget_destroy (priv->tray_icon);
#endif
  ...
  __gtk_widget_destroy (priv->dummy_widget);
			      ...
			      GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_PIXBUF:
      __gtk_status_icon_set_from_pixbuf (status_icon, g_value_get_object (value));
      break;
    case PROP_FILE:
      __gtk_status_icon_set_from_file (status_icon, g_value_get_string (value));
      break;
    case PROP_STOCK:
      __gtk_status_icon_set_from_stock (status_icon, g_value_get_string (value));
      break;
    case PROP_ICON_NAME:
      __gtk_status_icon_set_from_icon_name (status_icon, g_value_get_string (value));
      break;
    case PROP_GICON:
      __gtk_status_icon_set_from_gicon (status_icon, g_value_get_object (value));
      break;
    case PROP_SCREEN:
      __gtk_status_icon_set_screen (status_icon, g_value_get_object (value));
      break;
    case PROP_BLINKING:
      __gtk_status_icon_set_blinking (status_icon, g_value_get_boolean (value));
      break;
    case PROP_VISIBLE:
      __gtk_status_icon_set_visible (status_icon, g_value_get_boolean (value));
      break;
    case PROP_HAS_TOOLTIP:
      __gtk_status_icon_set_has_tooltip (status_icon, g_value_get_boolean (value));
      break;
    case PROP_TOOLTIP_TEXT:
      __gtk_status_icon_set_tooltip_text (status_icon, g_value_get_string (value));
      break;
    case PROP_TOOLTIP_MARKUP:
      __gtk_status_icon_set_tooltip_markup (status_icon, g_value_get_string (value));
      break;
    case PROP_TITLE:
      __gtk_status_icon_set_title (status_icon, g_value_get_string (value));
      break;
    default:
			      ...
			      GParamSpec *pspec)
{
  ...
  switch (prop_id)
	...
	g_value_set_object (value, __gtk_status_icon_get_pixbuf (status_icon));
      break;
    case PROP_STOCK:
      if (priv->storage_type != GTK_IMAGE_STOCK)
	g_value_set_string (value, NULL);
      else
	g_value_set_string (value, __gtk_status_icon_get_stock (status_icon));
      break;
    case PROP_ICON_NAME:
      if (priv->storage_type != GTK_IMAGE_ICON_NAME)
	g_value_set_string (value, NULL);
      else
	g_value_set_string (value, __gtk_status_icon_get_icon_name (status_icon));
      break;
    case PROP_GICON:
      if (priv->storage_type != GTK_IMAGE_GICON)
        g_value_set_object (value, NULL);
      else
        g_value_set_object (value, __gtk_status_icon_get_gicon (status_icon));
      break;
    case PROP_STORAGE_TYPE:
      g_value_set_enum (value, __gtk_status_icon_get_storage_type (status_icon));
      break;
    case PROP_SIZE:
      g_value_set_int (value, __gtk_status_icon_get_size (status_icon));
      break;
    case PROP_SCREEN:
      g_value_set_object (value, __gtk_status_icon_get_screen (status_icon));
      break;
    case PROP_BLINKING:
      g_value_set_boolean (value, __gtk_status_icon_get_blinking (status_icon));
      break;
    case PROP_VISIBLE:
      g_value_set_boolean (value, __gtk_status_icon_get_visible (status_icon));
      break;
    case PROP_EMBEDDED:
      g_value_set_boolean (value, __gtk_status_icon_is_embedded (status_icon));
      break;
    case PROP_ORIENTATION:
      ...
      break;
    case PROP_HAS_TOOLTIP:
      g_value_set_boolean (value, __gtk_status_icon_get_has_tooltip (status_icon));
      break;
    case PROP_TOOLTIP_TEXT:
      g_value_set_string (value, __gtk_status_icon_get_tooltip_text (status_icon));
      break;
    case PROP_TOOLTIP_MARKUP:
      g_value_set_string (value, __gtk_status_icon_get_tooltip_markup (status_icon));
      break;
    case PROP_TITLE:
      g_value_set_string (value, __gtk_status_icon_get_title (status_icon));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
 ...
 **/
GtkStatusIcon *
__gtk_status_icon_new (void)
{
  return g_object_new (GTK_TYPE_STATUS_ICON, NULL);
}

/**
 * __gtk_status_icon_new_from_pixbuf:
 * @pixbuf: a #GdkPixbuf
 * 
 ...
 **/
GtkStatusIcon *
__gtk_status_icon_new_from_pixbuf (GdkPixbuf *pixbuf)
{
...
/**
 * __gtk_status_icon_new_from_file:
 * @filename: a filename
 * 
 ...
 **/
GtkStatusIcon *
__gtk_status_icon_new_from_file (const gchar *filename)
{
  return g_object_new (GTK_TYPE_STATUS_ICON,
		       "file", filename,
		       NULL);
...
/**
 * __gtk_status_icon_new_from_stock:
 * @stock_id: a stock icon id
 * 
 * Creates a status icon displaying a stock icon. Sample stock icon
 * names are #GTK_STOCK_OPEN, #GTK_STOCK_QUIT. You can register your 
 * own stock icon names, see __gtk_icon_factory_add_default() and 
 * __gtk_icon_factory_add(). 
 *
 * Return value: a new #GtkStatusIcon
 *
 * Since: 2.10
 **/
GtkStatusIcon *
__gtk_status_icon_new_from_stock (const gchar *stock_id)
{
  return g_object_new (GTK_TYPE_STATUS_ICON,
		       "stock", stock_id,
		       NULL);
...
/**
 * __gtk_status_icon_new_from_icon_name:
 ...
 **/
GtkStatusIcon *
__gtk_status_icon_new_from_icon_name (const gchar *icon_name)
{
  return g_object_new (GTK_TYPE_STATUS_ICON,
		       "icon-name", icon_name,
		       NULL);
...
/**
 * __gtk_status_icon_new_from_gicon:
 * @icon: a #GIcon
 *
 ...
 **/
GtkStatusIcon *
__gtk_status_icon_new_from_gicon (GIcon *icon)
{
  return g_object_new (GTK_TYPE_STATUS_ICON,
		       "gicon", icon,
		       NULL);
		...
		gint       pixel_size)
{
  ...
  for (s = GTK_ICON_SIZE_MENU; s <= GTK_ICON_SIZE_DIALOG; s++)
    {
      if (__gtk_icon_size_lookup_for_settings (settings, s, &w, &h) &&
...
gtk_status_icon_update_image (GtkStatusIcon *status_icon)
{
  ...
  if (priv->blink_off)
    {
#ifdef GDK_WINDOWING_X11
      __gtk_image_set_from_pixbuf (GTK_IMAGE (priv->image),
  ...
  switch (priv->storage_type)
...
#ifdef GDK_WINDOWING_X11
	    __gtk_image_set_from_pixbuf (GTK_IMAGE (priv->image), scaled);
#endif
#ifdef GDK_WINDOWING_WIN32
	    prev_hicon = priv->nid.hIcon;
	...
	{
	  GdkPixbuf *pixbuf =
	    __gtk_widget_render_icon (priv->dummy_widget,
				    priv->image_data.stock_id,
...
#ifdef GDK_WINDOWING_QUARTZ
	{
	  ...
	  pixbuf = __gtk_widget_render_icon (priv->dummy_widget,
					   priv->image_data.stock_id,
					   GTK_ICON_SIZE_SMALL_TOOLBAR,
					   NULL);
	  QUARTZ_POOL_ALLOC;
	...
	{
	  GdkPixbuf *pixbuf =
	    __gtk_icon_theme_load_icon (__gtk_icon_theme_get_default (),
				      priv->image_data.icon_name,
				      priv->size,
				      0, NULL);
...
#ifdef GDK_WINDOWING_QUARTZ
	{
	  ...
	  pixbuf = __gtk_icon_theme_load_icon (__gtk_icon_theme_get_default (),
					     priv->image_data.icon_name,
					     priv->size,
					     0, NULL);
    ...
    case GTK_IMAGE_GICON:
...
#ifdef GDK_WINDOWING_X11
        GtkIconSize size = find_icon_size (priv->image, priv->size);
        __gtk_image_set_from_gicon (GTK_IMAGE (priv->image),
      ...
      {
        GtkIconInfo *info =
        __gtk_icon_theme_lookup_by_gicon (__gtk_icon_theme_get_default (),
                                        priv->image_data.gicon,
                                        priv->size,
                                        0);
        GdkPixbuf *pixbuf = __gtk_icon_info_load_icon (info, NULL);
				...
				GdkScreen *old_screen)
{
  ...
  if (__gtk_widget_get_screen (priv->tray_icon) != old_screen)
    {
...
{
  emit_popup_menu_signal (status_icon, 0, __gtk_get_current_event_time ());
}
...
/**
 * __gtk_status_icon_set_from_pixbuf:
 * @status_icon: a #GtkStatusIcon
 * @pixbuf: (allow-none): a #GdkPixbuf or %NULL
 *
 * Makes @status_icon display @pixbuf.
 * See __gtk_status_icon_new_from_pixbuf() for details.
 *
 * Since: 2.10
 **/
void
__gtk_status_icon_set_from_pixbuf (GtkStatusIcon *status_icon,
				 GdkPixbuf     *pixbuf)
{
...
/**
 * __gtk_status_icon_set_from_file:
 * @status_icon: a #GtkStatusIcon
 * @filename: a filename
 * 
 * Makes @status_icon display the file @filename.
 * See __gtk_status_icon_new_from_file() for details.
 *
 * Since: 2.10 
 **/
void
__gtk_status_icon_set_from_file (GtkStatusIcon *status_icon,
 			       const gchar   *filename)
{
  ...
  __gtk_status_icon_set_from_pixbuf (status_icon, pixbuf);
...
/**
 * __gtk_status_icon_set_from_stock:
 * @status_icon: a #GtkStatusIcon
 * @stock_id: a stock icon id
 * 
 * Makes @status_icon display the stock icon with the id @stock_id.
 * See __gtk_status_icon_new_from_stock() for details.
 *
 * Since: 2.10 
 **/
void
__gtk_status_icon_set_from_stock (GtkStatusIcon *status_icon,
...
/**
 * __gtk_status_icon_set_from_icon_name:
 * @status_icon: a #GtkStatusIcon
 * @icon_name: an icon name
 * 
 * Makes @status_icon display the icon named @icon_name from the 
 * current icon theme.
 * See __gtk_status_icon_new_from_icon_name() for details.
 *
 * Since: 2.10 
 **/
void
__gtk_status_icon_set_from_icon_name (GtkStatusIcon *status_icon,
...
/**
 * __gtk_status_icon_set_from_gicon:
 * @status_icon: a #GtkStatusIcon
 * @icon: a GIcon
 *
 * Makes @status_icon display the #GIcon.
 * See __gtk_status_icon_new_from_gicon() for details.
 *
 * Since: 2.14
 **/
void
__gtk_status_icon_set_from_gicon (GtkStatusIcon *status_icon,
                                GIcon         *icon)
{
  g_return_if_fail (GTK_IS_STATUS_ICON (status_icon));
...
/**
 * __gtk_status_icon_get_storage_type:
 * @status_icon: a #GtkStatusIcon
 * 
 ...
 **/
GtkImageType
__gtk_status_icon_get_storage_type (GtkStatusIcon *status_icon)
{
...
/**
 * __gtk_status_icon_get_pixbuf:
 * @status_icon: a #GtkStatusIcon
 * 
 * Gets the #GdkPixbuf being displayed by the #GtkStatusIcon.
 * The storage type of the status icon must be %GTK_IMAGE_EMPTY or
 * %GTK_IMAGE_PIXBUF (see __gtk_status_icon_get_storage_type()).
 ...
 **/
GdkPixbuf *
__gtk_status_icon_get_pixbuf (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
...
/**
 * __gtk_status_icon_get_stock:
 * @status_icon: a #GtkStatusIcon
 * 
 * Gets the id of the stock icon being displayed by the #GtkStatusIcon.
 * The storage type of the status icon must be %GTK_IMAGE_EMPTY or
 * %GTK_IMAGE_STOCK (see __gtk_status_icon_get_storage_type()).
 ...
 **/
const gchar *
__gtk_status_icon_get_stock (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
...
/**
 * __gtk_status_icon_get_icon_name:
 * @status_icon: a #GtkStatusIcon
 * 
 * Gets the name of the icon being displayed by the #GtkStatusIcon.
 * The storage type of the status icon must be %GTK_IMAGE_EMPTY or
 * %GTK_IMAGE_ICON_NAME (see __gtk_status_icon_get_storage_type()).
 * The returned string is owned by the #GtkStatusIcon and should not
 * be freed or modified.
 * 
 ...
 **/
const gchar *
__gtk_status_icon_get_icon_name (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
...
/**
 * __gtk_status_icon_get_gicon:
 * @status_icon: a #GtkStatusIcon
 *
 * Retrieves the #GIcon being displayed by the #GtkStatusIcon.
 * The storage type of the status icon must be %GTK_IMAGE_EMPTY or
 * %GTK_IMAGE_GICON (see __gtk_status_icon_get_storage_type()).
 * The caller of this function does not own a reference to the
 * returned #GIcon.
 *
 ...
 **/
GIcon *
__gtk_status_icon_get_gicon (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
 ...
 * status icon is embedded (see __gtk_status_icon_is_embedded()).
 * 
 ...
 **/
gint
__gtk_status_icon_get_size (GtkStatusIcon *status_icon)
{
 ...
 */
void
__gtk_status_icon_set_screen (GtkStatusIcon *status_icon,
                            GdkScreen     *screen)
{
  g_return_if_fail (GDK_IS_SCREEN (screen));

#ifdef GDK_WINDOWING_X11
  __gtk_window_set_screen (GTK_WINDOW (status_icon->priv->tray_icon), screen);
#endif
}

/**
 * __gtk_status_icon_get_screen:
 * @status_icon: a #GtkStatusIcon
 *
 ...
 */
GdkScreen *
__gtk_status_icon_get_screen (GtkStatusIcon *status_icon)
{
  g_return_val_if_fail (GTK_IS_STATUS_ICON (status_icon), NULL);

#ifdef GDK_WINDOWING_X11
  return __gtk_window_get_screen (GTK_WINDOW (status_icon->priv->tray_icon));
#else
 ...
 * Since: 2.10
 *
 * Deprecated: 2.16: Use __gtk_status_icon_set_tooltip_text() instead.
 */
void
__gtk_status_icon_set_tooltip (GtkStatusIcon *status_icon,
			     const gchar   *tooltip_text)
{
  __gtk_status_icon_set_tooltip_text (status_icon, tooltip_text);
}
...
gtk_status_icon_enable_blinking (GtkStatusIcon *status_icon)
{
  ...
  if (!priv->blinking_timeout)
	...
	__gdk_threads_add_timeout (BLINK_TIMEOUT, 
 ...
 **/
void
__gtk_status_icon_set_visible (GtkStatusIcon *status_icon,
			     gboolean       visible)
{
  GtkStatusIconPrivate *priv;
  ...
  if (priv->visible != visible)
    {
      ...
      if (visible)
	__gtk_widget_show (priv->tray_icon);
      else if (__gtk_widget_get_realized (priv->tray_icon))
        {
	  __gtk_widget_hide (priv->tray_icon);
	  __gtk_widget_unrealize (priv->tray_icon);
        }
#endif
#ifdef GDK_WINDOWING_WIN32
...
/**
 * __gtk_status_icon_get_visible:
 * @status_icon: a #GtkStatusIcon
 * 
 * Returns whether the status icon is visible or not. 
 * Note that being visible does not guarantee that 
 * the user can actually see the icon, see also 
 * __gtk_status_icon_is_embedded().
 * 
 ...
 **/
gboolean
__gtk_status_icon_get_visible (GtkStatusIcon *status_icon)
{
...
/**
 * __gtk_status_icon_set_blinking:
 * @status_icon: a #GtkStatusIcon
 ...
 **/
void
__gtk_status_icon_set_blinking (GtkStatusIcon *status_icon,
			      gboolean       blinking)
{
  GtkStatusIconPrivate *priv;
...
/**
 * __gtk_status_icon_get_blinking:
 * @status_icon: a #GtkStatusIcon
 * 
 ...
 **/
gboolean
__gtk_status_icon_get_blinking (GtkStatusIcon *status_icon)
{
  g_return_val_if_fail (GTK_IS_STATUS_ICON (status_icon), FALSE);
 ...
 **/
gboolean
__gtk_status_icon_is_embedded (GtkStatusIcon *status_icon)
{
#ifdef GDK_WINDOWING_X11
  GtkPlug *plug;
#endif
...
/**
 * __gtk_status_icon_position_menu:
 * @menu: the #GtkMenu
 ...
 *
 * Menu positioning function to use with __gtk_menu_popup()
 * to position @menu aligned to the status icon @user_data.
 * 
 * Since: 2.10
 **/
void
__gtk_status_icon_position_menu (GtkMenu  *menu,
			       gint     *x,
			       gint     *y,
			       gboolean *push_in,
			       gpointer  user_data)
...
/**
 * __gtk_status_icon_get_geometry:
 * @status_icon: a #GtkStatusIcon
 ...
 *
 * See __gtk_status_icon_position_menu() for a more convenient 
 ...
 */
gboolean  
__gtk_status_icon_get_geometry (GtkStatusIcon    *status_icon,
			      GdkScreen       **screen,
			      GdkRectangle     *area,
			      GtkOrientation   *orientation)
{
...
/**
 * __gtk_status_icon_set_has_tooltip:
 * @status_icon: a #GtkStatusIcon
 ...
 */
void
__gtk_status_icon_set_has_tooltip (GtkStatusIcon *status_icon,
...
#ifdef GDK_WINDOWING_X11
  __gtk_widget_set_has_tooltip (priv->tray_icon, has_tooltip);
#endif
#ifdef GDK_WINDOWING_WIN32
  if (!has_tooltip && priv->tooltip_text)
    __gtk_status_icon_set_tooltip_text (status_icon, NULL);
#endif
#ifdef GDK_WINDOWING_QUARTZ
  if (!has_tooltip && priv->tooltip_text)
    __gtk_status_icon_set_tooltip_text (status_icon, NULL);
...
/**
 * __gtk_status_icon_get_has_tooltip:
 * @status_icon: a #GtkStatusIcon
 *
 ...
 */
gboolean
__gtk_status_icon_get_has_tooltip (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
...
#ifdef GDK_WINDOWING_X11
  has_tooltip = __gtk_widget_get_has_tooltip (priv->tray_icon);
#endif
#ifdef GDK_WINDOWING_WIN32
...
/**
 * __gtk_status_icon_set_tooltip_text:
 * @status_icon: a #GtkStatusIcon
 ...
 * __gtk_tooltip_set_text().
 *
 * Since: 2.16
 */
void
__gtk_status_icon_set_tooltip_text (GtkStatusIcon *status_icon,
				  const gchar   *text)
{
  GtkStatusIconPrivate *priv;
  ...
  __gtk_widget_set_tooltip_text (priv->tray_icon, text);
...
/**
 * __gtk_status_icon_get_tooltip_text:
 * @status_icon: a #GtkStatusIcon
 *
 ...
 */
gchar *
__gtk_status_icon_get_tooltip_text (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
...
#ifdef GDK_WINDOWING_X11
  tooltip_text = __gtk_widget_get_tooltip_text (priv->tray_icon);
#endif
#ifdef GDK_WINDOWING_WIN32
...
/**
 * __gtk_status_icon_set_tooltip_markup:
 * @status_icon: a #GtkStatusIcon
 ...
 */
void
__gtk_status_icon_set_tooltip_markup (GtkStatusIcon *status_icon,
				    const gchar   *markup)
{
  GtkStatusIconPrivate *priv;
...
#ifdef GDK_WINDOWING_X11
  __gtk_widget_set_tooltip_markup (priv->tray_icon, markup);
#endif
#ifdef GDK_WINDOWING_WIN32
  if (markup)
    pango_parse_markup (markup, -1, 0, NULL, &text, NULL, NULL);
  __gtk_status_icon_set_tooltip_text (status_icon, text);
  g_free (text);
#endif
#ifdef GDK_WINDOWING_QUARTZ
  if (markup)
...
/**
 * __gtk_status_icon_get_tooltip_markup:
 * @status_icon: a #GtkStatusIcon
 *
 * Gets the contents of the tooltip for @status_icon.
 *
 ...
 */
gchar *
__gtk_status_icon_get_tooltip_markup (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
  gchar *markup = NULL;
...
#ifdef GDK_WINDOWING_X11
  markup = __gtk_widget_get_tooltip_markup (priv->tray_icon);
#endif
#ifdef GDK_WINDOWING_WIN32
  if (priv->tooltip_text)
...
/**
 * __gtk_status_icon_get_x11_window_id:
 * @status_icon: a #GtkStatusIcon
 *
 ...
 * as __gtk_status_icon_position_menu().
 *
 ...
 */
guint32
__gtk_status_icon_get_x11_window_id (GtkStatusIcon *status_icon)
{
#ifdef GDK_WINDOWING_X11
  __gtk_widget_realize (GTK_WIDGET (status_icon->priv->tray_icon));
 ...
 */
void
__gtk_status_icon_set_title (GtkStatusIcon *status_icon,
                           const gchar   *title)
{
  GtkStatusIconPrivate *priv;
...
#ifdef GDK_WINDOWING_X11
  __gtk_window_set_title (GTK_WINDOW (priv->tray_icon), title);
#endif
#ifdef GDK_WINDOWING_QUARTZ
  g_free (priv->title);
...
/**
 * __gtk_status_icon_get_title:
 * @status_icon: a #GtkStatusIcon
 *
 * Gets the title of this tray icon. See __gtk_status_icon_set_title().
 *
 ...
 */
const gchar *
__gtk_status_icon_get_title (GtkStatusIcon *status_icon)
{
  GtkStatusIconPrivate *priv;
...
#ifdef GDK_WINDOWING_X11
  return __gtk_window_get_title (GTK_WINDOW (priv->tray_icon));
#endif
#ifdef GDK_WINDOWING_QUARTZ
  return priv->title;
#endif
 ...
 */
void
__gtk_status_icon_set_name (GtkStatusIcon *status_icon,
                          const gchar   *name)
{
  GtkStatusIconPrivate *priv;
...
#ifdef GDK_WINDOWING_X11
  if (__gtk_widget_get_realized (priv->tray_icon))
    {
      /* __gtk_window_set_wmclass() only operates on non-realized windows,
