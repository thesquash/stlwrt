                   ...
                   Atom     atom)
{
  ...
  utf8_string = __gdk_x11_get_xatom_by_name ("UTF8_STRING");
               ...
               guchar   **pixdata)
{
  ...
  result = XGetWindowProperty (xdisplay,
                               xwindow,
                               __gdk_x11_get_xatom_by_name ("_NET_WM_ICON"),
                               0, G_MAXLONG,
                               False, XA_CARDINAL, &type, &format, &nitems,
...
_gtk_mount_operation_lookup_context_get (GdkDisplay *display)
{
  ...
  get_window_list (GDK_DISPLAY_XDISPLAY (context->display),
                   GDK_ROOT_WINDOW(),
                   __gdk_x11_get_xatom_by_name_for_display (context->display,
                                                          "_NET_CLIENT_LIST"),
                   &mapping,
                   &mapping_length);
  ...
  if (window != None)
    {
      ...
      if (ret == NULL)
        ret = get_utf8_property (GDK_DISPLAY_XDISPLAY (context->display),
                                 window, __gdk_x11_get_xatom_by_name_for_display (context->display,
                                                                                "_NET_WM_ICON_NAME"));
    }
