 ...
 **/
gint
__gdk_string_width (GdkFont     *font,
		  const gchar *string)
{
  g_return_val_if_fail (font != NULL, -1);
  g_return_val_if_fail (string != NULL, -1);

  return __gdk_text_width (font, string, _gdk_font_strlen (font, string));
}
 ...
 *
 * Deprecated: 2.2: Use __gdk_text_extents() instead.
 **/
gint
__gdk_char_width (GdkFont *font,
		gchar    character)
{
  g_return_val_if_fail (font != NULL, -1);

  return __gdk_text_width (font, &character, 1);
}
 ...
 **/
gint
__gdk_char_width_wc (GdkFont *font,
		   GdkWChar character)
{
  g_return_val_if_fail (font != NULL, -1);

  return __gdk_text_width_wc (font, &character, 1);
}

/**
 * __gdk_string_measure:
 * @font: a #GdkFont
 * @string: the nul-terminated string to measure.
 * 
 ...
 * See __gdk_string_width().
 * 
 * Return value: the right bearing of the string in pixels.
 **/
gint
__gdk_string_measure (GdkFont     *font,
                    const gchar *string)
{
  g_return_val_if_fail (font != NULL, -1);
  g_return_val_if_fail (string != NULL, -1);

  return __gdk_text_measure (font, string, _gdk_font_strlen (font, string));
}

/**
 * __gdk_string_extents:
 * @font: a #GdkFont.
 * @string: the nul-terminated string to measure.
 ...
 **/
void
__gdk_string_extents (GdkFont     *font,
		    const gchar *string,
		    gint        *lbearing,
		    gint        *rbearing,
		    gint        *width,
		    ...
		    gint        *descent)
{
  ...
  __gdk_text_extents (font, string, _gdk_font_strlen (font, string),
 ...
 * correct value for determining the origin of the next
 * portion when drawing text in multiple pieces. 
 * See __gdk_text_width().
 * 
 * Return value: the right bearing of the string in pixels.
 **/
gint
__gdk_text_measure (GdkFont     *font,
                  const gchar *text,
                  gint         text_length)
{
  gint rbearing;
  ...
  __gdk_text_extents (font, text, text_length, NULL, &rbearing, NULL, NULL, NULL);
  return rbearing;
}
 ...
 **/
gint
__gdk_char_measure (GdkFont *font,
                  gchar    character)
{
  g_return_val_if_fail (font != NULL, -1);

  return __gdk_text_measure (font, &character, 1);
}
 ...
 * relation to the baseline. See __gdk_string_extents().
 * 
 * Return value: the height of the string in pixels.
 **/
gint
__gdk_string_height (GdkFont     *font,
		   const gchar *string)
{
  g_return_val_if_fail (font != NULL, -1);
  g_return_val_if_fail (string != NULL, -1);

  return __gdk_text_height (font, string, _gdk_font_strlen (font, string));
}
 ...
 * relation to the baseline. See __gdk_text_extents().
 * 
 * Return value: the height of the string in pixels.
 **/
gint
__gdk_text_height (GdkFont     *font,
		 const gchar *text,
		 gint         text_length)
{
  gint ascent, descent;
  ...
  __gdk_text_extents (font, text, text_length, NULL, NULL, NULL, &ascent, &descent);
 ...
 **/
gint
__gdk_char_height (GdkFont *font,
		 gchar    character)
{
  g_return_val_if_fail (font != NULL, -1);

  return __gdk_text_height (font, &character, 1);
}

/**
 * __gdk_font_from_description:
 ...
 **/
GdkFont*
__gdk_font_from_description (PangoFontDescription *font_desc)
{
  return __gdk_font_from_description_for_display (__gdk_display_get_default (),font_desc);
}
 ...
 **/
GdkFont*
__gdk_font_load (const gchar *font_name)
{  
