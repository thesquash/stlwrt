  ...
  switch (prop_id)
    {
      case PROP_TEXT_COLUMN:
        __gtk_combo_box_entry_set_text_column (entry_box,
...
/**
 * __gtk_combo_box_entry_new:
 *
 * Creates a new #GtkComboBoxEntry which has a #GtkEntry as child. After
 * construction, you should set a model using __gtk_combo_box_set_model() and a
 * text column using __gtk_combo_box_entry_set_text_column().
 *
 * Return value: A new #GtkComboBoxEntry.
 *
 * Since: 2.4
 *
 * Deprecated: 2.24: Use __gtk_combo_box_new_with_entry() instead
 */
GtkWidget *
...
/**
 * __gtk_combo_box_entry_new_with_model:
 ...
 * Since: 2.4
 *
 * Deprecated: 2.24: Use __gtk_combo_box_new_with_model_and_entry() instead
 */
GtkWidget *
__gtk_combo_box_entry_new_with_model (GtkTreeModel *model,
                                    gint          text_column)
{
  GtkWidget *ret;
...
/**
 * __gtk_combo_box_entry_set_text_column:
 ...
 * Since: 2.4
 *
 * Deprecated: 2.24: Use __gtk_combo_box_set_entry_text_column() instead
 */
void
__gtk_combo_box_entry_set_text_column (GtkComboBoxEntry *entry_box,
                                     gint              text_column)
{
  GtkTreeModel *model = __gtk_combo_box_get_model (GTK_COMBO_BOX (entry_box));
...
/**
 * __gtk_combo_box_entry_get_text_column:
 * @entry_box: A #GtkComboBoxEntry.
 *
 ...
 * Since: 2.4
 *
 * Deprecated: 2.24: Use __gtk_combo_box_get_entry_text_column() instead
 */
gint
__gtk_combo_box_entry_get_text_column (GtkComboBoxEntry *entry_box)
{
...
/**
 * __gtk_combo_box_entry_new_text:
 *
 ...
 * the following convenience functions: __gtk_combo_box_append_text(),
 ...
 */
GtkWidget *
__gtk_combo_box_entry_new_text (void)
{
  GtkWidget *entry_box;
  GtkListStore *store;

  store = __gtk_list_store_new (1, G_TYPE_STRING);
  entry_box = __gtk_combo_box_entry_new_with_model (GTK_TREE_MODEL (store), 0);
