...
typedef struct _GdkGCClass	      GdkGCClassSkinny;
...
GdkGC *__gdk_gc_ref		  (GdkGC	    *gc);
void   __gdk_gc_unref		  (GdkGC	    *gc);

void   __gdk_gc_get_values	  (GdkGC	    *gc,
				   GdkGCValues	    *values);
void   __gdk_gc_set_values          (GdkGC           *gc,
                                   GdkGCValues	   *values,
                                   GdkGCValuesMask  values_mask);
void   __gdk_gc_set_foreground	  (GdkGC	    *gc,
				   const GdkColor   *color);
void   __gdk_gc_set_background	  (GdkGC	    *gc,
				   const GdkColor   *color);
void   __gdk_gc_set_font		  (GdkGC	    *gc,
				   GdkFont	    *font);
void   __gdk_gc_set_function	  (GdkGC	    *gc,
				   GdkFunction	     function);
void   __gdk_gc_set_fill		  (GdkGC	    *gc,
				   GdkFill	     fill);
void   __gdk_gc_set_tile		  (GdkGC	    *gc,
				   GdkPixmap	    *tile);
void   __gdk_gc_set_stipple	  (GdkGC	    *gc,
				   GdkPixmap	    *stipple);
void   __gdk_gc_set_ts_origin	  (GdkGC	    *gc,
				   gint		     x,
				   gint		     y);
void   __gdk_gc_set_clip_origin	  (GdkGC	    *gc,
				   gint		     x,
				   gint		     y);
void   __gdk_gc_set_clip_mask	  (GdkGC	    *gc,
				   GdkBitmap	    *mask);
void   __gdk_gc_set_clip_rectangle  (GdkGC	    *gc,
				   const GdkRectangle *rectangle);
void   __gdk_gc_set_clip_region	  (GdkGC	    *gc,
				   const GdkRegion  *region);
void   __gdk_gc_set_subwindow	  (GdkGC	    *gc,
				   GdkSubwindowMode  mode);
void   __gdk_gc_set_exposures	  (GdkGC	    *gc,
				   gboolean	     exposures);
void   __gdk_gc_set_line_attributes (GdkGC	    *gc,
				   gint		     line_width,
				   GdkLineStyle	     line_style,
				   GdkCapStyle	     cap_style,
				   GdkJoinStyle	     join_style);
void   __gdk_gc_set_dashes          (GdkGC            *gc,
				   gint	             dash_offset,
				   gint8             dash_list[],
				   gint              n);
void   __gdk_gc_offset              (GdkGC            *gc,
				   gint              x_offset,
				   gint              y_offset);
void   __gdk_gc_copy		  (GdkGC	    *dst_gc,
				   GdkGC	    *src_gc);


void         __gdk_gc_set_colormap     (GdkGC          *gc,
				      GdkColormap    *colormap);
GdkColormap *__gdk_gc_get_colormap     (GdkGC          *gc);
void         __gdk_gc_set_rgb_fg_color (GdkGC          *gc,
				      const GdkColor *color);
void         __gdk_gc_set_rgb_bg_color (GdkGC          *gc,
				      const GdkColor *color);
GdkScreen *  __gdk_gc_get_screen	     (GdkGC          *gc);
