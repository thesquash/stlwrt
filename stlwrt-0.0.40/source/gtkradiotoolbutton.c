...
gtk_radio_tool_button_init (GtkRadioToolButton *button)
{
  ...
  __gtk_toggle_button_set_mode (GTK_TOGGLE_BUTTON (______gtk_tool_button_get_button (tool_button)), FALSE);
}
...
{
  return GTK_RADIO_BUTTON (______gtk_tool_button_get_button (GTK_TOOL_BUTTON (button)));
}
