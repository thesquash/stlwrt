...
gtk_text_buffer_class_init (GtkTextBufferClass *klass)
{
   ...
   * see __gtk_text_buffer_get_text() for more information.
   *
   * Since: 2.8
   */
  g_object_class_install_property (object_class,
   ...
   * 
   * See also: 
   * __gtk_text_buffer_insert(), 
   * __gtk_text_buffer_insert_range().
   */
  signals[INSERT_TEXT] =
   ...
   * inserted @pixbuf.
   * 
   * See also: __gtk_text_buffer_insert_pixbuf().
   */
   ...
   * inserted @anchor.
   * 
   * See also: __gtk_text_buffer_insert_child_anchor().
   */
   ...
   * 
   * See also: __gtk_text_buffer_delete().
   */
   ...
   * 
   * See also:
   * __gtk_text_buffer_set_modified().
   */
   ...
   * 
   * See also: 
   * __gtk_text_buffer_create_mark(),
   * __gtk_text_buffer_move_mark().
   */
  signals[MARK_SET] =
   ...
   * 
   * See also: 
   * __gtk_text_buffer_apply_tag(),
   * __gtk_text_buffer_insert_with_tags(),
   * __gtk_text_buffer_insert_range().
   */ 
  signals[APPLY_TAG] =
   ...
   * 
   * See also: 
   * __gtk_text_buffer_begin_user_action(),
   * __gtk_text_buffer_insert_interactive(),
   * __gtk_text_buffer_insert_range_interactive(),
   * __gtk_text_buffer_delete_interactive(),
   * __gtk_text_buffer_backspace(),
   * __gtk_text_buffer_delete_selection().
   */ 
   ...
   * 
   * See also: 
   * __gtk_text_buffer_end_user_action(),
   * __gtk_text_buffer_insert_interactive(),
   * __gtk_text_buffer_insert_range_interactive(),
   * __gtk_text_buffer_delete_interactive(),
   * __gtk_text_buffer_backspace(),
   ...
   * See __gtk_text_buffer_paste_clipboard() for more details.
   * 
   * Since: 2.16
   */ 
  signals[PASTE_DONE] =
  ...
  if (table)
    {
      ...
      ______gtk_text_tag_table_add_buffer (table, buffer);
    }
}
  ...
  if (buffer->tag_table == NULL)
    {
      ...
      ______gtk_text_tag_table_add_buffer (buffer->tag_table, buffer);
    }
                              ...
                              GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_TEXT:
      __gtk_text_buffer_set_text (text_buffer,
                              ...
                              GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_TEXT:
      {
        ...
        __gtk_text_buffer_get_start_iter (text_buffer, &start);
        __gtk_text_buffer_get_end_iter (text_buffer, &end);

        g_value_take_string (value,
                            __gtk_text_buffer_get_text (text_buffer,
                                                      &start, &end, FALSE));
        break;
      }
    ...
    case PROP_CURSOR_POSITION:
      __gtk_text_buffer_get_iter_at_mark (text_buffer, &iter, 
    				        __gtk_text_buffer_get_insert (text_buffer));
      g_value_set_int (value, __gtk_text_iter_get_offset (&iter));
      break;

    case PROP_COPY_TARGET_LIST:
      g_value_set_boxed (value, __gtk_text_buffer_get_copy_target_list (text_buffer));
      break;

    case PROP_PASTE_TARGET_LIST:
      g_value_set_boxed (value, __gtk_text_buffer_get_paste_target_list (text_buffer));
      break;
 ...
 **/
GtkTextBuffer*
__gtk_text_buffer_new (GtkTextTagTable *table)
{
  GtkTextBuffer *text_buffer;
...
gtk_text_buffer_finalize (GObject *object)
{
  ...
  if (buffer->tag_table)
    {
      ______gtk_text_tag_table_remove_buffer (buffer->tag_table, buffer);
...
GtkTextBTree*
______gtk_text_buffer_get_btree (GtkTextBuffer *buffer)
{
  return get_btree (buffer);
}

/**
 * __gtk_text_buffer_get_tag_table:
 ...
 **/
GtkTextTagTable*
__gtk_text_buffer_get_tag_table (GtkTextBuffer *buffer)
{
 ...
 **/
void
__gtk_text_buffer_set_text (GtkTextBuffer *buffer,
                          const gchar   *text,
                          gint           len)
{
  GtkTextIter start, end;
  ...
  __gtk_text_buffer_get_bounds (buffer, &start, &end);

  __gtk_text_buffer_delete (buffer, &start, &end);

  if (len > 0)
    {
      __gtk_text_buffer_get_iter_at_offset (buffer, &start, 0);
      __gtk_text_buffer_insert (buffer, &start, text, len);
    }
 ...
 **/
void
__gtk_text_buffer_insert (GtkTextBuffer *buffer,
                        GtkTextIter   *iter,
                        const gchar   *text,
                        gint           len)
{
...
/**
 * __gtk_text_buffer_insert_at_cursor:
 * @buffer: a #GtkTextBuffer
 * @text: text in UTF-8 format
 * @len: length of text, in bytes
 *
 * Simply calls __gtk_text_buffer_insert(), using the current
 * cursor position as the insertion point.
 **/
void
__gtk_text_buffer_insert_at_cursor (GtkTextBuffer *buffer,
                                  const gchar   *text,
                                  gint           len)
{
  GtkTextIter iter;
  ...
  __gtk_text_buffer_get_iter_at_mark (buffer, &iter,
 ...
 *
 * Like __gtk_text_buffer_insert(), but the insertion will not occur if
 ...
 * result of __gtk_text_view_get_editable() is appropriate here.
 *
 * Return value: whether text was actually inserted
 **/
gboolean
__gtk_text_buffer_insert_interactive (GtkTextBuffer *buffer,
                                    GtkTextIter   *iter,
                                    const gchar   *text,
                                    gint           len,
                                    gboolean       default_editable)
{
  ...
  g_return_val_if_fail (__gtk_text_iter_get_buffer (iter) == buffer, FALSE);
...
/**
 * __gtk_text_buffer_insert_interactive_at_cursor:
 * @buffer: a #GtkTextBuffer
 * @text: text in UTF-8 format
 * @len: length of text in bytes, or -1
 * @default_editable: default editability of buffer
 *
 * Calls __gtk_text_buffer_insert_interactive() at the cursor
 * position.
 *
 * @default_editable indicates the editability of text that doesn't
 * have a tag affecting editability applied to it. Typically the
 ...
 **/
gboolean
__gtk_text_buffer_insert_interactive_at_cursor (GtkTextBuffer *buffer,
                                              const gchar   *text,
                                              gint           len,
                                              gboolean       default_editable)
{
  ...
  return __gtk_text_buffer_insert_interactive (buffer, &iter, text, len,
                                             default_editable);
}
                   ...
                   gboolean           interactive)
{
  ...
  text = __gtk_text_iter_get_text (orig_start, orig_end);
            ...
            GtkTextIter *whole_end)
{
  ...
  r->buffer = __gtk_text_iter_get_buffer (range_start);
  g_object_ref (r->buffer);
  
  r->start_mark = 
    __gtk_text_buffer_create_mark (__gtk_text_iter_get_buffer (range_start),
                                 NULL,
                                 range_start,
                                 FALSE);
  r->end_mark = 
...
{
  __gtk_text_buffer_get_iter_at_mark (r->buffer,
                                    r->range_start,
                                    r->start_mark);
  ...
  __gtk_text_buffer_delete_mark (r->buffer, r->start_mark);
  __gtk_text_buffer_delete_mark (r->buffer, r->end_mark);
  __gtk_text_buffer_delete_mark (r->buffer, r->whole_end_mark);
  ...
  if (__gtk_text_iter_compare (r->range_start, r->range_end) > 0)
    *r->range_start = *r->range_end;

  if (__gtk_text_iter_compare (r->range_end, r->whole_end) > 0)
                       ...
                       gboolean           interactive)
{
  ...
  if (__gtk_text_iter_equal (orig_start, orig_end))
    return;
  ...
  while (TRUE)
    {
      if (__gtk_text_iter_equal (&range_start, &range_end))
        {
          /* Figure out how to move forward */

          g_assert (__gtk_text_iter_compare (&range_end, &end) <= 0);
          
          if (__gtk_text_iter_equal (&range_end, &end))
            {
              /* nothing left to do */
              break;
            }
          else if (__gtk_text_iter_get_char (&range_end) == GTK_TEXT_UNKNOWN_CHAR)
            {
              GdkPixbuf *pixbuf = NULL;
              GtkTextChildAnchor *anchor = NULL;
              pixbuf = __gtk_text_iter_get_pixbuf (&range_end);
              anchor = __gtk_text_iter_get_child_anchor (&range_end);
              ...
              if (pixbuf)
                {
                  ...
                  __gtk_text_buffer_insert_pixbuf (buffer,
                                                 iter,
                                                 pixbuf);
                  ...
                  __gtk_text_iter_forward_char (&range_end);
              ...
              else
                {
                   ...
                   * keep going. 
                   */
                  __gtk_text_iter_forward_find_char (&range_end,
                              ...
                              gboolean           interactive)
{
  ...
  __gtk_text_iter_order (&start, &end);
  ...
  while (TRUE)
    {
      ...
      if (__gtk_text_iter_equal (&range_start, &end))
        break; /* All done */

      g_assert (__gtk_text_iter_compare (&range_start, &end) < 0);
      
      __gtk_text_iter_forward_to_tag_toggle (&range_end, NULL);

      g_assert (!__gtk_text_iter_equal (&range_start, &range_end));

      /* Clamp to the end iterator */
      if (__gtk_text_iter_compare (&range_end, &end) > 0)
        range_end = end;
      
      /* We have a range with unique tags; insert it, and
       * apply all tags.
       */
      start_offset = __gtk_text_iter_get_offset (iter);
      ...
      tags = __gtk_text_iter_get_tags (&range_start);
      tmp_list = tags;
      while (tmp_list != NULL)
        {
          __gtk_text_buffer_apply_tag (buffer,
                                     tmp_list->data,
                                     &start_iter,
                                     iter);
                                   ...
                                   gboolean           interactive)
{
  ...
  src_buffer = __gtk_text_iter_get_buffer (orig_start);
  
  if (__gtk_text_iter_get_buffer (iter) != src_buffer ||
      !__gtk_text_iter_in_range (iter, orig_start, orig_end))
    {
 ...
 **/
void
__gtk_text_buffer_insert_range (GtkTextBuffer     *buffer,
                              GtkTextIter       *iter,
 ...
 *
 * Same as __gtk_text_buffer_insert_range(), but does nothing if the
 * insertion point isn't editable. The @default_editable parameter
 * indicates whether the text is editable at @iter if no tags
 * enclosing @iter affect editability. Typically the result of
 * __gtk_text_view_get_editable() is appropriate here.
 *
 * Returns: whether an insertion was possible at @iter
 **/
gboolean
__gtk_text_buffer_insert_range_interactive (GtkTextBuffer     *buffer,
                                          GtkTextIter       *iter,
                                          const GtkTextIter *start,
                                          const GtkTextIter *end,
                                          gboolean           default_editable)
 ...
 * terminate the list. Equivalent to calling __gtk_text_buffer_insert(),
 * then __gtk_text_buffer_apply_tag() on the inserted text;
 * __gtk_text_buffer_insert_with_tags() is just a convenience function.
 **/
void
__gtk_text_buffer_insert_with_tags (GtkTextBuffer *buffer,
                                  GtkTextIter   *iter,
                                  const gchar   *text,
                                  gint           len,
                                  ...
                                  ...)
{
  ...
  __gtk_text_buffer_get_iter_at_offset (buffer, &start, start_offset);

  va_start (args, first_tag);
  tag = first_tag;
  while (tag)
    {
      __gtk_text_buffer_apply_tag (buffer, tag, &start, iter);
...
/**
 * __gtk_text_buffer_insert_with_tags_by_name:
 * @buffer: a #GtkTextBuffer
 ...
 *
 * Same as __gtk_text_buffer_insert_with_tags(), but allows you
 * to pass in tag names instead of tag objects.
 **/
void
__gtk_text_buffer_insert_with_tags_by_name  (GtkTextBuffer *buffer,
                                           GtkTextIter   *iter,
                                           const gchar   *text,
                                           gint           len,
...
/**
 * __gtk_text_buffer_delete:
 * @buffer: a #GtkTextBuffer
 * @start: a position in @buffer
 * @end: another position in @buffer
 *
 * Deletes text between @start and @end. The order of @start and @end
 * is not actually relevant; __gtk_text_buffer_delete() will reorder
 ...
 **/
void
__gtk_text_buffer_delete (GtkTextBuffer *buffer,
                        GtkTextIter   *start,
                        GtkTextIter   *end)
{
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
 ...
 * Calls __gtk_text_buffer_delete() for each editable sub-range of
 ...
 **/
gboolean
__gtk_text_buffer_delete_interactive (GtkTextBuffer *buffer,
                                    GtkTextIter   *start_iter,
                                    ...
                                    gboolean       default_editable)
{
  ...
  g_return_val_if_fail (__gtk_text_iter_get_buffer (start_iter) == buffer, FALSE);
  g_return_val_if_fail (__gtk_text_iter_get_buffer (end_iter) == buffer, FALSE);

  
  __gtk_text_buffer_begin_user_action (buffer);
  
  __gtk_text_iter_order (start_iter, end_iter);

  start_mark = __gtk_text_buffer_create_mark (buffer, NULL,
                                            start_iter, TRUE);
  end_mark = __gtk_text_buffer_create_mark (buffer, NULL,
                                          end_iter, FALSE);

  __gtk_text_buffer_get_iter_at_mark (buffer, &iter, start_mark);

  current_state = __gtk_text_iter_editable (&iter, default_editable);
  ...
  while (TRUE)
    {
      ...
      __gtk_text_buffer_get_iter_at_mark (buffer, &end, end_mark);

      if (__gtk_text_iter_compare (&iter, &end) >= 0)
        {
          done = TRUE;
          iter = end; /* clamp to the last boundary */
        }

      new_state = __gtk_text_iter_editable (&iter, default_editable);
              ...
              if (current_state)
                {
                  ...
                  __gtk_text_buffer_get_iter_at_mark (buffer, &start, start_mark);
	  ...
	  current_state = __gtk_text_iter_editable (&iter, default_editable);
      ...
      else
        {
          ...
          __gtk_text_buffer_move_mark (buffer, start_mark, &iter);
  ...
  __gtk_text_buffer_delete_mark (buffer, start_mark);
  __gtk_text_buffer_delete_mark (buffer, end_mark);
 ...
 * __gtk_text_buffer_get_slice().
 *
 * Return value: (transfer full): an allocated UTF-8 string
 **/
gchar*
__gtk_text_buffer_get_text (GtkTextBuffer     *buffer,
                          const GtkTextIter *start,
                          const GtkTextIter *end,
                          gboolean           include_hidden_chars)
{
  ...
  g_return_val_if_fail (__gtk_text_iter_get_buffer (start) == buffer, NULL);
  g_return_val_if_fail (__gtk_text_iter_get_buffer (end) == buffer, NULL);
  
  if (include_hidden_chars)
    return __gtk_text_iter_get_text (start, end);
  else
    return __gtk_text_iter_get_visible_text (start, end);
}
 ...
 * and character indexes into the buffer. Contrast with
 * __gtk_text_buffer_get_text(). Note that 0xFFFC can occur in normal
 ...
 **/
gchar*
__gtk_text_buffer_get_slice (GtkTextBuffer     *buffer,
                           const GtkTextIter *start,
                           const GtkTextIter *end,
                           gboolean           include_hidden_chars)
{
  ...
  if (include_hidden_chars)
    return __gtk_text_iter_get_slice (start, end);
  else
    return __gtk_text_iter_get_visible_slice (start, end);
}
...
/**
 * __gtk_text_buffer_insert_pixbuf:
 * @buffer: a #GtkTextBuffer
 ...
 * not. e.g. see __gtk_text_buffer_get_slice() and
 * __gtk_text_buffer_get_text().
 **/
void
__gtk_text_buffer_insert_pixbuf (GtkTextBuffer *buffer,
                               GtkTextIter   *iter,
                               GdkPixbuf     *pixbuf)
{
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
...
/**
 * __gtk_text_buffer_insert_child_anchor:
 * @buffer: a #GtkTextBuffer
 ...
 * not. E.g. see __gtk_text_buffer_get_slice() and
 * __gtk_text_buffer_get_text(). Consider
 * __gtk_text_buffer_create_child_anchor() as a more convenient
 * alternative to this function. The buffer will add a reference to
 * the anchor, so you can unref it after insertion.
 **/
void
__gtk_text_buffer_insert_child_anchor (GtkTextBuffer      *buffer,
                                     GtkTextIter        *iter,
                                     GtkTextChildAnchor *anchor)
{
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
...
/**
 * __gtk_text_buffer_create_child_anchor:
 * @buffer: a #GtkTextBuffer
 * @iter: location in the buffer
 * 
 * This is a convenience function which simply creates a child anchor
 * with __gtk_text_child_anchor_new() and inserts it into the buffer
 * with __gtk_text_buffer_insert_child_anchor(). The new anchor is
 * owned by the buffer; no reference count is returned to
 * the caller of __gtk_text_buffer_create_child_anchor().
 * 
 * Return value: (transfer none): the created child anchor
 **/
GtkTextChildAnchor*
__gtk_text_buffer_create_child_anchor (GtkTextBuffer *buffer,
                                     GtkTextIter   *iter)
{
  GtkTextChildAnchor *anchor;
  ...
  g_return_val_if_fail (__gtk_text_iter_get_buffer (iter) == buffer, NULL);
  
  anchor = __gtk_text_child_anchor_new ();

  __gtk_text_buffer_insert_child_anchor (buffer, iter, anchor);
 ...
 * __gtk_text_buffer_get_mark(). If a mark has left gravity, and text is
 ...
 **/
GtkTextMark*
__gtk_text_buffer_create_mark (GtkTextBuffer     *buffer,
                             const gchar       *mark_name,
 ...
 **/
void
__gtk_text_buffer_add_mark (GtkTextBuffer     *buffer,
                          GtkTextMark       *mark,
                          const GtkTextIter *where)
{
  const gchar *name;
  ...
  g_return_if_fail (__gtk_text_mark_get_buffer (mark) == NULL);

  name = __gtk_text_mark_get_name (mark);

  if (name != NULL && __gtk_text_buffer_get_mark (buffer, name) != NULL)
    {
 ...
 **/
void
__gtk_text_buffer_move_mark (GtkTextBuffer     *buffer,
                           GtkTextMark       *mark,
                           const GtkTextIter *where)
{
  g_return_if_fail (GTK_IS_TEXT_MARK (mark));
  g_return_if_fail (!__gtk_text_mark_get_deleted (mark));
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
...
/**
 * __gtk_text_buffer_get_iter_at_mark:
 * @buffer: a #GtkTextBuffer
 ...
 **/
void
__gtk_text_buffer_get_iter_at_mark (GtkTextBuffer *buffer,
                                  GtkTextIter   *iter,
                                  GtkTextMark   *mark)
{
  g_return_if_fail (GTK_IS_TEXT_MARK (mark));
 ...
 * __gtk_text_buffer_add_mark(). Use __gtk_text_mark_get_deleted() to  
 * find out if a mark has been removed from its buffer.
 * The "mark-deleted" signal will be emitted as notification after 
 * the mark is deleted.
 **/
void
__gtk_text_buffer_delete_mark (GtkTextBuffer *buffer,
                             GtkTextMark   *mark)
{
  g_return_if_fail (GTK_IS_TEXT_MARK (mark));
  g_return_if_fail (!__gtk_text_mark_get_deleted (mark));
 ...
 **/
GtkTextMark*
__gtk_text_buffer_get_mark (GtkTextBuffer *buffer,
                          const gchar   *name)
{
  GtkTextMark *mark;
...
/**
 * __gtk_text_buffer_move_mark_by_name:
 * @buffer: a #GtkTextBuffer
 * @name: name of a mark
 * @where: new location for mark
 *
 * Moves the mark named @name (which must exist) to location @where.
 * See __gtk_text_buffer_move_mark() for details.
 **/
void
__gtk_text_buffer_move_mark_by_name (GtkTextBuffer     *buffer,
                                   const gchar       *name,
                                   const GtkTextIter *where)
{
  GtkTextMark *mark;
...
/**
 * __gtk_text_buffer_delete_mark_by_name:
 * @buffer: a #GtkTextBuffer
 * @name: name of a mark in @buffer
 *
 * Deletes the mark named @name; the mark must exist. See
 * __gtk_text_buffer_delete_mark() for details.
 **/
void
__gtk_text_buffer_delete_mark_by_name (GtkTextBuffer *buffer,
                                     const gchar   *name)
{
  GtkTextMark *mark;
  ...
  __gtk_text_buffer_delete_mark (buffer, mark);
}

/**
 * __gtk_text_buffer_get_insert:
 * @buffer: a #GtkTextBuffer
 *
 * Returns the mark that represents the cursor (insertion point).
 * Equivalent to calling __gtk_text_buffer_get_mark() to get the mark
 ...
 **/
GtkTextMark*
__gtk_text_buffer_get_insert (GtkTextBuffer *buffer)
{
  g_return_val_if_fail (GTK_IS_TEXT_BUFFER (buffer), NULL);
...
/**
 * __gtk_text_buffer_get_selection_bound:
 * @buffer: a #GtkTextBuffer
 *
 * Returns the mark that represents the selection bound.  Equivalent
 * to calling __gtk_text_buffer_get_mark() to get the mark named
 ...
 * __gtk_text_buffer_get_selection_bounds() is another convenient function
 ...
 **/
GtkTextMark*
__gtk_text_buffer_get_selection_bound (GtkTextBuffer *buffer)
{
  g_return_val_if_fail (GTK_IS_TEXT_BUFFER (buffer), NULL);
...
/**
 * __gtk_text_buffer_get_iter_at_child_anchor:
 * @buffer: a #GtkTextBuffer
 ...
 **/
void
__gtk_text_buffer_get_iter_at_child_anchor (GtkTextBuffer      *buffer,
                                          GtkTextIter        *iter,
                                          GtkTextChildAnchor *anchor)
{
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
  g_return_if_fail (iter != NULL);
  g_return_if_fail (GTK_IS_TEXT_CHILD_ANCHOR (anchor));
  g_return_if_fail (!__gtk_text_child_anchor_get_deleted (anchor));
...
/**
 * __gtk_text_buffer_place_cursor:
 * @buffer: a #GtkTextBuffer
 * @where: where to put the cursor
 *
 * This function moves the "insert" and "selection_bound" marks
 * simultaneously.  If you move them to the same place in two steps
 * with __gtk_text_buffer_move_mark(), you will temporarily select a
 ...
 **/
void
__gtk_text_buffer_place_cursor (GtkTextBuffer     *buffer,
                              const GtkTextIter *where)
{
  __gtk_text_buffer_select_range (buffer, where, where);
}

/**
 * __gtk_text_buffer_select_range:
 * @buffer: a #GtkTextBuffer
 ...
 **/
void
__gtk_text_buffer_select_range (GtkTextBuffer     *buffer,
                              ...
                              const GtkTextIter *bound)
{
  ...
  gtk_text_buffer_mark_set (buffer, &real_bound,
                            __gtk_text_buffer_get_selection_bound (buffer));
}
 ...
 * Equivalent to calling __gtk_text_tag_new() and then adding the
 ...
 */
GtkTextTag*
__gtk_text_buffer_create_tag (GtkTextBuffer *buffer,
                            const gchar   *tag_name,
                            ...
                            ...)
{
  ...
  tag = __gtk_text_tag_new (tag_name);

  __gtk_text_tag_table_add (get_table (buffer), tag);
...
{
  __gtk_text_buffer_set_modified (buffer, TRUE);
}
                               ...
                               GtkTextMark       *mark)
{
  ...
  insert = __gtk_text_buffer_get_insert (buffer);

  if (mark == insert || mark == __gtk_text_buffer_get_selection_bound (buffer))
    {
      gboolean has_selection;

      update_selection_clipboards (buffer);
    
      has_selection = __gtk_text_buffer_get_selection_bounds (buffer,
                                                            NULL,
                                                            NULL);
                          ...
                          const GtkTextIter *end)
{
  ...
  __gtk_text_iter_order (&start_tmp, &end_tmp);
 ...
 **/
void
__gtk_text_buffer_apply_tag (GtkTextBuffer     *buffer,
                           GtkTextTag        *tag,
                           const GtkTextIter *start,
                           const GtkTextIter *end)
{
 ...
 **/
void
__gtk_text_buffer_remove_tag (GtkTextBuffer     *buffer,
                            GtkTextTag        *tag,
                            const GtkTextIter *start,
                            const GtkTextIter *end)
...
/**
 * __gtk_text_buffer_apply_tag_by_name:
 * @buffer: a #GtkTextBuffer
 * @name: name of a named #GtkTextTag
 * @start: one bound of range to be tagged
 * @end: other bound of range to be tagged
 *
 * Calls __gtk_text_tag_table_lookup() on the buffer's tag table to
 * get a #GtkTextTag, then calls __gtk_text_buffer_apply_tag().
 **/
void
__gtk_text_buffer_apply_tag_by_name (GtkTextBuffer     *buffer,
                                   const gchar       *name,
                                   const GtkTextIter *start,
                                   const GtkTextIter *end)
{
  ...
  tag = __gtk_text_tag_table_lookup (get_table (buffer),
                                   name);
...
/**
 * __gtk_text_buffer_remove_tag_by_name:
 * @buffer: a #GtkTextBuffer
 ...
 *
 * Calls __gtk_text_tag_table_lookup() on the buffer's tag table to
 * get a #GtkTextTag, then calls __gtk_text_buffer_remove_tag().
 **/
void
__gtk_text_buffer_remove_tag_by_name (GtkTextBuffer     *buffer,
                                    const gchar       *name,
                                    const GtkTextIter *start,
                                    const GtkTextIter *end)
{
...
/**
 * __gtk_text_buffer_remove_all_tags:
 * @buffer: a #GtkTextBuffer
 * @start: one bound of range to be untagged
 * @end: other bound of range to be untagged
 * 
 ...
 **/
void
__gtk_text_buffer_remove_all_tags (GtkTextBuffer     *buffer,
                                 const GtkTextIter *start,
                                 const GtkTextIter *end)
{
  ...
  __gtk_text_iter_order (&first, &second);

  /* Get all tags turned on at the start */
  tags = __gtk_text_iter_get_tags (&first);
  
  /* Find any that are toggled on within the range */
  tmp = first;
  while (__gtk_text_iter_forward_to_tag_toggle (&tmp, NULL))
    {
      GSList *toggled;
      GSList *tmp_list2;

      if (__gtk_text_iter_compare (&tmp, &second) >= 0)
        break; /* past the end of the range */
      
      toggled = __gtk_text_iter_get_toggled_tags (&tmp, TRUE);
  ...
  while (tmp_list != NULL)
    {
      ...
      __gtk_text_buffer_remove_tag (buffer, tag, &first, &second);
...
/**
 * __gtk_text_buffer_get_iter_at_line_offset:
 * @buffer: a #GtkTextBuffer
 * @iter: (out): iterator to initialize
 ...
 **/
void
__gtk_text_buffer_get_iter_at_line_offset (GtkTextBuffer *buffer,
                                         GtkTextIter   *iter,
                                         gint           line_number,
                                         gint           char_offset)
{
...
/**
 * __gtk_text_buffer_get_iter_at_line_index:
 * @buffer: a #GtkTextBuffer 
 * @iter: (out): iterator to initialize 
 * @line_number: line number counting from 0
 ...
 **/
void
__gtk_text_buffer_get_iter_at_line_index  (GtkTextBuffer *buffer,
                                         GtkTextIter   *iter,
                                         gint           line_number,
                                         gint           byte_index)
{
...
/**
 * __gtk_text_buffer_get_iter_at_line:
 * @buffer: a #GtkTextBuffer 
 * @iter: (out): iterator to initialize
 * @line_number: line number counting from 0
 * 
 ...
 **/
void
__gtk_text_buffer_get_iter_at_line (GtkTextBuffer *buffer,
                                  GtkTextIter   *iter,
                                  gint           line_number)
{
  g_return_if_fail (iter != NULL);
  ...
  __gtk_text_buffer_get_iter_at_line_offset (buffer, iter, line_number, 0);
}

/**
 * __gtk_text_buffer_get_iter_at_offset:
 * @buffer: a #GtkTextBuffer 
 * @iter: (out): iterator to initialize
 ...
 **/
void
__gtk_text_buffer_get_iter_at_offset (GtkTextBuffer *buffer,
                                    GtkTextIter   *iter,
                                    gint           char_offset)
{
  g_return_if_fail (iter != NULL);
...
/**
 * __gtk_text_buffer_get_start_iter:
 * @buffer: a #GtkTextBuffer
 * @iter: (out): iterator to initialize
 *
 * Initialized @iter with the first position in the text buffer. This
 * is the same as using __gtk_text_buffer_get_iter_at_offset() to get
 * the iter at character offset 0.
 **/
void
__gtk_text_buffer_get_start_iter (GtkTextBuffer *buffer,
                                GtkTextIter   *iter)
{
  g_return_if_fail (iter != NULL);
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
...
/**
 * __gtk_text_buffer_get_end_iter:
 * @buffer: a #GtkTextBuffer 
 * @iter: (out): iterator to initialize
 *
 * Initializes @iter with the "end iterator," one past the last valid
 * character in the text buffer. If dereferenced with
 * __gtk_text_iter_get_char(), the end iterator has a character value of
 * 0. The entire buffer lies in the range from the first position in
 * the buffer (call __gtk_text_buffer_get_start_iter() to get
 * character position 0) to the end iterator.
 **/
void
__gtk_text_buffer_get_end_iter (GtkTextBuffer *buffer,
                              GtkTextIter   *iter)
{
  g_return_if_fail (iter != NULL);
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
 ...
 **/
void
__gtk_text_buffer_get_bounds (GtkTextBuffer *buffer,
                            GtkTextIter   *start,
                            GtkTextIter   *end)
{
  g_return_if_fail (start != NULL);
...
/**
 * __gtk_text_buffer_get_modified:
 * @buffer: a #GtkTextBuffer 
 * 
 * Indicates whether the buffer has been modified since the last call
 * to __gtk_text_buffer_set_modified() set the modification flag to
 ...
 **/
gboolean
__gtk_text_buffer_get_modified (GtkTextBuffer *buffer)
{
  g_return_val_if_fail (GTK_IS_TEXT_BUFFER (buffer), FALSE);
 ...
 * __gtk_text_buffer_set_modified (@buffer, FALSE). When the buffer is modified,
 * it will automatically toggled on the modified bit again. When the modified
 * bit flips, the buffer emits a "modified-changed" signal.
 **/
void
__gtk_text_buffer_set_modified (GtkTextBuffer *buffer,
                              gboolean       setting)
{
...
/**
 * __gtk_text_buffer_get_has_selection:
 * @buffer: a #GtkTextBuffer 
 * 
 ...
 **/
gboolean
__gtk_text_buffer_get_has_selection (GtkTextBuffer *buffer)
{
  g_return_val_if_fail (GTK_IS_TEXT_BUFFER (buffer), FALSE);
...
/**
 * __gtk_text_buffer_get_line_count:
 * @buffer: a #GtkTextBuffer 
 * 
 ...
 **/
gint
__gtk_text_buffer_get_line_count (GtkTextBuffer *buffer)
{
...
/**
 * __gtk_text_buffer_get_char_count:
 * @buffer: a #GtkTextBuffer 
 * 
 ...
 **/
gint
__gtk_text_buffer_get_char_count (GtkTextBuffer *buffer)
{
  g_return_val_if_fail (GTK_IS_TEXT_BUFFER (buffer), 0);
                              ...
                              gpointer      data)
{
  ...
  __gtk_text_buffer_get_iter_at_mark (buffer, &insert,
                                    __gtk_text_buffer_get_insert (buffer));
  __gtk_text_buffer_get_iter_at_mark (buffer, &selection_bound,
                                    __gtk_text_buffer_get_selection_bound (buffer));

  if (!__gtk_text_iter_equal (&insert, &selection_bound))
    __gtk_text_buffer_move_mark (buffer,
                               __gtk_text_buffer_get_selection_bound (buffer),
                               &insert);
}
...
create_clipboard_contents_buffer (GtkTextBuffer *buffer)
{
  ...
  contents = __gtk_text_buffer_new (__gtk_text_buffer_get_tag_table (buffer));
                           ...
                           gpointer          data)
{
  ...
  if (info == GTK_TEXT_BUFFER_TARGET_INFO_BUFFER_CONTENTS)
  ...
  else if (info == GTK_TEXT_BUFFER_TARGET_INFO_RICH_TEXT)
    {
      ...
      __gtk_text_buffer_get_bounds (contents, &start, &end);

      str = __gtk_text_buffer_serialize (clipboard_source_buffer, contents,
                                       selection_data->target,
                                       &start, &end, &len);
                 ...
                 gboolean       clear_afterward)
{
  ...
  paste_point_override = __gtk_text_buffer_get_mark (buffer,
                                                   "gtk_paste_point_override");

  if (paste_point_override != NULL)
    {
      __gtk_text_buffer_get_iter_at_mark (buffer, &insert_point,
                                        paste_point_override);
      if (clear_afterward)
        __gtk_text_buffer_delete_mark (buffer, paste_point_override);
    }
  else
    {
      __gtk_text_buffer_get_iter_at_mark (buffer, &insert_point,
  ...
  if (request_data->replace_selection)
    {
      ...
      if (__gtk_text_buffer_get_selection_bounds (request_data->buffer,
                                                &start, &end))
        {
          if (request_data->interactive)
            __gtk_text_buffer_delete_interactive (request_data->buffer,
                                                &start,
                                                &end,
                                                request_data->default_editable);
          else
            __gtk_text_buffer_delete (request_data->buffer, &start, &end);
        }
    }
}
                         ...
                         gpointer      data)
{
  ...
  if (str)
	...
	__gtk_text_buffer_begin_user_action (buffer);
      ...
      if (request_data->interactive) 
	__gtk_text_buffer_insert_interactive (buffer, &insert_point,
					    str, -1, request_data->default_editable);
      else
        __gtk_text_buffer_insert (buffer, &insert_point,
                                str, -1);
                           ...
                           ClipboardRequest *request_data)
{
  ...
  owner = __gdk_selection_owner_get_for_display (selection_data->display,
					       selection_data->selection);

  if (owner == NULL)
    return NULL;
  
  if (__gdk_window_get_window_type (owner) == GDK_WINDOW_FOREIGN)
    return NULL;
  ...
  if (__gtk_text_buffer_get_tag_table (src_buffer) !=
      __gtk_text_buffer_get_tag_table (request_data->buffer))
    return NULL;
...
save_iter (const GtkTextIter *iter,
           gboolean           left_gravity)
{
  return __gtk_text_buffer_create_mark (__gtk_text_iter_get_buffer (iter),
                                      NULL,
                                      iter,
                                      TRUE);
}
...
restore_iter (const GtkTextIter *iter,
              gpointer           save_id)
{
  __gtk_text_buffer_get_iter_at_mark (__gtk_text_mark_get_buffer (save_id),
                                    (GtkTextIter*) iter,
                                    save_id);
  __gtk_text_buffer_delete_mark (__gtk_text_mark_get_buffer (save_id),
                               save_id);
}
#endif
  ...
  if (text != NULL && length > 0)
    {
      ...
      if (request_data->interactive)
        __gtk_text_buffer_begin_user_action (request_data->buffer);

      if (!request_data->interactive ||
          __gtk_text_iter_can_insert (&insert_point,
                                    request_data->default_editable))
        {
          retval = __gtk_text_buffer_deserialize (request_data->buffer,
                                                request_data->buffer,
                                                format,
                                                &insert_point,
                                                text, length,
      ...
      if (request_data->interactive)
        __gtk_text_buffer_end_user_action (request_data->buffer);
                                     ...
                                     gpointer          data)
{
  ...
  if (src_buffer)
	...
	{
	  __gtk_text_buffer_get_bounds (src_buffer, &start, &end);
	...
	{
	  if (__gtk_text_buffer_get_selection_bounds (src_buffer, &start, &end))
	    paste_from_buffer (clipboard, request_data, src_buffer,
			       &start, &end);
	}
    }
    ...
    {
      if (__gtk_clipboard_wait_is_rich_text_available (clipboard,
                                                     request_data->buffer))
        {
          /* Request rich text */
          __gtk_clipboard_request_rich_text (clipboard,
                                           request_data->buffer,
  ...
  while (tmp_list)
    {
      ...
      if (!__gtk_text_buffer_get_selection_bounds (buffer, &start, &end))
	{
	  if (__gtk_clipboard_get_owner (clipboard) == G_OBJECT (buffer))
      ...
      else
	{
	   ...
	   * timestamp.
	   */
	  if (!__gtk_clipboard_set_with_owner (clipboard,
...
/**
 * __gtk_text_buffer_add_selection_clipboard:
 * @buffer: a #GtkTextBuffer
 ...
 **/
void
__gtk_text_buffer_add_selection_clipboard (GtkTextBuffer *buffer,
					 GtkClipboard  *clipboard)
{
...
/**
 * __gtk_text_buffer_remove_selection_clipboard:
 * @buffer: a #GtkTextBuffer
 ...
 **/
void 
__gtk_text_buffer_remove_selection_clipboard (GtkTextBuffer *buffer,
					    GtkClipboard  *clipboard)
{
  SelectionClipboard *selection_clipboard;
...
/**
 * __gtk_text_buffer_paste_clipboard:
 * @buffer: a #GtkTextBuffer
 ...
 **/
void
__gtk_text_buffer_paste_clipboard (GtkTextBuffer *buffer,
				 GtkClipboard  *clipboard,
                                 ...
                                 gboolean       default_editable)
{
  ...
  if (override_location != NULL)
    __gtk_text_buffer_create_mark (buffer,
                                 "gtk_paste_point_override",
  ...
  if (__gtk_text_buffer_get_selection_bounds (buffer, &start, &end) &&
      (__gtk_text_iter_in_range (&paste_point, &start, &end) ||
       __gtk_text_iter_equal (&paste_point, &end)))
    data->replace_selection = TRUE;

  __gtk_clipboard_request_contents (clipboard,
				  __gdk_atom_intern_static_string ("GTK_TEXT_BUFFER_CONTENTS"),
 ...
 **/
gboolean
__gtk_text_buffer_delete_selection (GtkTextBuffer *buffer,
                                  gboolean interactive,
                                  gboolean default_editable)
{
  GtkTextIter start;
  ...
  if (!__gtk_text_buffer_get_selection_bounds (buffer, &start, &end))
    ...
    {
      if (interactive)
        __gtk_text_buffer_delete_interactive (buffer, &start, &end, default_editable);
      else
        __gtk_text_buffer_delete (buffer, &start, &end);
 ...
 **/
gboolean
__gtk_text_buffer_backspace (GtkTextBuffer *buffer,
			   GtkTextIter   *iter,
			   gboolean       interactive,
			   gboolean       default_editable)
{
  ...
  attrs = ______gtk_text_buffer_get_line_log_attrs (buffer, &start, NULL);
  ...
  if (attrs)
    {
      offset = __gtk_text_iter_get_line_offset (&start);
      backspace_deletes_character = attrs[offset].backspace_deletes_character;
    }
  else
    backspace_deletes_character = FALSE;

  __gtk_text_iter_backward_cursor_position (&start);

  if (__gtk_text_iter_equal (&start, &end))
    return FALSE;
    
  cluster_text = __gtk_text_iter_get_text (&start, &end);

  if (interactive)
    __gtk_text_buffer_begin_user_action (buffer);
  
  if (__gtk_text_buffer_delete_interactive (buffer, &start, &end,
					  default_editable))
    {
  ...
  if (!__gtk_text_buffer_get_selection_bounds (buffer, &start, &end))
    {
      ...
      GtkTextMark * anchor = __gtk_text_buffer_get_mark (buffer, "anchor");

      if (anchor == NULL)
        return;
      else
        {
          __gtk_text_buffer_get_iter_at_mark (buffer, &end, anchor);
          __gtk_text_iter_order (&start, &end);
        }
    }
  ...
  if (!__gtk_text_iter_equal (&start, &end))
    {
      ...
      __gtk_text_buffer_get_iter_at_offset (contents, &ins, 0);
      
      __gtk_text_buffer_insert_range (contents, &ins, &start, &end);
                                    
      if (!__gtk_clipboard_set_with_data (clipboard,
                                        priv->copy_target_entries,
                                        priv->n_copy_target_entries,
	...
	__gtk_clipboard_set_can_store (clipboard,
      ...
      if (delete_region_after)
        {
          if (interactive)
            __gtk_text_buffer_delete_interactive (buffer, &start, &end,
                                                default_editable);
          else
            __gtk_text_buffer_delete (buffer, &start, &end);
        }
...
/**
 * __gtk_text_buffer_cut_clipboard:
 * @buffer: a #GtkTextBuffer
 ...
 **/
void
__gtk_text_buffer_cut_clipboard (GtkTextBuffer *buffer,
			       GtkClipboard  *clipboard,
                               gboolean       default_editable)
{
  __gtk_text_buffer_begin_user_action (buffer);
...
/**
 * __gtk_text_buffer_copy_clipboard:
 * @buffer: a #GtkTextBuffer 
 ...
 **/
void
__gtk_text_buffer_copy_clipboard (GtkTextBuffer *buffer,
				GtkClipboard  *clipboard)
{
...
/**
 * __gtk_text_buffer_get_selection_bounds:
 ...
 **/
gboolean
__gtk_text_buffer_get_selection_bounds (GtkTextBuffer *buffer,
                                      GtkTextIter   *start,
                                      GtkTextIter   *end)
{
  g_return_val_if_fail (GTK_IS_TEXT_BUFFER (buffer), FALSE);
 ...
 * call to __gtk_text_buffer_end_user_action() are part of a single
 * user-visible operation. The operations between
 * __gtk_text_buffer_begin_user_action() and
 * __gtk_text_buffer_end_user_action() can then be grouped when creating
 * an undo stack. #GtkTextBuffer maintains a count of calls to
 * __gtk_text_buffer_begin_user_action() that have not been closed with
 * a call to __gtk_text_buffer_end_user_action(), and emits the 
 * "begin-user-action" and "end-user-action" signals only for the 
 * outermost pair of calls. This allows you to build user actions 
 * from other user actions.
 *
 * The "interactive" buffer mutation functions, such as
 * __gtk_text_buffer_insert_interactive(), automatically call begin/end
 * user action around the buffer operations they perform, so there's
 * no need to add extra calls if you user action consists solely of a
 * single call to one of those functions.
 **/
void
__gtk_text_buffer_begin_user_action (GtkTextBuffer *buffer)
{
  g_return_if_fail (GTK_IS_TEXT_BUFFER (buffer));
 ...
 * @buffer: a #GtkTextBuffer
 * 
 * Should be paired with a call to __gtk_text_buffer_begin_user_action().
...
gtk_text_buffer_free_target_lists (GtkTextBuffer *buffer)
{
  ...
  if (priv->copy_target_list)
    {
      __gtk_target_list_unref (priv->copy_target_list);
      priv->copy_target_list = NULL;

      __gtk_target_table_free (priv->copy_target_entries,
                             priv->n_copy_target_entries);
  ...
  if (priv->paste_target_list)
    {
      __gtk_target_list_unref (priv->paste_target_list);
      priv->paste_target_list = NULL;

      __gtk_target_table_free (priv->paste_target_entries,
                                 ...
                                 gint            *n_entries)
{
  ...
  __gtk_target_list_add (target_list,
                       __gdk_atom_intern_static_string ("GTK_TEXT_BUFFER_CONTENTS"),
                       GTK_TARGET_SAME_APP,
                       GTK_TEXT_BUFFER_TARGET_INFO_BUFFER_CONTENTS);

  __gtk_target_list_add_rich_text_targets (target_list,
                                         GTK_TEXT_BUFFER_TARGET_INFO_RICH_TEXT,
                                         deserializable,
                                         buffer);

  __gtk_target_list_add_text_targets (target_list,
                                    GTK_TEXT_BUFFER_TARGET_INFO_TEXT);

  *entries = __gtk_target_table_new_from_list (target_list, n_entries);

  return target_list;
}

/**
 * __gtk_text_buffer_get_copy_target_list:
 * @buffer: a #GtkTextBuffer
 *
 * This function returns the list of targets this text buffer can
 * provide for copying and as DND source. The targets in the list are
 * added with %info values from the #GtkTextBufferTargetInfo enum,
 * using __gtk_target_list_add_rich_text_targets() and
 ...
 **/
GtkTargetList *
__gtk_text_buffer_get_copy_target_list (GtkTextBuffer *buffer)
{
  GtkTextBufferPrivate *priv;
...
/**
 * __gtk_text_buffer_get_paste_target_list:
 * @buffer: a #GtkTextBuffer
 *
 ...
 **/
GtkTargetList *
__gtk_text_buffer_get_paste_target_list (GtkTextBuffer *buffer)
{
  GtkTextBufferPrivate *priv;
                   ...
                   gint              *char_lenp)
{
  ...
  paragraph = __gtk_text_iter_get_slice (&start, &end);
  ...
  pango_get_log_attrs (paragraph, byte_len, -1,
		       __gtk_text_iter_get_language (&start),
                       attrs,
                       char_len + 1);
 ...
 */
const PangoLogAttr*
______gtk_text_buffer_get_line_log_attrs (GtkTextBuffer     *buffer,
                                     ...
                                     gint              *char_len)
{
  ...
  if (__gtk_text_iter_is_end (anywhere_in_line) &&
      __gtk_text_iter_get_line_offset (anywhere_in_line) == 0)
    {
      if (char_len)
        *char_len = 0;
      return NULL;
...
void
______gtk_text_buffer_notify_will_remove_tag (GtkTextBuffer *buffer,
                                         GtkTextTag    *tag)
{
...
void
______gtk_text_buffer_spew (GtkTextBuffer *buffer)
{
