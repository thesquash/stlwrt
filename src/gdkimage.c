 ...
 **/
GdkImage *
__gdk_image_ref (GdkImage *image)
{
 ...
 **/
void
__gdk_image_unref (GdkImage *image)
{
 ...
 * 
 * This is a deprecated wrapper for __gdk_drawable_get_image();
 * __gdk_drawable_get_image() should be used instead. Or even better: in
 * most cases __gdk_pixbuf_get_from_drawable() is the most convenient
 * choice.
 * 
 ...
 **/
void
__gdk_image_set_colormap (GdkImage       *image,
 ...
 **/
GdkColormap *
__gdk_image_get_colormap (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), NULL);
 ...
 **/
GdkImageType
__gdk_image_get_image_type (GdkImage *image)
{
 ...
 **/
GdkVisual *
__gdk_image_get_visual (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), NULL);
 ...
 **/
GdkByteOrder
__gdk_image_get_byte_order (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), 0);
 ...
 **/
gint
__gdk_image_get_width (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), 0);
 ...
 **/
gint
__gdk_image_get_height (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), 0);
 ...
 **/
guint16
__gdk_image_get_depth (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), 0);
...
/**
 * __gdk_image_get_bytes_per_pixel:
 * @image: a #GdkImage
 *
 ...
 **/
guint16
__gdk_image_get_bytes_per_pixel (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), 0);
...
/**
 * __gdk_image_get_bytes_per_line:
 * @image: a #GdkImage
 *
 ...
 **/
guint16
__gdk_image_get_bytes_per_line (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), 0);
...
/**
 * __gdk_image_get_bits_per_pixel:
 * @image: a #GdkImage
 *
 ...
 **/
guint16
__gdk_image_get_bits_per_pixel (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), 0);
 ...
 */
gpointer
__gdk_image_get_pixels (GdkImage *image)
{
  g_return_val_if_fail (GDK_IS_IMAGE (image), NULL);
...
GdkImage*
__gdk_image_new (GdkImageType  type,
	       GdkVisual    *visual,
	       gint          width,
	       gint          height)
{
