...
/* -- type macros --- */
#define GTK_TYPE_SETTINGS             (__gtk_settings_get_type ())
...
typedef struct    _GtkSettingsClass GtkSettingsClassSkinny;
...
/* --- functions --- */
GType		__gtk_settings_get_type		     (void) G_GNUC_CONST;
