...
GType              SF(_T2_gtk_page_setup_get_type)          (void) G_GNUC_CONST;
GType              SF(_3T_gtk_page_setup_get_type)          (void) G_GNUC_CONST;
/* Supplied in the STLWRT public libraries */
GType              SF(gtk_page_setup_get_type)          (void) G_GNUC_CONST;
