...
STLWRT_DEFINE_FTYPE_VPARENT (GtkVRuler, gtk_vruler, GTK_TYPE_RULER, G_TYPE_FLAG_NONE, ;)
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (vruler),
