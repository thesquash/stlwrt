...
gtk_color_selection_dialog_init (GtkColorSelectionDialog *colorseldiag)
{
  ...
  __gtk_window_set_title (GTK_WINDOW (colorseldiag),
                        _("Color Selection"));
...
GtkWidget*
__gtk_color_selection_dialog_new (const gchar *title)
{
  ...
  if (title)
    __gtk_window_set_title (GTK_WINDOW (colorseldiag), title);

  __gtk_window_set_resizable (GTK_WINDOW (colorseldiag), FALSE);
  
  return GTK_WIDGET (colorseldiag);
}

/**
 * __gtk_color_selection_dialog_get_color_selection:
 ...
 **/
GtkWidget*
__gtk_color_selection_dialog_get_color_selection (GtkColorSelectionDialog *colorsel)
{
