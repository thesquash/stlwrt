  ...
  if (GTK_BIN (button)->child && __gtk_widget_get_visible (GTK_BIN (button)->child))
    {
      ...
      __gtk_widget_size_request (GTK_BIN (button)->child, &child_requisition);
			  ...
			  GtkAllocation *allocation)
{
  ...
  if (GTK_BIN (button)->child && __gtk_widget_get_visible (GTK_BIN (button)->child))
      ...
      if (button->depressed)
	{
      ...
      __gtk_widget_size_allocate (GTK_BIN (button)->child, &child_allocation);
    }
}

void
______gtk_button_paint (GtkButton          *button,
  ...
  if (__gtk_widget_is_drawable (widget))
    {
      ...
      ______gtk_button_paint (button, &event->area,
...
/**
 * ______gtk_button_set_depressed:
 * @button: a #GtkButton
 ...
 **/
void
______gtk_button_set_depressed (GtkButton *button,
			   gboolean   depressed)
{
  GtkWidget *widget = GTK_WIDGET (button);
...
gtk_button_update_state (GtkButton *button)
{
  ...
  ______gtk_button_set_depressed (button, depressed); 
