                                     ...
                                     guint           n_chars)
{
  ...
  __gtk_entry_buffer_emit_inserted_text (buffer, position, chars, n_chars);
  return n_chars;
}
  ...
  if (n_chars > 0)
    {
      ...
      __gtk_entry_buffer_emit_deleted_text (buffer, position, n_chars);
    }
                               ...
                               GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_TEXT:
      __gtk_entry_buffer_set_text (buffer, g_value_get_string (value), -1);
      break;
    case PROP_MAX_LENGTH:
      __gtk_entry_buffer_set_max_length (buffer, g_value_get_int (value));
      break;
    default:
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_TEXT:
      g_value_set_string (value, __gtk_entry_buffer_get_text (buffer));
      break;
    case PROP_LENGTH:
      g_value_set_uint (value, __gtk_entry_buffer_get_length (buffer));
      break;
    case PROP_MAX_LENGTH:
      g_value_set_int (value, __gtk_entry_buffer_get_max_length (buffer));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (obj, prop_id, pspec);
      break;
 ...
 **/
GtkEntryBuffer*
__gtk_entry_buffer_new (const gchar *initial_chars,
                      gint         n_initial_chars)
{
  GtkEntryBuffer *buffer = g_object_new (GTK_TYPE_ENTRY_BUFFER, NULL);
  if (initial_chars)
    __gtk_entry_buffer_set_text (buffer, initial_chars, n_initial_chars);
  return buffer;
}

/**
 * __gtk_entry_buffer_get_length:
 * @buffer: a #GtkEntryBuffer
 *
 ...
 **/
guint
__gtk_entry_buffer_get_length (GtkEntryBuffer *buffer)
{
...
/**
 * __gtk_entry_buffer_get_bytes:
 * @buffer: a #GtkEntryBuffer
 *
 * Retrieves the length in bytes of the buffer.
 * See __gtk_entry_buffer_get_length().
 *
 ...
 **/
gsize
__gtk_entry_buffer_get_bytes (GtkEntryBuffer *buffer)
{
  GtkEntryBufferClass *klass;
  gsize bytes = 0;
 ...
 **/
const gchar*
__gtk_entry_buffer_get_text (GtkEntryBuffer *buffer)
{
  GtkEntryBufferClass *klass;
 ...
 *
 * This is roughly equivalent to calling __gtk_entry_buffer_delete_text()
 * and __gtk_entry_buffer_insert_text().
 *
 ...
 **/
void
__gtk_entry_buffer_set_text (GtkEntryBuffer *buffer,
                           const gchar    *chars,
                           gint            n_chars)
{
  ...
  __gtk_entry_buffer_delete_text (buffer, 0, -1);
  __gtk_entry_buffer_insert_text (buffer, 0, chars, n_chars);
  g_object_thaw_notify (G_OBJECT (buffer));
}

/**
 * __gtk_entry_buffer_set_max_length:
 * @buffer: a #GtkEntryBuffer
 ...
 **/
void
__gtk_entry_buffer_set_max_length (GtkEntryBuffer *buffer,
                                 gint            max_length)
{
  g_return_if_fail (GTK_IS_ENTRY_BUFFER (buffer));
  ...
  if (max_length > 0 && __gtk_entry_buffer_get_length (buffer) > max_length)
    __gtk_entry_buffer_delete_text (buffer, max_length, -1);
...
/**
 * __gtk_entry_buffer_get_max_length:
 * @buffer: a #GtkEntryBuffer
 *
 * Retrieves the maximum allowed length of the text in
 * @buffer. See __gtk_entry_buffer_set_max_length().
 *
 ...
 */
gint
__gtk_entry_buffer_get_max_length (GtkEntryBuffer *buffer)
{
  g_return_val_if_fail (GTK_IS_ENTRY_BUFFER (buffer), 0);
...
/**
 * __gtk_entry_buffer_insert_text:
 * @buffer: a #GtkEntryBuffer
 ...
 */
guint
__gtk_entry_buffer_insert_text (GtkEntryBuffer *buffer,
                              guint           position,
                              const gchar    *chars,
                              gint            n_chars)
{
  ...
  length = __gtk_entry_buffer_get_length (buffer);
  pv = buffer->priv;
...
/**
 * __gtk_entry_buffer_delete_text:
 * @buffer: a #GtkEntryBuffer
 ...
 */
guint
__gtk_entry_buffer_delete_text (GtkEntryBuffer *buffer,
                              guint           position,
                              gint            n_chars)
{
  GtkEntryBufferClass *klass;
...
/**
 * __gtk_entry_buffer_emit_inserted_text:
 * @buffer: a #GtkEntryBuffer
 ...
 */
void
__gtk_entry_buffer_emit_inserted_text (GtkEntryBuffer *buffer,
                                     guint           position,
                                     const gchar    *chars,
                                     guint           n_chars)
{
...
/**
 * __gtk_entry_buffer_emit_deleted_text:
 * @buffer: a #GtkEntryBuffer
 ...
 */
void
__gtk_entry_buffer_emit_deleted_text (GtkEntryBuffer *buffer,
                                    guint           position,
                                    guint           n_chars)
{
  g_return_if_fail (GTK_IS_ENTRY_BUFFER (buffer));
