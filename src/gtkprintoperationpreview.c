  ...
  if (!initialized)
    {
       ...
       * context, using __gtk_print_context_set_cairo_context().
       */
...
/**
 * __gtk_print_operation_preview_render_page:
 ...
 */
void    
__gtk_print_operation_preview_render_page (GtkPrintOperationPreview *preview,
					 gint			   page_nr)
{
...
/**
 * __gtk_print_operation_preview_end_preview:
 * @preview: a #GtkPrintOperationPreview
 *
 * Ends a preview. 
 *
 ...
 */
void
__gtk_print_operation_preview_end_preview (GtkPrintOperationPreview *preview)
{
  g_return_if_fail (GTK_IS_PRINT_OPERATION_PREVIEW (preview));
...
/**
 * __gtk_print_operation_preview_is_selected:
 * @preview: a #GtkPrintOperationPreview
 ...
 */
gboolean
__gtk_print_operation_preview_is_selected (GtkPrintOperationPreview *preview,
					 gint                      page_nr)
{
