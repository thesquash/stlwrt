...
STLWRT_DEFINE_FTYPE_VPARENT (GtkRadioToolButton, gtk_radio_tool_button, GTK_TYPE_TOGGLE_TOOL_BUTTON,
                             G_TYPE_FLAG_NONE, ;)
...
gtk_radio_tool_button_init (GtkRadioToolButton *button)
{
  ...
  __gtk_toggle_button_set_mode (GTK_TOGGLE_BUTTON (___gtk_tool_button_get_button (tool_button)), FALSE);
}
	...
	if (G_VALUE_HOLDS_OBJECT (value)) 
	  {
	    ...
	    if (arg)
	      slist = __gtk_radio_tool_button_get_group (arg);
	    __gtk_radio_tool_button_set_group (button, slist);
	  }
      }
      break;
    default:
 ...
 **/
GtkToolItem *
__gtk_radio_tool_button_new (GSList *group)
{
  GtkRadioToolButton *button;
  ...
  __gtk_radio_tool_button_set_group (button, group);
  
  return GTK_TOOL_ITEM (button);
}

/**
 * __gtk_radio_tool_button_new_from_stock:
 * @group: (allow-none): an existing radio button group, or %NULL if you are creating a new group
 ...
 **/
GtkToolItem *
__gtk_radio_tool_button_new_from_stock (GSList      *group,
...
/**
 * __gtk_radio_tool_button_new_from_widget:
 ...
 **/
GtkToolItem *
__gtk_radio_tool_button_new_from_widget (GtkRadioToolButton *group)
{
  GSList *list = NULL;
  ...
  if (group)
    list = __gtk_radio_tool_button_get_group (GTK_RADIO_TOOL_BUTTON (group));
  
  return __gtk_radio_tool_button_new (list);
}

/**
 * __gtk_radio_tool_button_new_with_stock_from_widget:
 * @group: An existing #GtkRadioToolButton.
 * @stock_id: the name of a stock item
 *
 ...
 **/
GtkToolItem *
__gtk_radio_tool_button_new_with_stock_from_widget (GtkRadioToolButton *group,
						  const gchar        *stock_id)
{
  GSList *list = NULL;
  ...
  if (group)
    list = __gtk_radio_tool_button_get_group (group);
  
  return __gtk_radio_tool_button_new_from_stock (list, stock_id);
}

static GtkRadioButton *
get_radio_button (GtkRadioToolButton *button)
{
  return GTK_RADIO_BUTTON (___gtk_tool_button_get_button (GTK_TOOL_BUTTON (button)));
}

/**
 * __gtk_radio_tool_button_get_group:
 ...
 */
GSList *
__gtk_radio_tool_button_get_group (GtkRadioToolButton *button)
{
  g_return_val_if_fail (GTK_IS_RADIO_TOOL_BUTTON (button), NULL);

  return __gtk_radio_button_get_group (get_radio_button (button));
}

/**
 * __gtk_radio_tool_button_set_group:
 * @button: a #GtkRadioToolButton
 ...
 **/
void
__gtk_radio_tool_button_set_group (GtkRadioToolButton *button,
				 GSList             *group)
{
