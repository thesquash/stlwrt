...
typedef struct _GtkSpinButtonClass  GtkSpinButtonClassThin;
...
GType		_T2_gtk_spin_button_get_type	   (void) G_GNUC_CONST;
GType		_3T_gtk_spin_button_get_type	   (void) G_GNUC_CONST;
