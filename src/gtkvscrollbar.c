...
STLWRT_DEFINE_FTYPE_VPARENT (GtkVScrollbar, gtk_vscrollbar, GTK_TYPE_SCROLLBAR, G_TYPE_FLAG_NONE, ;)
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (vscrollbar),
                                  GTK_ORIENTATION_VERTICAL);
}

/**
 * __gtk_vscrollbar_new:
 ...
 */
GtkWidget *
__gtk_vscrollbar_new (GtkAdjustment *adjustment)
{
