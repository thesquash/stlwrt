 ...
 **/
guint32
__gdk_keyval_to_unicode (guint keyval)
{
  int min = 0;
  ...
  if (keyval == 0xffae)
    {
      GdkWin32Keymap *keymap = GDK_WIN32_KEYMAP (__gdk_keymap_get_default ());
 ...
 **/
guint
__gdk_unicode_to_keyval (guint32 wc)
{
  int min = 0;
