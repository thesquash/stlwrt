...
void
______gtk_button_box_child_requisition (GtkWidget *widget,
                                   int       *nvis_children,
...
gtk_button_box_kludge_get_layout_default (GtkButtonBox *widget)
{
  ...
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
    return ______gtk_hbutton_box_get_layout_default ();
  else
    return ______gtk_vbutton_box_get_layout_default ();
}
                             ...
                             GtkRequisition *requisition)
{
  ...
  ______gtk_button_box_child_requisition (widget,
                                     &nvis_children,
				     NULL,
                                     &child_width,
                                     &child_height);
