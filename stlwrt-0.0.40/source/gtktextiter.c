 ...
 **/
GtkTextBuffer*
__gtk_text_iter_get_buffer (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
 ...
 *
 * Return value: a copy of the @iter, free with __gtk_text_iter_free ()
 **/
GtkTextIter*
__gtk_text_iter_copy (const GtkTextIter *iter)
{
 ...
 **/
void
__gtk_text_iter_free (GtkTextIter *iter)
{
...
gtk_text_iter_get_type (void)
{
  ...
  if (our_type == 0)
    our_type = g_boxed_type_register_static (I_("GtkTextIter"),
					     (GBoxedCopyFunc) __gtk_text_iter_copy,
					     (GBoxedFreeFunc) __gtk_text_iter_free);
...
/* This function does not require a still-valid
   iterator */
GtkTextLine*
___gtk_text_iter_get_text_line (const GtkTextIter *iter)
{
...
/**
 * __gtk_text_iter_get_offset:
 * @iter: an iterator
 *
 * Returns the character offset of an iterator.
 * Each character in a #GtkTextBuffer has an offset,
 * starting with 0 for the first character in the buffer.
 * Use __gtk_text_buffer_get_iter_at_offset () to convert an
 * offset back into an iterator.
 *
 * Return value: a character offset
 **/
gint
__gtk_text_iter_get_offset (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
 ...
 **/
gint
__gtk_text_iter_get_line (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
...
/**
 * __gtk_text_iter_get_line_offset:
 * @iter: an iterator
 *
 ...
 **/
gint
__gtk_text_iter_get_line_offset (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
...
/**
 * __gtk_text_iter_get_line_index:
 * @iter: an iterator
 *
 ...
 **/
gint
__gtk_text_iter_get_line_index (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
...
/**
 * __gtk_text_iter_get_visible_line_offset:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gint
__gtk_text_iter_get_visible_line_offset (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
  gint vis_offset;
  GtkTextLineSegment *seg;
...
/**
 * __gtk_text_iter_get_visible_line_index:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gint
__gtk_text_iter_get_visible_line_index (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
  gint vis_offset;
  GtkTextLineSegment *seg;
 ...
 * So you can write a loop which ends when __gtk_text_iter_get_char ()
 * returns 0.
 *
 * Return value: a Unicode character, or 0 if @iter is not dereferenceable
 **/
gunichar
__gtk_text_iter_get_char (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
  ...
  if (__gtk_text_iter_is_end (iter))
    return 0;
 ...
 **/
gchar*
__gtk_text_iter_get_slice       (const GtkTextIter *start,
 ...
 **/
gchar*
__gtk_text_iter_get_text       (const GtkTextIter *start,
                              const GtkTextIter *end)
{
  g_return_val_if_fail (start != NULL, NULL);
  g_return_val_if_fail (end != NULL, NULL);
...
/**
 * __gtk_text_iter_get_visible_slice:
 * @start: iterator at start of range
 * @end: iterator at end of range
 *
 * Like __gtk_text_iter_get_slice (), but invisible text is not included.
 ...
 **/
gchar*
__gtk_text_iter_get_visible_slice (const GtkTextIter  *start,
                                 const GtkTextIter  *end)
{
  g_return_val_if_fail (start != NULL, NULL);
  g_return_val_if_fail (end != NULL, NULL);
...
/**
 * __gtk_text_iter_get_visible_text:
 * @start: iterator at start of range
 * @end: iterator at end of range
 *
 * Like __gtk_text_iter_get_text (), but invisible text is not included.
 * Invisible text is usually invisible because a #GtkTextTag with the
 * "invisible" attribute turned on has been applied to it.
 *
 ...
 **/
gchar*
__gtk_text_iter_get_visible_text (const GtkTextIter  *start,
                                const GtkTextIter  *end)
{
  g_return_val_if_fail (start != NULL, NULL);
  g_return_val_if_fail (end != NULL, NULL);
 ...
 **/
GdkPixbuf*
__gtk_text_iter_get_pixbuf (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
...
/**
 * __gtk_text_iter_get_child_anchor:
 * @iter: an iterator
 *
 ...
 **/
GtkTextChildAnchor*
__gtk_text_iter_get_child_anchor (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
 ...
 **/
GSList*
__gtk_text_iter_get_marks (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
  GtkTextLineSegment *seg;
  GSList *retval;
...
/**
 * __gtk_text_iter_get_toggled_tags:
 * @iter: an iterator
 ...
 **/
GSList*
__gtk_text_iter_get_toggled_tags  (const GtkTextIter  *iter,
                                 gboolean            toggled_on)
{
  GtkTextRealIter *real;
  GtkTextLineSegment *seg;
...
/**
 * __gtk_text_iter_ends_tag:
 * @iter: an iterator
 * @tag: (allow-none): a #GtkTextTag, or %NULL
 *
 * Returns %TRUE if @tag is toggled off at exactly this point. If @tag
 * is %NULL, returns %TRUE if any tag is toggled off at this point. Note
 * that the __gtk_text_iter_ends_tag () returns %TRUE if @iter is the
 ...
 **/
gboolean
__gtk_text_iter_ends_tag   (const GtkTextIter  *iter,
                          GtkTextTag         *tag)
{
  GtkTextRealIter *real;
  GtkTextLineSegment *seg;
...
/**
 * __gtk_text_iter_toggles_tag:
 * @iter: an iterator
 * @tag: (allow-none): a #GtkTextTag, or %NULL
 *
 * This is equivalent to (__gtk_text_iter_begins_tag () ||
 * __gtk_text_iter_ends_tag ()), i.e. it tells you whether a range with
 * @tag applied to it begins <emphasis>or</emphasis> ends at @iter.
 *
 * Return value: whether @tag is toggled on or off at @iter
 **/
gboolean
__gtk_text_iter_toggles_tag (const GtkTextIter  *iter,
                           GtkTextTag         *tag)
{
  GtkTextRealIter *real;
  GtkTextLineSegment *seg;
 ...
 **/
gboolean
__gtk_text_iter_has_tag (const GtkTextIter   *iter,
                       GtkTextTag          *tag)
{
  GtkTextRealIter *real;
 ...
 **/
GSList*
__gtk_text_iter_get_tags (const GtkTextIter *iter)
{
  GtkTextTag** tags;
  gint tag_count = 0;
  gint i;
 ...
 * wrapper around __gtk_text_iter_get_attributes (). If no tags applied
 ...
 * editable range. Use __gtk_text_iter_can_insert() to handle this
 * case.
 * 
 * Return value: whether @iter is inside an editable range
 **/
gboolean
__gtk_text_iter_editable (const GtkTextIter *iter,
                        gboolean           default_setting)
{
  ...
  values = __gtk_text_attributes_new ();

  values->editable = default_setting;

  __gtk_text_iter_get_attributes (iter, values);

  retval = values->editable;

  __gtk_text_attributes_unref (values);

  return retval;
}

/**
 * __gtk_text_iter_can_insert:
 * @iter: an iterator
 ...
 * __gtk_text_buffer_insert_interactive() uses this function to decide
 * whether insertions are allowed at a given position.
 * 
 * Return value: whether text inserted at @iter would be editable
 **/
gboolean
__gtk_text_iter_can_insert (const GtkTextIter *iter,
                          gboolean           default_editability)
{
  ...
  /* If at start/end of buffer, default editability is used */
  else if ((__gtk_text_iter_is_start (iter) ||
  ...
  else
    {
      ...
      __gtk_text_iter_backward_char (&prev);
      return __gtk_text_iter_editable (&prev, default_editability);
    }
}


/**
 * __gtk_text_iter_get_language:
 * @iter: an iterator
 *
 * A convenience wrapper around __gtk_text_iter_get_attributes (),
 ...
 **/
PangoLanguage *
__gtk_text_iter_get_language (const GtkTextIter *iter)
{
  GtkTextAttributes *values;
...
/**
 * __gtk_text_iter_starts_line:
 * @iter: an iterator
 *
 * Returns %TRUE if @iter begins a paragraph,
 * i.e. if __gtk_text_iter_get_line_offset () would return 0.
 * However this function is potentially more efficient than
 * __gtk_text_iter_get_line_offset () because it doesn't have to compute
 * the offset, it just has to see whether it's 0.
 *
 * Return value: whether @iter begins a line
 **/
gboolean
__gtk_text_iter_starts_line (const GtkTextIter   *iter)
{
  GtkTextRealIter *real;
 ...
 **/
gboolean
__gtk_text_iter_ends_line (const GtkTextIter   *iter)
{
  gunichar wc;
...
#define PARAGRAPH_SEPARATOR 0x2029
  ...
  wc = __gtk_text_iter_get_char (iter);
  ...
  if (wc == '\r' || wc == PARAGRAPH_SEPARATOR || wc == 0) /* wc == 0 is end iterator */
  ...
  else if (wc == '\n')
    {
      ...
      if (__gtk_text_iter_get_line_offset (&tmp) == 0)
        return TRUE;

      if (!__gtk_text_iter_backward_char (&tmp))
        return TRUE;

      return __gtk_text_iter_get_char (&tmp) != '\r';
    }
  else
    return FALSE;
}
...
/**
 * __gtk_text_iter_is_end:
 * @iter: an iterator
 *
 * Returns %TRUE if @iter is the end iterator, i.e. one past the last
 * dereferenceable iterator in the buffer. __gtk_text_iter_is_end () is
 ...
 **/
gboolean
__gtk_text_iter_is_end (const GtkTextIter *iter)
{
  GtkTextRealIter *real;
 ...
 **/
gboolean
__gtk_text_iter_is_start (const GtkTextIter *iter)
{
  return __gtk_text_iter_get_offset (iter) == 0;
}

/**
 * __gtk_text_iter_get_chars_in_line:
 * @iter: an iterator
 *
 ...
 **/
gint
__gtk_text_iter_get_chars_in_line (const GtkTextIter   *iter)
{
  GtkTextRealIter *real;
  gint count;
  GtkTextLineSegment *seg;
...
/**
 * __gtk_text_iter_get_bytes_in_line:
 * @iter: an iterator
 *
 ...
 **/
gint
__gtk_text_iter_get_bytes_in_line (const GtkTextIter   *iter)
{
  GtkTextRealIter *real;
  gint count;
  GtkTextLineSegment *seg;
...
/**
 * __gtk_text_iter_get_attributes:
 * @iter: an iterator
 ...
 * obtain the defaults from __gtk_text_view_get_default_attributes().
 *
 * __gtk_text_iter_get_attributes () will modify @values, applying the
 ...
 **/
gboolean
__gtk_text_iter_get_attributes (const GtkTextIter  *iter,
                              GtkTextAttributes  *values)
{
  GtkTextTag** tags;
  gint tag_count = 0;
...
forward_char (GtkTextRealIter *real)
{
  ...
  if ( (real->segment_char_offset + 1) == real->segment->char_count)
  ...
  else
    {
      ...
      if (__gtk_text_iter_is_end ((GtkTextIter*)real))
        return FALSE;
      else
        return TRUE;
    }
  ...
  if (seg != NULL)
    {
      ...
      return !__gtk_text_iter_is_end (iter);
    }
  else
    {
      /* End of the line */
      if (forward_line_leaving_caches_unmodified (real))
        {
          ...
          g_assert (__gtk_text_iter_starts_line (iter));
      ...
      else
        {
          ...
          g_assert (__gtk_text_iter_is_end (iter));
  ...
  if (seg == real->segment)
    {
       ...
       */
      if (__gtk_text_iter_backward_line (iter))
        {
...
/**
 * __gtk_text_iter_forward_char:
 * @iter: an iterator
 *
 * Moves @iter forward by one character offset. Note that images
 * embedded in the buffer occupy 1 character slot, so
 * __gtk_text_iter_forward_char () may actually move onto an image instead
 * of a character, if you have images in your buffer.  If @iter is the
 * end iterator or one character before it, @iter will now point at
 * the end iterator, and __gtk_text_iter_forward_char () returns %FALSE for
 * convenience when writing loops.
 *
 * Return value: whether @iter moved and is dereferenceable
 **/
gboolean
__gtk_text_iter_forward_char (GtkTextIter *iter)
{
  GtkTextRealIter *real;
...
/**
 * __gtk_text_iter_backward_char:
 * @iter: an iterator
 *
 * Moves backward by one character offset. Returns %TRUE if movement
 * was possible; if @iter was the first in the buffer (character
 * offset 0), __gtk_text_iter_backward_char () returns %FALSE for convenience when
 * writing loops.
 *
 * Return value: whether movement was possible
 **/
gboolean
__gtk_text_iter_backward_char (GtkTextIter *iter)
{
  g_return_val_if_fail (iter != NULL, FALSE);

  check_invariants (iter);

  return __gtk_text_iter_backward_chars (iter, 1);
}
 ...
 **/
gboolean
__gtk_text_iter_forward_chars (GtkTextIter *iter, gint count)
{
  GtkTextRealIter *real;
  ...
  if (real == NULL)
    ...
    return __gtk_text_iter_backward_chars (iter, 0 - count);
  ...
  else
    {
      ...
      current_char_index = __gtk_text_iter_get_offset (iter);
      ...
      __gtk_text_iter_set_offset (iter, new_char_index);
...
/**
 * __gtk_text_iter_backward_chars:
 * @iter: an iterator
 ...
 **/
gboolean
__gtk_text_iter_backward_chars (GtkTextIter *iter, gint count)
{
  GtkTextRealIter *real;
  ...
  if (real == NULL)
    ...
    return __gtk_text_iter_forward_chars (iter, 0 - count);
 ...
 * through the results of __gtk_text_iter_get_text (), rather than
 * __gtk_text_iter_get_slice ().
 *
 * Return value: whether @iter moved and is dereferenceable
 **/
 ...
 **/
gboolean
__gtk_text_iter_forward_line (GtkTextIter *iter)
{
  GtkTextRealIter *real;
  ...
  if (forward_line_leaving_caches_unmodified (real))
  ...
  else
    {
      ...
      if (!__gtk_text_iter_is_end (iter))
        __gtk_text_iter_forward_to_end (iter);
 ...
 **/
gboolean
__gtk_text_iter_backward_line (GtkTextIter *iter)
{
  GtkTextLine *new_line;
  GtkTextRealIter *real;
 ...
 **/
gboolean
__gtk_text_iter_forward_lines (GtkTextIter *iter, gint count)
{
  FIX_OVERFLOWS (count);
  
  if (count < 0)
    return __gtk_text_iter_backward_lines (iter, 0 - count);
  else if (count == 0)
    return FALSE;
  else if (count == 1)
    {
      check_invariants (iter);
      return __gtk_text_iter_forward_line (iter);
    }
  else
    {
      gint old_line;
      ...
      old_line = __gtk_text_iter_get_line (iter);

      __gtk_text_iter_set_line (iter, old_line + count);

      if ((__gtk_text_iter_get_line (iter) - old_line) < count)
        {
...
/**
 * __gtk_text_iter_backward_lines:
 * @iter: a #GtkTextIter
 ...
 **/
gboolean
__gtk_text_iter_backward_lines (GtkTextIter *iter, gint count)
{
  FIX_OVERFLOWS (count);
  
  if (count < 0)
    return __gtk_text_iter_forward_lines (iter, 0 - count);
  else if (count == 0)
    return FALSE;
  else if (count == 1)
    {
      return __gtk_text_iter_backward_line (iter);
    }
  else
    {
      gint old_line;
      ...
      __gtk_text_iter_set_line (iter, MAX (old_line - count, 0));

      return (__gtk_text_iter_get_line (iter) != old_line);
    }
}

/**
 * __gtk_text_iter_forward_visible_line:
 * @iter: an iterator
 *
 ...
 **/
gboolean
__gtk_text_iter_forward_visible_line (GtkTextIter *iter)
{
  while (__gtk_text_iter_forward_line (iter))
    {
      if (!_gtk_text_btree_char_is_invisible (iter))
      ...
      else
        {
          do
            {
              if (!__gtk_text_iter_forward_char (iter))
                return FALSE;
          
              if (!_gtk_text_btree_char_is_invisible (iter))
                return TRUE;
            }
          while (!__gtk_text_iter_ends_line (iter));
        }
    }
...
/**
 * __gtk_text_iter_backward_visible_line:
 * @iter: an iterator
 *
 ...
 **/
gboolean
__gtk_text_iter_backward_visible_line (GtkTextIter *iter)
{
  while (__gtk_text_iter_backward_line (iter))
    {
      if (!_gtk_text_btree_char_is_invisible (iter))
        return TRUE;
      else
        {
          do
            {
              if (!__gtk_text_iter_backward_char (iter))
                return FALSE;
          
              if (!_gtk_text_btree_char_is_invisible (iter))
                return TRUE;
            }
          while (!__gtk_text_iter_starts_line (iter));
        }
    }
...
/**
 * __gtk_text_iter_forward_visible_lines:
 * @iter: a #GtkTextIter
 * @count: number of lines to move forward
 *
 ...
 **/
gboolean
__gtk_text_iter_forward_visible_lines (GtkTextIter *iter,
                                     gint         count)
{
  FIX_OVERFLOWS (count);
  
  if (count < 0)
    return __gtk_text_iter_backward_visible_lines (iter, 0 - count);
  else if (count == 0)
    return FALSE;
  else if (count == 1)
    {
      check_invariants (iter);
      return __gtk_text_iter_forward_visible_line (iter);
    }
  else
    {
      while (__gtk_text_iter_forward_visible_line (iter) && count > 0)
        count--;
      return count == 0;
    }    
}
...
/**
 * __gtk_text_iter_backward_visible_lines:
 * @iter: a #GtkTextIter
 * @count: number of lines to move backward
 *
 ...
 **/
gboolean
__gtk_text_iter_backward_visible_lines (GtkTextIter *iter,
                                      gint         count)
{
  FIX_OVERFLOWS (count);
  
  if (count < 0)
    return __gtk_text_iter_forward_visible_lines (iter, 0 - count);
  else if (count == 0)
    return FALSE;
  else if (count == 1)
    {
      return __gtk_text_iter_backward_visible_line (iter);
    }
  else
    {
      while (__gtk_text_iter_backward_visible_line (iter) && count > 0)
        count--;
      return count == 0;
    }
}
                ...
                TestLogAttrFunc    func)
{
  ...
  attrs = ______gtk_text_buffer_get_line_log_attrs (__gtk_text_iter_get_buffer (iter),
                                               iter, &char_len);

  offset = __gtk_text_iter_get_line_offset (iter);
  ...
  if (!found)
    {
      if (forward)
        {
          if (__gtk_text_iter_forward_line (iter))
        ...
        {                    
           ...
           */
          if (__gtk_text_iter_get_line (iter) > 0 && 
              __gtk_text_iter_backward_line (iter))
            {
    ...
    {      
      __gtk_text_iter_set_line_offset (iter, offset);

      return
        (already_moved_initially || !__gtk_text_iter_equal (iter, &orig)) &&
        !__gtk_text_iter_is_end (iter);
    }
}
...
/**
 * __gtk_text_iter_forward_word_end:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_forward_word_end (GtkTextIter *iter)
{
  return find_by_log_attrs (iter, find_word_end_func, TRUE, FALSE);
}

/**
 * __gtk_text_iter_backward_word_start:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_backward_word_start (GtkTextIter      *iter)
{
...
/**
 * __gtk_text_iter_forward_word_ends:
 * @iter: a #GtkTextIter
 * @count: number of times to move
 * 
 * Calls __gtk_text_iter_forward_word_end() up to @count times.
 *
 * Return value: %TRUE if @iter moved and is not the end iterator 
 **/
gboolean
__gtk_text_iter_forward_word_ends (GtkTextIter      *iter,
                                 gint              count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_forward_word_end,
			      __gtk_text_iter_backward_word_starts);
}
 ...
 * @count: number of times to move
 * 
 * Calls __gtk_text_iter_backward_word_start() up to @count times.
 *
 * Return value: %TRUE if @iter moved and is not the end iterator 
 **/
gboolean
__gtk_text_iter_backward_word_starts (GtkTextIter      *iter,
                                    gint               count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_backward_word_start,
...
/**
 * __gtk_text_iter_forward_visible_word_end:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_forward_visible_word_end (GtkTextIter *iter)
{
  return find_visible_by_log_attrs (iter, find_word_end_func, TRUE, FALSE);
}

/**
 * __gtk_text_iter_backward_visible_word_start:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_backward_visible_word_start (GtkTextIter      *iter)
{
  return find_visible_by_log_attrs (iter, find_word_start_func, FALSE, FALSE);
}

/**
 * __gtk_text_iter_forward_visible_word_ends:
 * @iter: a #GtkTextIter
 * @count: number of times to move
 * 
 * Calls __gtk_text_iter_forward_visible_word_end() up to @count times.
 *
 * Return value: %TRUE if @iter moved and is not the end iterator 
 *
 * Since: 2.4
 **/
gboolean
__gtk_text_iter_forward_visible_word_ends (GtkTextIter *iter,
					 gint         count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_forward_visible_word_end,
			      __gtk_text_iter_backward_visible_word_starts);
}
 ...
 * @count: number of times to move
 * 
 * Calls __gtk_text_iter_backward_visible_word_start() up to @count times.
 *
 * Return value: %TRUE if @iter moved and is not the end iterator 
 * 
 * Since: 2.4
 **/
gboolean
__gtk_text_iter_backward_visible_word_starts (GtkTextIter *iter,
					    gint         count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_backward_visible_word_start,
 ...
 **/
gboolean
__gtk_text_iter_starts_word (const GtkTextIter *iter)
{
  return test_log_attrs (iter, is_word_start_func);
}

/**
 * __gtk_text_iter_ends_word:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_ends_word (const GtkTextIter *iter)
{
  return test_log_attrs (iter, is_word_end_func);
}

/**
 * __gtk_text_iter_inside_word:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_inside_word (const GtkTextIter *iter)
{
  return test_log_attrs (iter, inside_word_func);
}

/**
 * __gtk_text_iter_starts_sentence:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_starts_sentence (const GtkTextIter *iter)
{
  return test_log_attrs (iter, is_sentence_start_func);
}

/**
 * __gtk_text_iter_ends_sentence:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_ends_sentence (const GtkTextIter *iter)
{
  return test_log_attrs (iter, is_sentence_end_func);
}

/**
 * __gtk_text_iter_inside_sentence:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_inside_sentence (const GtkTextIter *iter)
{
  return test_log_attrs (iter, inside_sentence_func);
}

/**
 * __gtk_text_iter_forward_sentence_end:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_forward_sentence_end (GtkTextIter *iter)
{
  return find_by_log_attrs (iter, find_sentence_end_func, TRUE, FALSE);
}

/**
 * __gtk_text_iter_backward_sentence_start:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_backward_sentence_start (GtkTextIter      *iter)
{
 ...
 */
/**
 * __gtk_text_iter_forward_sentence_ends:
 * @iter: a #GtkTextIter
 * @count: number of sentences to move
 * 
 * Calls __gtk_text_iter_forward_sentence_end() @count times (or until
 * __gtk_text_iter_forward_sentence_end() returns %FALSE). If @count is
 * negative, moves backward instead of forward.
 * 
 * Return value: %TRUE if @iter moved and is not the end iterator
 **/
gboolean
__gtk_text_iter_forward_sentence_ends (GtkTextIter      *iter,
                                     gint              count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_forward_sentence_end,
			      __gtk_text_iter_backward_sentence_starts);
}
 ...
 * @count: number of sentences to move
 * 
 * Calls __gtk_text_iter_backward_sentence_start() up to @count times,
 ...
 **/
gboolean
__gtk_text_iter_backward_sentence_starts (GtkTextIter      *iter,
                                        gint               count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_backward_sentence_start,
...
/**
 * __gtk_text_iter_forward_cursor_position:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_forward_cursor_position (GtkTextIter *iter)
{
  return find_by_log_attrs (iter, find_forward_cursor_pos_func, TRUE, FALSE);
}

/**
 * __gtk_text_iter_backward_cursor_position:
 * @iter: a #GtkTextIter
 * 
 * Like __gtk_text_iter_forward_cursor_position(), but moves backward.
 * 
 * Return value: %TRUE if we moved
 **/
gboolean
__gtk_text_iter_backward_cursor_position (GtkTextIter *iter)
{
  return find_by_log_attrs (iter, find_backward_cursor_pos_func, FALSE, FALSE);
}

/**
 * __gtk_text_iter_forward_cursor_positions:
 * @iter: a #GtkTextIter
 * @count: number of positions to move
 * 
 * Moves up to @count cursor positions. See
 * __gtk_text_iter_forward_cursor_position() for details.
 * 
 * Return value: %TRUE if we moved and the new position is dereferenceable
 **/
gboolean
__gtk_text_iter_forward_cursor_positions (GtkTextIter *iter,
                                        gint         count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_forward_cursor_position,
			      __gtk_text_iter_backward_cursor_positions);
}
 ...
 **/
gboolean
__gtk_text_iter_backward_cursor_positions (GtkTextIter *iter,
                                         gint         count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_backward_cursor_position,
...
/**
 * __gtk_text_iter_forward_visible_cursor_position:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_forward_visible_cursor_position (GtkTextIter *iter)
{
  return find_visible_by_log_attrs (iter, find_forward_cursor_pos_func, TRUE, FALSE);
}

/**
 * __gtk_text_iter_backward_visible_cursor_position:
 * @iter: a #GtkTextIter
 * 
 * Moves @iter forward to the previous visible cursor position. See 
 * __gtk_text_iter_backward_cursor_position() for details.
 * 
 * Return value: %TRUE if we moved and the new position is dereferenceable
 * 
 * Since: 2.4
 **/
gboolean
__gtk_text_iter_backward_visible_cursor_position (GtkTextIter *iter)
{
  return find_visible_by_log_attrs (iter, find_backward_cursor_pos_func, FALSE, FALSE);
}

/**
 * __gtk_text_iter_forward_visible_cursor_positions:
 * @iter: a #GtkTextIter
 * @count: number of positions to move
 * 
 ...
 **/
gboolean
__gtk_text_iter_forward_visible_cursor_positions (GtkTextIter *iter,
						gint         count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_forward_visible_cursor_position,
			      __gtk_text_iter_backward_visible_cursor_positions);
}
 ...
 **/
gboolean
__gtk_text_iter_backward_visible_cursor_positions (GtkTextIter *iter,
						 gint         count)
{
  return move_multiple_steps (iter, count, 
			      __gtk_text_iter_backward_visible_cursor_position,
...
/**
 * __gtk_text_iter_is_cursor_position:
 * @iter: a #GtkTextIter
 * 
 * See __gtk_text_iter_forward_cursor_position() or #PangoLogAttr or
 * pango_break() for details on what a cursor position is.
 * 
 * Return value: %TRUE if the cursor can be placed at @iter
 **/
gboolean
__gtk_text_iter_is_cursor_position (const GtkTextIter *iter)
{
  return test_log_attrs (iter, is_cursor_pos_func);
}

/**
 * __gtk_text_iter_set_line_offset:
 * @iter: a #GtkTextIter 
 ...
 * __gtk_text_iter_set_line_index() if you have a byte index rather than
 * a character offset.
 *
 **/
void
__gtk_text_iter_set_line_offset (GtkTextIter *iter,
                               gint         char_on_line)
{
  GtkTextRealIter *real;
  gint chars_in_line;
  ...
  chars_in_line = __gtk_text_iter_get_chars_in_line (iter);
  ...
  if (char_on_line < chars_in_line)
    ...
    __gtk_text_iter_forward_line (iter); /* set to start of next line */
  
  check_invariants (iter);
}

/**
 * __gtk_text_iter_set_line_index:
 * @iter: a #GtkTextIter
 * @byte_on_line: a byte index relative to the start of @iter's current line
 *
 * Same as __gtk_text_iter_set_line_offset(), but works with a
 ...
 **/
void
__gtk_text_iter_set_line_index (GtkTextIter *iter,
                              gint         byte_on_line)
{
  GtkTextRealIter *real;
  gint bytes_in_line;
  ...
  bytes_in_line = __gtk_text_iter_get_bytes_in_line (iter);
  ...
  if (byte_on_line < bytes_in_line)
    ...
    __gtk_text_iter_forward_line (iter);
...
/**
 * __gtk_text_iter_set_visible_line_offset:
 * @iter: a #GtkTextIter
 * @char_on_line: a character offset
 * 
 * Like __gtk_text_iter_set_line_offset(), but the offset is in visible
 * characters, i.e. text with a tag making it invisible is not
 * counted in the offset.
 **/
void
__gtk_text_iter_set_visible_line_offset (GtkTextIter *iter,
                                       gint         char_on_line)
{
  gint chars_seen = 0;
  GtkTextIter pos;
  ...
  __gtk_text_iter_set_line_offset (iter, 0);
  ...
  while (chars_seen < char_on_line)
    {
      ...
      if (!__gtk_text_iter_forward_char (&pos))
        break;
  ...
  if (___gtk_text_iter_get_text_line (&pos) == ___gtk_text_iter_get_text_line (iter))
    *iter = pos;
  else
    __gtk_text_iter_forward_line (iter);
}
...
/**
 * __gtk_text_iter_set_visible_line_index:
 * @iter: a #GtkTextIter
 * @byte_on_line: a byte index
 * 
 * Like __gtk_text_iter_set_line_index(), but the index is in visible
 * bytes, i.e. text with a tag making it invisible is not counted
 * in the index.
 **/
void
__gtk_text_iter_set_visible_line_index (GtkTextIter *iter,
                                      gint         byte_on_line)
{
  GtkTextRealIter *real;
  gint offset = 0;
 ...
 **/
void
__gtk_text_iter_set_line (GtkTextIter *iter,
                        gint         line_number)
{
  GtkTextLine *line;
  gint real_line;
 ...
 **/
void
__gtk_text_iter_set_offset (GtkTextIter *iter,
                          gint         char_offset)
{
  GtkTextLine *line;
  GtkTextRealIter *real;
...
/**
 * __gtk_text_iter_forward_to_end:
 * @iter: a #GtkTextIter
 *
 * Moves @iter forward to the "end iterator," which points one past the last
 * valid character in the buffer. __gtk_text_iter_get_char() called on the
 * end iterator returns 0, which is convenient for writing loops.
 **/
void
__gtk_text_iter_forward_to_end  (GtkTextIter *iter)
{
...
/* FIXME this and __gtk_text_iter_forward_to_line_end() could be cleaned up
...
find_paragraph_delimiter_for_line (GtkTextIter *iter)
{
  ...
  if (_gtk_text_line_contains_end_iter (___gtk_text_iter_get_text_line (&end),
  ...
  else
    {
      ...
      __gtk_text_iter_backward_char (&end);
      while (!__gtk_text_iter_ends_line (&end))
        __gtk_text_iter_backward_char (&end);
    }

  return __gtk_text_iter_get_line_offset (&end);
}

/**
 * __gtk_text_iter_forward_to_line_end:
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
__gtk_text_iter_forward_to_line_end (GtkTextIter *iter)
{
  gint current_offset;
  gint new_offset;
  ...
  current_offset = __gtk_text_iter_get_line_offset (iter);
  new_offset = find_paragraph_delimiter_for_line (iter);
  
  if (current_offset < new_offset)
    {
      /* Move to end of this line. */
      __gtk_text_iter_set_line_offset (iter, new_offset);
      return !__gtk_text_iter_is_end (iter);
    }
  else
    {
...
/**
 * __gtk_text_iter_forward_to_tag_toggle:
 * @iter: a #GtkTextIter
 * @tag: (allow-none): a #GtkTextTag, or %NULL
 *
 ...
 **/
gboolean
__gtk_text_iter_forward_to_tag_toggle (GtkTextIter *iter,
                                     GtkTextTag  *tag)
{
  ...
  while (_gtk_text_iter_forward_indexable_segment (iter))
    {
      ...
      if (__gtk_text_iter_toggles_tag (iter, tag))
        {
...
/**
 * __gtk_text_iter_backward_to_tag_toggle:
 * @iter: a #GtkTextIter
 * @tag: (allow-none): a #GtkTextTag, or %NULL
 *
 ...
 **/
gboolean
__gtk_text_iter_backward_to_tag_toggle (GtkTextIter *iter,
                                      GtkTextTag  *tag)
{
  ...
  if (is_segment_start (real))
  ...
  else
    {
      ...
      if (!__gtk_text_iter_backward_chars (iter, real->segment_char_offset))
        return FALSE;
    }
              ...
              gpointer user_data)
{
  ...
  ch = __gtk_text_iter_get_char (iter);

  return (*pred) (ch, user_data);
}

/**
 * __gtk_text_iter_forward_find_char:
 * @iter: a #GtkTextIter
 ...
 **/
gboolean
__gtk_text_iter_forward_find_char (GtkTextIter         *iter,
                                 GtkTextCharPredicate pred,
                                 gpointer             user_data,
                                 const GtkTextIter   *limit)
{
  ...
  if (limit &&
      __gtk_text_iter_compare (iter, limit) >= 0)
    return FALSE;
  
  while ((limit == NULL ||
          !__gtk_text_iter_equal (limit, iter)) &&
         __gtk_text_iter_forward_char (iter))
    {      
...
/**
 * __gtk_text_iter_backward_find_char:
 * @iter: a #GtkTextIter
 * @pred: (scope call): function to be called on each character
 * @user_data: user data for @pred
 * @limit: (allow-none): search limit, or %NULL for none
 * 
 * Same as __gtk_text_iter_forward_find_char(), but goes backward from @iter.
 * 
 * Return value: whether a match was found
 **/
gboolean
__gtk_text_iter_backward_find_char (GtkTextIter         *iter,
                                  GtkTextCharPredicate pred,
                                  gpointer             user_data,
                                  const GtkTextIter   *limit)
{
  ...
  while (i > 0)
    {
      ...
      if (skip_nontext &&
          __gtk_text_iter_get_char (iter) == GTK_TEXT_UNKNOWN_CHAR)
        ignored = TRUE;
             ...
             GtkTextIter *match_end)
{
  ...
  next = *start;
  __gtk_text_iter_forward_line (&next);

  /* No more text in buffer, but *lines is nonempty */
  if (__gtk_text_iter_equal (start, &next))
    {
      return FALSE;
    }
  ...
  if (slice)
    {
      if (visible_only)
        line_text = __gtk_text_iter_get_visible_slice (start, &next);
      else
        line_text = __gtk_text_iter_get_slice (start, &next);
    }
  else
    {
      if (visible_only)
        line_text = __gtk_text_iter_get_visible_text (start, &next);
      else
        line_text = __gtk_text_iter_get_text (start, &next);
    }
...
/**
 * __gtk_text_iter_forward_search:
 ...
 **/
gboolean
__gtk_text_iter_forward_search (const GtkTextIter *iter,
                              const gchar       *str,
                              ...
                              const GtkTextIter *limit)
{
  ...
  if (*str == '\0')
    {
      ...
      if (__gtk_text_iter_forward_char (&match))
        {
          if (limit &&
              __gtk_text_iter_equal (&match, limit))
            return FALSE;
  ...
  do
    {
       ...
       * __gtk_text_iter_get_text () is called repeatedly on
       * a single line.
       */
      GtkTextIter end;

      if (limit &&
          __gtk_text_iter_compare (&search, limit) >= 0)
        break;
      ...
      if (lines_match (&search, (const gchar**)lines,
                       visible_only, slice, &match, &end))
        {
          if (limit == NULL ||
              (limit &&
               __gtk_text_iter_compare (&end, limit) <= 0))
            {
              retval = TRUE;
  ...
  while (__gtk_text_iter_forward_line (&search));
                   ...
                   const GtkTextIter *start)
{
   ...
   * n_lines can be 2.
   */
  if (__gtk_text_iter_is_start (start) ||
      __gtk_text_iter_get_line (start) + 1 < win->n_lines)
    {
  ...
  __gtk_text_iter_set_line_offset (&line_start, 0);

  if (__gtk_text_iter_equal (&line_start, &line_end))
    {
      /* we were already at the start; so go back one line */
      __gtk_text_iter_backward_line (&line_start);
    }
  ...
  while (i >= 0)
    {
      ...
      if (win->slice)
        {
          if (win->visible_only)
            line_text = __gtk_text_iter_get_visible_slice (&line_start, &line_end);
          else
            line_text = __gtk_text_iter_get_slice (&line_start, &line_end);
        }
      else
        {
          if (win->visible_only)
            line_text = __gtk_text_iter_get_visible_text (&line_start, &line_end);
          else
            line_text = __gtk_text_iter_get_text (&line_start, &line_end);
        }
...
lines_window_back (LinesWindow *win)
{
  ...
  if (!__gtk_text_iter_backward_line (&new_start))
    return FALSE;
  else
    {
      ...
      __gtk_text_iter_forward_line (&win->first_line_end);
    }

  if (win->slice)
    {
      if (win->visible_only)
        line_text = __gtk_text_iter_get_visible_slice (&win->first_line_start,
                                                     &win->first_line_end);
      else
        line_text = __gtk_text_iter_get_slice (&win->first_line_start,
                                             &win->first_line_end);
    }
  else
    {
      if (win->visible_only)
        line_text = __gtk_text_iter_get_visible_text (&win->first_line_start,
                                                    &win->first_line_end);
      else
        line_text = __gtk_text_iter_get_text (&win->first_line_start,
                                            &win->first_line_end);
    }
...
/**
 * __gtk_text_iter_backward_search:
 ...
 *
 * Same as __gtk_text_iter_forward_search(), but moves backward.
 *
 * Return value: whether a match was found
 **/
gboolean
__gtk_text_iter_backward_search (const GtkTextIter *iter,
                               const gchar       *str,
                               GtkTextSearchFlags flags,
                               GtkTextIter       *match_start,
                               GtkTextIter       *match_end,
                               const GtkTextIter *limit)
{
  ...
  if (limit &&
      __gtk_text_iter_compare (limit, iter) > 0)
    return FALSE;
  ...
  if (*str == '\0')
    {
      ...
      if (limit && __gtk_text_iter_equal (limit, &match))
        return FALSE;
      
      if (__gtk_text_iter_backward_char (&match))
        {
          if (match_start)
            *match_start = match;
          if (match_end)
  ...
  do
    {
      ...
      if (limit &&
          __gtk_text_iter_compare (limit, &win.first_line_end) > 0)
        {
      ...
      if (first_line_match &&
          vectors_equal_ignoring_trailing (lines + 1, win.lines + 1))
        {
          ...
          if (limit &&
              __gtk_text_iter_compare (limit, &start_tmp) > 0)
 ...
 **/
gint
__gtk_text_iter_compare (const GtkTextIter *lhs,
                       const GtkTextIter *rhs)
{
  GtkTextRealIter *real_lhs;
  GtkTextRealIter *real_rhs;
  ...
  if (real_lhs->line == real_rhs->line)
  ...
  else
    {
      ...
      line1 = __gtk_text_iter_get_line (lhs);
      line2 = __gtk_text_iter_get_line (rhs);
      if (line1 < line2)
        return -1;
      else if (line1 > line2)
        return 1;
 ...
 **/
gboolean
__gtk_text_iter_in_range (const GtkTextIter *iter,
                        const GtkTextIter *start,
                        const GtkTextIter *end)
{
  g_return_val_if_fail (iter != NULL, FALSE);
  ...
  g_return_val_if_fail (__gtk_text_iter_compare (start, end) <= 0, FALSE);
  
  return __gtk_text_iter_compare (iter, start) >= 0 &&
    __gtk_text_iter_compare (iter, end) < 0;
}

/**
 * __gtk_text_iter_order:
 * @first: a #GtkTextIter
 ...
 * in those cases. There are some exceptions, such as __gtk_text_iter_in_range(),
 * that expect a pre-sorted range.
 * 
 **/
void
__gtk_text_iter_order (GtkTextIter *first,
                     GtkTextIter *second)
{
  g_return_if_fail (first != NULL);
  g_return_if_fail (second != NULL);

  if (__gtk_text_iter_compare (first, second) > 0)
    {
      GtkTextIter tmp;
                                          ...
                                          GtkTextTag     *tag)
{
  ...
  if (line == NULL)
  ...
  else
    {
      ...
      if (!__gtk_text_iter_toggles_tag (iter, tag))
        __gtk_text_iter_forward_to_tag_toggle (iter, tag);
                                          ...
                                          GtkTextTag     *tag)
{
  ...
  _gtk_text_btree_get_end_iter (tree, iter);
  __gtk_text_iter_backward_to_tag_toggle (iter, tag);
  check_invariants (iter);
                                  ...
                                  GtkTextMark *mark)
{
  ...
  g_assert (seg->body.mark.line == ___gtk_text_iter_get_text_line (iter));
  check_invariants (iter);
}
                                          ...
                                          GtkTextChildAnchor *anchor)
{
  ...
  g_assert (seg->body.child.line == ___gtk_text_iter_get_text_line (iter));
  check_invariants (iter);
}
