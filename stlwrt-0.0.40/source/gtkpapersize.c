...
gtk_paper_size_get_type (void)
{
  ...
  if (our_type == 0)
    our_type = g_boxed_type_register_static (I_("GtkPaperSize"),
					     (GBoxedCopyFunc)__gtk_paper_size_copy,
					     (GBoxedFreeFunc)__gtk_paper_size_free);
  return our_type;
}
...
static GtkPaperSize *
__gtk_paper_size_new_from_info (const PaperInfo *info)
{
  GtkPaperSize *size;
 ...
 * see __gtk_paper_size_get_default().
 * 
 * Return value: a new #GtkPaperSize, use __gtk_paper_size_free()
 * to free it
 *
 * Since: 2.10
 */
GtkPaperSize *
__gtk_paper_size_new (const gchar *name)
{
  GtkPaperSize *size;
  char *short_name;
  double width, height;
  ...
  if (name == NULL)
    name = __gtk_paper_size_get_default ();
  ...
  if (parse_full_media_size_name (name, &short_name, &width, &height))
  ...
  else
    {
      ...
      if (info != NULL)
	size = __gtk_paper_size_new_from_info (info);
      else
	{
 ...
 */
GtkPaperSize *
__gtk_paper_size_new_from_ppd (const gchar *ppd_name,
			     ...
			     gdouble      height)
{
  ...
  for (i = 0; i < G_N_ELEMENTS(standard_names_offsets); i++)
	...
	{
	  size = __gtk_paper_size_new_from_info (&standard_names_offsets[i]);
	  goto out;
	}
    }
  ...
  for (i = 0; i < G_N_ELEMENTS(extra_ppd_names_offsets); i++)
	...
	{
	  size = __gtk_paper_size_new (paper_names + extra_ppd_names_offsets[i].standard_name);
	  goto out;
	}
    }

  name = g_strconcat ("ppd_", ppd_name, NULL);
  size = __gtk_paper_size_new_custom (name, ppd_display_name, width, height, GTK_UNIT_POINTS);
  g_free (name);
 ...
 * given parameters.
 * 
 * Return value: a new #GtkPaperSize object, use __gtk_paper_size_free()
 * to free it
 *
 * Since: 2.10
 */
GtkPaperSize *
__gtk_paper_size_new_custom (const gchar *name, 
 ...
 */
GtkPaperSize *
__gtk_paper_size_copy (GtkPaperSize *other)
{
  GtkPaperSize *size;
 ...
 */
void
__gtk_paper_size_free (GtkPaperSize *size)
{
  g_free (size->name);
 ...
 */
gboolean
__gtk_paper_size_is_equal (GtkPaperSize *size1,
			 GtkPaperSize *size2)
{
  if (size1->info != NULL && size2->info != NULL)
    return size1->info == size2->info;
  
  return strcmp (__gtk_paper_size_get_name (size1),
		 __gtk_paper_size_get_name (size2)) == 0;
}

GList * _gtk_load_custom_papers (void);

/**
 * __gtk_paper_size_get_paper_sizes:
 ...
 */
GList *
__gtk_paper_size_get_paper_sizes (gboolean include_custom)
{
  GList *list = NULL;
  guint i;
      ...
      for (l = page_setups; l != NULL; l = l->next)
        {
          ...
          size = __gtk_page_setup_get_paper_size (setup);
          list = g_list_prepend (list, __gtk_paper_size_copy (size));
        }
 ...
 */
const gchar *
__gtk_paper_size_get_name (GtkPaperSize *size)
{
  if (size->name)
    return size->name;
...
/**
 * __gtk_paper_size_get_display_name:
 * @size: a #GtkPaperSize object
 * 
 ...
 */
const gchar *
__gtk_paper_size_get_display_name (GtkPaperSize *size)
{
  const gchar *display_name;
 ...
 */
const gchar *
__gtk_paper_size_get_ppd_name (GtkPaperSize *size)
{
  if (size->ppd_name)
 ...
 */
gdouble
__gtk_paper_size_get_width (GtkPaperSize *size, 
			  GtkUnit       unit)
{
 ...
 */
gdouble
__gtk_paper_size_get_height (GtkPaperSize *size, 
			   GtkUnit       unit)
{
 ...
 **/
gboolean
__gtk_paper_size_is_custom (GtkPaperSize *size)
{
  return size->is_custom;
}

/**
 * __gtk_paper_size_set_size:
 ...
 */
void
__gtk_paper_size_set_size (GtkPaperSize *size, 
			 gdouble       width, 
			 gdouble       height, 
			 GtkUnit       unit)
{
 ...
 */
const gchar *
__gtk_paper_size_get_default (void)
{
...
/**
 * __gtk_paper_size_get_default_top_margin:
 * @size: a #GtkPaperSize object
 * @unit: the unit for the return value
 * 
 ...
 */
gdouble
__gtk_paper_size_get_default_top_margin (GtkPaperSize *size, 
				       GtkUnit       unit)
{
  gdouble margin;
...
/**
 * __gtk_paper_size_get_default_bottom_margin:
 * @size: a #GtkPaperSize object
 * @unit: the unit for the return value
 * 
 ...
 */
gdouble
__gtk_paper_size_get_default_bottom_margin (GtkPaperSize *size, 
					  GtkUnit       unit)
{
  gdouble margin;
  const gchar *name;
  ...
  name = __gtk_paper_size_get_name (size);
...
/**
 * __gtk_paper_size_get_default_left_margin:
 * @size: a #GtkPaperSize object
 * @unit: the unit for the return value
 * 
 ...
 */
gdouble
__gtk_paper_size_get_default_left_margin (GtkPaperSize *size, 
					GtkUnit       unit)
{
  gdouble margin;
...
/**
 * __gtk_paper_size_get_default_right_margin:
 * @size: a #GtkPaperSize object
 * @unit: the unit for the return value
 * 
 ...
 */
gdouble
__gtk_paper_size_get_default_right_margin (GtkPaperSize *size, 
					 GtkUnit       unit)
{
  gdouble margin;
...
/**
 * __gtk_paper_size_new_from_key_file:
 ...
 */
GtkPaperSize *
__gtk_paper_size_new_from_key_file (GKeyFile    *key_file,
...
#undef GET_DOUBLE
  ...
  if (ppd_name != NULL)
    paper_size = __gtk_paper_size_new_from_ppd (ppd_name,
                                              display_name,
                                              _gtk_print_convert_from_mm (width, GTK_UNIT_POINTS),
                                              _gtk_print_convert_from_mm (height, GTK_UNIT_POINTS));
  else if (name != NULL)
    paper_size = __gtk_paper_size_new_custom (name, display_name,
 ...
 */
void
__gtk_paper_size_to_key_file (GtkPaperSize *size,
			    GKeyFile     *key_file,
			    const gchar  *group_name)
{
  ...
  name = __gtk_paper_size_get_name (size);
  display_name = __gtk_paper_size_get_display_name (size);
  ppd_name = __gtk_paper_size_get_ppd_name (size);
  ...
  g_key_file_set_double (key_file, group_name,
			 "Width", __gtk_paper_size_get_width (size, GTK_UNIT_MM));
  g_key_file_set_double (key_file, group_name,
