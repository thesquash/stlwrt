...
gtk_widget_class_init (GtkWidgetClass *klass)
{
  ...
  klass->property_notify_event = ______gtk_selection_property_notify;
  klass->selection_clear_event = __gtk_selection_clear;
  klass->selection_request_event = ______gtk_selection_request;
  klass->selection_notify_event = ______gtk_selection_notify;
 ...
 */
  ...
  widget_signals[DRAG_FAILED] =
    g_signal_new (I_("drag-failed"),
		  G_TYPE_FROM_CLASS (gobject_class),
		  G_SIGNAL_RUN_LAST,
		  0, ______gtk_boolean_handled_accumulator, NULL,
		  NULL,
		  G_TYPE_BOOLEAN, 2,
		  GDK_TYPE_DRAG_CONTEXT,
...
gtk_widget_init (GtkWidget *widget)
{
  ...
  widget->style = __gtk_widget_get_default_style ();
...
__gtk_widget_unparent (GtkWidget *widget)
{
  ...
  if (__gtk_widget_is_toplevel (toplevel))
    ______gtk_window_unset_focus_and_default (GTK_WINDOW (toplevel), widget);

  if (GTK_CONTAINER (widget->parent)->focus_child == widget)
    __gtk_container_set_focus_child (GTK_CONTAINER (widget->parent), NULL);
  ...
  if (toplevel)
    {
      ______gtk_widget_propagate_hierarchy_changed (widget, toplevel);
 ...
 **/
void
__gtk_widget_destroy (GtkWidget *widget)
{
  g_return_if_fail (GTK_IS_WIDGET (widget));
  ...
  if (!__gtk_widget_get_visible (widget))
    {
      ...
      if (widget->parent &&
	  __gtk_widget_get_mapped (widget->parent) &&
...
__gtk_widget_map (GtkWidget *widget)
{
  ...
  if (!__gtk_widget_get_mapped (widget))
	...
	__gdk_window_invalidate_rect (widget->window, &widget->allocation, FALSE);
    }
}
  ...
  if (window_list == NULL)
    {
      if (__gtk_widget_get_has_window (widget))
        ...
        window_list = __gdk_window_get_children (widget->window);
  ...
  if (!__gtk_widget_get_realized (widget))
	...
	if (GTK_IS_CONTAINER (widget) && __gtk_widget_get_has_window (widget))
      ...
      */
      ...
      if (widget->parent && !__gtk_widget_get_realized (widget->parent))
	__gtk_widget_realize (widget->parent);
      ...
      if (GTK_WIDGET_HAS_SHAPE_MASK (widget))
	{
	  ...
	  __gdk_window_shape_combine_mask (widget->window,
      ...
      if (shape_info)
	__gdk_window_input_shape_combine_mask (widget->window,
					     shape_info->shape_mask,
					     shape_info->offset_x,
					     shape_info->offset_y);
 			    ...
 			    gint       height)
{
  ...
  if (__gtk_widget_get_has_window (widget))
      ...
      if (widget->parent)
	{
	  ...
	  __gdk_window_get_position (widget->window, &wx, &wy);
	  x -= wx - widget->allocation.x;
	  y -= wy - widget->allocation.y;
	  
	  wwidth = __gdk_window_get_width (widget->window);
	  wheight = __gdk_window_get_height (widget->window);
...
__gtk_widget_queue_resize (GtkWidget *widget)
{
  ...
  ______gtk_size_group_queue_resize (widget);
}
			 ...
			 GtkRequisition *requisition)
{
  ...
  if (requisition == &widget->requisition)
    g_warning ("__gtk_widget_size_request() called on child widget with request equal\n to widget->requisition. __gtk_widget_set_usize() may not work properly.");
#endif /* G_ENABLE_DEBUG */

  ______gtk_size_group_compute_requisition (widget, requisition);
}
...
__gtk_widget_get_child_requisition (GtkWidget	 *widget,
				  GtkRequisition *requisition)
{
  ______gtk_size_group_get_child_requisition (widget, requisition);
}
				      ...
				      GdkRegion *region)
{
  ...
  if (__gtk_widget_get_has_window (widget) && widget->parent)
    {
      int x, y;
      
      __gdk_window_get_position (widget->window, &x, &y);
      __gdk_region_offset (region, -x, -y);
    }

  __gdk_window_invalidate_maybe_recurse (widget->window, region,
			  ...
			  GtkAllocation *allocation)
{
  ...
  aux_info =______gtk_widget_get_aux_info (widget, FALSE);
  ...
  if (__gtk_widget_get_mapped (widget))
      ...
      if (!__gtk_widget_get_has_window (widget) && GTK_WIDGET_REDRAW_ON_ALLOC (widget) && position_changed)
	{
	   ...
	   */
	  GdkRegion *invalidate = __gdk_region_rectangle (&widget->allocation);
	  __gdk_region_union_with_rect (invalidate, &old_allocation);

	  __gdk_window_invalidate_region (widget->window, invalidate, FALSE);
  ...
  if ((size_changed || position_changed) && widget->parent &&
      __gtk_widget_get_realized (widget->parent) && GTK_CONTAINER (widget->parent)->reallocate_redraws)
    {
      GdkRegion *invalidate = __gdk_region_rectangle (&widget->parent->allocation);
				  ...
				  gint       *dest_y)
{
  ...
  if (__gtk_widget_get_has_window (src_widget) && src_widget->parent)
    {
      gint wx, wy;
      __gdk_window_get_position (src_widget->window, &wx, &wy);
                                    ...
                                    guint      signal_id)
{
  ...
  return __gtk_widget_is_sensitive (widget) &&
         ...
         __gdk_window_is_viewable (widget->window);
}
			   ...
			   GtkAccelGroup *accel_group)
{
  ...
  if (accel_path)
    {
      g_return_if_fail (GTK_IS_ACCEL_GROUP (accel_group));
      g_return_if_fail (______gtk_accel_path_is_valid (accel_path));
...
const gchar*
______gtk_widget_get_accel_path (GtkWidget *widget,
			    gboolean  *locked)
{
  AccelPath *apath;
  ...
  if (!return_val)
	...
	case GDK_FOCUS_CHANGE:
	  ...
	  if (event->focus_change.in)
	    ______gtk_tooltip_focus_in (widget);
	  else
	    ______gtk_tooltip_focus_out (widget);
	  break;
	case GDK_CONFIGURE:
				...
				GdkWindow *new_window)
{
  if (!__gtk_widget_get_has_window (widget))
    {
      GList *children = __gdk_window_get_children (widget->window);
      GList *tmp_list;
  ...
  else
   {
     ...
     parent = __gdk_window_get_parent (widget->window);

     if (parent == NULL)
       __gdk_window_reparent (widget->window, new_window, 0, 0);
     else
       {
		     ...
		     GtkWidget *new_parent)
{
  ...
  if (widget->parent != new_parent)
	...
	GTK_PRIVATE_SET_FLAG (widget, GTK_IN_REPARENT);
      ...
      g_object_ref (widget);
      __gtk_container_remove (GTK_CONTAINER (widget->parent), widget);
		      ...
		      GdkRectangle       *intersection)
{
  ...
  return_val = __gdk_rectangle_intersect (&widget->allocation, area, dest);
 ...
 **/
void
______gtk_widget_grab_notify (GtkWidget *widget,
  ...
  if (__gtk_widget_get_can_focus (focus_widget))
      ...
      if (__gtk_widget_is_toplevel (toplevel) && GTK_IS_WINDOW (toplevel))
	{
	  ...
	  if (widget == focus_widget)
	    {
	      /* We call ______gtk_window_internal_set_focus() here so that the
	       * toplevel window can request the focus if necessary.
	       * This is needed when the toplevel is a GtkPlug
	       */
	      if (!__gtk_widget_has_focus (widget))
		______gtk_window_internal_set_focus (GTK_WINDOW (toplevel), focus_widget);
      ...
      else if (toplevel != focus_widget)
	{
      ...
      while (widget->parent)
	{
	  __gtk_container_set_focus_child (GTK_CONTAINER (widget->parent), widget);
	  widget = widget->parent;
	}
      if (GTK_IS_WINDOW (widget))
	______gtk_window_internal_set_focus (GTK_WINDOW (widget), focus_widget);
    }
}
                           ...
                           GtkWidgetHelpType help_type)
{
  if (help_type == GTK_WIDGET_HELP_TOOLTIP)
    {
      ______gtk_tooltip_toggle_keyboard_mode (widget);
...
void
______gtk_widget_set_has_default (GtkWidget *widget,
...
void
______gtk_widget_set_has_grab (GtkWidget *widget,
                          gboolean   has_grab)
{
  if (has_grab)
		      ...
		      GtkStateType         state)
{
  ...
  if (state == GTK_STATE_INSENSITIVE)
  ...
  else
    {
      ...
      if (widget->parent)
	data.parent_sensitive = (__gtk_widget_is_sensitive (widget->parent) != FALSE);
      else
...
void
______gtk_widget_set_is_toplevel (GtkWidget *widget,
 ...
 *  __gdk_window_set_back_pixmap (window->window, NULL, FALSE);
		       ...
		       GtkWidget *parent)
{
  ...
  if (GTK_WIDGET_ANCHORED (widget->parent))
    ______gtk_widget_propagate_hierarchy_changed (widget, NULL);
  g_object_notify (G_OBJECT (widget), "parent");

  /* Enforce realized/mapped invariants
   */
  if (__gtk_widget_get_realized (widget->parent))
    __gtk_widget_realize (widget);

  if (__gtk_widget_get_visible (widget->parent) &&
  ...
  if (color)
    {
      ...
      ______gtk_rc_style_set_rc_property (rc_style, &rc_property);

      g_value_unset (&rc_property.value);
    }
  else
    ______gtk_rc_style_unset_rc_property (rc_style, type_name, property_name);
}
			       ...
			       gboolean   initial_emission)
{
  ...
  if (widget->style != style)
      ...
      if (__gtk_widget_get_realized (widget))
	{
	  ...
	  __gtk_style_detach (widget->style);
	}
...
/**
 * ______gtk_widget_propagate_hierarchy_changed:
 * @widget: a #GtkWidget
 ...
 **/
void
______gtk_widget_propagate_hierarchy_changed (GtkWidget    *widget,
					 GtkWidget    *previous_toplevel)
{
...
void
______gtk_widget_propagate_composited_changed (GtkWidget *widget)
{
  propagate_composited_changed (widget, NULL);
}

/**
 * ______gtk_widget_propagate_screen_changed:
 * @widget: a #GtkWidget
 ...
 **/
void
______gtk_widget_propagate_screen_changed (GtkWidget    *widget,
				      GdkScreen    *previous_screen)
{
  HierarchyChangedInfo info;
                        ...
                        const gchar    *detail)
{
  ...
  icon_set = __gtk_style_lookup_icon_set (widget->style, stock_id);
			      ...
			      gboolean   is_visible)
{
  ...
  if (widget->parent && __gtk_widget_get_realized (widget->parent))
    {
      if (__gtk_widget_get_mapped (widget->parent) &&
	  GTK_WIDGET_CHILD_VISIBLE (widget) &&
	  __gtk_widget_get_visible (widget))
	__gtk_widget_map (widget);
      else
...
__gtk_widget_error_bell (GtkWidget *widget)
{
  ...
  if (beep && widget->window)
    __gdk_window_beep (widget->window);
}
			  ...
			  gint	     y)
{
  ...
  aux_info =______gtk_widget_get_aux_info (widget, TRUE);
  ...
  if (GTK_IS_WINDOW (widget) && aux_info->x_set && aux_info->y_set)
    ______gtk_window_reposition (GTK_WINDOW (widget), aux_info->x, aux_info->y);
  
  if (__gtk_widget_get_visible (widget) && widget->parent)
    __gtk_widget_size_allocate (widget, &widget->allocation);
}
...
__gtk_widget_get_composite_name (GtkWidget *widget)
{
  ...
  if (((GTK_OBJECT_FLAGS (widget) & GTK_COMPOSITE_CHILD) != 0) && widget->parent)
    return ______gtk_container_child_composite_name (GTK_CONTAINER (widget->parent),
					       widget);
  else
    return NULL;
}
...
gtk_widget_real_unrealize (GtkWidget *widget)
{
  ...
  if (__gtk_widget_get_has_window (widget))
    {
      __gdk_window_set_user_data (widget->window, NULL);
...
/**
 * ______gtk_widget_peek_colormap:
 * 
 ...
 **/
GdkColormap*
______gtk_widget_peek_colormap (void)
{
  if (colormap_stack)
...
/*
 * ______gtk_widget_set_pointer_window:
 * @widget: a #GtkWidget.
 ...
 */
void
______gtk_widget_set_pointer_window (GtkWidget *widget,
                                GdkWindow *pointer_window)
{
  ...
  if (__gtk_widget_get_realized (widget))
    {
      GdkScreen *screen = __gdk_window_get_screen (widget->window);
...
/*
 * ______gtk_widget_get_pointer_window:
 * @widget: a #GtkWidget.
 *
 ...
 */
GdkWindow *
______gtk_widget_get_pointer_window (GtkWidget *widget)
{
  g_return_val_if_fail (GTK_IS_WIDGET (widget), NULL);
...
/*
 * ______gtk_widget_is_pointer_widget:
 * @widget: a #GtkWidget
 *
 * Returns %TRUE if the pointer window belongs to @widget.
 */
gboolean
______gtk_widget_is_pointer_widget (GtkWidget *widget)
{
  if (GTK_WIDGET_HAS_POINTER (widget))
    {
      ...
      win = ______gtk_widget_get_pointer_window (widget);
      if (win)
        {
...
/*
 * ______gtk_widget_synthesize_crossing:
 ...
 */
void
______gtk_widget_synthesize_crossing (GtkWidget      *from,
				 GtkWidget      *to,
				 GdkCrossingMode mode)
{
  ...
  if (from != NULL)
    from_window = GTK_WIDGET_HAS_POINTER (from)
      ? ______gtk_widget_get_pointer_window (from) : from->window;
  if (to != NULL)
    to_window = GTK_WIDGET_HAS_POINTER (to)
      ? ______gtk_widget_get_pointer_window (to) : to->window;
			    ...
			    GtkStateData        *data)
{
  ...
  if (__gtk_widget_is_sensitive (widget))
	...
	widget->saved_state = __gtk_widget_get_state (widget);
  ...
  if (old_state != __gtk_widget_get_state (widget) ||
	...
	{
	  if (!__gtk_widget_is_sensitive (widget))
	    ______gtk_widget_synthesize_crossing (widget, NULL, 
					     GDK_CROSSING_STATE_CHANGED);
	  else if (old_state == GTK_STATE_INSENSITIVE)
	    ______gtk_widget_synthesize_crossing (NULL, widget, 
					     GDK_CROSSING_STATE_CHANGED);
	}
 ...
 */
GtkWidgetAuxInfo*
______gtk_widget_get_aux_info (GtkWidget *widget,
			  gboolean   create)
{
  GtkWidgetAuxInfo *aux_info;
  ...
  if (!shape_mask)
    {
      ...
      if (widget->window)
	__gdk_window_shape_combine_mask (widget->window, NULL, 0, 0);
  ...
  else
    {
       ...
       */
      if (widget->window)
	__gdk_window_shape_combine_mask (widget->window, shape_mask,
				       offset_x, offset_y);
    }
}
				     ...
				     gint	offset_y)
{
  ...
  if (!shape_mask)
    {
      if (widget->window)
	__gdk_window_input_shape_combine_mask (widget->window, NULL, 0, 0);
  ...
  else
    {
       ...
       */
      if (widget->window)
	__gdk_window_input_shape_combine_mask (widget->window, shape_mask,
					     offset_x, offset_y);
    }
}
                         ...
                         GdkRectangle *clip_rect)
{
  ...
  if (widget->parent && __gtk_widget_get_has_window (widget))
    {
  ...
  if (!windows) /* NO_WINDOW || toplevel => parent_window == NULL || parent_window == widget->window */
    {
      __gdk_window_redirect_to_drawable (widget->window, pixmap, x, y, 0, 0, width, height);
      expose_window (widget->window);
    }
  for (list = windows; list; list = list->next)
    __gdk_window_remove_redirection (list->data);
  if (!windows) /* NO_WINDOW || toplevel */
    __gdk_window_remove_redirection (widget->window);
  g_list_free (windows);
					 ...
					 GParamSpec     *pspec)
{
  ...
  parser = ______gtk_rc_property_parser_from_type (G_PARAM_SPEC_VALUE_TYPE (pspec));
			       ...
			       GValue      *value)
{
  ...
  if (!pspec)
  ...
  else
    {
      ...
      peek_value = ______gtk_style_peek_property_value (widget->style,
						   G_OBJECT_TYPE (widget),
						   pspec,
...
void
______gtk_widget_buildable_finish_accelerator (GtkWidget *widget,
					  GtkWidget *toplevel,
					  gpointer   user_data)
{
  ...
  if (strcmp (tagname, "accelerator") == 0)
    {
      ...
      ______gtk_widget_buildable_finish_accelerator (GTK_WIDGET (buildable), toplevel, user_data);
    }
