...
void        __gdk_directfb_window_set_opacity (GdkWindow *window,
                                             guchar     opacity);

#ifndef GDK_DISABLE_DEPRECATED
GdkWindow * __gdk_directfb_window_new         (GdkWindow             *parent,
...
GdkVisual * __gdk_directfb_visual_by_format   (DFBSurfacePixelFormat  pixel_format);

IDirectFBWindow  *__gdk_directfb_window_lookup (GdkWindow *window);
IDirectFBSurface *__gdk_directfb_surface_lookup (GdkWindow *window);

GdkWindow *__gdk_directfb_create_child_window (GdkWindow        *parent,
