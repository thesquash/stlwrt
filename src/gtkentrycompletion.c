...
gtk_entry_completion_init (GtkEntryCompletion *completion)
{
  ...
  priv = completion->priv = gtk_entry_completion_get_instance_private (completion);
  ...
  __gtk_tree_view_set_headers_visible (GTK_TREE_VIEW (priv->tree_view), FALSE);
  __gtk_tree_view_set_hover_selection (GTK_TREE_VIEW (priv->tree_view), TRUE);

  sel = __gtk_tree_view_get_selection (GTK_TREE_VIEW (priv->tree_view));
  __gtk_tree_selection_set_mode (sel, GTK_SELECTION_SINGLE);
  __gtk_tree_selection_unselect_all (sel);
  ...
  priv->action_view =
    __gtk_tree_view_new_with_model (GTK_TREE_MODEL (priv->actions));
  ...
  g_signal_connect (priv->action_view, "motion-notify-event",
		    G_CALLBACK (gtk_entry_completion_list_motion_notify),
		    completion);
  __gtk_tree_view_set_headers_visible (GTK_TREE_VIEW (priv->action_view), FALSE);
  __gtk_tree_view_set_hover_selection (GTK_TREE_VIEW (priv->action_view), TRUE);

  sel = __gtk_tree_view_get_selection (GTK_TREE_VIEW (priv->action_view));
  __gtk_tree_selection_set_mode (sel, GTK_SELECTION_SINGLE);
  __gtk_tree_selection_unselect_all (sel);

  cell = __gtk_cell_renderer_text_new ();
  __gtk_tree_view_insert_column_with_data_func (GTK_TREE_VIEW (priv->action_view),
                                              0, "",
                                              cell,
  ...
  popup_frame = __gtk_frame_new (NULL);
  __gtk_frame_set_shadow_type (GTK_FRAME (popup_frame),
			     GTK_SHADOW_ETCHED_IN);
  __gtk_widget_show (popup_frame);
  __gtk_container_add (GTK_CONTAINER (priv->popup_window), popup_frame);
  
  priv->vbox = __gtk_vbox_new (FALSE, 0);
  __gtk_container_add (GTK_CONTAINER (popup_frame), priv->vbox);

  __gtk_container_add (GTK_CONTAINER (priv->scrolled_window), priv->tree_view);
  __gtk_box_pack_start (GTK_BOX (priv->vbox), priv->scrolled_window,
                      TRUE, TRUE, 0);
                                   ...
                                   GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
      case PROP_MODEL:
        __gtk_entry_completion_set_model (completion,
                                        g_value_get_object (value));
        break;

      case PROP_MINIMUM_KEY_LENGTH:
        __gtk_entry_completion_set_minimum_key_length (completion,
  ...
  switch (prop_id)
    {
      case PROP_MODEL:
        g_value_set_object (value,
                            __gtk_entry_completion_get_model (completion));
        break;

      case PROP_MINIMUM_KEY_LENGTH:
        g_value_set_int (value, __gtk_entry_completion_get_minimum_key_length (completion));
        break;

      case PROP_TEXT_COLUMN:
        g_value_set_int (value, __gtk_entry_completion_get_text_column (completion));
        break;

      case PROP_INLINE_COMPLETION:
        g_value_set_boolean (value, __gtk_entry_completion_get_inline_completion (completion));
        break;

      case PROP_POPUP_COMPLETION:
        g_value_set_boolean (value, __gtk_entry_completion_get_popup_completion (completion));
        break;

      case PROP_POPUP_SET_WIDTH:
        g_value_set_boolean (value, __gtk_entry_completion_get_popup_set_width (completion));
        break;

      case PROP_POPUP_SINGLE_MATCH:
        g_value_set_boolean (value, __gtk_entry_completion_get_popup_single_match (completion));
        break;

      case PROP_INLINE_SELECTION:
        g_value_set_boolean (value, __gtk_entry_completion_get_inline_selection (completion));
        break;
...
gtk_entry_completion_finalize (GObject *object)
{
  ...
  if (priv->entry)
    __gtk_entry_set_completion (GTK_ENTRY (priv->entry), NULL);
                                 ...
                                 gboolean         expand)
{
  ...
  priv = gtk_entry_completion_get_instance_private (cell_layout);
                                    ...
                                    gint             column)
{
  ...
  __gtk_tree_view_column_add_attribute (priv->column, cell, attribute, column);
}
                                         ...
                                         GDestroyNotify          destroy)
{
  ...
  __gtk_cell_layout_set_cell_data_func (GTK_CELL_LAYOUT (priv->column),
                                       ...
                                       GtkCellRenderer *cell)
{
  ...
  __gtk_tree_view_column_clear_attributes (priv->column, cell);
}
                              ...
                              gint             position)
{
  ...
  __gtk_cell_layout_reorder (GTK_CELL_LAYOUT (priv->column), cell, position);
}
...
gtk_entry_completion_get_cells (GtkCellLayout *cell_layout)
{
  ...
  return __gtk_cell_layout_get_cells (GTK_CELL_LAYOUT (priv->column));
}
                                              ...
                                              gpointer            user_data)
{
  ...
  model = __gtk_tree_model_filter_get_model (completion->priv->filter_model);

  g_return_val_if_fail (__gtk_tree_model_get_column_type (model, completion->priv->text_column) == G_TYPE_STRING, 
			FALSE);
                                      ...
                                      gpointer     user_data)
{
  ...
  __gtk_widget_event (completion->priv->entry, (GdkEvent *)event);
                                        ...
                                        gpointer        user_data)
{
  ...
  if (__gtk_tree_view_get_path_at_pos (GTK_TREE_VIEW (widget),
                                     ...
                                     &path, NULL, NULL, NULL))
    {
      ...
      __gtk_tree_model_get_iter (GTK_TREE_MODEL (completion->priv->filter_model),
                               &iter, path);
      __gtk_tree_path_free (path);
      __gtk_tree_model_filter_convert_iter_to_child_iter (completion->priv->filter_model,
                                                        &child_iter,
                                                        &iter);
      model = __gtk_tree_model_filter_get_model (completion->priv->filter_model);
  ...
  if (__gtk_tree_view_get_path_at_pos (GTK_TREE_VIEW (widget),
                                     ...
                                     &path, NULL, NULL, NULL))
    {
      g_signal_emit (completion, entry_completion_signals[ACTION_ACTIVATED],
                     0, __gtk_tree_path_get_indices (path)[0]);
      __gtk_tree_path_free (path);
  ...
  if (completion->priv->first_sel_changed)
    {
      ...
      if (__gtk_widget_is_focus (completion->priv->tree_view))
 ...
 */
GtkEntryCompletion *
__gtk_entry_completion_new (void)
{
...
/**
 * __gtk_entry_completion_get_entry:
 ...
 */
GtkWidget *
__gtk_entry_completion_get_entry (GtkEntryCompletion *completion)
{
...
/**
 * __gtk_entry_completion_set_model:
 * @completion: A #GtkEntryCompletion.
 ...
 */
void
__gtk_entry_completion_set_model (GtkEntryCompletion *completion,
                                GtkTreeModel       *model)
{
  ...
  if (!model)
    {
      __gtk_tree_view_set_model (GTK_TREE_VIEW (completion->priv->tree_view),
			       NULL);
      _gtk_entry_completion_popdown (completion);
  ...
  completion->priv->filter_model =
    GTK_TREE_MODEL_FILTER (__gtk_tree_model_filter_new (model, NULL));
  __gtk_tree_model_filter_set_visible_func (completion->priv->filter_model,
...
/**
 * __gtk_entry_completion_get_model:
 * @completion: A #GtkEntryCompletion.
 *
 ...
 */
GtkTreeModel *
__gtk_entry_completion_get_model (GtkEntryCompletion *completion)
{
  g_return_val_if_fail (GTK_IS_ENTRY_COMPLETION (completion), NULL);
  ...
  return __gtk_tree_model_filter_get_model (completion->priv->filter_model);
}

/**
 * __gtk_entry_completion_set_match_func:
 * @completion: A #GtkEntryCompletion.
 ...
 */
void
__gtk_entry_completion_set_match_func (GtkEntryCompletion          *completion,
...
/**
 * __gtk_entry_completion_set_minimum_key_length:
 * @completion: A #GtkEntryCompletion.
 ...
 */
void
__gtk_entry_completion_set_minimum_key_length (GtkEntryCompletion *completion,
                                             gint                length)
{
  g_return_if_fail (GTK_IS_ENTRY_COMPLETION (completion));
...
/**
 * __gtk_entry_completion_get_minimum_key_length:
 * @completion: A #GtkEntryCompletion.
 *
 ...
 */
gint
__gtk_entry_completion_get_minimum_key_length (GtkEntryCompletion *completion)
{
...
/**
 * __gtk_entry_completion_complete:
 * @completion: A #GtkEntryCompletion.
 *
 ...
 */
void
__gtk_entry_completion_complete (GtkEntryCompletion *completion)
{
  gchar *tmp;
  ...
  tmp = g_utf8_normalize (__gtk_entry_get_text (GTK_ENTRY (completion->priv->entry)),
                          -1, G_NORMALIZE_ALL);
  completion->priv->case_normalized_key = g_utf8_casefold (tmp, -1);
  g_free (tmp);

  __gtk_tree_model_filter_refilter (completion->priv->filter_model);
                                    ...
                                    gboolean            markup)
{
  ...
  __gtk_list_store_insert (completion->priv->actions, &iter, index);
  __gtk_list_store_set (completion->priv->actions, &iter,
                      0, string,
                      1, markup,
                      -1);
  ...
  if (!gtk_widget_get_props (completion->priv->action_view)->parent)
    {
      ...
      __gtk_box_pack_start (GTK_BOX (completion->priv->vbox),
                          completion->priv->action_view, FALSE, FALSE, 0);
      __gtk_widget_show (completion->priv->action_view);
    }
}

/**
 * __gtk_entry_completion_insert_action_text:
 * @completion: A #GtkEntryCompletion.
 ...
 * __gtk_entry_completion_insert_action_markup().
 *
 * Since: 2.4
 */
void
__gtk_entry_completion_insert_action_text (GtkEntryCompletion *completion,
                                         gint                index_,
                                         const gchar        *text)
{
  g_return_if_fail (GTK_IS_ENTRY_COMPLETION (completion));
 ...
 */
void
__gtk_entry_completion_insert_action_markup (GtkEntryCompletion *completion,
                                           gint                index_,
                                           const gchar        *markup)
{
  g_return_if_fail (GTK_IS_ENTRY_COMPLETION (completion));
...
/**
 * __gtk_entry_completion_delete_action:
 * @completion: A #GtkEntryCompletion.
 ...
 */
void
__gtk_entry_completion_delete_action (GtkEntryCompletion *completion,
                                    gint                index_)
{
  GtkTreeIter iter;
  ...
  __gtk_tree_model_iter_nth_child (GTK_TREE_MODEL (completion->priv->actions),
                                 &iter, NULL, index_);
  __gtk_list_store_remove (completion->priv->actions, &iter);
}

/**
 * __gtk_entry_completion_set_text_column:
 * @completion: A #GtkEntryCompletion.
 ...
 */
void
__gtk_entry_completion_set_text_column (GtkEntryCompletion *completion,
                                      gint                column)
{
  GtkCellRenderer *cell;
  ...
  cell = __gtk_cell_renderer_text_new ();
  __gtk_cell_layout_pack_start (GTK_CELL_LAYOUT (completion),
                              cell, TRUE);
  __gtk_cell_layout_add_attribute (GTK_CELL_LAYOUT (completion),
                                 cell,
                                 "text", column);
...
/**
 * __gtk_entry_completion_get_text_column:
 * @completion: a #GtkEntryCompletion
 * 
 ...
 **/
gint
__gtk_entry_completion_get_text_column (GtkEntryCompletion *completion)
{
...
_gtk_entry_completion_resize_popup (GtkEntryCompletion *completion)
{
  ...
  action_column  = __gtk_tree_view_get_column (GTK_TREE_VIEW (completion->priv->action_view), 0);

  __gtk_tree_view_column_cell_get_size (completion->priv->column, NULL,
                                      NULL, NULL, NULL, &height);
  __gtk_tree_view_column_cell_get_size (action_column, NULL,
                                      NULL, NULL, NULL, &action_height);

  __gtk_widget_style_get (GTK_WIDGET (completion->priv->tree_view),
                        "vertical-separator", &vertical_separator,
                        NULL);

  height += vertical_separator;
  
  __gtk_widget_realize (completion->priv->tree_view);
  ...
  if (items <= 0)
    __gtk_widget_hide (completion->priv->scrolled_window);
  else
  ...
  __gtk_tree_view_columns_autosize (GTK_TREE_VIEW (completion->priv->tree_view));
  __gtk_widget_set_size_request (completion->priv->tree_view, width, items * height);

  if (actions)
    {
      __gtk_widget_show (completion->priv->action_view);
      __gtk_widget_set_size_request (completion->priv->action_view, width, -1);
    }
  else
    __gtk_widget_hide (completion->priv->action_view);

  __gtk_widget_size_request (completion->priv->popup_window, &popup_req);
  __gtk_widget_size_request (completion->priv->entry, &entry_req);
  ...
  if (matches > 0) 
    {
      path = __gtk_tree_path_new_from_indices (above ? matches - 1 : 0, -1);
      __gtk_tree_view_scroll_to_cell (GTK_TREE_VIEW (completion->priv->tree_view), path, 
				    NULL, FALSE, 0.0, 0.0);
      __gtk_tree_path_free (path);
    }

  __gtk_window_move (GTK_WINDOW (completion->priv->popup_window), x, y);
...
_gtk_entry_completion_popup (GtkEntryCompletion *completion)
{
  ...
  if (!__gtk_widget_get_mapped (completion->priv->entry))
    return;

  if (!__gtk_widget_has_focus (completion->priv->entry))
    return;

  completion->priv->ignore_enter = TRUE;
    
  column = __gtk_tree_view_get_column (GTK_TREE_VIEW (completion->priv->action_view), 0);
  ...
  __gtk_widget_show_all (completion->priv->vbox);
  ...
  toplevel = __gtk_widget_get_toplevel (completion->priv->entry);
  ...
  __gtk_widget_grab_focus (completion->priv->tree_view);
  ...
  __gtk_window_set_screen (GTK_WINDOW (completion->priv->popup_window),
                         __gtk_widget_get_screen (completion->priv->entry));
...
_gtk_entry_completion_popdown (GtkEntryCompletion *completion)
{
  ...
  __gdk_pointer_ungrab (GDK_CURRENT_TIME);
  __gtk_grab_remove (completion->priv->popup_window);

  __gtk_widget_hide (completion->priv->popup_window);
}
				     ...
				     GtkTreeIter        *iter)
{
  ...
  __gtk_tree_model_get (model, iter, completion->priv->text_column, &str, -1);
  __gtk_entry_set_text (GTK_ENTRY (completion->priv->entry), str ? str : "");
  
  /* move cursor to the end */
  __gtk_editable_set_position (GTK_EDITABLE (completion->priv->entry), -1);
				      ...
				      const char         *key)
{
  ...
  valid = __gtk_tree_model_get_iter_first (GTK_TREE_MODEL (completion->priv->filter_model),
					 &iter);
  ...
  while (valid)
    {
      ...
      __gtk_tree_model_get (GTK_TREE_MODEL (completion->priv->filter_model),
      ...
      if (text && g_str_has_prefix (text, key))
	{
      ...
      g_free (text);
      valid = __gtk_tree_model_iter_next (GTK_TREE_MODEL (completion->priv->filter_model),
					&iter);
    }
  ...
  if (prefix)
    {
      ...
      key = __gtk_entry_get_text (GTK_ENTRY (completion->priv->entry));
      ...
      if (prefix_len > key_len)
	{
	  ...
	  __gtk_editable_insert_text (GTK_EDITABLE (completion->priv->entry),
				    prefix + strlen (key), -1, &pos);
	  __gtk_editable_select_region (GTK_EDITABLE (completion->priv->entry),
				      key_len, prefix_len);
...
/**
 * __gtk_entry_completion_get_completion_prefix:
 * @completion: a #GtkEntryCompletion
 * 
 ...
 **/
const gchar*
__gtk_entry_completion_get_completion_prefix (GtkEntryCompletion *completion)
{
  g_return_val_if_fail (GTK_IS_ENTRY_COMPLETION (completion), NULL);
					     ...
					     const gchar *text)
{
  ...
  __gtk_entry_set_text (GTK_ENTRY (priv->entry), text);

  len = strlen (priv->completion_prefix);
  __gtk_editable_select_region (GTK_EDITABLE (priv->entry), len, -1);
...
/**
 * __gtk_entry_completion_insert_prefix:
 * @completion: a #GtkEntryCompletion
 * 
...
void
__gtk_entry_completion_insert_prefix (GtkEntryCompletion *completion)
{
  gboolean done;
  gchar *prefix;
  ...
  prefix = _gtk_entry_completion_compute_prefix (completion,
						 __gtk_entry_get_text (GTK_ENTRY (completion->priv->entry)));
  if (prefix)
    {
...
/**
 * __gtk_entry_completion_set_inline_completion:
 * @completion: a #GtkEntryCompletion
 ...
 **/
void 
__gtk_entry_completion_set_inline_completion (GtkEntryCompletion *completion,
...
/**
 * __gtk_entry_completion_get_inline_completion:
 * @completion: a #GtkEntryCompletion
 * 
 ...
 **/
gboolean
__gtk_entry_completion_get_inline_completion (GtkEntryCompletion *completion)
{
...
/**
 * __gtk_entry_completion_set_popup_completion:
 * @completion: a #GtkEntryCompletion
 ...
 **/
void 
__gtk_entry_completion_set_popup_completion (GtkEntryCompletion *completion,
...
/**
 * __gtk_entry_completion_get_popup_completion:
 * @completion: a #GtkEntryCompletion
 * 
 ...
 **/
gboolean
__gtk_entry_completion_get_popup_completion (GtkEntryCompletion *completion)
{
...
/**
 * __gtk_entry_completion_set_popup_set_width:
 * @completion: a #GtkEntryCompletion
 ...
 */
void 
__gtk_entry_completion_set_popup_set_width (GtkEntryCompletion *completion,
...
/**
 * __gtk_entry_completion_get_popup_set_width:
 * @completion: a #GtkEntryCompletion
 * 
 ...
 **/
gboolean
__gtk_entry_completion_get_popup_set_width (GtkEntryCompletion *completion)
{
  g_return_val_if_fail (GTK_IS_ENTRY_COMPLETION (completion), TRUE);
...
/**
 * __gtk_entry_completion_set_popup_single_match:
 * @completion: a #GtkEntryCompletion
 ...
 */
void 
__gtk_entry_completion_set_popup_single_match (GtkEntryCompletion *completion,
...
/**
 * __gtk_entry_completion_get_popup_single_match:
 * @completion: a #GtkEntryCompletion
 * 
 ...
 **/
gboolean
__gtk_entry_completion_get_popup_single_match (GtkEntryCompletion *completion)
{
  g_return_val_if_fail (GTK_IS_ENTRY_COMPLETION (completion), TRUE);
...
/**
 * __gtk_entry_completion_set_inline_selection:
 * @completion: a #GtkEntryCompletion
 ...
 **/
void
__gtk_entry_completion_set_inline_selection (GtkEntryCompletion *completion,
...
/**
 * __gtk_entry_completion_get_inline_selection:
 * @completion: a #GtkEntryCompletion
 *
 ...
 **/
gboolean
__gtk_entry_completion_get_inline_selection (GtkEntryCompletion *completion)
{
  g_return_val_if_fail (GTK_IS_ENTRY_COMPLETION (completion), FALSE);
