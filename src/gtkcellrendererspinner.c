...
STLWRT_DEFINE_FTYPE_VPARENT (GtkCellRendererSpinner, gtk_cell_renderer_spinner, GTK_TYPE_CELL_RENDERER,
                             G_TYPE_FLAG_NONE, G_ADD_PRIVATE (GtkCellRendererSpinner))
...
/**
 * __gtk_cell_renderer_spinner_new
 *
 ...
 */
GtkCellRenderer *
__gtk_cell_renderer_spinner_new (void)
{
                                  ...
                                  guint            flags)
{
  ...
  if (!__gdk_rectangle_intersect (cell_area, &pix_rect, &draw_rect) ||
      !__gdk_rectangle_intersect (expose_area, &pix_rect, &draw_rect))
    {
      return;
    }
