...
/**
 * __gtk_clipboard_get_for_display:
 ...
 *
 * (Passing #GDK_NONE is the same as using <literal>__gdk_atom_intern
 ...
 **/
GtkClipboard *
__gtk_clipboard_get_for_display (GdkDisplay *display, 
			       GdkAtom     selection)
{
 ...
 *
 * Returns the clipboard object for the given selection.
 * See __gtk_clipboard_get_for_display() for complete details.
 *
 ...
 */
GtkClipboard *
__gtk_clipboard_get (GdkAtom selection)
{
  return __gtk_clipboard_get_for_display (__gdk_display_get_default (), selection);
}
...
selection_get_cb (GtkWidget          *widget,
		  ...
		  guint               time)
{
  GtkClipboard *clipboard = __gtk_widget_get_clipboard (widget, selection_data->selection);
...
{
  GtkClipboard *clipboard = __gtk_widget_get_clipboard (widget, event->selection);
...
make_clipboard_widget (GdkDisplay *display, 
		       gboolean    provider)
{
  GtkWidget *widget = __gtk_invisible_new_for_screen (__gdk_display_get_default_screen (display));
  ...
  if (provider)
    {
      /* We need this for __gdk_x11_get_server_time() */
      __gtk_widget_add_events (widget, GDK_PROPERTY_CHANGE_MASK);
 ...
 **/
gboolean
__gtk_clipboard_set_with_data (GtkClipboard          *clipboard,
			     const GtkTargetEntry  *targets,
			     guint                  n_targets,
			     GtkClipboardGetFunc    get_func,
			     GtkClipboardClearFunc  clear_func,
...
/**
 * __gtk_clipboard_set_with_owner:
 * @clipboard:  a #GtkClipboard
 * @targets:    array containing information about the available forms for the
 *              clipboard data
 * @n_targets:  number of elements in @targets
 ...
 * to call to get the actual data when it is requested.
 *
 * The difference between this function and __gtk_clipboard_set_with_data()
 ...
 **/
gboolean
__gtk_clipboard_set_with_owner (GtkClipboard          *clipboard,
			      const GtkTargetEntry  *targets,
			      guint                  n_targets,
			      GtkClipboardGetFunc    get_func,
			      GtkClipboardClearFunc  clear_func,
...
/**
 * __gtk_clipboard_get_owner:
 * @clipboard: a #GtkClipboard
 * 
 * If the clipboard contents callbacks were set with 
 * __gtk_clipboard_set_with_owner(), and the __gtk_clipboard_set_with_data() or 
 * __gtk_clipboard_clear() has not subsequently called, returns the owner set 
 * by __gtk_clipboard_set_with_owner().
 * 
 * Return value: (transfer none): the owner of the clipboard, if any; otherwise %NULL.
 **/
GObject *
__gtk_clipboard_get_owner (GtkClipboard *clipboard)
{
...
/**
 * __gtk_clipboard_clear:
 * @clipboard:  a #GtkClipboard
 * 
 * Clears the contents of the clipboard. Generally this should only
 * be called between the time you call __gtk_clipboard_set_with_owner()
 * or __gtk_clipboard_set_with_data(),
 * and when the @clear_func you supplied is called. Otherwise, the
 * clipboard may be owned by someone else.
 **/
void
__gtk_clipboard_clear (GtkClipboard *clipboard)
{
  g_return_if_fail (clipboard != NULL);

  if (clipboard->have_selection)
    __gtk_selection_owner_set_for_display (clipboard->display, 
					 NULL,
					 clipboard->selection,
					 clipboard_get_timestamp (clipboard));
}
...
text_get_func (GtkClipboard     *clipboard,
	       ...
	       gpointer          data)
{
  __gtk_selection_data_set_text (selection_data, data, -1);
}
 ...
 **/
void 
__gtk_clipboard_set_text (GtkClipboard *clipboard,
			const gchar  *text,
			gint          len)
{
  GtkTargetList *list;
  ...
  __gtk_clipboard_set_with_data (clipboard, 
			       targets, n_targets,
			       text_get_func, text_clear_func,
			       g_strndup (text, len));
  __gtk_clipboard_set_can_store (clipboard, NULL, 0);
...
pixbuf_get_func (GtkClipboard     *clipboard,
		 ...
		 gpointer          data)
{
  __gtk_selection_data_set_pixbuf (selection_data, data);
}
 ...
 **/
void
__gtk_clipboard_set_image (GtkClipboard *clipboard,
			  GdkPixbuf    *pixbuf)
{
  GtkTargetList *list;
  GtkTargetEntry *targets;
  ...
  list = __gtk_target_list_new (NULL, 0);
  __gtk_target_list_add_image_targets (list, 0, TRUE);
		    ...
		    guint                 time)
{
  ...
  request_info->callback (__gtk_widget_get_clipboard (widget, selection_data->selection), 
			  selection_data,
			  request_info->user_data);

  g_free (request_info);

  if (widget != get_clipboard_widget (__gtk_widget_get_display (widget)))
    __gtk_widget_destroy (widget);
}

/**
 * __gtk_clipboard_request_contents:
 * @clipboard: a #GtkClipboard
 ...
 **/
void 
__gtk_clipboard_request_contents (GtkClipboard            *clipboard,
				GdkAtom                  target,
				GtkClipboardReceivedFunc callback,
				gpointer                 user_data)
{
			    ...
			    gpointer          data)
{
  ...
  result = (gchar *) __gtk_selection_data_get_text (selection_data);
  ...
  if (!result)
    {
       ...
       */
      if (selection_data->target == __gdk_atom_intern_static_string ("UTF8_STRING"))
	{
	  __gtk_clipboard_request_contents (clipboard,
					  __gdk_atom_intern_static_string ("COMPOUND_TEXT"), 
					  request_text_received_func, info);
	  return;
	}
      else if (selection_data->target == __gdk_atom_intern_static_string ("COMPOUND_TEXT"))
	{
	  __gtk_clipboard_request_contents (clipboard,
					  GDK_TARGET_STRING, 
					  request_text_received_func, info);
 ...
 **/
void 
__gtk_clipboard_request_text (GtkClipboard                *clipboard,
			    GtkClipboardTextReceivedFunc callback,
			    gpointer                     user_data)
{
  ...
  __gtk_clipboard_request_contents (clipboard, __gdk_atom_intern_static_string ("UTF8_STRING"),
                                 ...
                                 gpointer          data)
{
  ...
  if ((!result || length < 1) && (info->current_atom < info->n_atoms))
    {
      __gtk_clipboard_request_contents (clipboard, info->atoms[info->current_atom],
...
/**
 * __gtk_clipboard_request_rich_text:
 * @clipboard: a #GtkClipboard
 ...
 **/
void
__gtk_clipboard_request_rich_text (GtkClipboard                    *clipboard,
                                 ...
                                 gpointer                         user_data)
{
  ...
  info->atoms = __gtk_text_buffer_get_deserialize_formats (buffer, &info->n_atoms);
			     ...
			     gpointer          data)
{
  ...
  result = __gtk_selection_data_get_pixbuf (selection_data);
  ...
  if (!result)
    {
       ...
       * If we asked for anything else and didn't get it, give up.
       */
      if (selection_data->target == __gdk_atom_intern_static_string ("image/png"))
	{
	  __gtk_clipboard_request_contents (clipboard,
					  __gdk_atom_intern_static_string ("image/jpeg"), 
					  request_image_received_func, info);
	  return;
	}
      else if (selection_data->target == __gdk_atom_intern_static_string ("image/jpeg"))
	{
	  __gtk_clipboard_request_contents (clipboard,
					  __gdk_atom_intern_static_string ("image/gif"), 
					  request_image_received_func, info);
	  return;
	}
      else if (selection_data->target == __gdk_atom_intern_static_string ("image/gif"))
	{
	  __gtk_clipboard_request_contents (clipboard,
					  __gdk_atom_intern_static_string ("image/bmp"), 
					  request_image_received_func, info);
	  return;
	}
    }
 ...
 **/
void 
__gtk_clipboard_request_image (GtkClipboard                  *clipboard,
			     GtkClipboardImageReceivedFunc  callback,
			     gpointer                       user_data)
{
  ...
  __gtk_clipboard_request_contents (clipboard, 
				  __gdk_atom_intern_static_string ("image/png"),
 ...
 **/
void 
__gtk_clipboard_request_uris (GtkClipboard                *clipboard,
			    GtkClipboardURIReceivedFunc  callback,
			    gpointer                     user_data)
{
  RequestURIInfo *info;
  ...
  __gtk_clipboard_request_contents (clipboard, __gdk_atom_intern_static_string ("text/uri-list"),
			       ...
			       gpointer          data)
{
  ...
  __gtk_selection_data_get_targets (selection_data, &targets, &n_targets);
...
/**
 * __gtk_clipboard_request_targets:
 * @clipboard: a #GtkClipboard
 ...
 **/
void 
__gtk_clipboard_request_targets (GtkClipboard                *clipboard,
			       GtkClipboardTargetsReceivedFunc callback,
			       gpointer                     user_data)
{
  ...
  if (__gdk_display_supports_selection_notification (__gtk_clipboard_get_display (clipboard)) &&
      clipboard->n_cached_targets != -1)
    {
  ...
  __gtk_clipboard_request_contents (clipboard, __gdk_atom_intern_static_string ("TARGETS"),
			 ...
			 gpointer          data)
{
  ...
  if (selection_data->length >= 0)
    results->data = __gtk_selection_data_copy (selection_data);
  
  g_main_loop_quit (results->loop);
}

/**
 * __gtk_clipboard_wait_for_contents:
 * @clipboard: a #GtkClipboard
 * @target: an atom representing the form into which the clipboard
 *          owner should convert the selection.
 * 
 ...
 *               this value must be freed with __gtk_selection_data_free() 
 *               when you are finished with it.
 **/
GtkSelectionData *
__gtk_clipboard_wait_for_contents (GtkClipboard *clipboard,
				 GdkAtom       target)
{
  WaitResults results;
  ...
  __gtk_clipboard_request_contents (clipboard, target, 
 ...
 **/
gchar *
__gtk_clipboard_wait_for_text (GtkClipboard *clipboard)
{
  WaitResults results;
...
/**
 * __gtk_clipboard_wait_for_rich_text:
 * @clipboard: a #GtkClipboard
 * @buffer: a #GtkTextBuffer
 ...
 **/
guint8 *
__gtk_clipboard_wait_for_rich_text (GtkClipboard  *clipboard,
                                  GtkTextBuffer *buffer,
                                  GdkAtom       *format,
                                  gsize         *length)
{
  ...
  __gtk_clipboard_request_rich_text (clipboard, buffer,
...
/**
 * __gtk_clipboard_wait_for_image:
 * @clipboard: a #GtkClipboard
 * 
 ...
 **/
GdkPixbuf *
__gtk_clipboard_wait_for_image (GtkClipboard *clipboard)
{
  WaitResults results;
  ...
  __gtk_clipboard_request_image (clipboard,
 ...
 **/
gchar **
__gtk_clipboard_wait_for_uris (GtkClipboard *clipboard)
{
  WaitResults results;
  ...
  __gtk_clipboard_request_uris (clipboard,
 ...
 **/
GdkDisplay *
__gtk_clipboard_get_display (GtkClipboard *clipboard)
{
  g_return_val_if_fail (clipboard != NULL, NULL);
...
/**
 * __gtk_clipboard_wait_is_text_available:
 * @clipboard: a #GtkClipboard
 * 
 ...
 * __gtk_clipboard_wait_for_text() since it doesn't need to retrieve
 * the actual text.
 * 
 * Return value: %TRUE is there is text available, %FALSE otherwise.
 **/
gboolean
__gtk_clipboard_wait_is_text_available (GtkClipboard *clipboard)
{
  GtkSelectionData *data;
  gboolean result = FALSE;

  data = __gtk_clipboard_wait_for_contents (clipboard, __gdk_atom_intern_static_string ("TARGETS"));
  if (data)
    {
      result = __gtk_selection_data_targets_include_text (data);
      __gtk_selection_data_free (data);
    }
...
/**
 * __gtk_clipboard_wait_is_rich_text_available:
 * @clipboard: a #GtkClipboard
 * @buffer: a #GtkTextBuffer
 *
 ...
 *
 * This function is a little faster than calling
 * __gtk_clipboard_wait_for_rich_text() since it doesn't need to retrieve
 * the actual text.
 *
 ...
 **/
gboolean
__gtk_clipboard_wait_is_rich_text_available (GtkClipboard  *clipboard,
                                           GtkTextBuffer *buffer)
{
  GtkSelectionData *data;
  gboolean result = FALSE;
  ...
  if (data)
    {
      result = __gtk_selection_data_targets_include_rich_text (data, buffer);
      __gtk_selection_data_free (data);
    }
...
/**
 * __gtk_clipboard_wait_is_image_available:
 * @clipboard: a #GtkClipboard
 * 
 ...
 *
 * This function is a little faster than calling
 * __gtk_clipboard_wait_for_image() since it doesn't need to retrieve
 ...
 **/
gboolean
__gtk_clipboard_wait_is_image_available (GtkClipboard *clipboard)
{
  GtkSelectionData *data;
  gboolean result = FALSE;

  data = __gtk_clipboard_wait_for_contents (clipboard, 
					  __gdk_atom_intern_static_string ("TARGETS"));
  if (data)
    {
      result = __gtk_selection_data_targets_include_image (data, FALSE);
      __gtk_selection_data_free (data);
    }
...
/**
 * __gtk_clipboard_wait_is_uris_available:
 * @clipboard: a #GtkClipboard
 * 
 ...
 *
 * This function is a little faster than calling
 * __gtk_clipboard_wait_for_uris() since it doesn't need to retrieve
 * the actual URI data.
 * 
 ...
 **/
gboolean
__gtk_clipboard_wait_is_uris_available (GtkClipboard *clipboard)
{
  GtkSelectionData *data;
  gboolean result = FALSE;
  ...
  if (data)
    {
      result = __gtk_selection_data_targets_include_uri (data);
      __gtk_selection_data_free (data);
    }
...
/**
 * __gtk_clipboard_wait_for_targets
 * @clipboard: a #GtkClipboard
 ...
 */
gboolean
__gtk_clipboard_wait_for_targets (GtkClipboard  *clipboard, 
				GdkAtom      **targets,
				gint          *n_targets)
{
  GtkSelectionData *data;
  ...
  if (data)
    {
      ...
      result = __gtk_selection_data_get_targets (data, &tmp_targets, &tmp_n_targets);
  ...
  if (!tmp_list && !only_if_exists)
    {
      ...
      __gdk_display_request_selection_notification (display, selection);
    }
...
/**
 * __gtk_clipboard_wait_is_target_available:
 * @clipboard: a #GtkClipboard
 ...
 * __gtk_clipboard_wait_is_text_available () instead.
 *
 ...
 */
gboolean
__gtk_clipboard_wait_is_target_available (GtkClipboard *clipboard,
					GdkAtom       target)
{
  GdkAtom *targets;
  gint i, n_targets;
  ...
  if (!__gtk_clipboard_wait_for_targets (clipboard, &targets, &n_targets))
    return FALSE;
...
/**
 * ______gtk_clipboard_handle_event:
 ...
 **/
void 
______gtk_clipboard_handle_event (GdkEventOwnerChange *event)
{
  GdkDisplay *display;
  GtkClipboard *clipboard;
  
  display = __gdk_window_get_display (event->window);
...
static gboolean
__gtk_clipboard_store_timeout (GtkClipboard *clipboard)
{
  g_main_loop_quit (clipboard->store_loop);
 ...
 * application exits or when __gtk_clipboard_store () is called.
 *
 * This value is reset when the clipboard owner changes.
 * Where the clipboard data is stored is platform dependent,
 * see __gdk_display_store_clipboard () for more information.
 * 
 * Since: 2.6
 */
void
__gtk_clipboard_set_can_store (GtkClipboard         *clipboard,
 			     const GtkTargetEntry *targets,
 			     gint                  n_targets)
{
  GtkWidget *clipboard_widget;
...
gtk_clipboard_selection_notify (GtkWidget         *widget,
				...
				GtkClipboard      *clipboard)
{
  if (event->selection == __gdk_atom_intern_static_string ("CLIPBOARD_MANAGER") &&
 ...
 */
void
__gtk_clipboard_store (GtkClipboard *clipboard)
{
  GtkWidget *clipboard_widget;
 ...
 */
void
______gtk_clipboard_store_all (void)
{
  GtkClipboard *clipboard;
  ...
  while (list)
    {
      ...
      if (clipboard)
	__gtk_clipboard_store (clipboard);
