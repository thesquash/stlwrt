...
#include <gtkaccellabel.h> /* For ___gtk_accel_label_class_get_accelerator_label */
#include <gtkaccelmap.h>
#include <gtkintl.h>
#include <gtkmain.h>		/* For ___gtk_boolean_handled_accumulator */
...
gtk_accel_group_finalize (GObject *object)
{
  ...
  for (i = 0; i < accel_group->n_accels; i++)
      ...
      if (entry->accel_path_quark)
	{
	  ...
	  ___gtk_accel_map_remove_group (accel_path, accel_group);
	}
...
void
___gtk_accel_group_attach (GtkAccelGroup *accel_group,
			 GObject       *object)
{
  GSList *slist;
...
void
___gtk_accel_group_detach (GtkAccelGroup *accel_group,
			 GObject       *object)
{
  GSList *slist;
		 ...
		 GQuark          path_quark)
{
  ...
  if (path_quark)
    ___gtk_accel_map_add_group (g_quark_to_string (path_quark), accel_group);
                    ...
                    guint               pos)
{
  ...
  if (entry->accel_path_quark)
    ___gtk_accel_map_remove_group (g_quark_to_string (entry->accel_path_quark), accel_group);
...
void
___gtk_accel_group_reconnect (GtkAccelGroup *accel_group,
			   ...
			   GdkModifierType accelerator_mods)
{
  ...
  label = ___gtk_accel_label_class_get_accelerator_label (klass, 
							accelerator_key, 
							accelerator_mods);
