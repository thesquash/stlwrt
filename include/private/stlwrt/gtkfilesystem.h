...
#define GTK_TYPE_FILE_SYSTEM         (___gtk_file_system_get_type ())
...
#define GTK_TYPE_FOLDER         (___gtk_folder_get_type ())
...
GType           ___gtk_file_system_get_type     (void) G_GNUC_CONST;
