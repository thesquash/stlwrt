...
STLWRT_DEFINE_FTYPE (GtkTextMark, gtk_text_mark, G_TYPE_OBJECT, G_TYPE_FLAG_NONE, ;)
			    ...
			    GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_NAME:
      g_value_set_string (value, __gtk_text_mark_get_name (mark));
      break;

    case PROP_LEFT_GRAVITY:
      g_value_set_boolean (value, __gtk_text_mark_get_left_gravity (mark));
      break;
 ...
 *
 * Creates a text mark. Add it to a buffer using __gtk_text_buffer_add_mark().
 * If @name is %NULL, the mark is anonymous; otherwise, the mark can be 
 * retrieved by name using __gtk_text_buffer_get_mark(). If a mark has left 
 ...
 **/
GtkTextMark *
__gtk_text_mark_new (const gchar *name,
 ...
 **/
gboolean
__gtk_text_mark_get_visible (GtkTextMark *mark)
{
  GtkTextLineSegment *seg;
 ...
 **/
const char *
__gtk_text_mark_get_name (GtkTextMark *mark)
{
  GtkTextLineSegment *seg;
...
/**
 * __gtk_text_mark_get_deleted:
 * @mark: a #GtkTextMark
 * 
 * Returns %TRUE if the mark has been removed from its buffer
 * with __gtk_text_buffer_delete_mark(). See __gtk_text_buffer_add_mark()
 * for a way to add it to a buffer again.
 * 
 * Return value: whether the mark is deleted
 **/
gboolean
__gtk_text_mark_get_deleted (GtkTextMark *mark)
{
  GtkTextLineSegment *seg;
 ...
 **/
GtkTextBuffer*
__gtk_text_mark_get_buffer (GtkTextMark *mark)
{
  GtkTextLineSegment *seg;
...
/**
 * __gtk_text_mark_get_left_gravity:
 * @mark: a #GtkTextMark
 * 
 ...
 **/
gboolean
__gtk_text_mark_get_left_gravity (GtkTextMark *mark)
{
  GtkTextLineSegment *seg;
