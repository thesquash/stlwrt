 ...
 **/
cairo_t *
__gdk_cairo_create (GdkDrawable *drawable)
{
...
/**
 * __gdk_cairo_reset_clip:
 * @cr: a #cairo_t
 * @drawable: a #GdkDrawable
 *
 * Resets the clip region for a Cairo context created by __gdk_cairo_create((GdkDrawable *) ().)
 *
 ...
 * using __gdk_cairo_create((GdkDrawable *) () each time they want to draw something.)
 *
 * Since: 2.18
 **/
void
__gdk_cairo_reset_clip (cairo_t            *cr,
 ...
 **/
void
__gdk_cairo_set_source_color (cairo_t        *cr,
 ...
 **/
void
__gdk_cairo_rectangle (cairo_t            *cr,
 ...
 **/
void
__gdk_cairo_set_source_pixbuf (cairo_t         *cr,
 ...
 *     with #GdkPixmap). Instead, use __gdk_cairo_set_source_window() where
 *     appropriate.
 **/
void
__gdk_cairo_set_source_pixmap (cairo_t   *cr,
			     GdkPixmap *pixmap,
			     double     pixmap_x,
			     double     pixmap_y)
{
 ...
 **/
void
__gdk_cairo_set_source_window (cairo_t   *cr,
                             GdkWindow *window,
                             double     x,
                             double     y)
{
