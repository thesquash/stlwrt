...
GtkTextBTree*
___gtk_text_buffer_get_btree (GtkTextBuffer *buffer)
{
			   ...
			   gboolean       default_editable)
{
  ...
  attrs = ___gtk_text_buffer_get_line_log_attrs (buffer, &start, NULL);
 ...
 */
const PangoLogAttr*
___gtk_text_buffer_get_line_log_attrs (GtkTextBuffer     *buffer,
...
void
___gtk_text_buffer_notify_will_remove_tag (GtkTextBuffer *buffer,
                                         GtkTextTag    *tag)
{
...
void
___gtk_text_buffer_spew (GtkTextBuffer *buffer)
{
