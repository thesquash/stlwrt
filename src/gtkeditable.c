  ...
  if (! initialized)
    {
      ...
      g_signal_new (I_("insert-text"),
		    GTK_TYPE_EDITABLE,
		    G_SIGNAL_RUN_LAST,
		    G_STRUCT_OFFSET (GtkEditableIface, insert_text),
		    NULL, NULL,
		    NULL,
		    G_TYPE_NONE, 3,
		    G_TYPE_STRING,
       ...
       * __gtk_editable_delete_text().
       */
      g_signal_new (I_("delete-text"),
		    GTK_TYPE_EDITABLE,
		    G_SIGNAL_RUN_LAST,
		    G_STRUCT_OFFSET (GtkEditableIface, delete_text),
		    NULL, NULL,
		    NULL,
		    G_TYPE_NONE, 2,
		    G_TYPE_INT,
      ...
      g_signal_new (I_("changed"),
		    GTK_TYPE_EDITABLE,
		    G_SIGNAL_RUN_LAST,
		    G_STRUCT_OFFSET (GtkEditableIface, changed),
		    NULL, NULL,
		    NULL,
		    G_TYPE_NONE, 0);
 ...
 */
void
__gtk_editable_insert_text (GtkEditable *editable,
 ...
 */
void
__gtk_editable_delete_text (GtkEditable *editable,
			  gint         start_pos,
			  gint         end_pos)
{
  g_return_if_fail (GTK_IS_EDITABLE (editable));
 ...
 */
gchar *    
__gtk_editable_get_chars (GtkEditable *editable,
			gint         start_pos,
			gint         end_pos)
{
 ...
 */
void
__gtk_editable_set_position (GtkEditable      *editable,
			   gint              position)
{
  g_return_if_fail (GTK_IS_EDITABLE (editable));
 ...
 */
gint
__gtk_editable_get_position (GtkEditable *editable)
{
...
/**
 * __gtk_editable_get_selection_bounds:
 * @editable: a #GtkEditable
 ...
 */
gboolean
__gtk_editable_get_selection_bounds (GtkEditable *editable,
				   gint        *start_pos,
				   gint        *end_pos)
{
...
/**
 * __gtk_editable_delete_selection:
 * @editable: a #GtkEditable
 *
 ...
 */
void
__gtk_editable_delete_selection (GtkEditable *editable)
{
  gint start, end;
 ...
 */
void
__gtk_editable_select_region (GtkEditable *editable,
			    gint         start_pos,
			    gint         end_pos)
{
  g_return_if_fail (GTK_IS_EDITABLE (editable));
 ...
 */
void
__gtk_editable_cut_clipboard (GtkEditable *editable)
{
  g_return_if_fail (GTK_IS_EDITABLE (editable));
 ...
 */
void
__gtk_editable_copy_clipboard (GtkEditable *editable)
{
  g_return_if_fail (GTK_IS_EDITABLE (editable));
...
/**
 * __gtk_editable_paste_clipboard:
 * @editable: a #GtkEditable
 *
 ...
 */
void
__gtk_editable_paste_clipboard (GtkEditable *editable)
{
  g_return_if_fail (GTK_IS_EDITABLE (editable));
 ...
 */
void
__gtk_editable_set_editable (GtkEditable    *editable,
 ...
 */
gboolean
__gtk_editable_get_editable (GtkEditable *editable)
{
  gboolean value;
