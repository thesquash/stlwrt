...
/**
 * __gtk_recent_filter_new:
 *
 * Creates a new #GtkRecentFilter with no rules added to it.
 * Such filter does not accept any recently used resources, so is not
 * particularly useful until you add rules with
 * __gtk_recent_filter_add_pattern(), __gtk_recent_filter_add_mime_type(),
 * __gtk_recent_filter_add_application(), __gtk_recent_filter_add_age().
 * To create a filter that accepts any recently used resource, use:
 * |[
 * GtkRecentFilter *filter = __gtk_recent_filter_new ();
 * __gtk_recent_filter_add_pattern (filter, "*");
 * ]|
 *
 ...
 */
GtkRecentFilter *
__gtk_recent_filter_new (void)
{
  return g_object_new (GTK_TYPE_RECENT_FILTER, NULL);
}

/**
 * __gtk_recent_filter_set_name:
 ...
 */
void
__gtk_recent_filter_set_name (GtkRecentFilter *filter,
			    const gchar     *name)
{
...
/**
 * __gtk_recent_filter_get_name:
 * @filter: a #GtkRecentFilter
 *
 * Gets the human-readable name for the filter.
 * See __gtk_recent_filter_set_name().
 *
 ...
 */
const gchar *
__gtk_recent_filter_get_name (GtkRecentFilter *filter)
{
...
/**
 * __gtk_recent_filter_get_needed:
 * @filter: a #GtkRecentFilter
 *
 * Gets the fields that need to be filled in for the structure
 * passed to __gtk_recent_filter_filter()
 * 
 ...
 *   calling __gtk_recent_filter_filter()
 *
 * Since: 2.10
 */
GtkRecentFilterFlags
__gtk_recent_filter_get_needed (GtkRecentFilter *filter)
{
...
/**
 * __gtk_recent_filter_add_mime_type:
 * @filter: a #GtkRecentFilter
 ...
 */
void
__gtk_recent_filter_add_mime_type (GtkRecentFilter *filter,
...
/**
 * __gtk_recent_filter_add_pattern:
 * @filter: a #GtkRecentFilter
 ...
 */
void
__gtk_recent_filter_add_pattern (GtkRecentFilter *filter,
			       const gchar     *pattern)
{
  FilterRule *rule;
...
/**
 * __gtk_recent_filter_add_pixbuf_formats:
 * @filter: a #GtkRecentFilter
 *
 ...
 */
void
__gtk_recent_filter_add_pixbuf_formats (GtkRecentFilter *filter)
{
  FilterRule *rule;
...
/**
 * __gtk_recent_filter_add_application:
 * @filter: a #GtkRecentFilter
 ...
 */
void
__gtk_recent_filter_add_application (GtkRecentFilter *filter,
 ...
 */
void
__gtk_recent_filter_add_group (GtkRecentFilter *filter,
			     const gchar     *group)
{
  FilterRule *rule;
 ...
 */
void
__gtk_recent_filter_add_age (GtkRecentFilter *filter,
			   gint             days)
{
  FilterRule *rule;
...
/**
 * __gtk_recent_filter_add_custom:
 * @filter: a #GtkRecentFilter
 ...
 **/
void
__gtk_recent_filter_add_custom (GtkRecentFilter      *filter,
			      GtkRecentFilterFlags  needed,
			      GtkRecentFilterFunc   func,
			      gpointer              data,
			      GDestroyNotify        data_destroy)
 ...
 * the fields returned from __gtk_recent_filter_get_needed().
 *
 * This function will not typically be used by applications; it
 * is intended principally for use in the implementation of
 * #GtkRecentChooser.
 ...
 */
gboolean
__gtk_recent_filter_filter (GtkRecentFilter           *filter,
