 ...
 * a vertical slider. To create one, use __gtk_hscale_new_with_range().
 *
...
{
  __gtk_orientable_set_orientation (GTK_ORIENTABLE (vscale),
 ...
 */
GtkWidget *
__gtk_vscale_new (GtkAdjustment *adjustment)
{
 ...
 **/
GtkWidget *
__gtk_vscale_new_with_range (gdouble min,
                           gdouble max,
                           gdouble step)
{
  GObject *adj;
