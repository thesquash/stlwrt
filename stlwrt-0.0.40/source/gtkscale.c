                  ...
                  GParamSpec *pspec)
{
  if (strcmp (pspec->name, "orientation") == 0)
  ...
  else if (strcmp (pspec->name, "inverted") == 0)
    {
      ...
      ______gtk_range_set_stop_values (GTK_RANGE (object), values, n);
		      ...
		      gint      digits)
{
  ...
  if (scale->digits != digits)
	...
	range->round_digits = digits;
      ...
      ______gtk_scale_clear_layout (scale);
                            ...
                            GtkBorder *border)
{
  ...
  ______gtk_scale_get_value_size (scale, &w, &h);
...
void
______gtk_scale_get_value_size (GtkScale *scale,
                           gint     *width,
                           gint     *height)
{
  GtkRange *range;
  ...
  if (scale->draw_value)
    {
      ...
      txt = ______gtk_scale_format_value (scale, range->adjustment->lower);
	...
	*height = logical_rect.height;
      ...
      txt = ______gtk_scale_format_value (scale, range->adjustment->upper);
      pango_layout_set_text (layout, txt, -1);
      g_free (txt);
                     ...
                     GtkStyle  *previous)
{
  ...
  ______gtk_scale_clear_layout (GTK_SCALE (widget));
  ...
  if (priv->marks)
    {
      ...
      ______gtk_range_get_stop_positions (range, &marks);
          ...
          if (range->orientation == GTK_ORIENTATION_HORIZONTAL)
            {
              ...
              __gtk_paint_vline (widget->style, widget->window, state_type,
              ...
              if (mark->markup)
                {
                  ...
                  __gtk_paint_layout (widget->style, widget->window, state_type,
          ...
          else
            {
              ...
              __gtk_paint_hline (widget->style, widget->window, state_type,
  ...
  if (scale->draw_value)
    {
      ...
      __gtk_paint_layout (widget->style,
                        widget->window,
                        state_type,
			FALSE,
                        NULL,
 ...
 */
gchar*
______gtk_scale_format_value (GtkScale *scale,
                         gdouble   value)
{
  gchar *fmt = NULL;
...
__gtk_scale_get_layout (GtkScale *scale)
{
  ...
  if (scale->draw_value) 
    {
      txt = ______gtk_scale_format_value (scale,
...
void
______gtk_scale_clear_layout (GtkScale *scale)
{
  GtkScalePrivate *priv = GTK_SCALE_GET_PRIVATE (scale);
...
__gtk_scale_clear_marks (GtkScale *scale)
{
  ...
  ______gtk_range_set_stop_values (GTK_RANGE (scale), NULL, 0);
                    ...
                    const gchar     *markup)
{
  ...
  ______gtk_range_set_stop_values (GTK_RANGE (scale), values, n);
