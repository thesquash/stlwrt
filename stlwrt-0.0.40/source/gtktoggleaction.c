 ...
 */
GtkToggleAction *
__gtk_toggle_action_new (const gchar *name,
		       const gchar *label,
		       const gchar *tooltip,
	      ...
	      GParamSpec  *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_DRAW_AS_RADIO:
      g_value_set_boolean (value, __gtk_toggle_action_get_draw_as_radio (action));
      break;
    case PROP_ACTIVE:
      g_value_set_boolean (value, __gtk_toggle_action_get_active (action));
      break;
    default:
	      ...
	      GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_DRAW_AS_RADIO:
      __gtk_toggle_action_set_draw_as_radio (action, g_value_get_boolean (value));
      break;
    case PROP_ACTIVE:
      __gtk_toggle_action_set_active (action, g_value_get_boolean (value));
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
 ...
 */
void
__gtk_toggle_action_toggled (GtkToggleAction *action)
{
  g_return_if_fail (GTK_IS_TOGGLE_ACTION (action));
...
/**
 * __gtk_toggle_action_set_active:
 * @action: the action object
 ...
 */
void
__gtk_toggle_action_set_active (GtkToggleAction *action, 
			      gboolean         is_active)
{
  g_return_if_fail (GTK_IS_TOGGLE_ACTION (action));
  ...
  if (action->private_data->active != is_active)
    ______gtk_action_emit_activate (GTK_ACTION (action));
}

/**
 * __gtk_toggle_action_get_active:
 * @action: the action object
 *
 ...
 */
gboolean
__gtk_toggle_action_get_active (GtkToggleAction *action)
{
...
/**
 * __gtk_toggle_action_set_draw_as_radio:
 * @action: the action object
 ...
 */
void
__gtk_toggle_action_set_draw_as_radio (GtkToggleAction *action, 
...
/**
 * __gtk_toggle_action_get_draw_as_radio:
 * @action: the action object
 *
 ...
 */
gboolean
__gtk_toggle_action_get_draw_as_radio (GtkToggleAction *action)
{
  g_return_val_if_fail (GTK_IS_TOGGLE_ACTION (action), FALSE);
