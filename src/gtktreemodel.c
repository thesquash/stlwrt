  ...
  if (! initialized)
    {
       ...
       * the wrapper functions (__gtk_tree_model_row_inserted(), etc.)
...
/**
 * __gtk_tree_path_new_from_string:
 ...
 **/
GtkTreePath *
__gtk_tree_path_new_from_string (const gchar *path)
{
  GtkTreePath *retval;
  ...
  while (1)
    {
      ...
      if (i < 0)
	{
	  g_warning (G_STRLOC ": Negative numbers in path %s passed to __gtk_tree_path_new_from_string", orig_path);
	...
	break;
      if (ptr == path || *ptr != ':')
	{
	  g_warning (G_STRLOC ": Invalid path %s passed to __gtk_tree_path_new_from_string", orig_path);
	  __gtk_tree_path_free (retval);
	  return NULL;
	}
      path = ptr + 1;
...
/**
 * __gtk_tree_path_new_from_indices:
 ...
 **/
GtkTreePath *
__gtk_tree_path_new_from_indices (gint first_index,
				...)
{
  int arg;
  va_list args;
  ...
  while (arg != -1)
    {
      __gtk_tree_path_append_index (path, arg);
 ...
 **/
gchar *
__gtk_tree_path_to_string (GtkTreePath *path)
{
 ...
 **/
GtkTreePath *
__gtk_tree_path_new_first (void)
{
  GtkTreePath *retval;

  retval = __gtk_tree_path_new ();
  __gtk_tree_path_append_index (retval, 0);

  return retval;
}

/**
 * __gtk_tree_path_append_index:
 * @path: A #GtkTreePath.
 * @index_: The index.
 *
 ...
 **/
void
__gtk_tree_path_append_index (GtkTreePath *path,
			    gint         index)
{
 ...
 **/
void
__gtk_tree_path_prepend_index (GtkTreePath *path,
			     gint       index)
{
  gint *new_indices;
 ...
 **/
gint
__gtk_tree_path_get_depth (GtkTreePath *path)
{
 ...
 **/
gint *
__gtk_tree_path_get_indices (GtkTreePath *path)
{
  g_return_val_if_fail (path != NULL, NULL);
...
/**
 * __gtk_tree_path_get_indices_with_depth:
 * @path: A #GtkTreePath.
 ...
 **/
gint *
__gtk_tree_path_get_indices_with_depth (GtkTreePath *path, gint *depth)
{
  g_return_val_if_fail (path != NULL, NULL);
...
/**
 * __gtk_tree_path_free:
 * @path: A #GtkTreePath.
 *
 * Frees @path.
 **/
void
__gtk_tree_path_free (GtkTreePath *path)
{
  if (!path)
    return;
 ...
 **/
GtkTreePath *
__gtk_tree_path_copy (const GtkTreePath *path)
{
  GtkTreePath *retval;
...
__gtk_tree_path_get_type (void)
{
  ...
  if (our_type == 0)
    our_type = g_boxed_type_register_static (I_("GtkTreePath"),
					     (GBoxedCopyFunc) __gtk_tree_path_copy,
					     (GBoxedFreeFunc) __gtk_tree_path_free);
 ...
 **/
gint
__gtk_tree_path_compare (const GtkTreePath *a,
		       const GtkTreePath *b)
{
  gint p = 0, q = 0;
 ...
 **/
gboolean
__gtk_tree_path_is_ancestor (GtkTreePath *path,
 ...
 **/
gboolean
__gtk_tree_path_is_descendant (GtkTreePath *path,
...
/**
 * __gtk_tree_path_next:
 * @path: A #GtkTreePath.
 *
 * Moves the @path to point to the next node at the current depth.
 **/
void
__gtk_tree_path_next (GtkTreePath *path)
{
  g_return_if_fail (path != NULL);
 ...
 **/
gboolean
__gtk_tree_path_prev (GtkTreePath *path)
{
  g_return_val_if_fail (path != NULL, FALSE);
 ...
 **/
gboolean
__gtk_tree_path_up (GtkTreePath *path)
{
  g_return_val_if_fail (path != NULL, FALSE);
...
/**
 * __gtk_tree_path_down:
 * @path: A #GtkTreePath.
 *
 * Moves @path to point to the first child of the current path.
 **/
void
__gtk_tree_path_down (GtkTreePath *path)
{
  g_return_if_fail (path != NULL);
 ...
 * You must free this iter with __gtk_tree_iter_free().
 *
 * Return value: a newly-allocated copy of @iter.
 **/
GtkTreeIter *
__gtk_tree_iter_copy (GtkTreeIter *iter)
{
  GtkTreeIter *retval;
...
/**
 * __gtk_tree_iter_free:
 * @iter: A dynamically allocated tree iterator.
 *
 * Frees an iterator that has been allocated by __gtk_tree_iter_copy().
 * This function is mainly used for language bindings.
 **/
void
__gtk_tree_iter_free (GtkTreeIter *iter)
{
...
__gtk_tree_iter_get_type (void)
{
  ...
  if (our_type == 0)
    our_type = g_boxed_type_register_static (I_("GtkTreeIter"),
					     (GBoxedCopyFunc) __gtk_tree_iter_copy,
					     (GBoxedFreeFunc) __gtk_tree_iter_free);
 ...
 **/
GtkTreeModelFlags
__gtk_tree_model_get_flags (GtkTreeModel *tree_model)
{
  GtkTreeModelIface *iface;
...
/**
 * __gtk_tree_model_get_n_columns:
 * @tree_model: A #GtkTreeModel.
 *
 ...
 **/
gint
__gtk_tree_model_get_n_columns (GtkTreeModel *tree_model)
{
  GtkTreeModelIface *iface;
  g_return_val_if_fail (GTK_IS_TREE_MODEL (tree_model), 0);
...
/**
 * __gtk_tree_model_get_column_type:
 * @tree_model: A #GtkTreeModel.
 ...
 **/
GType
__gtk_tree_model_get_column_type (GtkTreeModel *tree_model,
				gint          index)
{
  GtkTreeModelIface *iface;
 ...
 **/
gboolean
__gtk_tree_model_get_iter (GtkTreeModel *tree_model,
			 GtkTreeIter  *iter,
			 GtkTreePath  *path)
{
  GtkTreeModelIface *iface;
...
/**
 * __gtk_tree_model_get_iter_from_string:
 * @tree_model: A #GtkTreeModel.
 ...
 **/
gboolean
__gtk_tree_model_get_iter_from_string (GtkTreeModel *tree_model,
				     GtkTreeIter  *iter,
				     const gchar  *path_string)
{
  ...
  retval = __gtk_tree_model_get_iter (tree_model, iter, path);
...
/**
 * __gtk_tree_model_get_string_from_iter:
 * @tree_model: A #GtkTreeModel.
 * @iter: An #GtkTreeIter.
 *
 ...
 **/
gchar *
__gtk_tree_model_get_string_from_iter (GtkTreeModel *tree_model,
                                     GtkTreeIter  *iter)
{
  GtkTreePath *path;
  gchar *ret;
  ...
  ret = __gtk_tree_path_to_string (path);
  __gtk_tree_path_free (path);
...
/**
 * __gtk_tree_model_get_iter_first:
 * @tree_model: A #GtkTreeModel.
 * @iter: (out): The uninitialized #GtkTreeIter.
 * 
 ...
 **/
gboolean
__gtk_tree_model_get_iter_first (GtkTreeModel *tree_model,
			       GtkTreeIter  *iter)
{
  GtkTreePath *path;
  gboolean retval;
 ...
 **/
GtkTreePath *
__gtk_tree_model_get_path (GtkTreeModel *tree_model,
			 GtkTreeIter  *iter)
{
  GtkTreeModelIface *iface;
 ...
 */
void
__gtk_tree_model_get_value (GtkTreeModel *tree_model,
			  GtkTreeIter  *iter,
			  gint          column,
			  GValue       *value)
{
 ...
 **/
gboolean
__gtk_tree_model_iter_next (GtkTreeModel  *tree_model,
			  GtkTreeIter   *iter)
{
  GtkTreeModelIface *iface;
...
/**
 * __gtk_tree_model_iter_children:
 * @tree_model: A #GtkTreeModel.
 ...
 * <literal>__gtk_tree_model_get_iter_first (tree_model, iter);</literal>
 *
 * Return value: %TRUE, if @child has been set to the first child.
 **/
gboolean
__gtk_tree_model_iter_children (GtkTreeModel *tree_model,
			      GtkTreeIter  *iter,
			      GtkTreeIter  *parent)
{
  GtkTreeModelIface *iface;
...
/**
 * __gtk_tree_model_iter_has_child:
 * @tree_model: A #GtkTreeModel.
 ...
 **/
gboolean
__gtk_tree_model_iter_has_child (GtkTreeModel *tree_model,
			       GtkTreeIter  *iter)
{
  GtkTreeModelIface *iface;
...
/**
 * __gtk_tree_model_iter_n_children:
 * @tree_model: A #GtkTreeModel.
 ...
 **/
gint
__gtk_tree_model_iter_n_children (GtkTreeModel *tree_model,
				GtkTreeIter  *iter)
{
  GtkTreeModelIface *iface;
...
/**
 * __gtk_tree_model_iter_nth_child:
 * @tree_model: A #GtkTreeModel.
 ...
 **/
gboolean
__gtk_tree_model_iter_nth_child (GtkTreeModel *tree_model,
			       GtkTreeIter  *iter,
			       GtkTreeIter  *parent,
			       gint          n)
{
 ...
 **/
gboolean
__gtk_tree_model_iter_parent (GtkTreeModel *tree_model,
			    GtkTreeIter  *iter,
			    GtkTreeIter  *child)
{
  GtkTreeModelIface *iface;
 ...
 **/
void
__gtk_tree_model_ref_node (GtkTreeModel *tree_model,
			 GtkTreeIter  *iter)
{
  GtkTreeModelIface *iface;
 ...
 * primarily for performance reasons.
 *
 * For more information on what this means, see __gtk_tree_model_ref_node().
 * Please note that nodes that are deleted are not unreffed.
 **/
void
__gtk_tree_model_unref_node (GtkTreeModel *tree_model,
			   GtkTreeIter  *iter)
{
  GtkTreeModelIface *iface;
 ...
 * write: <literal>__gtk_tree_model_get (model, iter, 0, &amp;place_string_here, -1)</literal>,
 ...
 **/
void
__gtk_tree_model_get (GtkTreeModel *tree_model,
		    GtkTreeIter  *iter,
		    ...)
{
  va_list var_args;
  ...
  __gtk_tree_model_get_valist (tree_model, iter, var_args);
  va_end (var_args);
}

/**
 * __gtk_tree_model_get_valist:
 * @tree_model: a #GtkTreeModel
 * @iter: a row in @tree_model
 * @var_args: <type>va_list</type> of column/return location pairs
 *
 * See __gtk_tree_model_get(), this version takes a <type>va_list</type> 
 * for language bindings to use.
 **/
void
__gtk_tree_model_get_valist (GtkTreeModel *tree_model,
                           GtkTreeIter  *iter,
                           va_list	var_args)
{
  gint column;
  ...
  while (column != -1)
    {
      ...
      if (column >= __gtk_tree_model_get_n_columns (tree_model))
	{
	  g_warning ("%s: Invalid column number %d accessed (remember to end your list of columns with a -1)", G_STRLOC, column);
	  break;
	}

      __gtk_tree_model_get_value (GTK_TREE_MODEL (tree_model), iter, column, &value);
 ...
 **/
void
__gtk_tree_model_row_changed (GtkTreeModel *tree_model,
			    GtkTreePath  *path,
			    GtkTreeIter  *iter)
{
  g_return_if_fail (GTK_IS_TREE_MODEL (tree_model));
 ...
 **/
void
__gtk_tree_model_row_inserted (GtkTreeModel *tree_model,
			     GtkTreePath  *path,
			     GtkTreeIter  *iter)
{
  g_return_if_fail (GTK_IS_TREE_MODEL (tree_model));
...
/**
 * __gtk_tree_model_row_has_child_toggled:
 * @tree_model: A #GtkTreeModel
 * @path: A #GtkTreePath pointing to the changed row
 * @iter: A valid #GtkTreeIter pointing to the changed row
 * 
 ...
 **/
void
__gtk_tree_model_row_has_child_toggled (GtkTreeModel *tree_model,
				      GtkTreePath  *path,
				      GtkTreeIter  *iter)
{
  g_return_if_fail (GTK_IS_TREE_MODEL (tree_model));
 ...
 **/
void
__gtk_tree_model_row_deleted (GtkTreeModel *tree_model,
			    GtkTreePath  *path)
{
  g_return_if_fail (GTK_IS_TREE_MODEL (tree_model));
  g_return_if_fail (path != NULL);
...
/**
 * __gtk_tree_model_rows_reordered:
 * @tree_model: A #GtkTreeModel
 ...
 **/
void
__gtk_tree_model_rows_reordered (GtkTreeModel *tree_model,
			       GtkTreePath  *path,
			       GtkTreeIter  *iter,
			       gint         *new_order)
{
...
static gboolean
__gtk_tree_model_foreach_helper (GtkTreeModel            *model,
			       GtkTreeIter             *iter,
			       GtkTreePath             *path,
			       ...
			       gpointer                 user_data)
{
  do
      ...
      if (__gtk_tree_model_iter_children (model, &child, iter))
	{
	  ...
	  if (__gtk_tree_model_foreach_helper (model, &child, path, func, user_data))
	    return TRUE;
 ...
 * __gtk_tree_model_foreach() returns.
 **/
void
__gtk_tree_model_foreach (GtkTreeModel            *model,
			GtkTreeModelForeachFunc  func,
			gpointer                 user_data)
{
  GtkTreePath *path;
  ...
  path = __gtk_tree_path_new_first ();
  if (__gtk_tree_model_get_iter (model, &iter, path) == FALSE)
    {
      __gtk_tree_path_free (path);
      return;
    }

  __gtk_tree_model_foreach_helper (model, &iter, path, func, user_data);
  __gtk_tree_path_free (path);
}
...
__gtk_tree_row_reference_get_type (void)
{
  ...
  if (our_type == 0)
    our_type = g_boxed_type_register_static (I_("GtkTreeRowReference"),
					     (GBoxedCopyFunc) __gtk_tree_row_reference_copy,
					     (GBoxedFreeFunc) __gtk_tree_row_reference_free);
      ...
      if (reference->path)
	{
	  ...
	  if (path->indices[i] == reference->path->indices[i])
		...
		gtk_tree_row_reference_unref_path (reference->path, reference->model, path->depth - 1);
	      ...
	      __gtk_tree_path_free (reference->path);
	      reference->path = NULL;
	    }
  ...
  while (tmp_list != NULL)
    {
      ...
      length = __gtk_tree_model_iter_n_children (GTK_TREE_MODEL (reference->model), iter);

      if (length < 2)
	return;

      if ((reference->path) &&
	  (__gtk_tree_path_is_ancestor (path, reference->path)))
	{
	  gint ref_depth = __gtk_tree_path_get_depth (reference->path);
	  gint depth = __gtk_tree_path_get_depth (path);

	  if (ref_depth > depth)
	    {
	      gint i;
	      gint *indices = __gtk_tree_path_get_indices (reference->path);
					  ...
					  gint          current_depth)
{
  ...
  __gtk_tree_model_iter_nth_child (model, &iter, parent_iter, path->indices[current_depth]);
				   ...
				   gint          depth)
{
  ...
  __gtk_tree_model_iter_nth_child (model, &iter, NULL, path->indices[0]);
  gtk_tree_row_reference_unref_path_helper (path, model, &iter, depth, 1);
  __gtk_tree_model_unref_node (model, &iter);
}

/**
 * __gtk_tree_row_reference_new:
 * @model: A #GtkTreeModel
 ...
 **/
GtkTreeRowReference *
__gtk_tree_row_reference_new (GtkTreeModel *model,
                            GtkTreePath  *path)
{
   ...
   * __gtk_tree_row_reference_inserted(), etc, in the
   * class closure (default handler) marshalers for the signal.
   */  
  return __gtk_tree_row_reference_new_proxy (G_OBJECT (model), model, path);
}

/**
 * __gtk_tree_row_reference_new_proxy:
 ...
 * __gtk_tree_row_reference_new(), it does not listen to the model for changes.
 * The creator of the row reference must do this explicitly using
 * __gtk_tree_row_reference_inserted(), __gtk_tree_row_reference_deleted(),
 * __gtk_tree_row_reference_reordered().
 * 
 ...
 **/
GtkTreeRowReference *
__gtk_tree_row_reference_new_proxy (GObject      *proxy,
				  GtkTreeModel *model,
				  GtkTreePath  *path)
{
  ...
  if (__gtk_tree_model_get_iter (model, &parent_iter, path) == FALSE)
    return NULL;

  /* Now we want to ref every node */
  __gtk_tree_model_iter_nth_child (model, &parent_iter, NULL, path->indices[0]);
  __gtk_tree_model_ref_node (model, &parent_iter);

  for (i = 1; i < path->depth; i++)
    {
      GtkTreeIter iter;
      __gtk_tree_model_iter_nth_child (model, &iter, &parent_iter, path->indices[i]);
      __gtk_tree_model_ref_node (model, &iter);
      parent_iter = iter;
    }
  ...
  reference->path = __gtk_tree_path_copy (path);
...
/**
 * __gtk_tree_row_reference_get_path:
 ...
 **/
GtkTreePath *
__gtk_tree_row_reference_get_path (GtkTreeRowReference *reference)
{
  ...
  return __gtk_tree_path_copy (reference->path);
}

/**
 * __gtk_tree_row_reference_get_model:
 * @reference: A #GtkTreeRowReference
 *
 ...
 */
GtkTreeModel *
__gtk_tree_row_reference_get_model (GtkTreeRowReference *reference)
{
  g_return_val_if_fail (reference != NULL, NULL);
...
/**
 * __gtk_tree_row_reference_valid:
 ...
 **/
gboolean
__gtk_tree_row_reference_valid (GtkTreeRowReference *reference)
{
 ...
 **/
GtkTreeRowReference *
__gtk_tree_row_reference_copy (GtkTreeRowReference *reference)
{
  return __gtk_tree_row_reference_new_proxy (reference->proxy,
					   reference->model,
					   reference->path);
}

/**
 * __gtk_tree_row_reference_free:
 * @reference: (allow-none): A #GtkTreeRowReference, or %NULL
 * 
 * Free's @reference. @reference may be %NULL.
 **/
void
__gtk_tree_row_reference_free (GtkTreeRowReference *reference)
{
  RowRefList *refs;
...
/**
 * __gtk_tree_row_reference_inserted:
 * @proxy: A #GObject
 * @path: The row position that was inserted
 * 
 * Lets a set of row reference created by __gtk_tree_row_reference_new_proxy()
 * know that the model emitted the "row_inserted" signal.
 **/
void
__gtk_tree_row_reference_inserted (GObject     *proxy,
				 GtkTreePath *path)
{
...
/**
 * __gtk_tree_row_reference_deleted:
 * @proxy: A #GObject
 ...
 **/
void
__gtk_tree_row_reference_deleted (GObject     *proxy,
				GtkTreePath *path)
{
  g_return_if_fail (G_IS_OBJECT (proxy));
 ...
 **/
void
__gtk_tree_row_reference_reordered (GObject     *proxy,
				  GtkTreePath *path,
				  GtkTreeIter *iter,
				  gint        *new_order)
{
