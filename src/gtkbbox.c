...
{
  gtk_box_get_props (GTK_BOX (button_box))->spacing = 0;
			     ...
			     GParamSpec      *pspec)
{
  switch (prop_id)
    ...
    case PROP_LAYOUT_STYLE:
      __gtk_button_box_set_layout (GTK_BUTTON_BOX (object),
				   ...
				   GParamSpec      *pspec)
{
  switch (property_id)
    ...
    case CHILD_PROP_SECONDARY:
      __gtk_button_box_set_child_secondary (GTK_BUTTON_BOX (container), child,
  ...
  switch (property_id)
    ...
    case CHILD_PROP_SECONDARY:
      g_value_set_boolean (value, 
			   __gtk_button_box_get_child_secondary (GTK_BUTTON_BOX (container), 
							       child));
      break;
    default:
      GTK_CONTAINER_WARN_INVALID_CHILD_PROPERTY_ID (container, property_id, pspec);
                               ...
                               gint width, gint height)
{
  ...
  widget_props->child_min_width = width;
  widget_props->child_min_height = height;
}
                                   ...
                                   gint ipad_x, gint ipad_y)
{
  ...
  widget_props->child_ipad_x = ipad_x;
  widget_props->child_ipad_y = ipad_y;
}
                           ...
                           GtkButtonBoxStyle  layout_style)
{
  ...
  if (widget_props->layout_style != layout_style)
    {
      widget_props->layout_style = layout_style;
                               ...
                               gint *width, gint *height)
{
  ...
  *width  = widget_props->child_min_width;
  *height = widget_props->child_min_height;
}
                                   ...
                                   gint* ipad_x, gint *ipad_y)
{
  ...
  *ipad_x = widget_props->child_ipad_x;
  *ipad_y = widget_props->child_ipad_y;
}
...
__gtk_button_box_get_layout (GtkButtonBox *widget)
{
  ...
  return widget_props->layout_style;
}

/**
 * __gtk_button_box_get_child_secondary:
 ...
 **/
gboolean 
__gtk_button_box_get_child_secondary (GtkButtonBox *widget,
				    GtkWidget    *child)
{
  GList *list;
  ...
  child_info = NULL;
  list = gtk_box_get_props (GTK_BOX (widget))->children;
  while (list)
    {
...
/**
 * __gtk_button_box_set_child_secondary
 * @widget: a #GtkButtonBox
 * @child: a child of @widget
 ...
 * __gtk_widget_set_direction()). If the style is %GTK_BUTTONBOX_START
 * or %GTK_BUTTONBOX_END, then the secondary children are aligned at
 * the other end of the button box from the main children. For the
 * other styles, they appear immediately next to the main children.
 **/
void 
__gtk_button_box_set_child_secondary (GtkButtonBox *widget, 
				    GtkWidget    *child,
				    gboolean      is_secondary)
{
  ...
  __gtk_widget_child_notify (child, "secondary");

  if (__gtk_widget_get_visible (GTK_WIDGET (widget))
      && __gtk_widget_get_visible (child))
...
void
___gtk_button_box_child_requisition (GtkWidget *widget,
                                   int       *nvis_children,
                                   ...
                                   int       *height)
{
  ...
  nchildren = 0;
  nsecondaries = 0;
  children = gtk_box_get_props (GTK_BOX(bbox))->children;
...
gtk_button_box_kludge_get_layout_default (GtkButtonBox *widget)
{
  ...
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
    return ___gtk_hbutton_box_get_layout_default ();
  else
    return ___gtk_vbutton_box_get_layout_default ();
}
                              ...
                              GtkAllocation *allocation)
{
  ...
  if (orientation == GTK_ORIENTATION_HORIZONTAL)
    width = allocation->width - gtk_container_get_props (GTK_CONTAINER (box))->border_width*2;
  else
    height = allocation->height - gtk_container_get_props (GTK_CONTAINER (box))->border_width*2;
        ...
        if (orientation == GTK_ORIENTATION_HORIZONTAL)
          {
            ...
            secondary_x = allocation->x + allocation->width
              ...
              - gtk_container_get_props (GTK_CONTAINER (box))->border_width;
          }
        else
          {
            childspacing = spacing;
        ...
        if (orientation == GTK_ORIENTATION_HORIZONTAL)
          {
            ...
            x = allocation->x + allocation->width
              ...
              - gtk_container_get_props (GTK_CONTAINER (box))->border_width;
            secondary_x = allocation->x + gtk_container_get_props (GTK_CONTAINER (box))->border_width;
          }
        else
          {
            childspacing = spacing;
            y = allocation->y + allocation->height
              ...
              - spacing * (nvis_children - n_secondaries - 1)
              - gtk_container_get_props (GTK_CONTAINER (box))->border_width;
            secondary_y = allocation->y + gtk_container_get_props (GTK_CONTAINER (box))->border_width;
          }
  ...
  children = gtk_box_get_props (GTK_BOX (box))->children;
