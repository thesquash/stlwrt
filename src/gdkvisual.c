 ...
 **/
GList*
__gdk_list_visuals (void)
{
  return __gdk_screen_list_visuals (__gdk_screen_get_default ());
}

/**
 * __gdk_visual_get_system:
 * 
 ...
 **/
GdkVisual*
__gdk_visual_get_system (void)
{
  return __gdk_screen_get_system_visual (__gdk_screen_get_default());
}

/**
 * __gdk_visual_get_visual_type:
 * @visual: A #GdkVisual.
 *
 ...
 */
GdkVisualType
__gdk_visual_get_visual_type (GdkVisual *visual)
{
 ...
 */
gint
__gdk_visual_get_depth (GdkVisual *visual)
{
  g_return_val_if_fail (GDK_IS_VISUAL (visual), 0);
 ...
 */
GdkByteOrder
__gdk_visual_get_byte_order (GdkVisual *visual)
{
  g_return_val_if_fail (GDK_IS_VISUAL (visual), 0);
...
/**
 * __gdk_visual_get_colormap_size:
 * @visual: A #GdkVisual.
 *
 ...
 */
gint
__gdk_visual_get_colormap_size (GdkVisual *visual)
{
  g_return_val_if_fail (GDK_IS_VISUAL (visual), 0);
 ...
 */
gint
__gdk_visual_get_bits_per_rgb (GdkVisual *visual)
{
  g_return_val_if_fail (GDK_IS_VISUAL (visual), 0);
...
/**
 * __gdk_visual_get_red_pixel_details:
 * @visual: A #GdkVisual.
 ...
 */
void
__gdk_visual_get_red_pixel_details (GdkVisual *visual,
                                  guint32   *mask,
                                  gint      *shift,
                                  gint      *precision)
{
...
/**
 * __gdk_visual_get_green_pixel_details:
 * @visual: a #GdkVisual
 * @mask: (out) (allow-none): A pointer to a #guint32 to be filled in, or %NULL.
 * @shift: (out) (allow-none): A pointer to a #gint to be filled in, or %NULL.
 * @precision: (out) (allow-none): A pointer to a #gint to be filled in, or %NULL.
 ...
 */
void
__gdk_visual_get_green_pixel_details (GdkVisual *visual,
                                    guint32   *mask,
                                    gint      *shift,
                                    gint      *precision)
{
...
/**
 * __gdk_visual_get_blue_pixel_details:
 * @visual: a #GdkVisual
 * @mask: (out) (allow-none): A pointer to a #guint32 to be filled in, or %NULL.
 * @shift: (out) (allow-none): A pointer to a #gint to be filled in, or %NULL.
 * @precision: (out) (allow-none): A pointer to a #gint to be filled in, or %NULL.
 ...
 */
void
__gdk_visual_get_blue_pixel_details (GdkVisual *visual,
                                   guint32   *mask,
                                   gint      *shift,
                                   gint      *precision)
{
