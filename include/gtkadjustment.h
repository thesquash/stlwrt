...
#define GTK_TYPE_ADJUSTMENT                  (SF(gtk_adjustment_get_type) ())
...
void	   SF(gtk_adjustment_changed)		(GtkAdjustment	 *adjustment);
void	   SF(gtk_adjustment_value_changed)		(GtkAdjustment	 *adjustment);
void	   SF(gtk_adjustment_clamp_page)		(GtkAdjustment	 *adjustment,
						 gdouble	  lower,
						 gdouble	  upper);

gdouble	   SF(gtk_adjustment_get_value)		(GtkAdjustment   *adjustment);
void	   SF(gtk_adjustment_set_value)		(GtkAdjustment	 *adjustment,
						 gdouble	  value);
gdouble    SF(gtk_adjustment_get_lower)             (GtkAdjustment   *adjustment);
void       SF(gtk_adjustment_set_lower)             (GtkAdjustment   *adjustment,
                                                 gdouble          lower);
gdouble    SF(gtk_adjustment_get_upper)             (GtkAdjustment   *adjustment);
void       SF(gtk_adjustment_set_upper)             (GtkAdjustment   *adjustment,
                                                 gdouble          upper);
gdouble    SF(gtk_adjustment_get_step_increment)    (GtkAdjustment   *adjustment);
void       SF(gtk_adjustment_set_step_increment)    (GtkAdjustment   *adjustment,
                                                 gdouble          step_increment);
gdouble    SF(gtk_adjustment_get_page_increment)    (GtkAdjustment   *adjustment);
void       SF(gtk_adjustment_set_page_increment)    (GtkAdjustment   *adjustment,
                                                 gdouble          page_increment);
gdouble    SF(gtk_adjustment_get_page_size)         (GtkAdjustment   *adjustment);
void       SF(gtk_adjustment_set_page_size)         (GtkAdjustment   *adjustment,
                                                 gdouble          page_size);

void       SF(gtk_adjustment_configure)             (GtkAdjustment   *adjustment,
                                                 gdouble          value,
						 gdouble          lower,
						 gdouble          upper,
						 gdouble          step_increment,
