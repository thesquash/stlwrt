 ...
 */
GtkWidget *
___gtk_widget_find_at_coords (GdkWindow *window,
                            gint       window_x,
                            gint       window_y,
                            gint      *widget_x,
                            gint      *widget_y)
				       ...
				       gint     *y)
{
  ...
  tmp = ___gtk_widget_find_at_coords (event->any.window, dx, dy, &tx, &ty);
...
gtk_tooltip_show_tooltip (GdkDisplay *display)
{
  ...
  if (tooltip->keyboard_mode_enabled)
	...
	return;
      ...
      pointer_widget = tooltip_widget = ___gtk_widget_find_at_coords (window,
                                                                    x, y,
                                                                    &x, &y);
    }
...
void
___gtk_tooltip_focus_in (GtkWidget *widget)
{
  gint x, y;
  gboolean return_value = FALSE;
  GdkDisplay *display;
...
void
___gtk_tooltip_focus_out (GtkWidget *widget)
{
  GdkDisplay *display;
  GtkTooltip *tooltip;
...
void
___gtk_tooltip_toggle_keyboard_mode (GtkWidget *widget)
{
  GdkDisplay *display;
  GtkTooltip *tooltip;
...
void
___gtk_tooltip_hide (GtkWidget *widget)
{
  GtkWidget *toplevel;
  GdkDisplay *display;
  GtkTooltip *tooltip;
...
void
___gtk_tooltip_handle_event (GdkEvent *event)
{
  gint x, y;
  gboolean return_value = FALSE;
