 ...
 * clicks on a link or email address, see __gtk_about_dialog_set_email_hook()
 * and __gtk_about_dialog_set_url_hook(). Email addresses in the
 ...
 * __gtk_about_dialog_set_url_hook (GTK_ABOUT_DIALOG (dialog), launch_url, NULL, NULL);
 * __gtk_about_dialog_set_website (GTK_ABOUT_DIALOG (dialog), app_url);
 ...
 * use the function __gtk_show_about_dialog() which constructs and shows a dialog
                  ...
                  gpointer        user_data)
{
  ...
  screen = __gtk_widget_get_screen (GTK_WIDGET (about));

  if (!__gtk_show_uri (screen, uri, __gtk_get_current_event_time (), &error))
    {
      GtkWidget *dialog;

      dialog = __gtk_message_dialog_new (GTK_WINDOW (about),
...
STLWRT_DEFINE_FTYPE_VPARENT (GtkAboutDialog, gtk_about_dialog, GTK_TYPE_DIALOG, G_TYPE_FLAG_NONE,
...
gtk_about_dialog_class_init (GtkAboutDialogClass *klass)
{
  ...
  g_object_class_install_property (object_class,
                                   ...
                                   g_param_spec_object ("logo",
                                                        P_("Logo"),
                                                        P_("A logo for the about box. If this is not set, it defaults to __gtk_window_get_default_icon_list()"),
                                                        GDK_TYPE_PIXBUF,
                                                        GTK_PARAM_READWRITE));
...
gtk_about_dialog_init (GtkAboutDialog *about)
{
  ...
  GtkDialogProps *dialog_props = gtk_dialog_get_props (dialog);
  ...
  priv->hand_cursor = __gdk_cursor_new (GDK_HAND2);
  priv->regular_cursor = __gdk_cursor_new (GDK_XTERM);
  ...
  __gtk_box_set_spacing (GTK_BOX (dialog_props->vbox), 2); /* 2 * 5 + 2 = 12 */
  __gtk_container_set_border_width (GTK_CONTAINER (dialog_props->action_area), 5);

  /* Widgets */
  __gtk_widget_push_composite_child ();

  vbox = __gtk_vbox_new (FALSE, 8);
  __gtk_container_set_border_width (GTK_CONTAINER (vbox), 5);
  __gtk_box_pack_start (GTK_BOX (dialog_props->vbox), vbox, TRUE, TRUE, 0);

  priv->logo_image = __gtk_image_new ();
  __gtk_box_pack_start (GTK_BOX (vbox), priv->logo_image, FALSE, FALSE, 0);

  priv->name_label = __gtk_label_new (NULL);
  __gtk_label_set_selectable (GTK_LABEL (priv->name_label), TRUE);
  __gtk_label_set_justify (GTK_LABEL (priv->name_label), GTK_JUSTIFY_CENTER);
  __gtk_box_pack_start (GTK_BOX (vbox), priv->name_label, FALSE, FALSE, 0);

  priv->comments_label = __gtk_label_new (NULL);
  __gtk_label_set_selectable (GTK_LABEL (priv->comments_label), TRUE);
  __gtk_label_set_justify (GTK_LABEL (priv->comments_label), GTK_JUSTIFY_CENTER);
  __gtk_label_set_line_wrap (GTK_LABEL (priv->comments_label), TRUE);
  __gtk_box_pack_start (GTK_BOX (vbox), priv->comments_label, FALSE, FALSE, 0);

  priv->copyright_label = __gtk_label_new (NULL);
  __gtk_label_set_selectable (GTK_LABEL (priv->copyright_label), TRUE);
  __gtk_label_set_justify (GTK_LABEL (priv->copyright_label), GTK_JUSTIFY_CENTER);
  __gtk_box_pack_start (GTK_BOX (vbox), priv->copyright_label, FALSE, FALSE, 0);

  hbox = __gtk_hbox_new (TRUE, 0);
  __gtk_box_pack_start (GTK_BOX (vbox), hbox, TRUE, FALSE, 0);

  priv->website_label = button = __gtk_label_new ("");
  __gtk_widget_set_no_show_all (button, TRUE);
  __gtk_label_set_selectable (GTK_LABEL (button), TRUE);
  __gtk_box_pack_start (GTK_BOX (hbox), button, FALSE, FALSE, 0);
  g_signal_connect_swapped (button, "activate-link",
                            G_CALLBACK (emit_activate_link), about);

  __gtk_widget_show (vbox);
  __gtk_widget_show (priv->logo_image);
  __gtk_widget_show (priv->name_label);
  __gtk_widget_show (hbox);

  /* Add the close button */
  close_button = __gtk_dialog_add_button (GTK_DIALOG (about), GTK_STOCK_CLOSE,
                                        GTK_RESPONSE_CANCEL);
  __gtk_dialog_set_default_response (GTK_DIALOG (about), GTK_RESPONSE_CANCEL);

  /* Add the credits button */
  button = __gtk_button_new_with_mnemonic (_("C_redits"));
  ...
  __gtk_window_set_resizable (GTK_WINDOW (about), FALSE);

  __gtk_widget_pop_composite_child ();

  __gtk_widget_grab_default (close_button);
  __gtk_widget_grab_focus (close_button);

  /* force defaults */
  __gtk_about_dialog_set_program_name (about, NULL);
  __gtk_about_dialog_set_logo (about, NULL);
}
...
gtk_about_dialog_finalize (GObject *object)
{
  ...
  __gdk_cursor_unref (priv->hand_cursor);
  __gdk_cursor_unref (priv->regular_cursor);
                               ...
                               GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_NAME:
      __gtk_about_dialog_set_program_name (about, g_value_get_string (value));
      break;
    case PROP_VERSION:
      __gtk_about_dialog_set_version (about, g_value_get_string (value));
      break;
    case PROP_COMMENTS:
      __gtk_about_dialog_set_comments (about, g_value_get_string (value));
      break;
    case PROP_WEBSITE:
      __gtk_about_dialog_set_website (about, g_value_get_string (value));
      break;
    case PROP_WEBSITE_LABEL:
      __gtk_about_dialog_set_website_label (about, g_value_get_string (value));
      break;
    case PROP_LICENSE:
      __gtk_about_dialog_set_license (about, g_value_get_string (value));
      break;
    case PROP_COPYRIGHT:
      __gtk_about_dialog_set_copyright (about, g_value_get_string (value));
      break;
    case PROP_LOGO:
      __gtk_about_dialog_set_logo (about, g_value_get_object (value));
      break;
    case PROP_AUTHORS:
      __gtk_about_dialog_set_authors (about, (const gchar**)g_value_get_boxed (value));
      break;
    case PROP_DOCUMENTERS:
      __gtk_about_dialog_set_documenters (about, (const gchar**)g_value_get_boxed (value));
      break;
    case PROP_ARTISTS:
      __gtk_about_dialog_set_artists (about, (const gchar**)g_value_get_boxed (value));
      break;
    case PROP_TRANSLATOR_CREDITS:
      __gtk_about_dialog_set_translator_credits (about, g_value_get_string (value));
      break;
    case PROP_LOGO_ICON_NAME:
      __gtk_about_dialog_set_logo_icon_name (about, g_value_get_string (value));
      break;
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_ARTISTS:
      ...
      break;
    case PROP_LOGO:
      if (__gtk_image_get_storage_type (GTK_IMAGE (priv->logo_image)) == GTK_IMAGE_PIXBUF)
        g_value_set_object (value, __gtk_image_get_pixbuf (GTK_IMAGE (priv->logo_image)));
      else
        g_value_set_object (value, NULL);
      break;
    case PROP_LOGO_ICON_NAME:
      if (__gtk_image_get_storage_type (GTK_IMAGE (priv->logo_image)) == GTK_IMAGE_ICON_NAME)
        {
          const gchar *icon_name;

          __gtk_image_get_icon_name (GTK_IMAGE (priv->logo_image), &icon_name, NULL);
...
update_website (GtkAboutDialog *about)
{
  ...
  __gtk_widget_show (priv->website_label);
  ...
  if (priv->website_url && (!activate_url_hook_set || activate_url_hook != NULL))
    {
      ...
      __gtk_label_set_markup (GTK_LABEL (priv->website_label), markup);
      g_free (markup);
    }
  else
    {
      if (priv->website_url)
        __gtk_label_set_text (GTK_LABEL (priv->website_label), priv->website_url);
      else if (priv->website_text)
        __gtk_label_set_text (GTK_LABEL (priv->website_label), priv->website_text);
      else
        __gtk_widget_hide (priv->website_label);
    }
}
 ...
 * Since: 2.6
 *
 * Deprecated: 2.12: Use __gtk_about_dialog_get_program_name() instead.
 */
const gchar *
__gtk_about_dialog_get_name (GtkAboutDialog *about)
{
  return __gtk_about_dialog_get_program_name (about);
}

/**
 * __gtk_about_dialog_get_program_name:
 * @about: a #GtkAboutDialog
 *
 * Returns the program name displayed in the about dialog.
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_program_name (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
update_name_version (GtkAboutDialog *about)
{
  ...
  __gtk_window_set_title (GTK_WINDOW (about), title_string);
  g_free (title_string);
  ...
  __gtk_label_set_markup (GTK_LABEL (priv->name_label), name_string);

  g_free (name_string);
}

/**
 * __gtk_about_dialog_set_name:
 * @about: a #GtkAboutDialog
 ...
 * Since: 2.6
 *
 * Deprecated: 2.12: Use __gtk_about_dialog_set_program_name() instead.
 */
void
__gtk_about_dialog_set_name (GtkAboutDialog *about,
                           const gchar    *name)
{
    __gtk_about_dialog_set_program_name (about, name);
}

/**
 * __gtk_about_dialog_set_program_name:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_program_name (GtkAboutDialog *about,
                                   const gchar    *name)
{
  GtkAboutDialogPrivate *priv;
  gchar *tmp;
...
/**
 * __gtk_about_dialog_get_version:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_version (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_version:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_version (GtkAboutDialog *about,
                              const gchar    *version)
{
  GtkAboutDialogPrivate *priv;
  gchar *tmp;
...
/**
 * __gtk_about_dialog_get_copyright:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_copyright (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_copyright:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_copyright (GtkAboutDialog *about,
  ...
  if (priv->copyright != NULL)
    {
      copyright_string = g_markup_printf_escaped ("<span size=\"small\">%s</span>",
                                                  priv->copyright);
      __gtk_label_set_markup (GTK_LABEL (priv->copyright_label), copyright_string);
      g_free (copyright_string);

      __gtk_widget_show (priv->copyright_label);
    }
  else
    __gtk_widget_hide (priv->copyright_label);

  g_object_notify (G_OBJECT (about), "copyright");
}

/**
 * __gtk_about_dialog_get_comments:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_comments (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_comments:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_comments (GtkAboutDialog *about,
  ...
  if (comments)
    {
      ...
      __gtk_label_set_text (GTK_LABEL (priv->comments_label), priv->comments);
      __gtk_widget_show (priv->comments_label);
    }
  else
    {
      priv->comments = NULL;
      __gtk_widget_hide (priv->comments_label);
    }
  g_free (tmp);
...
/**
 * __gtk_about_dialog_get_license:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_license (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_license:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_license (GtkAboutDialog *about,
                              const gchar    *license)
{
  GtkAboutDialogPrivate *priv;
  gchar *tmp;
  ...
  if (license)
    {
      ...
      __gtk_widget_show (priv->license_button);
    }
  else
    {
      priv->license = NULL;
      __gtk_widget_hide (priv->license_button);
    }
  g_free (tmp);
...
/**
 * __gtk_about_dialog_get_wrap_license:
 * @about: a #GtkAboutDialog
 *
 ...
 */
gboolean
__gtk_about_dialog_get_wrap_license (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_wrap_license:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_wrap_license (GtkAboutDialog *about,
...
/**
 * __gtk_about_dialog_get_website:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_website (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_website:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_website (GtkAboutDialog *about,
                              const gchar    *website)
{
  GtkAboutDialogPrivate *priv;
  gchar *tmp;
...
/**
 * __gtk_about_dialog_get_website_label:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_website_label (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_website_label:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_website_label (GtkAboutDialog *about,
...
/**
 * __gtk_about_dialog_get_authors:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar * const *
__gtk_about_dialog_get_authors (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
update_credits_button_visibility (GtkAboutDialog *about)
{
  ...
  if (show)
    __gtk_widget_show (priv->credits_button);
  else
    __gtk_widget_hide (priv->credits_button);
}

/**
 * __gtk_about_dialog_set_authors:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_authors (GtkAboutDialog  *about,
                              const gchar    **authors)
{
  GtkAboutDialogPrivate *priv;
  gchar **tmp;
...
/**
 * __gtk_about_dialog_get_documenters:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar * const *
__gtk_about_dialog_get_documenters (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_documenters:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_documenters (GtkAboutDialog *about,
...
/**
 * __gtk_about_dialog_get_artists:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar * const *
__gtk_about_dialog_get_artists (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_artists:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_artists (GtkAboutDialog *about,
                              const gchar   **artists)
{
  GtkAboutDialogPrivate *priv;
  gchar **tmp;
...
/**
 * __gtk_about_dialog_get_translator_credits:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_translator_credits (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_translator_credits:
 * @about: a #GtkAboutDialog
 ...
 * |[
 *  __gtk_about_dialog_set_translator_credits (about, _("translator-credits"));
 * ]|
 ...
 */
void
__gtk_about_dialog_set_translator_credits (GtkAboutDialog *about,
 ...
 */
GdkPixbuf *
__gtk_about_dialog_get_logo (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
  ...
  if (__gtk_image_get_storage_type (GTK_IMAGE (priv->logo_image)) == GTK_IMAGE_PIXBUF)
    return __gtk_image_get_pixbuf (GTK_IMAGE (priv->logo_image));
  else
    return NULL;
}
...
{
  GtkIconSet *icon_set = __gtk_icon_set_new ();

  for (; pixbufs; pixbufs = pixbufs->next)
    {
      GdkPixbuf *pixbuf = GDK_PIXBUF (pixbufs->data);

      GtkIconSource *icon_source = __gtk_icon_source_new ();
      __gtk_icon_source_set_pixbuf (icon_source, pixbuf);
      __gtk_icon_set_add_source (icon_set, icon_source);
      __gtk_icon_source_free (icon_source);
    }
...
/**
 * __gtk_about_dialog_set_logo:
 * @about: a #GtkAboutDialog
 * @logo: (allow-none): a #GdkPixbuf, or %NULL
 *
 * Sets the pixbuf to be displayed as logo in the about dialog.
 * If it is %NULL, the default window icon set with
 * __gtk_window_set_default_icon() will be used.
 *
 * Since: 2.6
 */
void
__gtk_about_dialog_set_logo (GtkAboutDialog *about,
                           GdkPixbuf      *logo)
{
  GtkAboutDialogPrivate *priv;
  ...
  if (logo != NULL)
    __gtk_image_set_from_pixbuf (GTK_IMAGE (priv->logo_image), logo);
  else
    {
      GList *pixbufs = __gtk_window_get_default_icon_list ();

      if (pixbufs != NULL)
        {
          GtkIconSet *icon_set = icon_set_new_from_pixbufs (pixbufs);

          __gtk_image_set_from_icon_set (GTK_IMAGE (priv->logo_image),
...
/**
 * __gtk_about_dialog_get_logo_icon_name:
 * @about: a #GtkAboutDialog
 *
 ...
 */
const gchar *
__gtk_about_dialog_get_logo_icon_name (GtkAboutDialog *about)
{
  GtkAboutDialogPrivate *priv;
...
/**
 * __gtk_about_dialog_set_logo_icon_name:
 * @about: a #GtkAboutDialog
 ...
 */
void
__gtk_about_dialog_set_logo_icon_name (GtkAboutDialog *about,
                                     const gchar    *icon_name)
{
  GtkAboutDialogPrivate *priv;
  ...
  __gtk_image_set_from_icon_name (GTK_IMAGE (priv->logo_image), icon_name,
      ...
      if (uri && !g_slist_find_custom (priv->visited_links, uri, (GCompareFunc)strcmp))
        {
          ...
          __gtk_widget_ensure_style (GTK_WIDGET (about));
          __gtk_widget_style_get (GTK_WIDGET (about),
                                "visited-link-color", &style_visited_link_color,
                                NULL);
          if (style_visited_link_color)
            {
              color = *style_visited_link_color;
              __gdk_color_free (style_visited_link_color);
            }
          else
  ...
  switch (event->keyval)
    {
      ...
      case GDK_ISO_Enter:
      case GDK_KP_Enter:
        buffer = __gtk_text_view_get_buffer (GTK_TEXT_VIEW (text_view));
                       ...
                       GtkAboutDialog *about)
{
  ...
  __gtk_text_buffer_get_selection_bounds (buffer, &start, &end);
  if (__gtk_text_iter_get_offset (&start) != __gtk_text_iter_get_offset (&end))
    return FALSE;
  ...
  __gtk_text_view_get_iter_at_location (GTK_TEXT_VIEW (text_view), &iter, x, y);
  ...
  if (hovering_over_link != priv->hovering_over_link)
    {
      ...
      if (hovering_over_link)
        __gdk_window_set_cursor (__gtk_text_view_get_window (text_view, GTK_TEXT_WINDOW_TEXT), priv->hand_cursor);
      else
        __gdk_window_set_cursor (__gtk_text_view_get_window (text_view, GTK_TEXT_WINDOW_TEXT), priv->regular_cursor);
    }
               ...
               GtkWrapMode      wrap_mode)
{
  ...
  if (style_link_color)
    {
      ...
      __gdk_color_free (style_link_color);
    }
  else
  ...
  view = __gtk_text_view_new ();
  text_view = GTK_TEXT_VIEW (view);
  buffer = __gtk_text_view_get_buffer (text_view);
  __gtk_text_view_set_cursor_visible (text_view, FALSE);
  __gtk_text_view_set_editable (text_view, FALSE);
  __gtk_text_view_set_wrap_mode (text_view, wrap_mode);

  __gtk_text_view_set_left_margin (text_view, 8);
  __gtk_text_view_set_right_margin (text_view, 8);
          ...
          if (q1 && q2)
            {
              ...
              if (*q1 == '<')
                {
                  __gtk_text_buffer_insert_at_cursor (buffer, q0, (q1 - q0) + 1);
                ...
                {
                  __gtk_text_buffer_insert_at_cursor (buffer, q0, q1 - q0);
                  __gtk_text_buffer_get_end_iter (buffer, &end);
                  link_type = "uri";
                }
              ...
              tag = __gtk_text_buffer_create_tag (buffer, NULL,
              ...
              __gtk_text_buffer_insert_with_tags (buffer, &end, link, -1, tag, NULL);

              g_free (link);
            }
          else
            {
              __gtk_text_buffer_insert_at_cursor (buffer, q0, -1);
              break;
            }
        }

      if (p[1])
        __gtk_text_buffer_insert_at_cursor (buffer, "\n", 1);
    }

  __gtk_widget_show (view);
  return view;
}
                  ...
                  gchar         **people)
{
  ...
  sw = __gtk_scrolled_window_new (NULL, NULL);
  __gtk_scrolled_window_set_shadow_type (GTK_SCROLLED_WINDOW (sw),
                                       GTK_SHADOW_IN);
  __gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (sw),
                                  GTK_POLICY_AUTOMATIC,
                                  GTK_POLICY_AUTOMATIC);
  __gtk_container_add (GTK_CONTAINER (sw), view);

  __gtk_notebook_append_page (GTK_NOTEBOOK (notebook),
                            sw, __gtk_label_new (title));
}
                        ...
                        gpointer   data)
{
  ...
  GtkDialogProps *credits_dialog_props;

  if (priv->credits_dialog != NULL)
    {
      __gtk_window_present (GTK_WINDOW (priv->credits_dialog));
      return;
    }

  dialog = __gtk_dialog_new_with_buttons (_("Credits"),
                                        GTK_WINDOW (about),
                                        GTK_DIALOG_DESTROY_WITH_PARENT,
                                        GTK_STOCK_CLOSE, GTK_RESPONSE_CANCEL,
                                        NULL);
  credits_dialog = GTK_DIALOG (dialog);
  credits_dialog_props = gtk_dialog_get_props (credits_dialog);
  __gtk_dialog_set_has_separator (credits_dialog, FALSE);
  __gtk_container_set_border_width (GTK_CONTAINER (credits_dialog), 5);
  __gtk_box_set_spacing (GTK_BOX (credits_dialog_props->vbox), 2); /* 2 * 5 + 2 = 12 */
  __gtk_container_set_border_width (GTK_CONTAINER (credits_dialog_props->action_area), 5);

  priv->credits_dialog = dialog;
  __gtk_window_set_default_size (GTK_WINDOW (dialog), 360, 260);
  __gtk_dialog_set_default_response (credits_dialog, GTK_RESPONSE_CANCEL);

  __gtk_window_set_modal (GTK_WINDOW (dialog),
                        __gtk_window_get_modal (GTK_WINDOW (about)));

  g_signal_connect (dialog, "response",
                    G_CALLBACK (__gtk_widget_destroy), dialog);
                        ...
                        gpointer   data)
{
  ...
  GtkDialogProps *licence_dialog_props;
  gchar *strings[2];

  if (priv->license_dialog != NULL)
    {
      __gtk_window_present (GTK_WINDOW (priv->license_dialog));
      return;
    }

  dialog = __gtk_dialog_new_with_buttons (_("License"),
                                        GTK_WINDOW (about),
                                        GTK_DIALOG_DESTROY_WITH_PARENT,
                                        GTK_STOCK_CLOSE, GTK_RESPONSE_CANCEL,
                                        NULL);
  licence_dialog = GTK_DIALOG (dialog);
  licence_dialog_props = gtk_dialog_get_props (licence_dialog);
  __gtk_dialog_set_has_separator (licence_dialog, FALSE);
  __gtk_container_set_border_width (GTK_CONTAINER (licence_dialog), 5);
  __gtk_box_set_spacing (GTK_BOX (licence_dialog_props->vbox), 2); /* 2 * 5 + 2 = 12 */
  __gtk_container_set_border_width (GTK_CONTAINER (licence_dialog_props->action_area), 5);

  priv->license_dialog = dialog;
  __gtk_window_set_default_size (GTK_WINDOW (dialog), 420, 320);
  __gtk_dialog_set_default_response (licence_dialog, GTK_RESPONSE_CANCEL);
  ...
  sw = __gtk_scrolled_window_new (NULL, NULL);
  __gtk_container_set_border_width (GTK_CONTAINER (sw), 5);
  __gtk_scrolled_window_set_shadow_type (GTK_SCROLLED_WINDOW (sw),
                                       GTK_SHADOW_IN);
  __gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (sw),
                                  GTK_POLICY_NEVER,
...
/**
 * __gtk_about_dialog_set_email_hook:
 ...
 *
 * Since 2.18 there exists a default function which uses __gtk_show_uri(). To
...
__gtk_about_dialog_set_email_hook (GtkAboutDialogActivateLinkFunc func,
                                 gpointer                       data,
 ...
 */
GtkAboutDialogActivateLinkFunc
__gtk_about_dialog_set_url_hook (GtkAboutDialogActivateLinkFunc func,
                               gpointer                       data,
                               GDestroyNotify                 destroy)
{
  GtkAboutDialogActivateLinkFunc old;
...
close_cb (GtkAboutDialog *about)
{
  ...
  if (priv->license_dialog != NULL)
    {
      __gtk_widget_destroy (priv->license_dialog);
      priv->license_dialog = NULL;
    }

  if (priv->credits_dialog != NULL)
    {
      __gtk_widget_destroy (priv->credits_dialog);
      priv->credits_dialog = NULL;
    }

  __gtk_widget_hide (GTK_WIDGET (about));

}

/**
 * __gtk_show_about_dialog:
 ...
 */
void
__gtk_show_about_dialog (GtkWindow   *parent,
                       ...
                       ...)
{
  ...
  if (!dialog)
    {
      dialog = __gtk_about_dialog_new ();

      g_object_ref_sink (dialog);

      g_signal_connect (dialog, "delete-event",
                        G_CALLBACK (__gtk_widget_hide_on_delete), NULL);
      ...
      if (parent)
        {
          __gtk_window_set_transient_for (GTK_WINDOW (dialog), parent);
